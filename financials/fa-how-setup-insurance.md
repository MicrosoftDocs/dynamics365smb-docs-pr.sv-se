---
title: "Så här: Skapa försäkring för anläggningstillgångar | Microsoft Docs"
description: "Beskriver hur du ställer in systemet för försäkring för anläggningstillgångar."
...
1. I det övre högra hörnet väljer du ikonen **Sök efter sidan eller rapporten** ![Sök efter sidan eller rapporten](media/ui-search/search_small.png "Sök efter sidan eller rapporten"), ange **Inställningar i anl.**, och välj sedan relaterad länk.  
...
1. I det övre högra hörnet väljer du ikonen **Sök efter sidan eller rapporten** ![Sök efter sidan eller rapporten](media/ui-search/search_small.png "Sök efter sidan eller rapporten"), ange **Försäkringsjournalmallar**, och välj sedan relaterad länk.  
2. Fyll i fälten om det behövs.
