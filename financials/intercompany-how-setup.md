...
---
# <a name="how-to-set-up-intercompany"></a>Så här konfigurerar du Koncernintern
...
3. Öppna kortet för en leverantör som är en koncernintern partner. Mer information finns i [Så här registrerar du nya leverantörer](purchasing-how-register-new-vendors.md).
