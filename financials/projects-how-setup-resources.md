---
title: "Så här ställer du in resurser | Microsoft Docs"
description: "Beskriver hur du förbereder systemet till att använda resurser i projekt."
...
1. I det övre högra hörnet väljer du ikonen **Sök efter sidan eller rapporten** ![Sök efter sidan eller rapporten](media/ui-search/search_small.png "ikonen Sök efter sidan eller rapporten"), anger **Resursgrupper** och väljer sedan relaterad länk.
2. Välj åtgärden **Ny**.
