...
Artiklar kan vara både lagerartiklar och tjänster, betecknade med typerna **objekt - lager** och **objekt - tjänst** på försäljningsraderna. Försäljningsorderprocessen är samma för båda artikeltyper. Mer information finns i [Så här registrerar du nya artiklar](inventory-how-register-new-items.md).
