---
title: "Så här anskaffar du anläggningstillgångar | Microsoft Docs"
description: "Beskriver hur du skapar och anskaffar en anläggningstillgång."
...
6. I det övre högra hörnet väljer du ikonen **Sök efter sidan eller rapporten** ![Sök efter sidan eller rapporten](media/ui-search/search_small.png "Sök efter sidan eller rapporten"), ange **Inställningar för anläggningstillgångar**, och välj sedan relaterad länk.
...
1. I det övre högra hörnet väljer du ikonen **Sök efter sidan eller rapporten** ![Sök efter sidan eller rapporten](media/ui-search/search_small.png "Sök efter sidan eller rapporten"), ange **Rätta anl.trans.**, och välj sedan relaterad länk.
