...
## <a name="to-track-the-status-of-a-configuration-project"></a>Spåra statusen för ett konfigurationsprojekt  
...
## <a name="to-see-a-filtered-view-of-table-status"></a>Se en filtrerad vy över tabellstatusen  
