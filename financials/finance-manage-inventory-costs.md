...
|**Om du vill**|**Gå till**|  
|------------|-------------|  
|Läs information om olika begrepp för att förstå principerna och definitionerna som styr lagerkostnadsredovisningsfunktionen i [!INCLUDE[d365fin_long](includes/d365fin_long_md.md)].|[Om Lagerkostnad](finance-learn-about-costing.md)|  
...
|Du måste regelbundet uppdatera standardkostnader för komponenter i monterings- eller produktionsstrukturer och överföra de nya kostnaderna till den överordnade artikeln.|[Så här kan du uppdatera standardkostnader](finance-how-to-update-standard-costs.md)|
