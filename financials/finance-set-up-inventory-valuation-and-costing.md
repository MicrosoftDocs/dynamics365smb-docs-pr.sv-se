...
|**Om du vill**|**Gå till**|  
|------------|-------------|  
|ange en värderingsprincip för varje artikel för att styra hur dess ingående kostnad används för att fastställa lagervärde och kostnaden för sålda varor.|[Så här registrerar du nya objekt](inventory-how-register-new-items.md)|  
...
|ställa in systemet till att automatiskt justera för alla kostnadsändringar varje gång du bokför lagertransaktioner.|[Så här justerar du artikelkostnader](inventory-how-adjust-item-costs.md)|  
...
|definiera lagerperioder för att kontrollera lagervärde över tid genom att inaktivera transaktionsbokföring i avslutade lagerperioder.|[Så här kan du arbeta med lagerperioder](finance-how-to-work-with-inventory-periods.md)|  
