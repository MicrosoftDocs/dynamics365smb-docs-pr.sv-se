...
## <a name="using-the-order-planning-window"></a>Använda fönstret Orderplanering  
 Fönstret **Orderplanering** kan öppnas från flera olika ställen på menyn **Avdelningar** i navigeringsrutan:  

-   Produktion, Planering  
-   Försäljning och marknadsföring, Orderbearbetning  
-   Inköp, Planering  
-   Du kan dessutom öppna fönstret för en specifik produktionsorder genom att välja **Planering** på fliken **Analysera** i gruppen **Order**.  
