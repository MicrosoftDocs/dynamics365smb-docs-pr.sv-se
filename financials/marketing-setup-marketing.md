---
title: "Ställa in Kundhantering | Microsoft Docs"
description: "Beskriver hur du skapar marknadsförings- och kontakthantering i Financials "
...
Du kan skapa marknadsförings- och kontakthantering från fönstret **Marknadsföringsinställningar**. För att öppna fönstret **Marknadsföringsinställning** i det övre högra hörnet ikonen **Sök efter sidan eller rapporten** ![Sök efter sidan eller rapporten](media/ui-search/search_small.png "ikonen Sök efter sidan eller rapporten"), ange **Marknadsföringsinställning**, och välj sedan relaterad länk.

## <a name="automatically-copy-specific-information-from-the-contact-companies-to-the-contact-persons"></a>Automatisk kopiering av särskild information från kontaktföretag till kontaktpersoner
...
## <a name="use-predefined-defaults-on-new-contacts"></a>Använd fördefinierade standardinställningar på nya kontakter
...
## <a name="automatically-record-interactions"></a>Automatiskt registrerade interaktioner
...
## <a name="synchronize-contacts-with-customers-and-more"></a>Synkronisera kontakter med kunder och fler
...
## <a name="assign-a-number-series-to-contacts-and-opportunities"></a>Tilldela en nummerserie för kontakter och affärsmöjligheter
...
## <a name="search-for-duplicate-contacts-when-contacts-are-created"></a>Söka efter dubbelkontakter, när kontakter skapas
...
## <a name="set-up-email-logging"></a>Konfigurera e-postloggning
