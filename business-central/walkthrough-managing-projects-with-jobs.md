...
---
# <a name="walkthrough-managing-projects"></a>Genomgång: Hantera projekt med Projekt
...
### <a name="setting-up-a-project"></a>Lägga upp ett projekt
...
### <a name="to-create-a-project-journal-batch"></a>Skapa en ny journal
...
## <a name="setting-up-a-project-1"></a>Lägga upp ett projekt
...
### <a name="to-set-up-a-project"></a>Så här lägger du upp ett projekt:
...
### <a name="to-enter-hours-in-a-project-journal"></a>Så här registrerar du timmar i projektjournalen
...
### <a name="to-copy-a-project"></a>Så här kopierar du ett projekt
