...
description: I den här genomgången får du en introduktion till projekthanteringsfunktionerna som låter dig schemalägga användningen av ditt företags resurser.
author: brentholtorf
ms.topic: conceptual
ms.devlang: al
...
### <a name="copying-a-project"></a>Kopiera projekt
...
I kontraktets totalpris finns endast de ursprungligen kontrakterade 30 timmarna som har överenskommits med kunden.  
