...
ms.author: edupont
---
# <a name="set-up-document-sending-profiles" />Skapa dokumentutskicksprofiler
...
## <a name="to-set-up-a-document-sending-profile" />Så här konfigurerar du en dokumentutskicksprofil
...
## <a name="to-specify-a-sending-profile-on-a-customer-card" />Så här anger du en utskicksprofil på ett kundkort
