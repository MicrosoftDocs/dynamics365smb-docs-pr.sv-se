...
ms.author: edupont
---
# <a name="set-up-document-sending-profiles"></a><a name="set-up-document-sending-profiles"></a>Skapa dokumentutskicksprofiler
...
## <a name="to-set-up-a-document-sending-profile"></a><a name="to-set-up-a-document-sending-profile"></a>Så här konfigurerar du en dokumentutskicksprofil
...
## <a name="to-specify-a-sending-profile-on-a-customer-card"></a><a name="to-specify-a-sending-profile-on-a-customer-card"></a>Så här anger du en utskicksprofil på ett kundkort
