...
ms.author: edupont
---
# <a name="set-up-fixed-asset-maintenance"></a><a name="set-up-fixed-asset-maintenance"></a><a name="set-up-fixed-asset-maintenance"></a>Skapa underhåll för anläggningstillgångar
...
## <a name="to-set-up-general-maintenance-information"></a><a name="to-set-up-general-maintenance-information"></a><a name="to-set-up-general-maintenance-information"></a>Så här ställer du in allmän underhållsinformation
...
## <a name="to-set-up-maintenance-codes"></a><a name="to-set-up-maintenance-codes"></a><a name="to-set-up-maintenance-codes"></a>Så här skapar du underhållskoder
...
## <a name="to-set-up-maintenance-expense-accounts"></a><a name="to-set-up-maintenance-expense-accounts"></a><a name="to-set-up-maintenance-expense-accounts"></a>Så här skapar du underhållskostnader
