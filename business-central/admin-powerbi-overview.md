...
---
# <a name="power-bi-integration-component-and-architecture-overview-for-"></a><a name="power-bi-integration-component-and-architecture-overview-for-prod_short"></a>Power BI-integreringskomponent och arkitekturöversikt för [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="components"></a><a name="components"></a>Komponenter
...
## <a name="whats-available-from-the-start"></a><a name="whats-available-from-the-start"></a>Vad finns tillgängligt från början?
...
## <a name="general-flow"></a><a name="general-flow"></a>Allmänt flöde
