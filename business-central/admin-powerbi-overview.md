...
---
# <a name="power-bi-integration-component-and-architecture-overview"></a>Power BI-integreringskomponent och arkitekturöversikt för [!INCLUDE[prod_short](includes/prod_short.md)]
