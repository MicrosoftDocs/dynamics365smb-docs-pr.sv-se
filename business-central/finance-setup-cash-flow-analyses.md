...
ms.author: bholtorf
---
# <a name="setting-up-cash-flow-analysis"></a><a name="setting-up-cash-flow-analysis"></a>Ställa in analysvy för kassaflöde
...
## <a name="the-cash-cycle-and-income--expense-charts"></a><a name="the-cash-cycle-and-income--expense-charts"></a>Kassacykeln och diagram för inkomster och utgifter
...
## <a name="set-up-the-cash-flow-chart"></a><a name="set-up-the-cash-flow-chart"></a>Konfigurera kassaflödesdiagrammet
...
## <a name="set-up-cash-flow-forecasts"></a><a name="set-up-cash-flow-forecasts"></a>Konfigurera kassaflödesprognoser.
...
## <a name="design-details"></a><a name="design-details"></a>Designinformation
...
### <a name="data-required-for-forecast"></a><a name="data-required-for-forecast"></a>Data som krävs för prognoser
...
#### <a name="receivables"></a><a name="receivables"></a>Kundreskontra
...
#### <a name="payables"></a><a name="payables"></a>Leverantörsreskontra
...
#### <a name="tax"></a><a name="tax"></a>Moms
...
## <a name="create-and-use-your-own-predictive-web-service-for-cash-flow-forecasts"></a><a name="create-and-use-your-own-predictive-web-service-for-cash-flow-forecasts"></a><a name="AnchorText"></a>Skapa och använda en egen prediktiv webbtjänst för kassaflödesprognoser
