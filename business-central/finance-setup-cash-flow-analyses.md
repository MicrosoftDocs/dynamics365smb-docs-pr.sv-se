...
ms.author: bholtorf
---
# <a name="setting-up-cash-flow-analysis" />Ställa in analysvy för kassaflöde
...
## <a name="the-cash-cycle-and-income--expense-charts" />Kassacykeln och diagram för inkomster och utgifter
...
## <a name="set-up-the-cash-flow-chart" />Konfigurera kassaflödesdiagrammet
...
## <a name="set-up-cash-flow-forecasts" />Konfigurera kassaflödesprognoser.
...
#### <a name="receivables" />Kundreskontra
...
#### <a name="payables" />Leverantörsreskontra
