...
ms.author: edupont
---
# <a name="create-recurring-sales"></a><a name="create-recurring-sales"></a>Skapa återkommande försäljning
...
## <a name="set-up-recurring-sales-lines"></a><a name="set-up-recurring-sales-lines"></a>Skapa återkommande försäljningsrader
...
## <a name="assign-recurring-sales-lines-to-a-customer"></a><a name="assign-recurring-sales-lines-to-a-customer"></a>Tilldela återkommande försäljningsrader till kunder
...
## <a name="insert-recurring-sales-lines-on-a-sales-invoice"></a><a name="insert-recurring-sales-lines-on-a-sales-invoice"></a>Infoga återkommande försäljningsrader i en försäljningsfaktura
...
## <a name="create-multiple-sales-invoices-based-on-recurring-sales-lines"></a><a name="create-multiple-sales-invoices-based-on-recurring-sales-lines"></a>Skapa flera försäljningsfakturor utifrån återkommande försäljningsrader
