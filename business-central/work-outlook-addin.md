...
ms.author: jswymer
---
# <a name="use-business-central-as-your-business-inbox-in-outlook" />Använda Business Central som din företagsinkorg i Outlook
...
## <a name="work-with-contacts-and-documents-using-the-contact-insights-add-in" />Arbeta med kontakter och dokument med hjälp av tillägget för information om kontakter
...
### <a name="look-up-a-business-contact-when-composing-an-email" />Slå upp en företagskontakt när du skriver ett e-postmeddelande
...
### <a name="view-and-change-the-contact-details-or-switch-company" />Visa och ändra kontaktinformation eller växla företag
...
### <a name="track-incoming-documents" />Spåra inkommande dokument
...
### <a name="create-and-send-new-document-to-a-contact" />Skapa och skicka ett nytt dokument till en kontakt
...
### <a name="attach-files-to-records" />Bifoga filer till poster
...
#### <a name="how-to-attach-a-file" />Så här bifogar du en fil
...
## <a name="view-a-document-from-an-email-using-the-document-view-add-in" />Visa ett dokument från ett e-postmeddelande med tillägget dokumentvisning
