...
## <a name="see-related-microsoft-trainingtrainingmodulesset-up-assembly-items-dynamics--business-central" />Se relaterad [Microsoft-utbildning](/training/modules/set-up-assembly-items-dynamics-365-business-central/).
