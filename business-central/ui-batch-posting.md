...
ms.author: edupont
---
# <a name="post-multiple-documents-at-the-same-time" />Bokföra flera dokument på samma gång
...
## <a name="to-post-multiple-purchase-orders-immediately" />Så här bokför du flera inköpsorder direkt
...
## <a name="to-batch-post-multiple-purchase-orders" />Så här bokför du flera inköpsorder
...
## <a name="to-set-up-background-posting-with-job-queues" />Att ställa in bakgrundsbokföring med jobbköer
...
### <a name="to-view-status-from-a-sales-or-purchase-document" />Så här visar du status från ett försäljnings- eller inköpsdokument
...
## <a name="to-create-a-job-queue-entry-for-batch-posting-of-sales-orders" />Skapa en jobbkötransaktion för batchbokföring av försäljningsorder
...
## <a name="monitor-the-job-queue" />Övervaka jobbkön
