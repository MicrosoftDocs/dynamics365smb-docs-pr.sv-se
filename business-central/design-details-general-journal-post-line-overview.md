...
ms.author: edupont
---
# <a name="general-journal-post-line-overview" />Översikt över bokföring av rad i redovisningsjournalen
...
## <a name="old-architecture" />Gammal arkitektur
...
### <a name="new-architecture" />Ny arkitektur
