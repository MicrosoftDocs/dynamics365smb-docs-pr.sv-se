...
ms.author: edupont
---
# <a name="general-journal-post-line-overview"></a><a name="general-journal-post-line-overview"></a>Översikt över bokföring av rad i redovisningsjournalen
...
## <a name="old-architecture"></a><a name="old-architecture"></a>Gammal arkitektur
...
### <a name="new-architecture"></a><a name="new-architecture"></a>Ny arkitektur
