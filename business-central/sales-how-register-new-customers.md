...
ms.author: edupont
---
# <a name="register-new-customers"></a><a name="register-new-customers"></a><a name="register-new-customers"></a>Registrera nya kunder
...
## <a name="adding-new-customers"></a><a name="adding-new-customers"></a><a name="adding-new-customers"></a>Lägga till nya kunder
...
### <a name="to-create-a-new-customer-card"></a><a name="to-create-a-new-customer-card"></a><a name="to-create-a-new-customer-card"></a>SÅ här skapar du ett nytt kundkort
...
### <a name="to-save-the-customer-card-as-a-template"></a><a name="to-save-the-customer-card-as-a-template"></a><a name="to-save-the-customer-card-as-a-template"></a>Om du vill spara kundkortet som en mall
...
## <a name="deleting-customer-cards"></a><a name="deleting-customer-cards"></a><a name="deleting-customer-cards"></a>Ta bort kundkort
...
## <a name="managing-credit-limits"></a><a name="managing-credit-limits"></a><a name="managing-credit-limits"></a>Hantera kreditlimits
...
### <a name="to-specify-credit-limit-warnings"></a><a name="to-specify-credit-limit-warnings"></a><a name="to-specify-credit-limit-warnings"></a>Så här anger du varningar om kreditlimit
