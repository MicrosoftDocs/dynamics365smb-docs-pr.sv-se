...
ms.author: edupont
---
# <a name="copy-existing-items-to-create-new-items" />Kopiera befintliga artiklar till Skapa nya artiklar
...
## <a name="to-copy-an-existing-item-to-a-new-item" />Kopiera ett befintligt objekt till ett nytt objekt.
