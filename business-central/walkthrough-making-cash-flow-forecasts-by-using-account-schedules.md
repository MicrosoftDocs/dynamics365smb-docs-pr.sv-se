...
ms.author: edupont
---
# <a name="walkthrough-making-cash-flow-forecasts-using-financial-reports" />Genomgång: Utföra kassaflödesprognoser med hjälp av ekonomiska rapporter
...
## <a name="setting-up-a-new-financial-report-name" />Lägga upp ett nytt namn för ekonomisk rapport
...
### <a name="set-up-a-new-financial-report-name" />Lägga upp ett nytt namn för ekonomisk rapport
...
## <a name="setting-up-row-definition-lines" />Ställa in raddefinitionsrader
...
### <a name="set-up-row-definition-lines" />Ställa in raddefinitionsrader
...
## <a name="setting-up-a-new-column-definition" />Skapa en ny kolumndefinition
...
### <a name="set-up-a-new-column-definition" />Lägga upp en ny kolumndefinition
...
## <a name="assigning-the-column-definition-to-the-financial-report-name" />Tilldela en kolumndefinition till namnet på den ekonomiska rapporten

Nu kan Ken koppla kolumndefinitionen till namnet på den ekonomiska rapporten.  

### <a name="assign-the-column-definition-to-the-financial-report-name" />Tilldela en kolumndefinition till namnet på den ekonomiska rapporten
...
## <a name="view-and-print-the-cash-flow-forecast" />Visa och skriv ut kassaflödesprognosen
...
## <a name="see-related-microsoft-trainingtrainingmodulesforecast-cash-flow-dynamics-365-business-central" />Se relaterad [Microsoft utbildning](/training/modules/forecast-cash-flow-dynamics-365-business-central/)
