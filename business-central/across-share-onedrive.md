...
ms.author: jswymer
---
# <a name="opening-and-sharing-business-central-files-in-microsoft-onedrive" />Öppna och dela Business Central-filer i Microsoft OneDrive
...
## <a name="open-in-onedrive" />Öppna i OneDrive
...
## <a name="first-time-sign-in-from-business-central" />Första gången du loggar in från Business Central
...
## <a name="managing-multiple-copies-of-a-file" />Hantera flera kopior av en fil
...
## <a name="about-your-business-central-folder-on-onedrive" />Om din Business Central-mapp på OneDrive
