...
Ibland är den part som tar emot en service inte densamma som den part som betalar räkningen. På sidan **Projekt** kan du ange kunden som kommer att dra nytta av projektet i **Sälja till** och parten som ska faktureras i **Fakturera till**. Du kan också ange var arbetet ska utföras genom att välja från en lista över leveransadresser för kunden, lägga till information om externa referenser för att förenkla kommunikationen med projektet och skriva över projektets standard ekonomiska villkor.
