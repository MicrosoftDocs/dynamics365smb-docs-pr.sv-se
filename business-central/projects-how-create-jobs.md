...
ms.author: edupont
---
# <a name="create-jobs"></a><a name="create-jobs"></a><a name="create-jobs"></a>Skapa projekt
...
## <a name="to-create-a-job-card"></a><a name="to-create-a-job-card"></a><a name="to-create-a-job-card"></a>Så här skapar du ett projektkort.
...
## <a name="to-create-tasks-for-a-job"></a><a name="to-create-tasks-for-a-job"></a><a name="to-create-tasks-for-a-job"></a>Skapa aktiviteter för ett projekt
...
## <a name="to-create-planning-lines-for-a-job"></a><a name="to-create-planning-lines-for-a-job"></a><a name="to-create-planning-lines-for-a-job"></a>Så här skapar du en planeringsrad för ett projekt
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relaterad [Microsoft utbildning](/training/modules/create-new-job/)
