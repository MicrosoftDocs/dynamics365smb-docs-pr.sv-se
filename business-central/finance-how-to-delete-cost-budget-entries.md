...
ms.author: edupont
---
# <a name="delete-cost-budget-entries"></a><a name="delete-cost-budget-entries"></a><a name="delete-cost-budget-entries"></a>Ta bort kostnadsbudgettransaktioner
...
## <a name="to-delete-a-cost-budget-entry"></a><a name="to-delete-a-cost-budget-entry"></a><a name="to-delete-a-cost-budget-entry"></a>Ta bort kostnadsbudgettransaktioner
