...
ms.author: bholtorf
---
# <a name="define-retention-policies"></a><a name="define-retention-policies"></a>Definiera bevarandeprinciper
...
## <a name="required-setups-and-permissions"></a><a name="required-setups-and-permissions"></a>Nödvändiga konfigurationer och behörigheter
...
### <a name="to-create-retention-periods"></a><a name="to-create-retention-periods"></a>Så här skapar du perioder för lagring
...
### <a name="set-up-a-retention-policy"></a><a name="set-up-a-retention-policy"></a>Konfigurera en bevarandeprincip
...
## <a name="applying-retention-policies"></a><a name="applying-retention-policies"></a>Tillämpa bevarandeprinciper
...
## <a name="viewing-retention-policy-log-entries"></a><a name="viewing-retention-policy-log-entries"></a>Visa loggposter för bevarandeprincip
...
## <a name="including-your-extension-in-a-retention-policy-requires-help-from-a-developer"></a><a name="including-your-extension-in-a-retention-policy-requires-help-from-a-developer"></a>Inkludera tillägget i en bevarandeprincip (kräver hjälp från en utvecklare)
