...
ms.author: bholtorf
---
# <a name="define-retention-policies" />Definiera bevarandeprinciper
...
## <a name="required-setups-and-permissions" />Nödvändiga konfigurationer och behörigheter
...
### <a name="to-create-retention-periods" />Så här skapar du perioder för lagring
...
### <a name="set-up-a-retention-policy" />Konfigurera en bevarandeprincip
...
## <a name="applying-retention-policies" />Tillämpa bevarandeprinciper
...
## <a name="viewing-retention-policy-log-entries" />Visa loggposter för bevarandeprincip
...
## <a name="including-your-extension-in-a-retention-policy-requires-help-from-a-developer" />Inkludera tillägget i en bevarandeprincip (kräver hjälp från en utvecklare)
