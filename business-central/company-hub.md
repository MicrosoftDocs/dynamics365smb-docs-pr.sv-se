...
# <a name="manage-work-across-multiple-companies-in-the-company-hub"></a><a name="manage-work-across-multiple-companies-in-the-company-hub"></a>Hantera arbete i flera företag med företagsnavet
...
## <a name="company-hub-home-page"></a><a name="company-hub-home-page"></a>Företagetsnavets hemsida
...
## <a name="assigned-tasks"></a><a name="assigned-tasks"></a>Tilldelade uppgifter
...
### <a name="my-user-tasks"></a><a name="my-user-tasks"></a>Mina användaruppgifter
...
## <a name="access-the-company-hub"></a><a name="access-the-company-hub"></a>Komma åt företagsnavet
...
## <a name="set-up-the-company-hub"></a><a name="set-up-the-company-hub"></a>Ställa in företagsnavet
