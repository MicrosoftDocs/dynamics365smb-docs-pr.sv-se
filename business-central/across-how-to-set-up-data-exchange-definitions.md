...
### <a name="to-map-columns-in-the-data-file-to-fields-in-prod_short"></a><a name=mapfields></a>Mappa kolumner i datafilen till fält i [!INCLUDE[prod_short](includes/prod_short.md)]
