...
ms.author: bholtorf
---
# <a name="set-up-data-exchange-definitions" />Skapa dataintegreringsdefinitioner
...
## <a name="create-a-data-exchange-definition" />Skapa en datautbytesdefinition
...
## <a name="transformation-rules" />Omvandlingsregler
...
### <a name="tip-for-developers-example-of-the-custom-option" />Tips för utvecklare: exempel på det anpassade alternativet
...
## <a name="export-a-data-exchange-definition-as-an-xml-file-for-use-by-others" />Exportera en datautbytesdefinition som en XML-fil som andra ska använda
...
## <a name="import-an-existing-data-exchange-definition" />Importera en befintlig datautbytesdefinition
