...
ms.author: edupont
---
# <a name="set-up-resources-for-projects"></a><a name="set-up-resources-for-projects"></a>Konfigurera resurser för projekt
...
## <a name="to-set-up-a-resource"></a><a name="to-set-up-a-resource"></a>Så här skapar du resurser
...
## <a name="to-set-up-a-resource-group"></a><a name="to-set-up-a-resource-group"></a>Så här skapar du en resursgrupp
...
## <a name="to-set-capacity-for-a-resource"></a><a name="to-set-capacity-for-a-resource"></a>Ställa in kapaciteten för en resurs
...
## <a name="to-set-up-alternate-resource-costs"></a><a name="to-set-up-alternate-resource-costs"></a>Så här skapar du alternativa resurskostnader
...
## <a name="to-set-up-alternate-resource-prices"></a><a name="to-set-up-alternate-resource-prices"></a>Så här skapar du alternativa resurspriser
