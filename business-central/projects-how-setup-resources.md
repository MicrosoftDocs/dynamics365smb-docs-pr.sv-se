...
ms.author: edupont
---
# <a name="set-up-resources-for-projects" />Konfigurera resurser för projekt
...
## <a name="to-set-up-a-resource" />Så här skapar du resurser
...
## <a name="to-set-up-a-resource-group" />Så här skapar du en resursgrupp
...
## <a name="to-set-capacity-for-a-resource" />Ställa in kapaciteten för en resurs
...
## <a name="to-set-up-alternate-resource-costs" />Så här skapar du alternativa resurskostnader
...
## <a name="to-set-up-alternate-resource-prices" />Så här skapar du alternativa resurspriser
