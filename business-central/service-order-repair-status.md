...
ms.author: edupont
---
# <a name="set-up-statuses-for-service-orders-and-repairs"></a><a name="set-up-statuses-for-service-orders-and-repairs"></a><a name="set-up-statuses-for-service-orders-and-repairs"></a>Ställ in status för serviceorder och reparationer
...
## <a name="to-set-up-service-status-priorities"></a><a name="to-set-up-service-status-priorities"></a><a name="to-set-up-service-status-priorities"></a>Så här skapar du servicestatusprioriteter
...
## <a name="to-set-up-a-repair-status"></a><a name="to-set-up-a-repair-status"></a><a name="to-set-up-a-repair-status"></a>Så här skapar du en reparationsstatus
