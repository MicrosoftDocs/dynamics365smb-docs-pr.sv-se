...
# <a name="bookmark-a-page-or-report-on-your-role-center" />Förse en sida eller rapport med ett bokmärke på ditt rollcenter
...
## <a name="to-bookmark-the-target-page" />Så här förser du målsidan med bokmärke
...
## <a name="to-bookmark-the-target-report" />Så här förser du målrapporten med bokmärke
...
## <a name="to-bookmark-a-page-or-report-from-the-tell-me-window" />Så här lägger du till ett bokmärke från en sida eller rapport från fönstret berätta
...
## <a name="frequently-asked-questions" />Vanliga frågor och svar
