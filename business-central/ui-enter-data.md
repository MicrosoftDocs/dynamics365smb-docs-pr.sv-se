...
ms.author: jswymer
---
# <a name="entering-data" />Ange data
...
## <a name="work-with-editable-fields" />Arbeta med redigerbara fält
...
### <a name="modifying-a-field-value" />Ändra ett fältvärde
...
### <a name="how-quick-entry-works" />Hur snabbinmatning fungerar
...
#### <a name="tips-and-tricks" />Tips och råd
...
### <a name="to-change-quick-entry-fields" />Så här ändrar du snabbinmatningsfält
...
## <a name="mandatory-fields" />Obligatoriska fält
...
## <a name="finding-data-as-you-type" />Söka efter data allt eftersom du skriver
...
## <a name="copying-and-pasting-faq-fields-and-lines" />Kopiera och klistra in fält och rader för vanliga frågor
...
## <a name="filtering-line-items" />Filtrera radposter
...
### <a name="switching-the-focus-on-and-off" />Aktivera och inaktivera fokus
...
## <a name="multitasking-across-multiple-pages" />Multikörning över flera sidor
...
## <a name="entering-quantities-by-calculation" />Ange antal genom beräkning
...
## <a name="entering-negative-numbers" />Ange negativa antal
...
## <a name="entering-dates-and-times" />Ange datum och tider
...
## <a name="entering-combined-datetimes" />Ange kombinerade datum och tider
