...
---
# <a name="design-details-planning-parameters" />Designdetaljer: Planeringsparametrar
...
## <a name="define-whether-the-item-is-planned" />Ange om artikeln ska planeras
...
## <a name="define-when-to-reorder" />Definiera när du ska beställa
...
## <a name="define-how-much-to-reorder" />Definiera hur mycket som ska beställas
...
## <a name="optimize-when-and-how-much-to-reorder" />Optimera när och hur mycket som ska beställas
...
## <a name="modify-the-supply-orders" />Ändra leveransorder
...
## <a name="delimit-the-item" />Begränsa artikeln
...
## <a name="use-low-level-codes-to-manage-derived-demand" />Använd lågnivåkoder för att hantera härledd efterfrågan
