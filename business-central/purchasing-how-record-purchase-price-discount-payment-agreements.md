...
ms.author: bholtorf
---
# <a name="record-special-purchase-prices-and-discounts" />Registrera speciella inköpspriser och rabatter
...
## <a name="to-set-up-a-special-purchase-price-for-a-vendor" />Om du vill definiera ett speciellt inköpspris för en leverantör
...
## <a name="to-set-up-a-line-discount-for-a-vendor" />Om du vill definiera en radrabatt för en leverantör
...
## <a name="to-set-up-an-invoice-discount-for-a-vendor" />Så här definierar du radrabatt för en leverantör
...
## <a name="to-choose-a-principle-for-posting-purchase-discounts" />Så här väljer du princip för bokföring av inköpsrabatter:
...
## <a name="purchase-invoice-discounts-and-service-charges" />Inköpsfakturarabatter och faktureringsavgifter
...
## <a name="see-related-microsoft-trainingtrainingmodulesset-up-prices-discounts-dynamics-365-business-centralindex" />Se relaterad [Microsoft utbildning](/training/modules/set-up-prices-discounts-dynamics-365-business-central/index)
