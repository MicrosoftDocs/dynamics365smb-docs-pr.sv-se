...
# <a name="set-up-pricing-and-additional-costs-for-services" />Registrera prissättning och alternativa kostnader för tjänster
...
## <a name="to-set-up-a-service-price-group" />Så här skapar du en serviceprisgrupp
...
## <a name="to-set-up-a-service-price-adjustment-group" />Så här skapar du serviceprisjusteringsgrupper
...
## <a name="to-set-up-additional-costs-for-services" />Så här: registrera alternativa kostnader för tjänster
...
### <a name="to-set-up-service-costs" />Så här skapar du servicekostnader:
...
### <a name="to-specify-a-default-cost-for-service-orders" />Ange standardkostnaden för serviceorder
