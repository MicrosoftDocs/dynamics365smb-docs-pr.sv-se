...
ms.author: solsen
---
# <a name="view-test-reports-before-posting" />Visa testrapporter före bokföring
...
## <a name="to-print-a-test-report-before-posting-a-purchase-invoice" />Så här skriver du ut testrapporter före bokföringen av inköpsfakturor:
