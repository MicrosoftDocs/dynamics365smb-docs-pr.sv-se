...
ms.author: edupont
---
# <a name="set-up-standard-routing-lines"></a><a name="set-up-standard-routing-lines"></a><a name="set-up-standard-routing-lines"></a>Skapa standardverksamhetsföljdrader
...
## <a name="to-set-up-a-standard-task"></a><a name="to-set-up-a-standard-task"></a><a name="to-set-up-a-standard-task"></a>Så här ställer du in standarduppgift
...
## <a name="to-add-a-standard-task-to-an-operation"></a><a name="to-add-a-standard-task-to-an-operation"></a><a name="to-add-a-standard-task-to-an-operation"></a>Lägga till en standarduppgift till en operation
