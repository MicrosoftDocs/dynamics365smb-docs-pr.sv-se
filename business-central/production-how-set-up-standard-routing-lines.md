...
ms.author: edupont
---
# <a name="set-up-standard-routing-lines" />Skapa standardverksamhetsföljdrader
...
## <a name="to-set-up-a-standard-task" />Så här ställer du in standarduppgift
...
## <a name="to-add-a-standard-task-to-an-operation" />Lägga till en standarduppgift till en operation
