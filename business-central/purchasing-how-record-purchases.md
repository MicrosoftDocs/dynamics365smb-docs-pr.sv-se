...
ms.author: edupont
---
# <a name="record-purchases-with-purchase-invoices-and-orders" />Registrera inköp med inköpsfakturor och order
...
## <a name="record-purchases-with-purchase-invoices" />Registrera inköp med inköpsfakturor
...
### <a name="create-a-and-post-purchase-invoice" />Skapa och bokföra inköpsfaktura
...
## <a name="purchasing-non-inventory-items" />Köpa artiklar som inte finns i lager
...
## <a name="when-to-use-purchase-orders" />När inköpsorder ska användas
...
## <a name="receive-items-with-a-purchase-order" />Inleverera artiklar med en inköpsorder
...
## <a name="receive-more-items-than-ordered" />Så här tar du emot fler artiklar än vad som beställts
...
### <a name="set-up-over-receipts" />Så här lägger du upp överinleveranser
...
### <a name="assign-the-over-receipt-code-to-an-item" />Tilldela koden för överinleverans för en artikel
...
### <a name="over-receive-an-order" />Överleverans av en order
...
## <a name="posting-purchases" />Bokföra inköp
...
## <a name="viewing-ledger-entries" />Visa reskontratransaktioner
...
## <a name="editing-ledger-entries" />Redigera reskontratransaktioner
...
## <a name="see-related-microsoft-trainingtrainingmodulesreceive-invoice-dynamics-d365-business-centralindex" />Se relaterad [Microsoft utbildning](/training/modules/receive-invoice-dynamics-d365-business-central/index).

## <a name="see-related-microsoft-trainingtrainingmodulesprocessing-invoices-dynamics-365-business-centralindex" />Se relaterad [Microsoft utbildning](/training/modules/processing-invoices-dynamics-365-business-central/index)
