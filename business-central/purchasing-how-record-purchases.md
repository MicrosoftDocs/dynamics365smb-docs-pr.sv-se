...
ms.author: edupont
---
# <a name="record-purchases-with-purchase-invoices-and-orders"></a><a name="record-purchases-with-purchase-invoices-and-orders"></a><a name="record-purchases-with-purchase-invoices-and-orders"></a>Registrera inköp med inköpsfakturor och order
...
## <a name="record-purchases-with-purchase-invoices"></a><a name="record-purchases-with-purchase-invoices"></a><a name="record-purchases-with-purchase-invoices"></a>Registrera inköp med inköpsfakturor
...
### <a name="create-a-and-post-purchase-invoice"></a><a name="create-a-and-post-purchase-invoice"></a><a name="create-a-and-post-purchase-invoice"></a>Skapa och bokföra inköpsfaktura
...
## <a name="posted-invoices"></a><a name="posted-invoices"></a><a name="posted-invoices"></a>Bokförda fakturor
...
## <a name="purchasing-non-inventory-items"></a><a name="purchasing-non-inventory-items"></a><a name="purchasing-non-inventory-items"></a>Köpa artiklar som inte finns i lager
...
## <a name="when-to-use-purchase-orders"></a><a name="when-to-use-purchase-orders"></a><a name="when-to-use-purchase-orders"></a>När inköpsorder ska användas
...
## <a name="receive-items-with-a-purchase-order"></a><a name="receive-items-with-a-purchase-order"></a><a name="receive-items-with-a-purchase-order"></a>Inleverera artiklar med en inköpsorder
...
## <a name="receive-more-items-than-ordered"></a><a name="receive-more-items-than-ordered"></a><a name="receive-more-items-than-ordered"></a>Så här tar du emot fler artiklar än vad som beställts
...
### <a name="set-up-over-receipts"></a><a name="set-up-over-receipts"></a><a name="set-up-over-receipts"></a>Så här lägger du upp överinleveranser
...
### <a name="assign-the-over-receipt-code-to-an-item"></a><a name="assign-the-over-receipt-code-to-an-item"></a><a name="assign-the-over-receipt-code-to-an-item"></a>Tilldela koden för överinleverans för en artikel
...
### <a name="over-receive-an-order"></a><a name="over-receive-an-order"></a><a name="over-receive-an-order"></a>Överleverans av en order
...
## <a name="external-document-number"></a><a name="external-document-number"></a><a name="external-document-number"></a>Externt dokumentnummer

[!INCLUDE [ext-doc-no-purch](includes/ext-doc-no-purch.md)]

## <a name="posting-purchases"></a><a name="posting-purchases"></a><a name="posting-purchases"></a>Bokföra inköp
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relaterad [Microsoft utbildning](/training/modules/receive-invoice-dynamics-d365-business-central/index).

## <a name="see-related-microsoft-training-1"></a><a name="see-related-microsoft-training-1"></a><a name="see-related-microsoft-training-1"></a>Se relaterad [Microsoft utbildning](/training/modules/processing-invoices-dynamics-365-business-central/index)
