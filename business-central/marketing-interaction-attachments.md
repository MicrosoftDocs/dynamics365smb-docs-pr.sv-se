...
Bilagor kan vara nästan alla typer av filer, till exempel Word-dokument, PowerPoint-presentationer, Excel- eller textfiler, och så vidare.
...
Du kan göra följande saker med bilagor:

* **Öppna**: Du kan starta det kopplade programmet, till exempel Microsoft Word, så öppnas dokumentet. Då kan du ändra i det.
* **Importera**: Du kan importera alla slags bilagor. Du kan till exempel skanna ett brev du fått, importera det och koppla det till interaktionen som registrerar det som mottaget.
* **Exportera**: Du kan exportera bilagor till ett lagerställer i en diskfil.
* **Ta bort**: Du kan ta bort aktuell bilaga från en interaktionsmall.
* **Kopiera**: Du kan kopiera bilagor från andra interaktionsmallar.
