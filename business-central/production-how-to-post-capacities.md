...
ms.author: edupont
---
# <a name="post-capacities" />Bokför kapaciteter
...
## <a name="to-post-capacities" />Så här bokför du kapaciteter
...
## <a name="to-view-work-center-ledger-entries" />Så här visar du produktionsgruppstransaktioner
