...
ms.author: edupont
---
# <a name="post-capacities"></a><a name="post-capacities"></a><a name="post-capacities"></a>Bokför kapaciteter
...
## <a name="to-post-capacities"></a><a name="to-post-capacities"></a><a name="to-post-capacities"></a>Så här bokför du kapaciteter
...
## <a name="to-view-work-center-ledger-entries"></a><a name="to-view-work-center-ledger-entries"></a><a name="to-view-work-center-ledger-entries"></a>Så här visar du produktionsgruppstransaktioner
