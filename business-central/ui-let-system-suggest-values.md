...
ms.author: edupont
---
# <a name="letting-includeprodshortincludesprodshortmd-suggest-values" />Låta [!INCLUDE[prod_short](includes/prod_short.md)] föreslå värden
...
## <a name="the-suggest-balancing-amount-check-box-on-the-general-journal-batches-page" />Kryssrutan **Föreslå saldobelopp** på sidan **Redovisningsjournaler**
...
### <a name="to-have-the-amount-field-on-balancing-general-journal-lines-filled-automatically" />Om du vill ha fältet **Belopp** på balanserande redovisningsjournalrader fyllas i automatiskt
...
## <a name="the-automatically-fill-date-received-field-on-the-payment-registration-page" />Fältet **Fyll i Tillbaka datum automatiskt** på sidan **Betalningregistrering**
...
### <a name="to-have-the-date-received-field-on-the-payment-registration-page-filled-automatically" />Att ha fältet **Fyll i Tillbaka datum automatiskt** på sidan **Betalningregistrering** ifyllt automatiskt.
