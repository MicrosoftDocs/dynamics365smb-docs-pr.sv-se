...
Du kan också definiera rätt detaljnivå i fälten **prognos per lagerställe** och **prognos per variant** på sidan **efterfrågeprognos översikt**. Filter och andra inställningar lagras i tabellen **namn på efterfrågeprognos** så att du enkelt kan stoppa och fortsätta arbetet senare. 
...
### <a name="if-you-dont-use-forecast-by-locations"></a>Om du inte använder prognos efter lagerställen
