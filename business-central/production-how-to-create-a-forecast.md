...
ms.author: edupont
---
# <a name="create-a-demand-forecast" />Skapa en efterfrågeprognos
...
## <a name="sales-forecasts-and-production-forecasts" />Försäljningsprognoser och produktionsprognoser
...
## <a name="component-forecast" />Komponentprognos
...
## <a name="forecasting-periods" />Prognosperioder
...
## <a name="forecast-by-locations" />Prognos efter lagerställen
...
### <a name="use-forecast-by-locations" />Använd prognos efter lagerställen
...
### <a name="do-not-use-forecast-by-locations" />Använd inte prognos efter lagerställen
...
## <a name="to-create-a-demand-forecast" />Att skapa en efterfrågeprognos
