...
ms.author: edupont
---
# <a name="create-a-demand-forecast"></a><a name="create-a-demand-forecast"></a><a name="create-a-demand-forecast"></a>Skapa en efterfrågeprognos
...
## <a name="sales-forecasts-and-production-forecasts"></a><a name="sales-forecasts-and-production-forecasts"></a><a name="sales-forecasts-and-production-forecasts"></a>Försäljningsprognoser och produktionsprognoser
...
## <a name="component-forecast"></a><a name="component-forecast"></a><a name="component-forecast"></a>Komponentprognos
...
## <a name="forecasting-periods"></a><a name="forecasting-periods"></a><a name="forecasting-periods"></a>Prognosperioder
...
## <a name="forecast-by-locations"></a><a name="forecast-by-locations"></a><a name="forecast-by-locations"></a>Prognos efter lagerställen
...
### <a name="use-forecast-by-locations"></a><a name="use-forecast-by-locations"></a><a name="use-forecast-by-locations"></a>Använd prognos efter lagerställen
...
### <a name="do-not-use-forecast-by-locations"></a><a name="do-not-use-forecast-by-locations"></a><a name="do-not-use-forecast-by-locations"></a>Använd inte prognos efter lagerställen
...
## <a name="to-create-a-demand-forecast"></a><a name="to-create-a-demand-forecast"></a><a name="to-create-a-demand-forecast"></a>Att skapa en efterfrågeprognos
