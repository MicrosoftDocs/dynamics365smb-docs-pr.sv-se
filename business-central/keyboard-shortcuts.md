...
|<kbd>Shift</kbd>+klicka|Utöka radmarkeringen så att den rad som du klickar på och samtliga där emellan inkluderas.<br /><br />Du kan använda detta när du har använt <kbd>Ctrl</kbd>+<kbd>uppåtpil</kbd> or <kbd>Ctrl</kbd>+<kbd> nedpil</kbd> för att utöka ditt val.|Ej tillämpbart.|
