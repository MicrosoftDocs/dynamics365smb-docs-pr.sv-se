...
ms.author: jswymer
---
# <a name="analyzing-report-data-with-excel-and-xml" />Analysera rapportdata med Excel och XML
...
## <a name="more-about-excel-data-only" />Mer om Excel (endast data)
...
## <a name="for-administrators" />För administratörer
...
## <a name="for-developers-and-advanced-users" />För utvecklare och erfarna användare
