...
ms.author: edupont
---
# <a name="create-routings"></a><a name="create-routings"></a><a name="create-routings"></a>Skapa verksamhetsföljder
...
## <a name="to-create-a-routing"></a><a name="to-create-a-routing"></a><a name="to-create-a-routing"></a>Så här skapar du en verksamhetsföljd
...
## <a name="to-create-routing-links"></a><a name="to-create-routing-links"></a><a name="to-create-routing-links"></a>Så här skapar du en verksamhetsföljdslänk
...
## <a name="to-assign-personnel-tools-and-quality-measures-to-routing-operations"></a><a name="to-assign-personnel-tools-and-quality-measures-to-routing-operations"></a><a name="to-assign-personnel-tools-and-quality-measures-to-routing-operations"></a>Tilldela personal, verktyg och kvalitetsmått för verksamhetsföljdsuppgifter
...
## <a name="to-create-a-new-versions-of-a-routing"></a><a name="to-create-a-new-versions-of-a-routing"></a><a name="to-create-a-new-versions-of-a-routing"></a>Så här skapar du nya versioner av verksamhetsföljder
