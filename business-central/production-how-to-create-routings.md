...
ms.author: edupont
---
# <a name="create-routings" />Skapa verksamhetsföljder
...
## <a name="to-create-a-routing" />Så här skapar du en verksamhetsföljd
...
## <a name="to-create-routing-links" />Så här skapar du en verksamhetsföljdslänk
...
## <a name="to-assign-personnel-tools-and-quality-measures-to-routing-operations" />Tilldela personal, verktyg och kvalitetsmått för verksamhetsföljdsuppgifter
...
## <a name="to-create-a-new-versions-of-a-routing" />Så här skapar du nya versioner av verksamhetsföljder
