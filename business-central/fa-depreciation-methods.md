...
ms.author: edupont
---
# <a name="depreciation-methods-for-fixed-assets"></a><a name="depreciation-methods-for-fixed-assets"></a><a name="depreciation-methods-for-fixed-assets"></a>Avskrivningsmetoder för anläggningstillgångar
...
## <a name="straight-line-depreciation"></a><a name="straight-line-depreciation"></a><a name="straight-line-depreciation"></a>Linjär avskrivning
...
### <a name="depreciation-period"></a><a name="depreciation-period"></a><a name="depreciation-period"></a>Avskrivningsperiod
...
### <a name="fixed-yearly-percentage"></a><a name="fixed-yearly-percentage"></a><a name="fixed-yearly-percentage"></a>Fast årlig procentsats
...
### <a name="fixed-yearly-amount"></a><a name="fixed-yearly-amount"></a><a name="fixed-yearly-amount"></a>Fast årligt belopp
...
### <a name="example---straight-line-depreciation"></a><a name="example---straight-line-depreciation"></a><a name="example---straight-line-depreciation"></a>Exempel – linjär avskrivningsmetod
...
## <a name="declining-balance-1-depreciation"></a><a name="declining-balance-1-depreciation"></a><a name="declining-balance-1-depreciation"></a>Degressiv 1, avskrivning
...
### <a name="example---declining-balance-1-depreciation"></a><a name="example---declining-balance-1-depreciation"></a><a name="example---declining-balance-1-depreciation"></a>Exempel – Degressiv 1, avskrivning
...
## <a name="declining-balance-2-depreciation"></a><a name="declining-balance-2-depreciation"></a><a name="declining-balance-2-depreciation"></a>Degressiv 2, avskrivning
...
### <a name="example---declining-balance-2-depreciation"></a><a name="example---declining-balance-2-depreciation"></a><a name="example---declining-balance-2-depreciation"></a>Exempel – Degressiv 2, avskrivning
...
## <a name="db1sl-depreciation"></a><a name="db1sl-depreciation"></a><a name="db1sl-depreciation"></a>DB1/SL Avskrivning
...
### <a name="example---db1-sl-depreciation"></a><a name="example---db1-sl-depreciation"></a><a name="example---db1-sl-depreciation"></a>Exempel – DB1-SL-avskrivning
...
## <a name="half-year-convention-depreciation"></a><a name="half-year-convention-depreciation"></a><a name="half-year-convention-depreciation"></a>Avskrivning med halvårspraxis
...
### <a name="example---half-year-convention-depreciation"></a><a name="example---half-year-convention-depreciation"></a><a name="example---half-year-convention-depreciation"></a>Exempel: Avskrivning med metoden Halvårspraxis
...
## <a name="example---db1sl-depreciation-using-half-year-convention"></a><a name="example---db1sl-depreciation-using-half-year-convention"></a><a name="example---db1sl-depreciation-using-half-year-convention"></a>Exempel: DEG1/LIN-avskrivning med metoden Halvårspraxis
...
## <a name="duplicating-entries-to-more-depreciation-books"></a><a name="duplicating-entries-to-more-depreciation-books"></a><a name="duplicating-entries-to-more-depreciation-books"></a>Kopiera transaktioner till fler avskrivningsregler
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relaterad [Microsoft utbildning](/training/modules/configure-depreciation-books/)
