...
ms.author: edupont
---
# <a name="depreciation-methods-for-fixed-assets" />Avskrivningsmetoder för anläggningstillgångar
...
## <a name="straight-line-depreciation" />Linjär avskrivning
...
### <a name="depreciation-period" />Avskrivningsperiod
...
### <a name="fixed-yearly-percentage" />Fast årlig procentsats
...
### <a name="fixed-yearly-amount" />Fast årligt belopp
...
### <a name="example---straight-line-depreciation" />Exempel – linjär avskrivningsmetod
...
## <a name="half-year-convention-depreciation" />Avskrivning med halvårspraxis
...
### <a name="example---half-year-convention-depreciation" />Exempel: Avskrivning med metoden Halvårspraxis
...
## <a name="duplicating-entries-to-more-depreciation-books" />Kopiera transaktioner till fler avskrivningsregler
