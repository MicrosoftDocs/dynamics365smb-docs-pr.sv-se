...
---
# <a name="the-service-declaration-extension" />Tjänstdeklarationstillägget
...
## <a name="enable-the-service-declaration-extension" />Aktivera tjänstdeklarationstillägget
...
## <a name="set-up-the-service-declaration-extension" />Ställ in tjänstdeklarationstillägget

Du kan ställa in tillägget manuellt, eller genom att använda en rapporteringsfil i datautbytesdefinition.

### <a name="to-set-up-service-declaration-manually" />Ställ in tjänstedeklarationen manuellt
...
### <a name="item-charges" />Artikelkostnader
...
## <a name="create-new-service-declaration" />Skapa en ny tjänstdeklaration
...
## <a name="modify-a-service-declaration" />Ändra en tjänstedeklaration
...
## <a name="overview-the-service-declaration-lines" />Översikt över tjänstedeklarationrader
...
## <a name="report-service-declaration-in-a-file" />Rapportera tjänstdeklaration i en fil
...
## <a name="other-considerations" />Övrigt att tänka på
...
### <a name="using-services-in-document-lines" />Använda tjänster på dokumentrader
