...
description: Den här artikeln besvarar vanliga frågor om Copilot i Business Central.
author: mikebc
ms.author: mikebc
ms.reviewer: jswymer
ms.topic: overview
...
Den här artikeln besvarar vanliga frågor om Microsoft Copilot i Dynamics 365 Business Central.

## <a name="what-is-copilot-in-business-central"></a>Vad är Copilot i Business Central?

Copilot är den AI-drivna assistenten som hjälper till att gnista kreativitet, öka produktiviteten och eliminera tråkiga uppgifter. Copilot i Business Central är världens första AI-drivna assistent inom alla affärsområden. Med Copilot i Business Central ger små och medelstora organisationer sina anställda intuitiva AI-verktyg som ökar kreativiteten och sparar tid.
...
Copilot innehåller en ständigt växande uppsättning funktioner som hjälper användare i olika roller och uppgifter. [Läs mer om Copilot och andra AI-funktioner i Business Central](https://aka.ms/BCAI).

## <a name="is-copilot-free"></a>Är Copilot gratis?

För närvarande ingår Copilot i Business Central i din Business Central-licens utan extra kostnad. Policyer, kvoter eller prissättning för rättvis användning kan dock införas senare.
...
## <a name="how-does-copilot-use-the-azure-ai-time-quota-that-is-included-with-licenses"></a>Hur använder Copilot den Azure AI-tidskvot som medföljer licenser?
...
Copilot innehåller en ständigt växande uppsättning funktioner som hjälper användare i olika roller och uppgifter. Varje Copilot-funktion definierar en egen lista över regioner som stöds och språk som stöds. Även om de flesta funktioner förmodligen kommer att börja som tillgängliga endast på engelska, strävar vi efter att låsa upp fler språk och regioner med tiden. [Du kan få en översikt över de Copilot-språk och -regioner som är tillgängliga för affärsappar](https://dynamics.microsoft.com/availability-reports/copilotreport).

## <a name="is-copilot-aware-of-my-environment-customizations"></a>Känner Copilot till mina miljöanpassningar?

Vissa men inte alla Copilot-funktioner kan fungera med dina anpassade sidor och tabeller. Du kan till exempel använda [analyshjälp](analysis-assist.md) för dina anpassade listor eller så kan du använda [chatta med Copilot](chat-with-copilot.md) för att hitta poster i anpassade tabeller. Information om vilka Copilot-funktioner som fungerar med anpassningar finns i artiklarna för respektive funktion.

## <a name="does-copilot-have-to-be-trained-on-my-data"></a>Måste Copilot utbildas i mina data?

Copilot i Business Central förlitar sig på kraftfulla AI-grundmodeller som är kopplade till datahanteringsfunktioner i Business Central-plattformen. Ingen dyr eller tidskrävande utbildning behövs innan din organisation kan börja använda Copilot med dina egna företagsdata.
...
Du kan också ansluta copilots med hjälp av Copilot Studio. Dessutom kan du implementera dina egna fristående AI-drivna appar och tjänster som ansluter till Business Central. [Lär dig hur du utvecklar eller anpassar copilot-upplevelser i Microsoft Cloud](/microsoft-cloud/dev/copilot/overview).

## <a name="how-do-i-stay-up-with-the-latest-news-about-copilot-in-business-central"></a>Hur håller jag mig uppdaterad med de senaste nyheterna om Copilot i Business Central?

För nyheter om Copilot och annan AI-innovation i Business Central kan du följa [utgivningsplanerna](https://aka.ms/BCReleasePlan).
...
Copilot i Business Central är automatiskt tillgängligt när du etablerar en Microsoft Entra-klientorganisation med en Business Central-miljö på webbplatsen [kundens digitala upplevelser (CDX)](https://aka.ms/CDX). [Lär dig hur du förbereder demonstrationer av Business Central](/dynamics365/business-central/dev-itpro/administration/demo-environment).
...
Ja, Copilot är exklusivt för Business Central Online. Därför är den inte tillgänglig för andra distributionstyper, till exempel lokala eller privata moln.

## <a name="is-copilot-available-to-embed-applications"></a>Är Copilot tillgängligt för inbäddade appar?

På grund av tekniska begränsningar kan vi för närvarande inte erbjuda Copilot till kunder som kör inbäddade appar från oberoende programvaruleverantör (ISV). ISV:er kan utöka Copilot med sina egna funktioner eller tillhandahålla alternativa användningsområden för generativ AI.
