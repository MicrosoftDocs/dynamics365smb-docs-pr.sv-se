...
ms.author: edupont
---
# <a name="manage-budgets-for-fixed-assets"></a><a name="manage-budgets-for-fixed-assets"></a>Hantera budgetar för anläggningstillgångar
...
## <a name="to-budget-the-acquisition-cost-of-a-fixed-asset"></a><a name="to-budget-the-acquisition-cost-of-a-fixed-asset"></a>För att budgetera anskaffningskostnaden för en anläggningstillgång
...
## <a name="to-budget-the-disposal-of-a-fixed-asset"></a><a name="to-budget-the-disposal-of-a-fixed-asset"></a>För att budgetera avyttringen av en anläggningstillgång:
...
## <a name="to-view-projected-disposal-values"></a><a name="to-view-projected-disposal-values"></a>Så här visar du planerade avyttringsvärden
...
## <a name="to-budget-depreciation"></a><a name="to-budget-depreciation"></a>Så här budgeterar du avskrivning
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relaterad [Microsoft utbildning](/training/modules/budget-fixed-assets/)
