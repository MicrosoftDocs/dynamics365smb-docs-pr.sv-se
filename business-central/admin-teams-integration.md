...
# <a name="managing-microsoft-teams-integration-with-"></a>Hantera Microsoft Teams-integrering med [!INCLUDE [prod_short](includes/prod_short.md)]
...
### <a name="managing-the--app-optional"></a>Hantera [!INCLUDE [prod_short](includes/prod_short.md)]-appen (valfritt)
...
### <a name="minimum-requirements-1"></a>Minsta krav
...
### <a name="understanding-where--cards-are-stored"></a>Förstå var [!INCLUDE [prod_short](includes/prod_short.md)]-kort lagras
...
## <a name="show-or-hide-record-data-on-cards"></a>Visa eller dölja postdata på kort
