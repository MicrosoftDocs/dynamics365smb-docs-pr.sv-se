...
ms.author: edupont
---
# <a name="design-details-item-application"></a><a name="design-details-item-application"></a>Designdetaljer: Artikelkoppling
...
## <a name="inventory-increase"></a><a name="inventory-increase"></a>Lagerökning
...
## <a name="inventory-decrease"></a><a name="inventory-decrease"></a>Lagerminskning
...
## <a name="fixed-application"></a><a name="fixed-application"></a>Fast koppling
...
### <a name="example--fixed-application-in-purchase-return"></a><a name="example--fixed-application-in-purchase-return"></a>Exempel – Fast koppling i inköpsretur
...
### <a name="example--fixed-application-with-average-cost"></a><a name="example--fixed-application-with-average-cost"></a>Exempel – Fast koppling med genomsnittskostnad
...
### <a name="example--fixed-application-in-sales-return"></a><a name="example--fixed-application-in-sales-return"></a>Exempel – Fast koppling i försäljningsretur
...
## <a name="transfer-application"></a><a name="transfer-application"></a>Överföring koppling
...
### <a name="example--average-costing-method"></a><a name="example--average-costing-method"></a>Exempel – Metoden Genomsnittskostnad
...
### <a name="example--standard-costing-method"></a><a name="example--standard-costing-method"></a>Exempel – Värderingsprincip Standard
...
## <a name="reapplication"></a><a name="reapplication"></a>Omkopplingar
