...
ms.author: edupont
---
# <a name="design-details-item-application" />Designdetaljer: Artikelkoppling
...
## <a name="inventory-increase" />Lagerökning
...
## <a name="inventory-decrease" />Lagerminskning
...
## <a name="fixed-application" />Fast koppling
...
### <a name="example--fixed-application-in-purchase-return" />Exempel – Fast koppling i inköpsretur
...
### <a name="example--fixed-application-with-average-cost" />Exempel – Fast koppling med genomsnittskostnad
...
### <a name="example--fixed-application-in-sales-return" />Exempel – Fast koppling i försäljningsretur
...
## <a name="transfer-application" />Överföring koppling
...
### <a name="example--average-costing-method" />Exempel – Metoden Genomsnittskostnad
...
### <a name="example--standard-costing-method" />Exempel – Värderingsprincip Standard
...
## <a name="reapplication" />Omkopplingar
