...
---
# <a name="create-workflows-to-connect-tasks-in-business-processes"></a><a name="create-workflows-to-connect-tasks-in-business-processes"></a>Skapa arbetsflöden för att koppla uppgifter i affärsprocesser
...
## <a name="to-create-a-workflow"></a><a name="to-create-a-workflow"></a>Skapa ett arbetsflöde
...
## <a name="example-of-creating-a-new-workflow-using-existing-events"></a><a name="example-of-creating-a-new-workflow-using-existing-events"></a>Exempel på hur du skapar ett nytt arbetsflöde med hjälp av befintliga händelser
