...
ms.author: edupont
---
# <a name="approval-workflow-notifications"></a><a name="approval-workflow-notifications"></a><a name="approval-workflow-notifications"></a>Aviseringar för godkännandearbetsflöde
...
## <a name="set-up-notifications"></a><a name="set-up-notifications"></a><a name="set-up-notifications"></a>Ställa in aviseringar
