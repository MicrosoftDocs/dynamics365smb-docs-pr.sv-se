...
---
# <a name="design-details-central-concepts-of-the-planning-system" />Designdetaljer: Centrala koncept i planeringssystemet
...
## <a name="planning-starting-date" />Planeringsstartdatum
...
## <a name="dynamic-order-tracking-pegging" />Dynamisk orderspårning (pegging)
...
### <a name="dynamic-order-tracking-versus-the-planning-system" />Dynamisk orderspårning kontra planeringssystemet
...
## <a name="sequence-and-priority-in-planning" />Sekvens och prioritet i planering
...
### <a name="item-priority--low-level-code" />Artikelprioritet/lågnivåkod
...
#### <a name="optimizing-performance-for-low-level-calculations" />Optimera prestanda för beräkningar på låg nivå
...
### <a name="locations--transfer-level-priority" />Lagerställen/Prioritet för överföringsnivå
...
### <a name="order-priority" />Orderprioritet
...
## <a name="demand-forecasts-and-blanket-orders" />Efterfrågeprognoser och avropsorder
...
## <a name="planning-assignment" />Planeringsfördelning
...
## <a name="item-dimensions" />Artikeldimensioner
...
## <a name="item-attributes" />Artikelattribut
...
### <a name="specific-attributes" />Specifika attribut
...
### <a name="non-specific-attributes" />Icke-specifika attribut
...
## <a name="reservations" />Reservationer
...
## <a name="order-planning" />Orderplanering
...
## <a name="finite-loading" />Bestämd beläggning
