...
---
# <a name="design-details-central-concepts-of-the-planning-system"></a><a name="design-details-central-concepts-of-the-planning-system"></a>Designdetaljer: Centrala koncept i planeringssystemet
...
## <a name="planning-parameters"></a><a name="planning-parameters"></a>Planeringsparametrar
...
## <a name="planning-starting-date"></a><a name="planning-starting-date"></a>Planeringsstartdatum
...
## <a name="dynamic-order-tracking-pegging"></a><a name="dynamic-order-tracking-pegging"></a>Dynamisk orderspårning (pegging)
...
### <a name="dynamic-order-tracking-versus-the-planning-system"></a><a name="dynamic-order-tracking-versus-the-planning-system"></a>Dynamisk orderspårning kontra planeringssystemet
...
## <a name="sequence-and-priority-in-planning"></a><a name="sequence-and-priority-in-planning"></a>Sekvens och prioritet i planering
...
### <a name="item-priority--low-level-code"></a><a name="item-priority--low-level-code"></a>Artikelprioritet/lågnivåkod
...
#### <a name="optimizing-performance-for-low-level-calculations"></a><a name="optimizing-performance-for-low-level-calculations"></a>Optimera prestanda för beräkningar på låg nivå
...
### <a name="locations--transfer-level-priority"></a><a name="locations--transfer-level-priority"></a>Lagerställen/Prioritet för överföringsnivå
...
### <a name="order-priority"></a><a name="order-priority"></a>Orderprioritet
...
## <a name="demand-forecasts-and-blanket-orders"></a><a name="demand-forecasts-and-blanket-orders"></a>Efterfrågeprognoser och avropsorder
...
## <a name="planning-assignment"></a><a name="planning-assignment"></a>Planeringsfördelning
...
## <a name="item-dimensions"></a><a name="item-dimensions"></a>Artikeldimensioner
...
## <a name="item-attributes"></a><a name="item-attributes"></a>Artikelattribut
...
### <a name="specific-attributes"></a><a name="specific-attributes"></a>Specifika attribut
...
### <a name="non-specific-attributes"></a><a name="non-specific-attributes"></a>Icke-specifika attribut
...
## <a name="order-to-order-links"></a><a name="order-to-order-links"></a>Order-till-order-länkar
...
## <a name="reservations"></a><a name="reservations"></a>Reservationer
...
## <a name="warnings"></a><a name="warnings"></a>Varningar
...
### <a name="emergency"></a><a name="emergency"></a>Nödsituation
...
### <a name="exception"></a><a name="exception"></a>Undantag
...
### <a name="attention"></a><a name="attention"></a>Observera!
...
## <a name="error-logs"></a><a name="error-logs"></a>Felloggar
...
## <a name="planning-flexibility"></a><a name="planning-flexibility"></a>Planeringsflexibilitet
...
## <a name="order-planning"></a><a name="order-planning"></a>Orderplanering
...
## <a name="finite-loading"></a><a name="finite-loading"></a>Bestämd beläggning
