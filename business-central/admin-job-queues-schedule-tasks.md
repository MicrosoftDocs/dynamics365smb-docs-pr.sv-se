...
## <a name="scheduling-synchronization-between-d365fin-and-crm_md"></a>Schemalägga synkronisering mellan [!INCLUDE[d365fin](includes/d365fin_md.md)] och [!INCLUDE[crm_md](includes/crm_md.md)]
