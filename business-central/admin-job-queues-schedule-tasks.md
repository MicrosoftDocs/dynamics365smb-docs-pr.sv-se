...
---
# <a name="use-job-queues-to-schedule-tasks" />Använda jobbköer för att schemalägga uppgifter
...
## <a name="monitor-status-or-errors-in-the-job-queue" />Övervaka status eller fel i jobbkön
...
### <a name="to-view-status-for-any-job" />Så här visar du status för ett projekt
...
## <a name="view-scheduled-tasks" />Visa schemalagda uppgifter
...
## <a name="the-my-job-queue-part" />Min jobbködel
...
### <a name="to-view-an-error-from-the-my-job-queue-part" />Så här kan du visa ett fel från delen Min jobbkö

1. På en transaktion med statusen **fel**, väljer du åtgärden **Visa felet**.
2. Granska felmeddelandet och lös problemet.

## <a name="examples-of-what-you-can-schedule-using-job-queue-entries" />Exempel på vad du kan schemalägga med jobbkötransaktioner

### <a name="schedule-reports" />Schemalägg rapporter
...
### <a name="schedule-when-to-post-sales-and-purchase-orders" />Schemalägg när du ska bokföra försäljnings- och inköpsorder
...
## <a name="handle-job-queue-entry-issues" />Hantera problem med jobbkötransaktioner
...
## <a name="monitor-the-job-queue-with-telemetry" />Övervaka jobbkön med telemetri
