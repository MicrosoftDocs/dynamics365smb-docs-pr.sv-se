...
# <a name="keyboard-quick-reference---pc-only"></a><a name="keyboard-quick-reference---pc-only"></a><a name="keyboard-quick-reference---pc-only"></a>Snabbguide för kortkommandon – endast dator
...
#### <a name="navigate--select-rows"></a><a name="navigate--select-rows"></a><a name="navigate--select-rows"></a>Navigera och markera rader
...
#### <a name="copy--paste"></a><a name="copy--paste"></a><a name="copy--paste"></a>Kopiera och klistra in
...
#### <a name="search-filter--sort"></a><a name="search-filter--sort"></a><a name="search-filter--sort"></a>Sök, filtrera och sortera
...
#### <a name="quick-entry"></a><a name="quick-entry"></a><a name="quick-entry"></a>Snabbinmatning
...
##### <a name="report-preview"></a><a name="report-preview"></a><a name="report-preview"></a>Förhandsgranskning av rapport

|Välj dessa tangenter|Om du vill|
|-|-|
|<kbd>Ctrl</kbd>+<kbd>Home</kbd>/<kbd>End</kbd>|Gå till första/sista sidan|

#### <a name="numeric-keypad"></a><a name="numeric-keypad"></a><a name="numeric-keypad"></a>Numeriskt tangentbord
