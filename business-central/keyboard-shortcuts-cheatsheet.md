...
# <a name="keyboard-quick-reference---pc-only" />Snabbguide för kortkommandon – endast dator
...
#### <a name="navigate--select-rows" />Navigera och markera rader
...
#### <a name="copy--paste" />Kopiera och klistra in
...
#### <a name="search-filter--sort" />Sök, filtrera och sortera
...
#### <a name="quick-entry" />Snabbinmatning
...
##### <a name="report-preview" />Förhandsgranskning av rapport

|Välj dessa tangenter|Om du vill|
|-|-|
|<kbd>Ctrl</kbd>+<kbd>Home</kbd>/<kbd>End</kbd>|Gå till första/sista sidan|

#### <a name="numeric-keypad" />Numeriskt tangentbord
