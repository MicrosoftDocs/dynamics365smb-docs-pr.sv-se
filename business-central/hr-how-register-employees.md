...
ms.author: edupont
---
# <a name="register-employees"></a><a name="register-employees"></a>Registrera personal
...
## <a name="adding-new-employees"></a><a name="adding-new-employees"></a>Lägga till nya medarbetare
...
## <a name="to-set-up-an-employee"></a><a name="to-set-up-an-employee"></a>Så här registrerar du personal
...
## <a name="to-insert-a-picture-of-an-employee"></a><a name="to-insert-a-picture-of-an-employee"></a>Infoga en bild av den anställde
...
## <a name="to-register-various-information-about-an-employee"></a><a name="to-register-various-information-about-an-employee"></a>Så här registrerar du information om en anställd
