...
ms.author: edupont
---
# <a name="replan-or-refresh-production-orders-directly" />Omplanera eller uppdatera produktionsorder direkt
...
## <a name="to-replan-a-production-order" />Så här planerar du om en produktionsorder
...
## <a name="to-refresh-a-production-order" />Så här uppdaterar du en produktionsorder
