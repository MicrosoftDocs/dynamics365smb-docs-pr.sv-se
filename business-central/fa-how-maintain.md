...
ms.author: edupont
---
# <a name="maintain-fixed-assets" />Underhålla anläggningstillgångar
...
## <a name="to-record-maintenance-work-on-a-fixed-asset" />Om du vill registrera underhållsarbete på en anläggningstillgång
...
## <a name="to-post-maintenance-costs-from-a-fixed-asset-gl-journal" />Att bokföra underhållskostnader från en redovisningsjournalen för anläggningstillgångar.
...
## <a name="to-follow-up-on-fixed-assets-service-visits" />Så här följer du upp servicebesök för anläggningstillgångar
...
## <a name="to-monitor-maintenance-costs" />Så här övervakar du underhållskostnader:
...
## <a name="to-view-or-print-maintenance-costs-for-multiple-fixed-assets" />Om du vill visa eller skriva ut underhållskostnader för åtskilliga anläggningstillgångar
...
## <a name="to-view-maintenance-ledger-entries" />Så här visar du underhållstransaktioner
...
## <a name="to-view-or-print-maintenance-ledger-entries-for-multiple-fixed-assets" />Om du vill visa eller skriva ut underhållstransaktioner för åtskilliga anläggningstillgångar
