...
ms.author: edupont
---
# <a name="set-up-a-document-exchange-service" />Konfigurera en tjänst för dokumentutbyte
...
## <a name="connecting-with-trading-partners" />Ansluta till handelspartner
...
## <a name="to-connect-to-the-business-central-integration-app-on-tradeshift" />Så här ansluter du till programmet Business Central-integration på Tradeshift
...
## <a name="to-connect-to-a-document-exchange-service" />Så här ansluter du till en dokumentväxlingstjänst
...
## <a name="settings-for-business-central-on-premises" />Inställningar för Business Central lokalt
