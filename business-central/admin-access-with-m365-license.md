...
# <a name="business-central-access-with-microsoft-365-licenses"></a><a name="business-central-access-with-microsoft-365-licenses"></a><a name="business-central-access-with-microsoft-365-licenses"></a>Business Central-åtkomst med Microsoft 365-licenser
...
## <a name="why-enable-access-with-microsoft-365-licenses"></a><a name="why-enable-access-with-microsoft-365-licenses"></a><a name="why-enable-access-with-microsoft-365-licenses"></a>Varför aktivera åtkomst med Microsoft 365-licenser
...
## <a name="use-rights"></a><a name="use-rights"></a><a name="use-rights"></a>Använda rättigheter
...
 
### <a name="client-access"></a><a name="client-access"></a><a name="client-access"></a>Klientåtkomst
...
### <a name="data-access"></a><a name="data-access"></a><a name="data-access"></a>Dataåtkomst
...
### <a name="use-of-objects"></a><a name="use-of-objects"></a><a name="use-of-objects"></a>Användning av föremål
...
## <a name="simplified-user-interface"></a><a name="simplified-user-interface"></a><a name="simplified-user-interface"></a>Förenklat användargränssnitt
...
### <a name="requirements-to-enable-access"></a><a name="requirements-to-enable-access"></a><a name="requirements-to-enable-access"></a>Krav för att möjliggöra åtkomst

- [!INCLUDE [prod_short](includes/prod_short.md)] Online (SaaS).

- Miljöer måste vara av plattform version 21.1 eller senare.

### <a name="requirements-for-individual-users-to-access-data-in-teams"></a><a name="requirements-for-individual-users-to-access-data-in-teams"></a><a name="requirements-for-individual-users-to-access-data-in-teams"></a>Krav för att enskilda användare ska ha åtkomst till data i Teams
