...
# <a name="business-central-for-multi-site-and-international-organizations"></a><a name="business-central-for-multi-site-and-international-organizations"></a>Business Central för flera platser och internationella organisationer
...
## <a name="integrating-the-headquarter-company-and-the-sites"></a><a name="integrating-the-headquarter-company-and-the-sites"></a>Integrera moderbolaget och platserna
...
## <a name="meet-the-needs-of-domestic-and-international-sites"></a><a name="meet-the-needs-of-domestic-and-international-sites"></a>Uppfylla behoven hos inhemska och internationella platser
...
## <a name="consolidate-financial-data"></a><a name="consolidate-financial-data"></a>Konsolidera ekonomiska data
...
## <a name="share-business-insight-with-integrated-analytics"></a><a name="share-business-insight-with-integrated-analytics"></a>Dela affärsinsikt med integrerad analys
...
## <a name="exchange-data-using-apis-and-xmlports"></a><a name="exchange-data-using-apis-and-xmlports"></a>Utbyta data med hjälp av API:er och XMLportar
...
## <a name="promote-an-efficient-intercompany-supply-chain"></a><a name="promote-an-efficient-intercompany-supply-chain"></a>Främja en effektiv koncernintern försörjningskedja
...
## <a name="respond-quickly-to-new-business-conditions"></a><a name="respond-quickly-to-new-business-conditions"></a>Svara snabbt på nya affärsvillkor
