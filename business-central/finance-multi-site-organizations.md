...
| **Affärsbehov** | **Så här stöder Business Central det** | **Läs mer** |
|-------------------------|-------------------------|-------------------------|
| Dela med dig insikter med platser utan omfattande IT-support. | Skapa KPI:er och affärsintelligens-instrumentpaneler i Power BI baserat på dina data. | [Anslut till Power BI från Business Central lokalt](across-working-with-business-central-in-powerbi.md) |
