...
# <a name="business-central-for-multi-site-and-international-organizations" />Business Central för flera platser och internationella organisationer
...
## <a name="integrating-the-headquarter-company-and-the-sites" />Integrera moderbolaget och platserna
...
## <a name="meet-the-needs-of-domestic-and-international-sites" />Uppfylla behoven hos inhemska och internationella platser
...
## <a name="consolidate-financial-data" />Konsolidera ekonomiska data
...
## <a name="share-business-insight-with-integrated-analytics" />Dela affärsinsikt med integrerad analys
...
## <a name="exchange-data-using-apis-and-xmlports" />Utbyta data med hjälp av API:er och XMLportar
...
## <a name="promote-an-efficient-intercompany-supply-chain" />Främja en effektiv koncernintern försörjningskedja
...
## <a name="respond-quickly-to-new-business-conditions" />Svara snabbt på nya affärsvillkor
