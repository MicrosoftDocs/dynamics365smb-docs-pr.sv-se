...
# <a name="view-the-status-of-synchronization-jobs" />Visa status för en synkroniseringsjobb
...
## <a name="to-view-and-resolve-synchronization-errors-for-coupled-records" />Så här visar och löser du synkroniseringsfel för kopplade poster
...
## <a name="to-view-the-synchronization-log-for-a-specific-manually-synchronized-record" />Så här visar du synkroniseringsloggen för specifika (manuellt synkroniserade) poster
...
## <a name="remove-couplings-between-records" />Ta bort kopplingar mellan poster
