...
ms.author: edupont
---
# <a name="prioritize-vendors"></a><a name="prioritize-vendors"></a>Prioritera leverantörer
...
## <a name="to-prioritize-vendors"></a><a name="to-prioritize-vendors"></a>Så här prioriterar du leverantörer:
