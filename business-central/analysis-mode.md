...
---
# <a name="analyze-list-data-using-data-analysis-mode"></a><a name="analyze-list-data-using-data-analysis-mode"></a>Analysera listdata med hjälp av dataanalysläge
...
## <a name="prerequisite"></a><a name="prerequisite"></a>Förutsättningar
...
## <a name="work-with-data-analysis-mode"></a><a name="work-with-data-analysis-mode"></a>Arbeta med dataanalysläge
...
### <a name="summary-bar-2"></a><a name="summary-bar-2"></a>Sammanfattningsfält (2)
...
### <a name="columns-3"></a><a name="columns-3"></a>Kolumner (3)
...
### <a name="analysis-filters-4"></a><a name="analysis-filters-4"></a>Analysfilter (4)
...
### <a name="tabs-5"></a><a name="tabs-5"></a>Flikar (5)
...
## <a name="pivot-mode"></a><a name="pivot-mode"></a>Pivotläge
