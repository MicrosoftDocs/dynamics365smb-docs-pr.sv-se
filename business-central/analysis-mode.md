...
---
# <a name="analyze-list-data-using-data-analysis-mode" />Analysera listdata med hjälp av dataanalysläge
...
## <a name="prerequisite" />Förutsättningar
...
## <a name="work-with-data-analysis-mode" />Arbeta med dataanalysläge
...
## <a name="limitations" />Begränsningar
