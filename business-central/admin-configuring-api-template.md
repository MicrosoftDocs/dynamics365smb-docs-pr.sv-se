...
# <a name="configure-api-templates" />Konfigurera API-mallar
...
## <a name="setting-up-the-entity-template" />Konfigurera enhetsmall
...
## <a name="assign-the-template-to-an-api" />Tilldela mallen till en API
