...
# <a name="configure-api-templates"></a><a name="configure-api-templates"></a>Konfigurera API-mallar
...
## <a name="setting-up-the-entity-template"></a><a name="setting-up-the-entity-template"></a>Konfigurera enhetsmall
...
## <a name="assign-the-template-to-an-api"></a><a name="assign-the-template-to-an-api"></a>Tilldela mallen till en API
