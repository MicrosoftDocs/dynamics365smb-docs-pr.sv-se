...
ms.author: edupont
---
# <a name="create-number-series" />Skapa nummerserier
...
## <a name="gaps-in-number-series" />Luckor i nummerserier
...
## <a name="behavior-of-the-no-field-on-documents-and-cards" />Fältet Nr. på dokument och kort
...
## <a name="to-create-a-new-number-series" />Så här skapar du nummerserier
...
## <a name="to-create-relationships-between-number-series" />Så här skapar du samband mellan nummerserier
...
## <a name="to-set-up-where-a-number-series-is-used" />Om du vill konfigurera var en nummerserie används
...
## <a name="see-related-microsoft-trainingtrainingmodulesnumber-series-trail-codes-dynamics-365-business-centralindex" />Se relaterad [Microsoft utbildning](/training/modules/number-series-trail-codes-dynamics-365-business-central/index)
