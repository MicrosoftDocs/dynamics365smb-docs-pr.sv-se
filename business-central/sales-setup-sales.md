...
ms.author: edupont
---
# <a name="setting-up-sales"></a><a name="setting-up-sales"></a>Konfigurera försäljning
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relaterad [Microsoft utbildning](/training/paths/trade-get-started-dynamics-365-business-central/)
