...
ms.author: edupont
---
# <a name="setting-up-sales" />Konfigurera försäljning
...
## <a name="see-related-microsoft-training" />Se relaterad [Microsoft utbildning](/training/paths/trade-get-started-dynamics-365-business-central/)
