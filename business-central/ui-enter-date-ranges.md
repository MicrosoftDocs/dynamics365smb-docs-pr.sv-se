...
# <a name="work-with-calendar-dates-and-times"></a><a name="work-with-calendar-dates-and-times"></a>Arbeta med kalenderdatum och tider
...
## <a name="check-your-region-and-language-settings"></a><a name="check-your-region-and-language-settings"></a>Kontrollera inställningarna för region och språk
...
### <a name="picking-dates-from-the-calendar"></a><a name="picking-dates-from-the-calendar"></a>Välja datum från kalendern
...
### <a name="day-week-year-pattern"></a><a name="day-week-year-pattern"></a>Dag\-vecka\-år-mönster
...
### <a name="digit-patterns"></a><a name="digit-patterns"></a>Siffermönster
...
### <a name="today"></a><a name="today"></a>I dag
...
### <a name="period"></a><a name="period"></a>Period
...
### <a name="closing-date"></a><a name="closing-date"></a>Avslutsdatum
...
## <a name="setting-ranges"></a><a name="setting-ranges"></a><a name="BKMK_SettingDateRanges"></a> Inställningsintervall
...
## <a name="use-date-formulas"></a><a name="use-date-formulas"></a>Använd datumformler
...
## <a name="entering-combined-dates-and-times"></a><a name="entering-combined-dates-and-times"></a>Ange kombinerade datum och tider
