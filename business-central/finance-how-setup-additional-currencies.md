...
ms.author: edupont
---
# <a name="set-up-an-additional-reporting-currency" />Ställa in en alternativ rapporteringsvaluta.
...
## <a name="displaying-reports-and-amounts-in-the-additional-reporting-currency" />Visa rapporter och belopp i den alternativa rapporteringsvalutan
...
## <a name="adjusting-exchange-rates" />Justera valutakurser
...
## <a name="setting-up-an-additional-reporting-currency" />Skapa en alternativ rapporteringsvaluta
...
### <a name="to-specify-general-ledger-accounts-for-posting-exchange-rate-adjustments" />Så här anger du redovisningskonton för bokföring av valutakursjusteringar
...
### <a name="to-specify-the-exchange-rate-adjustment-method-for-all-general-ledger-accounts" />Ange kursjusteringsmetod för alla redovisningskonton
...
### <a name="to-specify-exchange-rate-adjustment-method-for-vat-entries" />Så här anger du kursjusteringsmetod för momstransaktioner
...
### <a name="to-activate-the-additional-reporting-currency" />Så här aktiverar du den alternativa rapporteringsvalutan.
