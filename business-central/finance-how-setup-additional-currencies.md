...
ms.author: edupont
---
# <a name="set-up-an-additional-reporting-currency"></a><a name="set-up-an-additional-reporting-currency"></a>Ställa in en alternativ rapporteringsvaluta.
...
## <a name="displaying-reports-and-amounts-in-the-additional-reporting-currency"></a><a name="displaying-reports-and-amounts-in-the-additional-reporting-currency"></a>Visa rapporter och belopp i den alternativa rapporteringsvalutan
...
## <a name="setting-up-an-additional-reporting-currency"></a><a name="setting-up-an-additional-reporting-currency"></a>Skapa en alternativ rapporteringsvaluta
...
### <a name="to-specify-general-ledger-accounts-for-posting-exchange-rate-adjustments"></a><a name="to-specify-general-ledger-accounts-for-posting-exchange-rate-adjustments"></a>Så här anger du redovisningskonton för bokföring av valutakursjusteringar
...
### <a name="to-specify-the-exchange-rate-adjustment-method-for-all-general-ledger-accounts"></a><a name="to-specify-the-exchange-rate-adjustment-method-for-all-general-ledger-accounts"></a>Ange kursjusteringsmetod för alla redovisningskonton
...
### <a name="to-specify-exchange-rate-adjustment-method-for-vat-entries"></a><a name="to-specify-exchange-rate-adjustment-method-for-vat-entries"></a>Så här anger du kursjusteringsmetod för momstransaktioner
...
### <a name="to-activate-the-additional-reporting-currency"></a><a name="to-activate-the-additional-reporting-currency"></a>Så här aktiverar du den alternativa rapporteringsvalutan.
