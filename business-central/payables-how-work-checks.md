...
ms.author: edupont
---
# <a name="make-check-payments"></a><a name="make-check-payments"></a><a name="make-check-payments"></a>Gör checkbetalningar
...
## <a name="to-pay-a-vendor-invoice-with-a-computer-check"></a><a name="to-pay-a-vendor-invoice-with-a-computer-check"></a><a name="to-pay-a-vendor-invoice-with-a-computer-check"></a>Betala en leverantörsfaktura med datorcheck
...
## <a name="to-cancel-printed-checks-that-are-not-posted"></a><a name="to-cancel-printed-checks-that-are-not-posted"></a><a name="to-cancel-printed-checks-that-are-not-posted"></a>Att skriva ut checkar som inte har bokförts
...
## <a name="to-void-checks"></a><a name="to-void-checks"></a><a name="to-void-checks"></a>Så här makulerar du checkar:
...
## <a name="to-view-a-summary-of-posted-checks"></a><a name="to-view-a-summary-of-posted-checks"></a><a name="to-view-a-summary-of-posted-checks"></a>Om du vill visa en sammanfattning av bokförda checkar
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relaterad [Microsoft utbildning](/training/modules/use-checks-dynamics-365-business-central/)
