...
# <a name="install-and-uninstall-extensions-apps-in-business-central"></a><a name="install-and-uninstall-extensions-apps-in-business-central"></a><a name="install-and-uninstall-extensions-apps-in-business-central"></a>Installera och avinstallera tillägg (appar) i Business Central
...
## <a name="install-an-extension"></a><a name="install-an-extension"></a><a name="install-an-extension"></a><a name="install"></a>Installera ett tillägg
...
## <a name="set-up-an-app"></a><a name="set-up-an-app"></a><a name="set-up-an-app"></a>Konfigurera ett tillägg
...
## <a name="upload-a-per-tenant-extension-pte"></a><a name="upload-a-per-tenant-extension-pte"></a><a name="upload-a-per-tenant-extension-pte"></a>Ladda upp ett tillägg per klientorganisation (PTE)
...
## <a name="uninstall-an-app"></a><a name="uninstall-an-app"></a><a name="uninstall-an-app"></a>Avinstallera en app
