...
# <a name="install-and-uninstall-extensions-apps-in-business-central" />Installera och avinstallera tillägg (appar) i Business Central
...
## <a name="set-up-an-app" />Konfigurera ett tillägg
...
## <a name="upload-a-per-tenant-extension-pte" />Ladda upp ett tillägg per klientorganisation (PTE)
...
## <a name="uninstall-an-app" />Avinstallera en app
