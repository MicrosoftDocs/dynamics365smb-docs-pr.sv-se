...
ms.author: jswymer
---
# <a name="add-contacts-to-segments" />Lägga till kontakter i segment
...
## <a name="to-add-a-contact-to-a-segment" />Så här lägger du till kontakter i ett segment
...
## <a name="to-refine-the-number-of-contacts" />Om du vill förfina antalet kontakter
...
## <a name="to-reduce-the-number-of-contacts" />Om du vill minska antalet kontakter
