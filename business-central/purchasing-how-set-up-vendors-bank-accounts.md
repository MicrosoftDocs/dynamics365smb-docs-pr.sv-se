...
---
# <a name="set-up-vendor-bank-accounts"></a><a name="set-up-vendor-bank-accounts"></a>Skapa bankkonton för leverantörer
...
## <a name="add-or-edit-a-vendor-bank-account"></a><a name="add-or-edit-a-vendor-bank-account"></a>Lägga till eller redigera ett leverantörs bankkonto
...
## <a name="set-up-a-preferred-vendor-bank-account"></a><a name="set-up-a-preferred-vendor-bank-account"></a>Skapa önskat bankkonton för leverantörer
