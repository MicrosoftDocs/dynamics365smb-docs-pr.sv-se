...
ms.author: edupont
---
# <a name="create-special-orders"></a><a name="create-special-orders"></a>Skapa specialorder
...
## <a name="to-create-a-special-order"></a><a name="to-create-a-special-order"></a>Så här skapar du en specialorder
