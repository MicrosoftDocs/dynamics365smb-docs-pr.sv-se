...
ms.author: edupont
---
# <a name="create-reports-with-xbrl"></a><a name="create-reports-with-xbrl"></a><a name="create-reports-with-xbrl"></a>Skapa rapporter med XBRL
...
## <a name="xbrl-comprises-the-following-components"></a><a name="xbrl-comprises-the-following-components"></a><a name="xbrl-comprises-the-following-components"></a>XBRL består av följande komponenter
...
## <a name="layered-taxonomies"></a><a name="layered-taxonomies"></a><a name="layered-taxonomies"></a>Överlappande taxonomier
...
## <a name="linkbases"></a><a name="linkbases"></a><a name="linkbases"></a>Länkbaser
...
## <a name="set-up-xbrl-lines"></a><a name="set-up-xbrl-lines"></a><a name="set-up-xbrl-lines"></a>Ställ in XBRL-rader
...
## <a name="import-an-xbrl-taxonomy"></a><a name="import-an-xbrl-taxonomy"></a><a name="import-an-xbrl-taxonomy"></a>Importera en XBRL-taxonomi
...
## <a name="update-an-xbrl-taxonomy"></a><a name="update-an-xbrl-taxonomy"></a><a name="update-an-xbrl-taxonomy"></a>Uppdatera en XBRL-taxonomi
...
5. Välj lämplig länkbas eller tryck på <kbd>Ctrl</kbd>+<kbd>N</kbd> för en ny rad, välj länkbastyp och skriv sedan in en beskrivning.  
6. Importera länkbasen genom att välja åtgärden **importera**.  
7. Välj **Ja** när du vill koppla länkbasen till uppställningen.  

## <a name="see-related-training-at-microsoft-learn"></a><a name="see-related-training-at-microsoft-learn"></a><a name="see-related-training-at-microsoft-learn"></a>Se relaterad utbildning på [Microsoft Learn](/learn/modules/xbrl-reports-dynamics-365-business-central/index).
