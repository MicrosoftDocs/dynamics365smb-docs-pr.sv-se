...
## <a name="to-set-up-bank-accounts"></a><a name="to-set-up-bank-accounts"></a>Så här skapar du bankkonton
...
## <a name="to-enter-an-opening-balance"></a><a name="to-enter-an-opening-balance"></a>Ange ett ingående saldo
...
## <a name="to-set-up-your-bank-account-for-import-or-export-of-bank-files"></a><a name="to-set-up-your-bank-account-for-import-or-export-of-bank-files"></a>Så här skapar du ett bankkonto för import eller export av bankfilerna
...
## <a name="to-set-up-vendor-bank-accounts-for-export-of-bank-files"></a><a name="to-set-up-vendor-bank-accounts-for-export-of-bank-files"></a>Så här skapar du leverantörsbankkonto för export av bankfiler
...
## <a name="changing-your-bank-account"></a><a name="changing-your-bank-account"></a>Ändra ditt bankkonto
