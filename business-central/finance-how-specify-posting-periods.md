...
ms.author: edupont
---
# <a name="specify-posting-periods"></a><a name="specify-posting-periods"></a><a name="specify-posting-periods"></a>Så här anger du bokföringsperioder

Använd bokföringsperioder för att ange om användare kan bokföra i redovisningen.  

## <a name="to-specify-posting-periods"></a><a name="to-specify-posting-periods"></a><a name="to-specify-posting-periods"></a>Så här anger du bokföringsperioder
