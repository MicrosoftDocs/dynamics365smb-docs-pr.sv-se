...
ms.author: edupont
---
# <a name="legacy-import-and-export-custom-report-layouts"></a><a name="legacy-import-and-export-custom-report-layouts"></a>(Äldre) Importera och exportera en anpassad rapportlayout
...
### <a name="to-export-a-report-layout-to-a-file"></a><a name="to-export-a-report-layout-to-a-file"></a>Så här exporterar du en rapportlayout till en fil
...
### <a name="to-import-a-report-layout-file"></a><a name="to-import-a-report-layout-file"></a>Så här importerar du en rapportlayoutfil
