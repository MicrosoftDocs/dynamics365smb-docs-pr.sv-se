...
# <a name="get-started-with-a-business-central-preview-version-for-copilot" />Kom igång med en Business Central förhandsversion för Copilot
...
## <a name="your-organization-already-uses-business-central" />Organisationen använder redan Business Central
...
## <a name="your-organization-doesnt-use-business-central" />Organisationen använder inte Business Central
