...
ms.author: edupont
---
# <a name="set-up-work-hours-and-service-hours" />Ställa in arbetstimmar och tjänstetider
...
## <a name="to-set-up-default-service-hours" />Så här skapar du standard servicetider
...
## <a name="to-set-up-work-hour-templates" />Så här skapar du arbetstidsmallar
...
## <a name="to-set-up-contract-specific-service-hours" />Så här skapar du en kontraktspecifik servicekalender
