...
ms.author: edupont
---
# <a name="onboard-users-with-checklists"></a><a name="onboard-users-with-checklists"></a>Integrera användare med checklistor
...
## <a name="to-add-an-item-to-the-checklist"></a><a name="to-add-an-item-to-the-checklist"></a>Lägg till en artikel i checklistan
