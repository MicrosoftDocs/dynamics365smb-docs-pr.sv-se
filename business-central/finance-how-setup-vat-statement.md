...
ms.author: bholtorf
---
# <a name="set-up-vat-statement-templates-and-vat-statement-names"></a><a name="set-up-vat-statement-templates-and-vat-statement-names"></a>Ställa in momsrapportmallar och momsrapportnamn
...
## <a name="to-define-a-vat-statement"></a><a name="to-define-a-vat-statement"></a>Definiera en momsrapport
...
## <a name="to-preview-the-vat-statement"></a><a name="to-preview-the-vat-statement"></a>Förhandsgranska momsrapporten
