...
ms.author: bholtorf
---
# <a name="synchronize-contacts-in-business-central-with-contacts-in-microsoft-outlook" />Synkronisera kontakter i Business Central med kontakter i Microsoft Outlook
...
## <a name="set-up-synchronization" />Konfigurera synkronisering
...
## <a name="synchronize-contacts" />Synkronisera kontakter
