...
ms.author: edupont
---
# <a name="record-and-reimburse-employees-expenses" />Skapa och återbetala de anställdas utgifter
...
## <a name="to-record-an-employees-expense" />Om du vill registrera en anställd utgifter
...
## <a name="to-reimburse-an-employee" />Återbetala en medarbetare
...
## <a name="to-reconcile-reimbursements-with-employee-ledger-entries" />Så här synkroniserar du återbetalningar med transaktioner för medarbetare
