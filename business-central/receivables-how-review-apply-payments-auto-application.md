...
ms.author: edupont
---
# <a name="review-and-apply-payments-manually-after-automatic-application" />Granska och koppla betalningar manuellt efter automatisk koppling
...
## <a name="to-review-or-apply-payments-after-automatic-application" />Så här granskar och kopplar du betalningar efter automatisk koppling
