...
ms.author: edupont
---
# <a name="set-up-finance-charge-terms" />Konfigurera räntevillkor
...
## <a name="finance-charge-terms" />Räntevillkor
...
### <a name="to-set-up-finance-charge-terms" />Ange räntevillkoren
...
## <a name="see-related-microsoft-training" />Se relaterad [Microsoft utbildning](/training/modules/send-memos-dynamics-365-business-central/)
