...
ms.author: edupont
---
# <a name="collect-payments-with-sepa-direct-debit" />Samla in betalningar med SEPA-autogiro
...
## <a name="setting-up-sepa-direct-debit" />Konfigurera SEPA Autogiro
...
### <a name="to-set-up-your-bank-account-for-sepa-direct-debit" />Så här ställer du in ditt bankkonto för SEPA-autogiro
...
### <a name="to-set-up-the-customers-payment-method-for-sepa-direct-debit" />För att ställa in kundens betalningssätt för SEPA-autogiro
...
#### <a name="to-set-up-the-direct-debit-mandate-that-represents-the-customer-agreement" />Så här ställer du in medgivande för autogiro som representerar kundavtalet
...
## <a name="creating-sepa-direct-debit-collection-entries-and-export-to-a-bank-file" />Skapa insamlingsposter för SEPA Autogiro och exportera till en bankfil
...
### <a name="to-create-a-direct-debit-collection" />Skapa en direktdebitering-insamling
...
### <a name="to-export-a-direct-debit-collection-entry-to-a-bank-file" />Så här exporterar du direktdebeterings-insamlingposter till en bankfil
...
### <a name="to-reject-a-direct-debit-collection-entry" />Avvisa en direktdebitering-insamlingspost
...
### <a name="to-close-a-direct-debit-collection" />Stänga en direktdebitering-insamling
...
## <a name="posting-sepa-direct-debit-payment-receipts" />Bokföra betalningsinleveranser för SEPA Autogiro
...
### <a name="to-post-a-direct-debit-payment-receipt-from-the-direct-debit-collections-page" />Så här bokför du ett betalningskvitto på sidan Samlingar med autogiro
