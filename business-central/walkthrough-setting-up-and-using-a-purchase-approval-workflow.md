...
ms.author: edupont
---
# <a name="walkthrough-setting-up-and-using-a-purchase-approval-workflow"></a><a name="walkthrough-setting-up-and-using-a-purchase-approval-workflow"></a>Genomgång: Konfigurera och använda ett arbetsflöde för godkännande av inköp
...
## <a name="users"></a><a name="users"></a>Användare
...
### <a name="setting-up-approval-users"></a><a name="setting-up-approval-users"></a>Ställa in godkännandeanvändare
...
#### <a name="to-set-up-yourself-and-alicia-as-approval-users"></a><a name="to-set-up-yourself-and-alicia-as-approval-users"></a>Så här ställer du in dig själv och Alicia som godkännandeanvändare
...
### <a name="setting-up-notifications"></a><a name="setting-up-notifications"></a>Ställa in meddelanden
...
#### <a name="to-set-up-how-and-when-you-are-notified"></a><a name="to-set-up-how-and-when-you-are-notified"></a>Så här ställer du in hur och när du får meddelande
...
## <a name="creating-the-approval-workflow"></a><a name="creating-the-approval-workflow"></a>Skapa godkännandearbetsflödet
...
### <a name="to-create-and-enable-a-purchase-order-approval-workflow"></a><a name="to-create-and-enable-a-purchase-order-approval-workflow"></a>Så här skapar och aktiverar du ett arbetsflöde för inköpsordergodkännade
...
## <a name="use-the-approval-workflow"></a><a name="use-the-approval-workflow"></a>Använda godkännandearbetsflödet
...
### <a name="to-request-approval-of-a-purchase-order-as-alicia"></a><a name="to-request-approval-of-a-purchase-order-as-alicia"></a>Så här begär du godkännande av en inköpsorder, som Alicia.
...
### <a name="to-approve-the-purchase-order-as-sean"></a><a name="to-approve-the-purchase-order-as-sean"></a>Så här godkänner du inköpsordern, som Sean
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relaterad [Microsoft utbildning](/training/modules/use-approval-workflows/)
