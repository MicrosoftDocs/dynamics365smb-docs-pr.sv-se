...
---
# <a name="walkthrough-set-up-and-use-a-purchase-approval-workflow"></a>Genomgång: Konfigurera och använda ett arbetsflöde för godkännande av inköp
...
#### <a name="to-set-up-how-and-when-youre-notified"></a>Så här ställer du in hur och när du får meddelande
...
## <a name="create-the-approval-workflow"></a>Skapa godkännandearbetsflödet
