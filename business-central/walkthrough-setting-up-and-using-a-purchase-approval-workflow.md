...
ms.author: edupont
---
# <a name="walkthrough-setting-up-and-using-a-purchase-approval-workflow" />Genomgång: Konfigurera och använda ett arbetsflöde för godkännande av inköp
...
### <a name="setting-up-approval-users" />Ställa in godkännandeanvändare
...
#### <a name="to-set-up-yourself-and-alicia-as-approval-users" />Så här ställer du in dig själv och Alicia som godkännandeanvändare
...
### <a name="setting-up-notifications" />Ställa in meddelanden
...
#### <a name="to-set-up-how-and-when-you-are-notified" />Så här ställer du in hur och när du får meddelande
...
## <a name="creating-the-approval-workflow" />Skapa godkännandearbetsflödet
...
### <a name="to-create-and-enable-a-purchase-order-approval-workflow" />Så här skapar och aktiverar du ett arbetsflöde för inköpsordergodkännade
...
## <a name="use-the-approval-workflow" />Använda godkännandearbetsflödet
...
### <a name="to-request-approval-of-a-purchase-order-as-alicia" />Så här begär du godkännande av en inköpsorder, som Alicia.
...
### <a name="to-approve-the-purchase-order-as-sean" />Så här godkänner du inköpsordern, som Sean
