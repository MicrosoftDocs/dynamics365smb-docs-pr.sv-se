...
Detta ämne beskriver hur administratörer skapar användare och definierar vem som kan logga in på [!INCLUDE[d365fin](includes/d365fin_md.md)], samt vilka behörigheter som tilldelas olika användartyper beroende på licens.
...
> [!NOTE]
> Hanteringen av användare och licenser varierar beroende på om lösningen [!INCLUDE[d365fin](includes/d365fin_md.md)] distribueras online eller lokalt. I online-distributioner kan du till exempel bara hantera användare när dessa har lagts till i [!INCLUDE[d365fin](includes/d365fin_md.md)] från Office 365. I lokala distributioner kan du skapa, redigera och ta bort användare direkt.  
...
2. Beroende på vad du vill göra väljer du antingen åtgärden **Hämta nya användare Office 365** eller åtgärden **Uppdatera användare från Office 365**.

De nya användarna och den nya användarinformationen i din Office 365-prenumeration läggs till på sidan **Användare** i [!INCLUDE[d365fin](includes/d365fin_md.md)]. Mer information om hur du synkroniserar användarinformation Office 365 finns i [Synkronisera med Office 365](ui-how-users-permissions.md#synchronization-with-office-365).
...
> [!NOTE]
> Alla användare måste tilldelas samma licens, antingen Essential eller Premium. Mer information finns i Licensieringsguiden för Microsoft Dynamics 365 Business Central. Guiden kan hämtas på webbplatsen för [Business Central](https://dynamics.microsoft.com/en-us/business-central/overview/).
...
* Administratören kan lägga till användaren genom att välja åtgärden **Uppdatera användare från Office 365** på sidan **Användare**.
...
> [!NOTE]
> För lokala distributioner kan en administratör ange hur användarautentiseringsuppgifter ska autentiseras i [!INCLUDE[server](includes/server.md)]-instansen. När du skapar en användare anger du vilken autentiseringstyp du använder.<br /><br />
> Mer information finns i [Autentisering och autentiseringstyper](/dynamics365/business-central/dev-itpro/administration/users-credential-types) i avsnittet Administration för utvecklar och IT-Pro-innehåll för [!INCLUDE[d365fin](includes/d365fin_md.md)].
