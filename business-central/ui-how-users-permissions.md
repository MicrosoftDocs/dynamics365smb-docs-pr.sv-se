...
- Ditt företags Microsoft 365-administratör kan göra detta i [administratörscentret för Microsoft 365](https://admin.microsoft.com). Mer information finns i [Lägga till användare individuellt eller i bulk till Microsoft 365](/microsoft-365/admin/add-users/add-users).  
...
> [!NOTE]
> Åtgärderna som beskrivs i följande register är emellertid korrekta, men den enda du behöver är **Uppdatera användare från Microsoft 365**, som har lagts till i syfte att förenkla processen. Övriga åtgärder kommer att tas bort i framtida versioner av [!INCLUDE[prod_short](includes/prod_short.md)].
...
|Uppdatera användarposten baserat på information i Microsoft 365: Status, fullständigt namn, e-postadress för kontakt, e-post för autentisering.<!--<br /><br />Codeunit "Azure AD   Graph User".UpdateUserFromAzureGraph-->|**INTER**|**INTER**|**INTER**|**INTER**||**INTER**|
...
3. På sidan **Välj en grupptyp** väljer du alternativet **Säkerhet** och sedan åtgärden **Lägg till**.
4. På sidan **Grunder** anger du **Dynamics 365 Business Central-enhetsanvändare** som namnet på gruppen.
  
   >[!NOTE]
   >Namnet på gruppen måste stavas på engelska exakt så som visas i steg 4, även om du använder ett annat språk. Om du har kopierat gruppens namn från ett dokument, till exempel en PDF-fil, kontrollerar du att namnet inte innehåller extra blanksteg.
5. Välj knappen **Stäng**.

> [!NOTE]
> Du kan också skapa en grupp av typen Microsoft 365. Mer information finns i [Jämför grupper](/microsoft-365/admin/create-groups/compare-groups)
...
[Lägga till användare i Microsoft 365 för företag](/microsoft-365/admin/add-users/add-users)  
