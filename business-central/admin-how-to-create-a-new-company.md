---
title: Skapa ett nytt företag med konfigurationspaket
...
ms.locfileid: "8512418"
---
# <a name="create-a-new-company-based-on-configuration-packages"></a>Skapa ett nytt företag baserat på konfigurationspaket
...
## <a name="to-use-the-sample-configuration-packages"></a>Om du vill använda exempelkonfigurationspaket

1. Öppna demonstrationsföretaget CRONUS. Mer information finns i [Ändra grundläggande inställningar](ui-change-basic-settings.md).  
2. Välj den ![Glödlampa som öppnar funktionen Berätta.](media/ui-search/search_small.png "Berätta för mig vad du vill göra") anger du **Konfigurationspaket** och väljer sedan relaterad länk.  
3. Välj relevant paket i listan och välj sedan åtgärden **Exportera paket**.  

Använd följande procedur för att skapa ett nytt företag, och använd konfigurationspaketet som en del av processen.  
...
2. Välj den ![Glödlampa som öppnar funktionen Berätta.](media/ui-search/search_small.png "Berätta för mig vad du vill göra") anger du **Konfigurationspaket** och väljer sedan relaterad länk.  
3. Välj åtgärden **Importera paket** och ange sedan den .rapidstart-fil som du vill importera.  
