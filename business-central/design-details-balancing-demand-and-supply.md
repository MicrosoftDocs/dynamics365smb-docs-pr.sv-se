...
---
# <a name="design-details-balancing-supply-and-demand"></a><a name="design-details-balancing-supply-and-demand"></a>Designdetaljer: Balansera efterfrågan och tillgång
...
## <a name="supply-and-demand"></a><a name="supply-and-demand"></a>Tillgång och efterfrågan
...
## <a name="the-concept-of-balancing-in-brief"></a><a name="the-concept-of-balancing-in-brief"></a>Begreppet motkonto i korthet
...
## <a name="process-orders-before-the-planning-start-date"></a><a name="process-orders-before-the-planning-start-date"></a>Hantera order före planeringsstartdatumet
...
### <a name="serial-and-lot-numbers-and-order-to-order-links-are-exempt-from-the-previous-period"></a><a name="serial-and-lot-numbers-and-order-to-order-links-are-exempt-from-the-previous-period"></a>Serie- och partinummer och order-till-order-länkar är undantagna från föregående period
...
## <a name="load-inventory-profiles"></a><a name="load-inventory-profiles"></a>Läsa in lagerprofiler
...
### <a name="item-dimensions-are-separated"></a><a name="item-dimensions-are-separated"></a>Artikeldimensioner är separerade
...
### <a name="serial-and-lot-numbers-are-loaded-by-specification-level"></a><a name="serial-and-lot-numbers-are-loaded-by-specification-level"></a>Serie- och partinummer läses in efter specifikationsnivå
...
### <a name="order-to-order-links-are-never-broken"></a><a name="order-to-order-links-are-never-broken"></a>Order-till-order-länkar bryts aldrig
...
### <a name="component-need-is-loaded-according-to-production-order-changes"></a><a name="component-need-is-loaded-according-to-production-order-changes"></a>Komponentbehov läses in enligt produktionsorderändringar
...
### <a name="consume-safety-stock"></a><a name="consume-safety-stock"></a>Förbruka säkerhetslager
...
### <a name="forecast-demand-is-reduced-by-sales-orders"></a><a name="forecast-demand-is-reduced-by-sales-orders"></a>Prognostiserad efterfrågan minskas av försäljningsorder
...
### <a name="blanket-order-demand-is-reduced-by-sales-orders"></a><a name="blanket-order-demand-is-reduced-by-sales-orders"></a>Avropsorderbegäran minskas med försäljningsorder
...
## <a name="prioritize-orders"></a><a name="prioritize-orders"></a>Prioritera order
...
### <a name="priorities-on-the-demand-side"></a><a name="priorities-on-the-demand-side"></a>Prioriteter på efterfråganssidan
...
### <a name="priorities-on-the-supply-side"></a><a name="priorities-on-the-supply-side"></a>Prioriteter på tillgångssidan
...
### <a name="priority-related-to-the-state-of-supply-and-demand"></a><a name="priority-related-to-the-state-of-supply-and-demand"></a>Prioritet kopplad till status för tillgång och efterfrågan
...
## <a name="balancing-supply-with-demand"></a><a name="balancing-supply-with-demand"></a>Balansera tillgång med efterfrågan
...
### <a name="rules-for-actions-for-supply-events"></a><a name="rules-for-actions-for-supply-events"></a>Regler om åtgärder för tillgångshändelser
...
### <a name="determine-the-supply-quantity"></a><a name="determine-the-supply-quantity"></a>Fastställa tillgångsantalet
...
### <a name="order-tracking-links-during-planning"></a><a name="order-tracking-links-during-planning"></a>Orderspårninglänkar under planering
...
## <a name="close-balanced-supply-and-demand"></a><a name="close-balanced-supply-and-demand"></a>Stäng balanserad tillgång och efterfrågan
...
### <a name="create-the-planning-line-suggested-action"></a><a name="create-the-planning-line-suggested-action"></a>Skapa planeringsraden (föreslagen åtgärd)
