...
ms.author: edupont
---
# <a name="enable-picking-items-by-fefo"></a><a name="enable-picking-items-by-fefo"></a><a name="enable-picking-items-by-fefo"></a>Aktivera plockning av artiklar med FEFO
