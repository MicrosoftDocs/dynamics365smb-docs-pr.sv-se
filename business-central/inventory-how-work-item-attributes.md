...
ms.author: edupont
---
# <a name="work-with-item-attributes" />Arbeta med artikelattribut
...
## <a name="create-item-attributes" />Skapa artikelattribut
...
## <a name="create-values-for-item-attributes-of-type-option" />Skapa värden för artikelattribut av typen alternativ
...
## <a name="assign-item-attributes-to-items" />Tilldela artikelattribut till artiklar
...
## <a name="assign-item-attributes-to-item-categories" />Tilldela artikelattribut till artikelkategorier
...
## <a name="filter-by-item-attributes" />Filtrera artikel efter attribut
