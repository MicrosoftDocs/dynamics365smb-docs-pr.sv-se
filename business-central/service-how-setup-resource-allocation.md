...
# <a name="set-up-resource-allocation" />Så här skapar du resursfördelningar
...
## <a name="to-set-up-skills" />Så här ställer du in kvalifikationer
...
## <a name="to-assign-skills-to-service-items-and-resources" />Du tilldelar kvalifikationer till serviceartiklar och resurser.
...
## <a name="to-set-up-zones" />Så här skapar du zoner:
...
## <a name="to-assign-zones-to-customers-and-resources" />Så här tilldelar du zoner till kunder och resurser
...
## <a name="to-specify-what-to-show-when-a-resource-is-chosen" />Om du vill ange vad som ska visas när en resurs har valts
...
## <a name="to-update-resource-capacity" />Så här uppdaterar du resurskapacitet:
...
## <a name="to-update-skills-for-items-service-items-or-service-item-groups" />Uppdatera kunskaper för artiklar, serviceartiklar eller serviceartikelgrupper
