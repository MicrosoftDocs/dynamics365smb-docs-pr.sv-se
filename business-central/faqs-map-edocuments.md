...
### <a name="what-is-expected-of-users-while-using-e-documents-matching-assistance"></a>Vad förväntas av användare när de använder matchningshjälp för e-dokument?
...
### <a name="what-is-expected-of-administrators-and-users-when-operating-e-documents-matching-assistance"></a>Vad förväntas av administratörer och användare när de använder matchningshjälp för e-dokument?
