...
ms.author: edupont
---
# <a name="create-service-quotes"></a><a name="create-service-quotes"></a>Skapa tjänsteofferter
...
## <a name="to-create-a-service-quote"></a><a name="to-create-a-service-quote"></a>Så här skapar du serviceofferter
