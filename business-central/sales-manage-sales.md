...
ms.author: edupont
---
# <a name="sales"></a><a name="sales"></a>FÖRS
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relaterad [Microsoft utbildning](/training/paths/sell-items-services-dynamics-365-business-central/).
