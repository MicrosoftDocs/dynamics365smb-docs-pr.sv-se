...
# <a name="validate-vat-registration-numbers"></a><a name="validate-vat-registration-numbers"></a>Validera momsregistreringsnummer
...
## <a name="configure-the-service-to-verify-vat-registration-numbers-automatically"></a><a name="configure-the-service-to-verify-vat-registration-numbers-automatically"></a>Konfigurera tjänsten för att verifiera momsregistreringsnummer automatiskt
...
## <a name="validation-templates"></a><a name="validation-templates"></a>Valideringsmallar
