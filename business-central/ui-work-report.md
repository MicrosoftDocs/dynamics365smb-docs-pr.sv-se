...
ms.author: jswymer
---
# <a name="run-and-print-reports" />Köra och skriva ut rapporter
...
## <a name="specifying-the-data-to-include-in-a-report" />Ange data att inkludera i rapporter
...
## <a name="previewing-a-report" />Förhandsgranska en rapport
...
### <a name="work-with-the-preview" />Arbeta med förhandsgranskning
...
## <a name="saving-a-report-to-a-file" />Spara en rapport i en fil
...
### <a name="manage-scheduled-recurring-reports" />Hantera schemalagda återkommande rapporter
...
### <a name="printing-reports-in-thai" />Skriva ut rapporter på thailändska
...
## <a name="switching-the-report-layout" />Växla rapportlayouten
...
## <a name="change-language-and-format-of-numbers-dates-and-times" />Ändra språk och format för tal, datum och tid
...
## <a name="advanced-options" />Avancerade alternativ
