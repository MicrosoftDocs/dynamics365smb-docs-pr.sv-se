...
# <a name="set-up-fault-reporting"></a><a name="set-up-fault-reporting"></a>Konfigurera felrapportering
...
## <a name="to-specify-the-overall-level-of-fault-reporting"></a><a name="to-specify-the-overall-level-of-fault-reporting"></a>Ange övergripandenivå av felrapportering
...
## <a name="to-create-fault-and-resolution-code-relationships"></a><a name="to-create-fault-and-resolution-code-relationships"></a>Så här skapar du fel- och åtgärdskodssamband
