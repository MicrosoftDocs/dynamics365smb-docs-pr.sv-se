...
ms.author: edupont
---
# <a name="flush-components-according-to-operation-output" />Bokföra komponenter utifrån verksamhetens utflöde
...
## <a name="automatic-consumption-posting-flushing-methods" />Metoder för automatisk bokföring av förbrukning
...
### <a name="automatic-reporting---forward-flush-the-entire-order" />Automatisk rapportering – Bokför hela ordern framåt
...
### <a name="automatic-reporting---forward-flushing-by-operation" />Automatisk rapportering – Bokföring framåt efter operation
...
### <a name="automatic-reporting---back-flushing-by-operation" />Automatisk rapportering – Bokföring bakåt efter operation
...
### <a name="automatic-reporting---back-flushing-the-entire-order" />Automatisk rapportering – Bokför hela ordern bakåt
...
## <a name="to-flush-components-according-to-operation-output" />Bokföra komponenter utifrån operationens utflöde
...
## <a name="flushing-methods" />Bokföringsmetoder
