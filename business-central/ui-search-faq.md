...
Nej, men det är lätt att komma åt informationen från Hjälp fönstret. Välj bara menyalternativet **Hjälp** (frågetecknet i det övre högra hörnet) eller tryck på Ctrl+F1 på ditt tangentbord. Mer information finns i [Hjälpfönster](product-help-and-support.md#help-pane).
