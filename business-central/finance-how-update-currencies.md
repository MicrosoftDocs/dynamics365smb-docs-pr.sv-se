...
ms.author: edupont
---
# <a name="update-currency-exchange-rates" />Uppdatera valutakurser
...
### <a name="effect-on-customers-and-vendors" />Påverkan på kunder och leverantörer
...
#### <a name="dimensions-on-customer-and-vendor-ledger-entries" />Dimensioner på kund-/leverantörstransaktioner
...
### <a name="effect-on-bank-accounts" />Påverkan på bankkonton
...
#### <a name="dimensions-on-bank-account-entries" />Dimensioner för bankkontotransaktioner
...
### <a name="effect-on-gl-accounts" />Påverkan på redovisningskonton
...
##### <a name="dimensions-on-gl-account-entries" />Dimensioner för redovisningskontotransaktioner
...
## <a name="to-set-up-a-currency-exchange-rate-service" />Så här konfigurerar du en valutakurstjänst
...
## <a name="to-update-currency-exchange-rates-through-a-service" />Så här uppdaterar du valutakurser från en tjänst
