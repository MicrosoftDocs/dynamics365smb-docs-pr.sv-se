...
## <a name="adjust-exchange-rates"></a>Justera valutakurser
...
## <a name="preview-the-effect-of-an-adjustment"></a>Förhandsgranska effekten av en justering
...
#### <a name="dimensions-on-customer-and-vendor-ledger-entries"></a>Dimensioner på kund- och leverantörsreskontratransaktioner
...
## <a name="set-up-a-currency-exchange-rate-service"></a>Konfigurera en valutakurstjänst

Du kan använda en extern tjänst för kontinuerlig uppdatering av aktuella valutakurser.
...
4. Mappa fälten från XML-filen till tabellen Valutakurser i källfältet.
5. Tillämpa nödvändiga omvandlingsregler.
6. Aktivera **Aktiverad** för att aktivera tjänsten.
...
## <a name="update-currency-exchange-rates-through-a-service"></a>Uppdatera du valutakurser från en tjänst
...
## <a name="correct-mistakes"></a>Korrigera misstag
