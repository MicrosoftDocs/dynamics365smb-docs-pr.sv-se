...
ms.author: edupont
---
# <a name="remove-and-reapply-item-ledger-entries" />Ta bort och koppla om artikeltransaktioner
...
## <a name="to-remove-an-item-application-by-using-the-application-worksheet" />Ta bort en artikelkoppling med hjälp av kopplingsformulär
...
## <a name="to-reapply-an-item-application-by-using-the-application-worksheet" />Koppla om en artikelkoppling med hjälp av kopplingsformuläret
