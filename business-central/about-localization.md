...
ms.author: edupont
---
# <a name="local-functionality-in-"></a><a name="local-functionality-in-"></a>Lokal funktionalitet i [!INCLUDE[prod_long](includes/prod_long.md)]
...
## <a name="local-functionality"></a><a name="local-functionality"></a>Lokal funktionalitet
...
### <a name="other-countries"></a><a name="other-countries"></a>Övriga länder
