...
4. I fältet **Brytdatum för uppladdning** anger du ett datum före vilket betalningar inte inkluderas i den exporterade filen.
...
## <a name="to-view-exported-positive-pay-records"></a>Så här visar du exporterade Positive Pay-poster
...
## <a name="to-reexport-positive-pay-files"></a>Att återexportera Positive Pay-filer
