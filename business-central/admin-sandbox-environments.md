...
ms.author: solsen
---
# <a name="sandbox-environments-in-"></a><a name="sandbox-environments-in-"></a><a name="sandbox-environments-in-"></a>Begränsade miljöer i [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="advanced-user-experience"></a><a name="advanced-user-experience"></a><a name="advanced-user-experience"></a>Avancerad användarupplevelse
...
### <a name="complete-sample-data"></a><a name="complete-sample-data"></a><a name="complete-sample-data"></a>Fullständiga exempeldata
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relaterad [Microsoft utbildning](/training/modules/admin-online-dynamics-365-business-central/)
