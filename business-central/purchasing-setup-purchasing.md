...
ms.author: edupont
---
# <a name="setting-up-purchasing" />Ställa in inköp
...
## <a name="purchases-and-payables-setup" />Konfiguration av inköp och leverantörsreskontra
...
### <a name="general-settings" />Allmänna inställningar
...
### <a name="number-series-settings" />Inställningar för nummerserier
...
## <a name="exact-cost-reversing" />Exakt kostnadsåterföring
...
## <a name="more-purchasing-setups" />Fler inköpsinställningar
...
## <a name="see-related-training-at-microsoft-learnlearnpathstrade-get-started-dynamics--business-central" />Se relaterad utbildning på [Microsoft Learn](/learn/paths/trade-get-started-dynamics-365-business-central/).
