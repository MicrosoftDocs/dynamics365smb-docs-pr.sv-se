...
---
# <a name="walkthrough-picking-and-shipping-in-basic-warehouse-configurations" />Genomgång: Plockning och leverans i grundläggande lagerkonfiguration
...
### <a name="setting-up-the-bin-codes" />Ställer in lagerplatskoder

När du har skapat ett lagerställe måste du lägga till två lagerplatser.

#### <a name="to-setup-the-bin-codes" />Ställa in lagerplatskoder

1. Välj åtgärden **Lagerplatser**.
2. Skapa två lagerplatser med koderna *S-01-0001* och *S-01-0002*.

### <a name="making-yourself-a-warehouse-employee-at-location-south" />Skapa en distributionslagerarbetare på lagerstället SYD

För att kunna använda den här funktionen måste du lägga till dig själv till lagerstället som distributionslagerarbetare. 

#### <a name="to-make-yourself-a-warehouse-employee" />Så här skapar du en distributionslagerarbetare
...
## <a name="creating-the-sales-order" />Skapar försäljningsreturordern
...
## <a name="picking-and-shipping-items" />Plocka och leverera artiklar
...
### <a name="to-pick-and-ship-items" />Plocka och utleverera artiklar så här
