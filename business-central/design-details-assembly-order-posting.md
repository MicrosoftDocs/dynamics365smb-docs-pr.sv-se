...
ms.author: edupont
---
# <a name="design-details-assembly-order-posting"></a><a name="design-details-assembly-order-posting"></a>Designdetaljer: Bokföring av monteringsorder
...
## <a name="posting-sequence"></a><a name="posting-sequence"></a>Bokföringssekvens
...
## <a name="cost-adjustment"></a><a name="cost-adjustment"></a>Kostnadsjustering
...
### <a name="performing-the-adjustment"></a><a name="performing-the-adjustment"></a>Utföra justeringen
...
## <a name="assembly-costs-are-always-actual"></a><a name="assembly-costs-are-always-actual"></a>Monteringkostnader är alltid faktiska
...
### <a name="posting-dates"></a><a name="posting-dates"></a>Bokföringsdatum
