...
## Visa alla anpassade sidor för en profil
...
## Radera anpassningar för en profil
...
## Ta bort anpassning av specifika sidor för en profil
...
### Lägg till tabellfält som inte finns på sidobjektet

Om du vill göra ett tabellfält tillgängligt på en sida för användare måste du först lägga till det på sidan. När du har lagt till fältet kan användarna välja att visa eller dölja fältet med hjälp av anpassning. Det finns några olika sätt att lägga till ett fält.
...
När fältet har lagts till växlar verktygstipset för fältet i fönstret **Lägg till fält** på sida till **Definieras av sidan**.

> [!NOTE]
> Det tillagda fältet är låst från redigering och kan inte låsas upp.
