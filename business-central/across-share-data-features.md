...
ms.author: jswymer
---
# <a name="sharing-business-data-from-business-central"></a><a name="sharing-business-data-from-business-central"></a>Dela affärsdata från Business Central
...
## <a name="copying-a-link"></a><a name="copying-a-link"></a>Kopiera en länk
...
### <a name="modify-the-page-link"></a><a name="modify-the-page-link"></a>Ändra sidlänken
...
### <a name="about-filtered-lists"></a><a name="about-filtered-lists"></a>Om filtrerade listor
...
## <a name="sharing-to-teams"></a><a name="sharing-to-teams"></a>Dela med Teams
...
## <a name="sharing-through-onedrive"></a><a name="sharing-through-onedrive"></a>Dela via OneDrive
...
## <a name="opening-in-excel"></a><a name="opening-in-excel"></a>Öppna i Excel
...
## <a name="sharing-rows-or-tables"></a><a name="sharing-rows-or-tables"></a>Dela rader eller tabeller
