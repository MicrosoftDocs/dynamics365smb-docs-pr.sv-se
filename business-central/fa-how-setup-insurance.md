...
ms.author: edupont
---
# <a name="set-up-fixed-asset-insurance" />Skapa försäkring för anläggningstillgångar
...
## <a name="to-set-up-general-insurance-information" />Så här anger du allmän försäkringsinformation
...
## <a name="to-set-up-insurance-types" />Så här skapar du försäkringstyper
...
## <a name="to-set-up-insurance-cards" />Så här skapar du försäkringskort
...
## <a name="to-set-up-insurance-journal-templates" />Så här skapar du journalmallar för försäkringar
...
## <a name="to-set-up-insurance-journal-batches" />Så här skapar du försäkringsjournaler
