...
ms.author: edupont
---
# <a name="set-up-fixed-asset-insurance"></a><a name="set-up-fixed-asset-insurance"></a><a name="set-up-fixed-asset-insurance"></a>Skapa försäkring för anläggningstillgångar
...
## <a name="to-set-up-general-insurance-information"></a><a name="to-set-up-general-insurance-information"></a><a name="to-set-up-general-insurance-information"></a>Så här anger du allmän försäkringsinformation
...
## <a name="to-set-up-insurance-types"></a><a name="to-set-up-insurance-types"></a><a name="to-set-up-insurance-types"></a>Så här skapar du försäkringstyper
...
## <a name="to-set-up-insurance-cards"></a><a name="to-set-up-insurance-cards"></a><a name="to-set-up-insurance-cards"></a>Så här skapar du försäkringskort
...
## <a name="to-set-up-insurance-journal-templates"></a><a name="to-set-up-insurance-journal-templates"></a><a name="to-set-up-insurance-journal-templates"></a>Så här skapar du journalmallar för försäkringar
...
## <a name="to-set-up-insurance-journal-batches"></a><a name="to-set-up-insurance-journal-batches"></a><a name="to-set-up-insurance-journal-batches"></a>Så här skapar du försäkringsjournaler
