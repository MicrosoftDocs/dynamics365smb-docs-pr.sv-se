...
# <a name="the-quickbooks-online-data-migration-extension" />Tillägget QuickBooks Online datamigrering
...
## <a name="what-data-can-i-import-from-quickbooks-online" />Vilka data kan jag importera från QuickBooks Online?
...
## <a name="how-do-i-start-using-the-extension" />Hur börjar jag använda tillägget?
...
## <a name="what-do-i-do-after-i-migrate-data" />Vad gör jag efter att jag har migrerat data?
...
## <a name="see-related-microsoft-training" />Se relaterad [Microsoft utbildning](/training/modules/migrate-data-dynamics-365-business-central/)
