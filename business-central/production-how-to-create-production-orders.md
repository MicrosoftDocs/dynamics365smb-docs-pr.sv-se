...
ms.author: edupont
---
# <a name="create-production-order-headers" />Så här skapar du produktionsorderhuvud
...
## <a name="to-create-a-production-order-header" />Så här skapar du ett produktionsorderhuvud
