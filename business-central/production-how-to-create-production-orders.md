...
ms.author: edupont
---
# <a name="create-production-order-headers"></a><a name="create-production-order-headers"></a><a name="create-production-order-headers"></a>Så här skapar du produktionsorderhuvud
...
## <a name="to-create-a-production-order-header"></a><a name="to-create-a-production-order-header"></a><a name="to-create-a-production-order-header"></a>Så här skapar du ett produktionsorderhuvud
