...
# <a name="couple-and-synchronize-records-between-dataverse-and-business-central" />Koppla och synkronisera poster mellan Dataverse och Business Central
...
## <a name="video-example" />Videoexempel
...
## <a name="to-couple-a-record" />Om du vill koppla en post
...
## <a name="to-synchronize-a-single-record" />Om du vill synkronisera en enda post
...
## <a name="to-couple-multiple-records-using-match-based-coupling" />För at koppla flera poster med matchningsbaserad koppling
...
## <a name="to-synchronize-multiple-records" />Om du vill synkronisera flera poster
...
## <a name="bulk-insert-and-couple-records" />Massinfoga och koppla poster
...
## <a name="uncoupling-records" />Frånkopplingsposter
