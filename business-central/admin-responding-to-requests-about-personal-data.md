...
# <a name="responding-to-requests-about-users-personal-data" />Svara på begäranden om användarens personuppgifter
...
## <a name="types-of-requests" />Typer av begäranden
...
## <a name="restrict-data-processing-for-a-data-subject" />Begränsa databearbetning för registrerade
...
## <a name="handling-data-subject-requests-when-using-a-trial-version" />Hantera begäranden av registrerade när du använder en testversion
...
## <a name="exporting-data-from-tables-not-classified-by-data-subject" />Exportera Data från tabeller som inte klassificeras av registrerade
...
## <a name="handling-data-about-minors" />Hantera data om minderåriga
