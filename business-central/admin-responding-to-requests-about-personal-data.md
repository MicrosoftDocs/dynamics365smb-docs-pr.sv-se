...
# Svara på begäranden om användarens personuppgifter
...
## Begränsa databearbetning för registrerade
...
## Hantera begäranden av registrerade när du använder en testversion
...
## Exportera Data från tabeller som inte klassificeras av registrerade
