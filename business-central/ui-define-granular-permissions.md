...
# <a name="assign-permissions-to-users-and-groups"></a><a name="assign-permissions-to-users-and-groups"></a>Tilldela behörigheter till användare och grupper
...
## <a name="to-create-a-permission-set"></a><a name="to-create-a-permission-set"></a>Skapa en behörighetsuppsättning
...
### <a name="example---indirect-permission"></a><a name="example---indirect-permission"></a>Exempel – Indirekt behörighet
...
### <a name="to-add-other-permission-sets"></a><a name="to-add-other-permission-sets"></a>Lägga till andra behörighetsuppsättningar
...
## <a name="to-copy-a-permission-set"></a><a name="to-copy-a-permission-set"></a>Att kopiera behörighetsuppsättning
...
## <a name="to-create-or-modify-permissions-by-recording-your-actions"></a><a name="to-create-or-modify-permissions-by-recording-your-actions"></a>Skapa eller ändra behörigheter genom att registrera dina åtgärder
...
### <a name="to-export-and-import-a-permission-set"></a><a name="to-export-and-import-a-permission-set"></a>Så här exporterar och importerar du en behörighetsgrupp
...
## <a name="to-remove-obsolete-permissions-from-all-permission-sets"></a><a name="to-remove-obsolete-permissions-from-all-permission-sets"></a>Ta bort föråldrade behörigheter från alla behörighetsgrupper

På sidan **Behörighetsuppsättningar**, välj åtgärden **Ta bort inaktuella behörigheter**.

## <a name="to-set-up-time-constraints-for-users"></a><a name="to-set-up-time-constraints-for-users"></a>Så här ställer du in tidsbegränsningar för användare
...
## <a name="to-manage-permissions-through-user-groups"></a><a name="to-manage-permissions-through-user-groups"></a>Hantera behörigheter via användargrupper
...
### <a name="to-add-users-to-a-user-group"></a><a name="to-add-users-to-a-user-group"></a>Så här lägger du till användare i en användargrupp
...
### <a name="to-copy-a-user-group-and-all-its-permission-sets"></a><a name="to-copy-a-user-group-and-all-its-permission-sets"></a>Om du vill kopiera en användargrupp och dess behörighetsuppsättningar
...
### <a name="to-assign-permission-sets-to-user-groups"></a><a name="to-assign-permission-sets-to-user-groups"></a>Tilldela behörighetsuppsättningar till användargrupper
...
### <a name="to-assign-a-permission-set-on-the-permission-set-by-user-group-page"></a><a name="to-assign-a-permission-set-on-the-permission-set-by-user-group-page"></a>Tilldela en behörighetsuppsättning på sidan **Behörighetsuppsättning efter användargrupp**
...
## <a name="to-assign-permission-sets-to-users"></a><a name="to-assign-permission-sets-to-users"></a>Så här tilldelar behörighetsuppsättningar till användare
...
### <a name="to-assign-a-permission-set-on-a-user-card"></a><a name="to-assign-a-permission-set-on-a-user-card"></a>Så här tilldelar du en behörighetsuppsättning till ett användarkort
...
### <a name="to-assign-a-permission-set-on-the-permission-set-by-user-page"></a><a name="to-assign-a-permission-set-on-the-permission-set-by-user-page"></a>Så här tilldelar du en behörighetsuppsättning till sidan Behörighetsuppsättning efter användare
...
## <a name="to-get-an-overview-of-a-users-permissions"></a><a name="to-get-an-overview-of-a-users-permissions"></a>Så här får du en översikt en användares behörigheter
...
### <a name="security-filters-limit-a-users-access-to-specific-records-in-a-table"></a><a name="security-filters-limit-a-users-access-to-specific-records-in-a-table"></a>Säkerhetsfilter – begränsa användarens åtkomst till specifika poster i en tabell
...
## <a name="viewing-permission-changes-telemetry"></a><a name="viewing-permission-changes-telemetry"></a>Visa telemetri över behörighetsförändringar
...
## <a name="delegated-admin-users"></a><a name="delegated-admin-users"></a>Utsedda adminanvändare
