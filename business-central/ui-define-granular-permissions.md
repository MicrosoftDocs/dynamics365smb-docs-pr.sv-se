...
# <a name="assign-permissions-to-users-and-groups" />Tilldela behörigheter till användare och grupper
...
## <a name="to-create-a-permission-set" />Skapa en behörighetsuppsättning
...
### <a name="example---indirect-permission" />Exempel – Indirekt behörighet
...
### <a name="to-add-other-permission-sets" />Lägga till andra behörighetsuppsättningar
...
## <a name="to-copy-a-permission-set" />Att kopiera behörighetsuppsättning
...
## <a name="to-create-or-modify-permissions-by-recording-your-actions" />Skapa eller ändra behörigheter genom att registrera dina åtgärder
...
### <a name="to-export-and-import-a-permission-set" />Så här exporterar och importerar du en behörighetsgrupp
...
## <a name="to-remove-obsolete-permissions-from-all-permission-sets" />Ta bort föråldrade behörigheter från alla behörighetsgrupper

På sidan **Behörighetsuppsättningar**, välj åtgärden **Ta bort inaktuella behörigheter**.

## <a name="to-set-up-time-constraints-for-users" />Så här ställer du in tidsbegränsningar för användare
...
## <a name="to-manage-permissions-through-user-groups" />Hantera behörigheter via användargrupper
...
### <a name="to-add-users-to-a-user-group" />Så här lägger du till användare i en användargrupp
...
### <a name="to-copy-a-user-group-and-all-its-permission-sets" />Om du vill kopiera en användargrupp och dess behörighetsuppsättningar
...
### <a name="to-assign-permission-sets-to-user-groups" />Tilldela behörighetsuppsättningar till användargrupper
...
### <a name="to-assign-a-permission-set-on-the-permission-set-by-user-group-page" />Tilldela en behörighetsuppsättning på sidan **Behörighetsuppsättning efter användargrupp**
...
## <a name="to-assign-permission-sets-to-users" />Så här tilldelar behörighetsuppsättningar till användare
...
### <a name="to-assign-a-permission-set-on-a-user-card" />Så här tilldelar du en behörighetsuppsättning till ett användarkort
...
### <a name="to-assign-a-permission-set-on-the-permission-set-by-user-page" />Så här tilldelar du en behörighetsuppsättning till sidan Behörighetsuppsättning efter användare
...
## <a name="to-get-an-overview-of-a-users-permissions" />Så här får du en översikt en användares behörigheter
...
### <a name="security-filters-limit-a-users-access-to-specific-records-in-a-table" />Säkerhetsfilter – begränsa användarens åtkomst till specifika poster i en tabell
...
## <a name="viewing-permission-changes-telemetry" />Visa telemetri över behörighetsförändringar
...
## <a name="delegated-admin-users" />Utsedda adminanvändare
