...
ms.author: edupont
---
# <a name="set-up-bin-types"></a><a name="set-up-bin-types"></a><a name="set-up-bin-types"></a>Skapa lagerplatstyper
...
## <a name="to-set-up-the-bin-types-you-want-to-use"></a><a name="to-set-up-the-bin-types-you-want-to-use"></a><a name="to-set-up-the-bin-types-you-want-to-use"></a>Så här skapar du de lagerplatstyper som du vill använda
