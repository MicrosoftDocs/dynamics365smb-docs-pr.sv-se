...
Se [Designdetaljer: Ankommande distributionslagerflöde](design-details-inbound-warehouse-flow.md) för exempel på hur användargränssnittsdokumenten används per lagerkomplexitetsnivå.  
