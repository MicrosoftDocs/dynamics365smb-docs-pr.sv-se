...
description: Beskriver uppgiften att fördela en transaktion i en återkommande redovisningsjournal på flera olika konton när du bokför journalen.
author: brentholtorf
ms.author: bholtorf
...
---
# <a name="allocate-recurring-costs-and-income"></a>Fördela återkommande kostnader och intäkter

Du kan fördela en transaktion i en återkommande redovisningsjournal på flera olika konton när du bokför journalen. Mer information om återkommande redovisningsjournaler finns i [Arbeta med återkommande journaler](ui-work-general-journals.md#work-with-recurring-journals). 

Fördelningen kan göras enligt tre olika metoder:

* Kvantitet
* Procent (%)
* Momsbelopp

Fördelningsfunktionerna kan användas med återkommande redovisningsjournaler samt i anläggningstillgångsjournaler.
...
4. Fyll i de relevanta fälten och välj sedan **OK**.
