...
ms.author: edupont
---
# <a name="set-up-reminder-terms-and-levels"></a><a name="set-up-reminder-terms-and-levels"></a>Konfigurera påminnelsevillkor och nivåer
...
## <a name="reminder-terms"></a><a name="reminder-terms"></a>Betalningspåminnelsevillkor
...
### <a name="to-set-up-reminder-terms"></a><a name="to-set-up-reminder-terms"></a>Så här ställer du in betalningspåminnelsevillkor
...
## <a name="reminder-levels"></a><a name="reminder-levels"></a>Betalningspåminnelsenivåer
...
### <a name="to-set-up-reminder-levels"></a><a name="to-set-up-reminder-levels"></a>Så här ställer du in nivåer för betalningspåminnelser
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relaterad [Microsoft utbildning](/training/modules/send-reminders-dynamics-365-business-central/)
