...
---
# <a name="create-recurring-purchase-lines" />Skapa återkommande inköpsrader
...
## <a name="set-up-recurring-purchase-lines" />Ställ in återkommande inköpsrader
...
## <a name="assign-recurring-purchase-lines-to-a-vendor" />Tilldela en leverantör återkommande inköpsrader
...
## <a name="insert-recurring-purchase-lines-on-a-purchase-invoice" />Så här kan du automatiskt infoga återkommande inköpsrader på en inköpsfaktura
