...
ms.author: bholtorf
---
# <a name="use-a-power-automate-flow-for-alerts-to-dataverse-entity-changes" />Använda ett Power Automate flöde för aviseringar till Dataverse enhetsändringar
...
## <a name="import-the-flow-template" />Importera flödesmallen
...
## <a name="define-the-flow-trigger" />Definiera flödesutlösaren
...
## <a name="define-the-flow-condition" />Definiera flödesvillkor
...
## <a name="notify-business-central-about-a-change" />Meddela Business Central om en ändring
