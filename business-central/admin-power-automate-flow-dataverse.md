...
3. Lägg till en avsluta kontroll om du vill stoppa flödet om villkoret uppfylls. Det vill säga om villkoret uppfylls och en enhet ändrades av integrationsanvändarkontot.

Följande bild visar den information som ska läggas till för att definiera flödesutlösaren och flödesvillkoret.
