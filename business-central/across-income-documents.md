...
ms.author: edupont
---
# <a name="incoming-documents" />Inkommande dokument
...
## <a name="usage-scenario" />Användningsscenario
...
## <a name="incoming-document-features" />Funktioner för inkommande dokument
