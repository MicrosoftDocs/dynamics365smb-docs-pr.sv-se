...
ms.author: edupont
---
# <a name="incoming-documents"></a><a name="incoming-documents"></a><a name="incoming-documents"></a>Inkommande dokument
...
## <a name="usage-scenario"></a><a name="usage-scenario"></a><a name="usage-scenario"></a>Användningsscenario
...
## <a name="incoming-document-features"></a><a name="incoming-document-features"></a><a name="incoming-document-features"></a>Funktioner för inkommande dokument
