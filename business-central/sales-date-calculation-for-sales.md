...
ms.author: edupont
---
# <a name="delivery-date-calculation-for-sales" />Beräkning av leveransdatum för försäljning
...
## <a name="calculating-a-requested-delivery-date" />Beräkna ett begärt leveransdatum
...
## <a name="calculating-the-earliest-possible-delivery-date" />Beräkna tidigaste möjliga leveransdatum
...
## <a name="see-related-microsoft-training" />Se relaterad [Microsoft-utbildning](/training/modules/promising-sales-order-delivery-dynamics-365-business-central/).
