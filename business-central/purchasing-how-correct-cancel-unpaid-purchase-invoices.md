...
ms.author: edupont
---
# <a name="correct-or-cancel-unpaid-purchase-invoices" />Korrigera eller annullera obetalda inköpsfakturor
...
## <a name="to-correct-a-posted-purchase-invoice" />Korrigera en bokförd inköpsfaktura
...
## <a name="to-cancel-a-posted-purchase-invoice" />Avbryta en bokförd inköpsfaktura
...
### <a name="partial-invoice-posting-also-supported" />Delfakturabokföring stöds också
...
## <a name="see-related-microsoft-trainingtrainingmodulesreceive-invoice-dynamics-d365-business-central" />Se relaterad [Microsoft utbildning](/training/modules/receive-invoice-dynamics-d365-business-central/)
