...
ms.author: jswymer
---
# <a name="closing-years-and-periods"></a><a name="closing-years-and-periods"></a><a name="closing-years-and-periods"></a>Avsluta år och perioder
...
| Till | Gå till |
| --- | --- |
| Ange räkenskapsåret och dela upp det i tidsperioder för rapportering av ekonomiska resultat. | [Arbeta med bokföringsperioder och räkenskapsår](finance-accounting-periods-and-fiscal-years.md)|
...
| Få en översikt över aktiviteter som ofta utförs i samband med att du avslutar en period, till exempel bokföring av alla dokument och journaler, eller köra ekonomiska rapporter. |[Avsluta perioder](year-how-complete-period-end-processes.md) |
...
| Förbereda rapport av momsbelopp som du har lagrat för försäljning till skattemyndighetens webbtjänst. |[Rapportera moms till skattemyndigheterna](finance-how-report-vat.md)|
| Skriv ut rapporter för att kontrollera saldona för redovisnings-, kund-, leverantörs- och bankkonton innan du avslutar en period. |[Förbereder rapporter före bokslut](year-prepare-preclose-reports.md) |
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relaterad [Microsoft utbildning](/training/modules/close-fiscal-year-dynamics-365-business-central/index)
