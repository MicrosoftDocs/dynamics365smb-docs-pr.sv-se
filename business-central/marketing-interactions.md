...
ms.author: jswymer
---
# <a name="record-interactions-with-contacts"></a><a name="record-interactions-with-contacts"></a><a name="record-interactions-with-contacts"></a>Spela in interaktioner med kontakter
...
## <a name="setting-up-interaction-templates"></a><a name="setting-up-interaction-templates"></a><a name="setting-up-interaction-templates"></a>Skapa interaktionsmallar
...
## <a name="creating-interactions"></a><a name="creating-interactions"></a><a name="creating-interactions"></a>Skapa interaktioner
...
## <a name="viewing-and-managing-recorded-interactions"></a><a name="viewing-and-managing-recorded-interactions"></a><a name="viewing-and-managing-recorded-interactions"></a>Visa och hantera registrerade interaktioner
