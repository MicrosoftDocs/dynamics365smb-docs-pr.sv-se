...
ms.author: edupont
---
# <a name="design-details-accounts-in-the-general-ledger" />Designdetaljer: Konton i redovisningen
...
## <a name="from-the-inventory-ledger" />Från inventeringstransaktioner
...
## <a name="from-the-capacity-ledger" />Från kapacitetstransaktioner
...
## <a name="calculating-the-amount-to-post-to-the-general-ledger" />Beräknar antal att bokföra i redovisningen
