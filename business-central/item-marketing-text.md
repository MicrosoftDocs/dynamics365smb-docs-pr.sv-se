...
# <a name="add-marketing-text-to-items" />Lägg till marknadsföringstext för artiklar
...
## <a name="a-namecopilotacreate-ai-generated-marketing-text-preview-with-copilot" /><a name=copilot></a>Skapa AI-genererad marknadsföringstext (förhandsgranskning) med Copilot
...
### <a name="create-first-draft-with-copilot" />Skapa första utkast med Copilot
...
### <a name="review-edit-and-save-text" />Granska, redigera och spara text
...
### <a name="improve-and-tailor-text-suggestions" />Förbättra och anpassa textförslag
...
## <a name="create-marketing-text-from-scratch" />Skapa marknadsföringstext från grunden
