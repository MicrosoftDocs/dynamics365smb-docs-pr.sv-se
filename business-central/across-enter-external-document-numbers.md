...
ms.author: edupont
---
# <a name="enter-external-document-numbers" />Ange externa dokumentnummer
...
## <a name="to-enter-external-document-numbers-in-a-sales-order" />Så här anger du externa dokumentnummer i en försäljningsorder
