...
ms.author: edupont
---
# <a name="use-resources-for-jobs" />Använda resurser för projekt
...
## <a name="to-assign-resources-to-jobs" />Så här tilldelar du resurser till projekt
...
## <a name="to-record-resource-usage-for-a-job" />Registrera resursförbrukning för ett projekt
...
## <a name="to-adjust-resource-prices" />Justera resurspriser
...
## <a name="to-get-resource-price-change-suggestions-based-on-existing-alternate-prices" />Så här får du förslag till resursprisändringar enligt befintliga alternativa priser:
...
## <a name="to-get-resource-price-change-suggestions-based-on-standard-prices" />Så här får du förslag till resursprisändringar enligt standardpriser
...
## <a name="to-get-resource-price-change-suggestions-based-on-alternate-prices" />Så här får du förslag till resursprisändringar baserat på alternativa priser
