...
ms.author: edupont
---
# <a name="walkthrough-setting-up-and-invoicing-sales-prepayments"></a><a name="walkthrough-setting-up-and-invoicing-sales-prepayments"></a>Genomgång: Lägga upp och fakturera förskottsbetaln., försäljning
...
## <a name="set-up-prepayments"></a><a name="set-up-prepayments"></a>Konfigurera förskottsbetalningar
...
### <a name="to-set-up-number-series-for-prepayments"></a><a name="to-set-up-number-series-for-prepayments"></a>Så här lägger du upp nummerserier för förskottsbetalningar
...
### <a name="to-block-shipments-for-unpaid-prepayment"></a><a name="to-block-shipments-for-unpaid-prepayment"></a>Så här spärrar du utleveranser för obetalda förskottsbetalningar
...
### <a name="to-assign-default-prepayment-percentages-to-customers-and-items"></a><a name="to-assign-default-prepayment-percentages-to-customers-and-items"></a>Så här tilldelar du kunder och artiklar procentuella standardvärden för förskottsbetalningar
...
### <a name="to-specify-an-account-for-sales-prepayments-in-general-posting-setup"></a><a name="to-specify-an-account-for-sales-prepayments-in-general-posting-setup"></a>Så här kan du skriva in ett konto för utgående förskottsbetalningar i bokföringsinställningarna
...
## <a name="create-an-order-that-requires-a-prepayment"></a><a name="create-an-order-that-requires-a-prepayment"></a>Skapa en order som kräver förskottsbetalning
...
### <a name="to-create-a-sales-order-with-a-prepayment"></a><a name="to-create-a-sales-order-with-a-prepayment"></a>Så här skapar du en försäljningsorder med förskottsbetalning
...
## <a name="create-a-prepayment-invoice"></a><a name="create-a-prepayment-invoice"></a>Skapa en förskottsfaktura
...
### <a name="to-create-a-prepayment-invoice"></a><a name="to-create-a-prepayment-invoice"></a>Så här skapar du en förskottsfaktura
...
## <a name="create-an-additional-prepayment-invoice"></a><a name="create-an-additional-prepayment-invoice"></a>Skapa en ytterligare förskottsfaktura
...
### <a name="to-create-an-additional-prepayment-invoice"></a><a name="to-create-an-additional-prepayment-invoice"></a>Så här skapar du ytterligare en förskottsfaktura
...
## <a name="apply-the-prepayments"></a><a name="apply-the-prepayments"></a>Använda förskottsbetalningar
...
### <a name="to-apply-a-payment-to-the-prepayment-invoices"></a><a name="to-apply-a-payment-to-the-prepayment-invoices"></a>Så här bokför du betalningar mot förskottsfakturor
...
## <a name="invoice-the-remaining-amount"></a><a name="invoice-the-remaining-amount"></a>Fakturera återstående belopp
...
### <a name="to-invoice-the-remaining-amount"></a><a name="to-invoice-the-remaining-amount"></a>Så här fakturerar du återstående belopp
...
## <a name="update-the-status-of-prepaid-orders-and-invoices-automatically"></a><a name="update-the-status-of-prepaid-orders-and-invoices-automatically"></a>Uppdatera statusen för förutbetalda order och fakturor automatiskt
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relaterad [Microsoft utbildning](/training/modules/prepayment-invoices-dynamics-365-business-central/)
