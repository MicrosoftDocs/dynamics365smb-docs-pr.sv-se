...
ms.author: edupont
---
# <a name="reconcile-vendor-payments-with-the-payment-journal-or-from-vendor-ledger-entries" />Stäm av leverantörsbetalningar med betalningsjournalen eller från bokförda leverantörsreskontratransaktioner
...
## <a name="to-apply-a-payment-to-a-single-or-multiple-vendor-ledger-entries" />Så här kopplar du en betalning till en enskild eller flera leverantörsreskontratransaktioner
...
## <a name="to-apply-a-credit-memo-to-a-single-or-multiple-vendor-ledger-entries" />Så här kopplar du en kreditnota till en enskild eller flera leverantörsreskontratransaktioner:
...
## <a name="to-apply-posted-vendor-ledger-entries" />Så här kopplar du bokförda leverantörsreskontratransaktioner:
...
## <a name="to-apply-vendor-ledger-entries-in-different-currencies-to-one-another" />Så här kopplar du leverantörsreskontratransaktioner i olika valutor till varandra:
...
## <a name="to-unapply-an-application-of-vendor-entries" />Så här tar du bort en koppling av leverantörstransaktioner
