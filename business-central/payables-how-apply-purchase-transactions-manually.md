...
---
# <a name="reconcile-vendor-payments-manually"></a>Stämma av leverantörsbetalningar manuellt
...
4. Eller så här kopplar du flera leverantörsreskontratransaktioner:
   ...
   2. I fönstret **Koppla leverantörstrans.** markerar du raden med transaktioner som du vill koppla betalningen till.
...
1. Välj ikonen ![Glödlampa som öppnar funktionen Berätta](media/ui-search/search_small.png "Berätta vad du vill göra") och ange **Inköpskreditnota** och välj sedan relaterad länk.
