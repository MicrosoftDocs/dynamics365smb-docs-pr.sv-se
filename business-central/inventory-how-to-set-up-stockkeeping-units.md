...
# <a name="set-up-stockkeeping-units"></a><a name="set-up-stockkeeping-units"></a>Konfigurera lagerställeenheter
...
## <a name="to-set-up-a-stockkeeping-unit"></a><a name="to-set-up-a-stockkeeping-unit"></a>Så här skapar du lagerställeenheter
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relaterad [Microsoft utbildning](/training/modules/control-inventory-multiple-locations/)
