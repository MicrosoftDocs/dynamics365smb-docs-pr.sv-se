...
# <a name="troubleshooting-and-correcting-dimensions"></a><a name="troubleshooting-and-correcting-dimensions"></a>Felsökning och korrigering av dimensioner
...
## <a name="troubleshooting-dimensions-errors"></a><a name="troubleshooting-dimensions-errors"></a>Felsökning av dimensionsfel
...
## <a name="changing-dimension-assignments-after-posting"></a><a name="changing-dimension-assignments-after-posting"></a>Ändra dimensionstilldelningar efter bokföring
...
### <a name="setting-up-dimension-corrections"></a><a name="setting-up-dimension-corrections"></a>Ställa in dimensionskorrigeringar
...
### <a name="correcting-a-dimension"></a><a name="correcting-a-dimension"></a>Korrigera en dimension
...
### <a name="validating-dimension-corrections"></a><a name="validating-dimension-corrections"></a>Validera dimensionskorrigeringar
...
### <a name="undoing-a-correction"></a><a name="undoing-a-correction"></a>Ångra en korrigering
...
### <a name="dimension-corrections-on-large-data-sets"></a><a name="dimension-corrections-on-large-data-sets"></a>Dimensionskorrigeringar på stora datauppsättningar
...
### <a name="use-analysis-views-with-dimension-corrections"></a><a name="use-analysis-views-with-dimension-corrections"></a>Använda analysvyer med dimensionskorrigeringar
...
### <a name="viewing-historical-dimension-corrections"></a><a name="viewing-historical-dimension-corrections"></a>Visa historiska dimensionskorrigeringar
...
### <a name="handling-incomplete-corrections"></a><a name="handling-incomplete-corrections"></a>Hantera ofullständiga korrigeringar
...
### <a name="use-cost-accounting-with-corrected-gl-entries"></a><a name="use-cost-accounting-with-corrected-gl-entries"></a>Använda Kostnadsredovisning med korrigerade redovisningstransaktioner
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relaterad [Microsoft utbildning](/training/modules/dimensions-dynamics-365-business-central/)
