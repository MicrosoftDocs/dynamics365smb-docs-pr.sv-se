...
# <a name="troubleshooting-and-correcting-dimensions" />Felsökning och korrigering av dimensioner
...
## <a name="troubleshooting-dimensions-errors" />Felsökning av dimensionsfel
...
## <a name="changing-dimension-assignments-after-posting" />Ändra dimensionstilldelningar efter bokföring
...
### <a name="setting-up-dimension-corrections" />Ställa in dimensionskorrigeringar
...
### <a name="correcting-a-dimension" />Korrigera en dimension
...
### <a name="validating-dimension-corrections" />Validera dimensionskorrigeringar
...
### <a name="undoing-a-correction" />Ångra en korrigering
...
### <a name="dimension-corrections-on-large-data-sets" />Dimensionskorrigeringar på stora datauppsättningar
...
### <a name="use-analysis-views-with-dimension-corrections" />Använda analysvyer med dimensionskorrigeringar
...
### <a name="viewing-historical-dimension-corrections" />Visa historiska dimensionskorrigeringar
...
### <a name="handling-incomplete-corrections" />Hantera ofullständiga korrigeringar
...
### <a name="use-cost-accounting-with-corrected-gl-entries" />Använda Kostnadsredovisning med korrigerade redovisningstransaktioner
...
## <a name="see-related-microsoft-training" />Se relaterad [Microsoft utbildning](/training/modules/dimensions-dynamics-365-business-central/)
