...
## <a name="view-and-approve-time-sheets-by-project"></a>Visa och godkänna tidrapporter per projekt
...
### <a name="approve-or-reject-a-time-sheet-by-project"></a>Godkänn eller avvisa en tidrapport för projekt
...
## <a name="post-time-sheet-lines-in-a-project-journal"></a>Bokför tidrapportrader i en projektjournal
