...
description: 'Lär dig hur du skapar, skickar, godkänner och bokför tidrapporter för resurser, projekt och tjänster.'
author: brentholtorf
ms.author: bholtorf
...
I detta hypotetiska exempel ska du registrera relevanta timmar under aktuella dagar för respektive veckodag.  
...
Om din tidrapportsinformation är samma från tidsperiod till tidsperiod kopierar du raderna från den föregående perioden för att spara tid. Sedan kan du ange bara din tidförbrukning för den nya perioden.

1. Välj ikonen med ![glödlampan som öppnar funktionen Berätta](media/ui-search/search_small.png "Berätta vad du vill göra") anger du **tidrapporter** och väljer sedan relaterad länk.  
...
## <a name="copy-project-planning-lines-to-a-time-sheet"></a>Kopiera projektplaneringsrader till en tidrapport
...
> [!TIP]
> Du kan följa liknande steg för att definiera frånvarokoder.
...
## <a name="approve-or-reject-a-time-sheet"></a>Godkänna eller avvisa en tidrapport
...
## <a name="view-and-approve-time-sheets-by-project"></a>Visa och godkänn tidrapporter per projekt
...
### <a name="approve-or-reject-a-time-sheet-by-project"></a>Godkänn eller avvisa en tidrapport per projekt
...
## <a name="post-time-sheet-lines-in-a-project-journal"></a>Bokföra tidrapportrader i en projektjournal
...
## <a name="archive-time-sheets"></a>Arkivera tidrapporter
