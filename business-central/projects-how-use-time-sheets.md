...
ms.author: edupont
---
# <a name="use-time-sheets" />Använd tidrapporter
...
## <a name="to-create-time-sheets" />Så här skapar du tidrapporter
...
## <a name="to-reuse-time-sheet-lines-in-other-time-sheets" />Så här kan du återanvända tidrapportsrader i andra tidrapporter
...
## <a name="to-copy-job-planning-lines-to-a-time-sheet" />Så här kan du kopiera projektplaneringsrader till en tidrapport
...
## <a name="to-define-work-types-and-add-one-to-a-time-sheet" />Om du vill definiera arbetstyper och lägga till en till en tidrapport
...
## <a name="to-fill-in-time-sheet-lines-and-submit-for-approval" />Fylla i tidrapportrader och skicka för godkännande
...
## <a name="to-approve-or-reject-a-time-sheet" />Så här kan du godkänna eller avvisa en tidrapport
...
## <a name="to-reopen-a-time-sheet" />Öppna en tidrapport igen
...
## <a name="to-view-and-approve-time-sheets-by-job" />Visa och godkänna tidrapporter per projekt
...
### <a name="to-approve-or-reject-a-time-sheet-by-job" />Så här kan du godkänna eller avvisa en tidrapport per projekt
...
## <a name="to-post-time-sheet-lines-in-a-resource-journal" />Bokföra tidrapportsrader i en resursjournal
...
## <a name="to-post-time-sheet-lines-in-a-job-journal" />Bokföra tidrapportsrader i en projektjournal
...
## <a name="to-archive-time-sheets" />Så här arkiverar du tidrapporter
