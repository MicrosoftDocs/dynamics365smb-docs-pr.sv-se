...
ms.author: jswymer
---
# <a name="process-sales-opportunities"></a><a name="process-sales-opportunities"></a><a name="process-sales-opportunities"></a>Behandla försäljningsmöjligheter
...
## <a name="to-view-opportunities"></a><a name="to-view-opportunities"></a><a name="to-view-opportunities"></a>Visa affärsmöjligheter.
...
## <a name="to-close-opportunities"></a><a name="to-close-opportunities"></a><a name="to-close-opportunities"></a>Avsluta affärsmöjligheter
...
## <a name="to-create-quotes-for-opportunities"></a><a name="to-create-quotes-for-opportunities"></a><a name="to-create-quotes-for-opportunities"></a>Skapa offerter för affärsmöjligheter
> [!NOTE]
...
## <a name="to-create-sales-orders-for-opportunities"></a><a name="to-create-sales-orders-for-opportunities"></a><a name="to-create-sales-orders-for-opportunities"></a>Skapa försäljningsorder för affärsmöjligheter
...
## <a name="to-delete-opportunities"></a><a name="to-delete-opportunities"></a><a name="to-delete-opportunities"></a>Ta bort affärsmöjligheter
...
## <a name="to-move-an-opportunity-through-sales-cycle-stages"></a><a name="to-move-an-opportunity-through-sales-cycle-stages"></a><a name="to-move-an-opportunity-through-sales-cycle-stages"></a>Flytta en Affärsmöjlighet via försäljningscykeletapper
