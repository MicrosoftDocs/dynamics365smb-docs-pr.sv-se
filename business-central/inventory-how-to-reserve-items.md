...
ms.author: edupont
---
# <a name="reserve-items" />Reservera artiklar
...
## <a name="reserve-items-for-sales" />Reservera artiklar för försäljning
...
## <a name="reserve-an-item-for-a-production-order-line" />Reservera artiklar för produktionsorderrader
...
## <a name="reserve-items-for-production-order-components" />Reservera artiklar för produktionsorderkomponenter
...
## <a name="change-a-reservation" />Ändra reservation
...
## <a name="cancel-a-reservation" />Avbeställ en reservation
...
## <a name="reserve-a-specific-serial-or-lot-number" />Reservera ett visst serie- eller partinummer
