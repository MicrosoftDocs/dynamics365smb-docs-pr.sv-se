...
ms.author: edupont
---
# <a name="reserve-items"></a><a name="reserve-items"></a>Reservera artiklar
...
## <a name="reserve-items-for-sales"></a><a name="reserve-items-for-sales"></a>Reservera artiklar för försäljning
...
## <a name="reserve-an-item-for-a-production-order-line"></a><a name="reserve-an-item-for-a-production-order-line"></a>Reservera artiklar för produktionsorderrader
...
## <a name="reserve-items-for-production-order-components"></a><a name="reserve-items-for-production-order-components"></a>Reservera artiklar för produktionsorderkomponenter
...
## <a name="change-a-reservation"></a><a name="change-a-reservation"></a>Ändra reservation
...
## <a name="cancel-a-reservation"></a><a name="cancel-a-reservation"></a>Avbeställ en reservation
...
## <a name="reserve-a-specific-serial-or-lot-number"></a><a name="reserve-a-specific-serial-or-lot-number"></a>Reservera ett visst serie- eller partinummer
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relaterad [Microsoft utbildning](/training/modules/manage-outbound-serial-lot-numbers/)
