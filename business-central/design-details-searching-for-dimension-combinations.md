...
ms.author: edupont
---
# <a name="design-details-searching-for-dimension-combinations"></a><a name="design-details-searching-for-dimension-combinations"></a>Designdetaljer: Söka efter dimensionskombinationer
...
## <a name="building-search-tree"></a><a name="building-search-tree"></a>Bygga sökträd
...
### <a name="example-1"></a><a name="example-1"></a>Exempel 1
...
### <a name="example-2"></a><a name="example-2"></a>Exempel 2
...
### <a name="finding-dimension-set-id"></a><a name="finding-dimension-set-id"></a>Hitta dimensionsuppsättnings-ID
