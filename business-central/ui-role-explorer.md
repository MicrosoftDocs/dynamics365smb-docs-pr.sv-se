...
# <a name="finding-pages-with-the-role-explorer" />Söka efter sidor med rollutforskaren
...
## <a name="open-the-role-explorer" />Öppna rollutforskaren
...
## <a name="navigate-features" />Navigera i funktioner
...
## <a name="search-for-features" />Söka efter funktioner
...
## <a name="explore-other-roles" />Utforska andra roller
...
## <a name="expand-and-collapse-nodes-on-the-role-explorer" />Expandera och komprimera noder i rollutforskaren
