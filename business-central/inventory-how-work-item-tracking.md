---
title: 'Spåra artiklar med serie-, parti- eller paketnummer'
...
---
# <a name="track-items-with-serial-lot-and-package-numbers"></a>Spåra artiklar med serie-, parti- eller paketnummer
...
I antalsfält längst upp på fönstret **Artikelspårningsrader** visas antalen och summorna för artikelspårningsnummer som anges på raderna i fönstret. Antalet måste stämma överens med antalet på dokumentraderna, vilket indikeras med *0* i fälten **Odefinierad** .
...
Om du har arbetat på sidan **Artikelspårningsrader** under en längre tid, eller om Dit aktiviteter med artikeln du arbetar med, kan du välja **åtgärden Uppdatera tillgänglighet** . Dispositionen för artikeln kontrolleras automatiskt på nytt när sidan stängs, så att eventuella dispositionsproblem kan upptäckas.
...
3.  **På sidan Artikel kort**  väljer du åtgärden **Relaterad**, väljer den **relaterade** åtgärden, väljer **åtgärden Transaktioner** och väljer **sedan Transaktioner**.
...
1. Välj ![glödlampan som öppnar funktionen Berätta.](media/ui-search/search_small.png "Berätta vad du vill göra") , ange **Artikelgrupperingsjournaler** och välj sedan relaterad länk.  
...
4. I serienr **.** eller **Partinr.** Välj aktuellt serie- eller partinummer.  
...
|Artikelspårningsrader för distributionslager     |* Serienummer<br><br>* Nytt serienummer<br><br>* Partinummer<br><br>* Nytt partinummer<br><br>* Paketnummer<br><br>* Nytt paketnummer|
