...
# <a name="business-central-and-onedrive-for-business-integration" />Business Central och OneDrive för företag-integration
...
## <a name="get-started-with-onedrive-features" />Kom igång med OneDrive-funktioner
...
### <a name="open-and-share-in-onedrive" />Öppna och dela i OneDrive
...
### <a name="save-excel-workbooks-and-report-files-in-onedrive" />Spara Excel-arbetsböcker och rapportera filer i OneDrive
