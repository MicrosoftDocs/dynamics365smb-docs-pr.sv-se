...
ms.author: edupont
---
# <a name="set-up-work-centers-and-machine-centers" />Ställa in produktionsgrupper och maskingrupper
...
## <a name="to-set-up-a-work-center" />Så här skapar du produktionsgrupper:
...
## <a name="considerations-about-capacity" />Överväganden om kapacitet
...
### <a name="run-time" />Bearbetningstid
...
### <a name="setup-time" />Omställningstid
...
### <a name="work-center-processing-multiple-orders-simultaneously" />Bearbeta flera order samtidigt i produktionsgruppen
...
### <a name="efficient-resource-can-dedicate-only-part-of-their-work-date-to-productive-work" />Effektiv resurs kan endast avsätta en del av sitt arbetsdatum för att producera arbete
...
### <a name="consolidated-calendar" />Konsoliderad kalender
...
### <a name="example---different-machine-centers-assigned-to-a-work-center" />Exempel – Olika maskingrupper kan kopplas till en produktionsgrupp
...
## <a name="to-set-up-a-capacity-constrained-machine-or-work-center" />Om du vill ställa in en kapacitetsbegränsad maskin- eller produktionsgrupp
