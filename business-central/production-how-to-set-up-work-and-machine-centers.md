...
ms.author: edupont
---
# <a name="set-up-work-centers-and-machine-centers"></a><a name="set-up-work-centers-and-machine-centers"></a>Ställa in produktionsgrupper och maskingrupper
...
## <a name="to-set-up-a-work-center"></a><a name="to-set-up-a-work-center"></a>Så här skapar du produktionsgrupper:
...
## <a name="considerations-about-capacity"></a><a name="considerations-about-capacity"></a>Överväganden om kapacitet
...
### <a name="run-time"></a><a name="run-time"></a>Bearbetningstid
...
### <a name="setup-time"></a><a name="setup-time"></a>Omställningstid
...
### <a name="work-center-processing-multiple-orders-simultaneously"></a><a name="work-center-processing-multiple-orders-simultaneously"></a>Bearbeta flera order samtidigt i produktionsgruppen
...
### <a name="efficient-resource-can-dedicate-only-part-of-their-work-date-to-productive-work"></a><a name="efficient-resource-can-dedicate-only-part-of-their-work-date-to-productive-work"></a>Effektiv resurs kan endast avsätta en del av sitt arbetsdatum för att producera arbete
...
### <a name="consolidated-calendar"></a><a name="consolidated-calendar"></a>Konsoliderad kalender
...
### <a name="example---different-machine-centers-assigned-to-a-work-center"></a><a name="example---different-machine-centers-assigned-to-a-work-center"></a>Exempel – Olika maskingrupper kan kopplas till en produktionsgrupp
...
## <a name="to-set-up-a-capacity-constrained-machine-or-work-center"></a><a name="to-set-up-a-capacity-constrained-machine-or-work-center"></a>Om du vill ställa in en kapacitetsbegränsad maskin- eller produktionsgrupp
