...
# <a name="handling-missing-option-values"></a><a name="handling-missing-option-values"></a>Hantera alternativvärden som saknas
> [!NOTE]
...
### <a name="extending-option-sets-in-"></a><a name="extending-option-sets-in-"></a>Utöka alternativuppsättningar i [!INCLUDE[prod_short](includes/prod_short.md)]
...
### <a name="update--option-mapping"></a><a name="update--option-mapping"></a>Uppdatera alternativmappningen för [!INCLUDE[prod_short](includes/cds_long_md.md)]
