...
ms.author: edupont
---
# <a name="work-with-production-families" />Arbeta med produktionsfamiljer
...
## <a name="to-set-up-a-production-family" />Så här skapar du produktionfamilj
...
## <a name="to-produce-based-on-a-production-family" />Om du vill skapa baserat på en produktionsfamilj
