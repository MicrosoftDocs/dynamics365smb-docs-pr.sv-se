...
ms.author: bholtorf
---
# <a name="create-service-invoices-or-credit-memos" />Skapa tjänstefakturor eller kreditnotor
...
## <a name="to-invoice-several-service-contracts" />Så här fakturerar du servicekontrakt
...
## <a name="to-invoice-a-service-contract-from-the-service-contract-page" />Fakturera ett servicekontrakt från servicekontraktsidan
...
## <a name="to-post-an-invoice-from-a-service-order" />Så här bokför du förbrukning från en serviceorder
...
## <a name="to-create-a-service-invoice-manually" />Så här skapar du en servicefaktura manuellt
...
## <a name="to-create-an-invoice-that-combines-posted-shipment-lines-from-one-or-more-service-orders" />Så här skapar du en faktura som kombinerar bokförda leveransrader från en eller flera serviceorder
...
## <a name="to-create-a-service-credit-memo" />Så här skapar du servicekreditnotor
