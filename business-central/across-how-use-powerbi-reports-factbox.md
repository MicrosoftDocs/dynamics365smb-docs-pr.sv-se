...
## <a name="create-a-report-for-a-list-page" />Skapa en rapport för en listsida
...
## <a name="set-the-report-size-and-color" />Ställa in rapportens storlek och färg
...
## <a name="reports-with-multiple-pages" />Rapporter med flera sidor
...
### <a name="you-cant-see-the-power-bi-factbox-on-a-list-page" />Du kan inte se Power BI Faktabox på en listsida
...
### <a name="you-cant-see-the-report-in-the-select-report-pane" />Rapporter kan inte visas på fönstret Välj rapport.
...
### <a name="report-is-loaded-but-blank-not-filtered-or-filtered-incorrectly" />Rapporten laddas in men är tom, ofiltrerad eller felaktigt filtrerad.
...
### <a name="report-is-loaded-but-it-shows-a-page-you-didnt-expect" />Rapporten laddas men visar en oväntad sida

Bekräfta att den sida du vill visa är den första sidan i rapporten.  

### <a name="report-appears-with-an-unwanted-gray-boarder-or-its-too-small-or-too-large" />Rapporten visas med en oönskad grå ram eller är för stor/för liten
