...
ms.locfileid: "9605657"
---
# <a name="work-with-accounting-periods-and-fiscal-years"></a>Arbeta med bokföringsperioder och räkenskapsår
...
### <a name="how-to-create-accounting-periods-in-bulk"></a>Så här skapar du flera bokföringsperioder samtidigt
...
## <a name="posting-entries-to-a-closed-fiscal-year"></a>Bokföra transaktioner till ett avslutat räkenskapsår
