...
ms.author: jswymer
---
# <a name="create-segments"></a><a name="create-segments"></a><a name="create-segments"></a>Skapa segment
...
## <a name="to-create-a-segment"></a><a name="to-create-a-segment"></a><a name="to-create-a-segment"></a>Skapa segment så här
