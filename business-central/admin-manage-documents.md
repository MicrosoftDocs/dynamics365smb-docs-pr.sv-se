...
ms.author: edupont
---
# <a name="manage-storage-by-deleting-documents-or-compressing-data"></a><a name="manage-storage-by-deleting-documents-or-compressing-data"></a>Hantera lagring genom att ta bort dokument eller komprimera data
...
## <a name="delete-documents"></a><a name="delete-documents"></a>Ta bort dokument
...
## <a name="compress-data-with-date-compression"></a><a name="compress-data-with-date-compression"></a>Komprimera data med datumkomprimering
...
## <a name="posting-compressed-entries"></a><a name="posting-compressed-entries"></a>Bokför komprimerade poster
...
### <a name="to-run-a-date-compression"></a><a name="to-run-a-date-compression"></a>För att köra en datakomprimering
