...
ms.author: edupont
---
# <a name="manage-storage-by-deleting-documents-or-compressing-data" />Hantera lagring genom att ta bort dokument eller komprimera data
...
## <a name="delete-documents" />Ta bort dokument
...
## <a name="compress-data-with-date-compression" />Komprimera data med datumkomprimering
...
## <a name="posting-compressed-entries" />Bokför komprimerade poster
...
### <a name="to-run-a-date-compression" />För att köra en datakomprimering
