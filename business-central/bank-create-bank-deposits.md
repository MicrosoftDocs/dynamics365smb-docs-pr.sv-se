...
ms.author: bholtorf
---
# <a name="create-bank-deposits" />Skapa bankinsättningar
> [!NOTE]
...
### <a name="number-series-and-lump-sum-deposits" />Insättningar av nummerserie och klumpsumma
...
### <a name="general-journal-templates-for-bank-deposits" />Journalmallar för bankinsättningar
...
## <a name="dimensions-on-bank-deposit-lines" />Dimensioner på bankinsättningsrader
...
## <a name="create-a-bank-deposit" />Skapa ny bankinsättning
...
## <a name="finding-posted-bank-deposits" />Hitta bokförda bankinsättningar
...
## <a name="reversing-a-posted-bank-deposit" />Återföra en bokförd bankinsättning
