...
ms.author: edupont
---
# <a name="design-details-known-item-application-issue"></a><a name="design-details-known-item-application-issue"></a>Designdetaljer: Kända problem med artikelkopplingar
...
## <a name="symptoms-of-the-issue"></a><a name="symptoms-of-the-issue"></a>Symptom på problemet
...
## <a name="basics-of-item-application"></a><a name="basics-of-item-application"></a>Grunderna för artikelkoppling
...
### <a name="quantity-application"></a><a name="quantity-application"></a>Antalskoppling
...
### <a name="cost-application"></a><a name="cost-application"></a>Kost.koppling
...
## <a name="illustration-of-a-basic-cost-flow"></a><a name="illustration-of-a-basic-cost-flow"></a>Bild av ett grundläggande kostnadsflöde
...
## <a name="reasons-for-the-issue"></a><a name="reasons-for-the-issue"></a>Orsakerna till problemet
...
## <a name="identifying-the-issue"></a><a name="identifying-the-issue"></a>Identifierar problemet
...
## <a name="workaround-for-the-issue"></a><a name="workaround-for-the-issue"></a>Åtgärda problemet
