...
---
# <a name="track-email-message-exchanges-between-salespeople-and-contacts" />Spåra utbyte av e-postmeddelanden mellan säljare och kontakter
...
## <a name="to-set-up-email-logging" />Så här konfigurerar du e-postloggning

### <a name="set-up-public-folders-and-rules-for-email-logging-in-exchange-online" />Konfigurera gemensamma mappar och regler för e-postloggning i Exchange Online

[!INCLUDE[admin-setup-email-public-folder](includes/admin-setup-email-public-folder.md)]

Därefter ansluter du [!INCLUDE[prod_short](includes/prod_short.md)] med Exchange Online.

### <a name="set-up-a-shared-mailbox-and-rules-for-email-logging-in-exchange-online" />Konfigurera en delad brevlåda och regler för e-postinloggning i Exchange Online
...
### <a name="add-a-user-account-for-members-of-the-shared-mailbox" />Lägga till ett användarkonto för medlemmar i den delade postlådan
...
### <a name="allow-other-users-to-see-logged-emails" />Låta andra användare se loggade e-postmeddelanden
...
## <a name="view-email-message-exchanges-in-the-interaction-log" />Visa e-postutbyten i interaktionsloggen
...
## <a name="mailbox-and-folder-limits-in-exchange-online" />Begränsningar för postlådor och mappar i Exchange Online
...
## <a name="connect-on-premises-versions-to-microsoft-exchange" />Ansluta lokala versioner till Microsoft Exchange
...
-->
## <a name="connect-to-exchange-online" />Ansluta till Exchange Online
...
### <a name="to-register-an-application-in-azure-ad-for-connecting-from-business-central-to-exchange-online" />Så här registrerar du ett program i Azure AD för att ansluta från Business Central till Exchange Online
...
### <a name="use-another-identity-and-access-management-service" />Använda en annan identitets- och åtkomsthanteringstjänst
...
## <a name="to-start-logging-email" />Så här börjar du logga e-post
...
## <a name="to-stop-logging-email" />Så här slutar du logga e-post
