...
ms.locfileid: "4751661"
---
# <a name="design-details-dimension-set-entries"></a>Designdetaljer: Dimensionsuppsättningstransaktioner
Dokumentationen ger en detaljerad teknisk inblick i begreppen och principerna för lagrings- och bokföringsfunktioner för dimensionstransaktioner i [!INCLUDE[prod_short](includes/prod_short.md)].
