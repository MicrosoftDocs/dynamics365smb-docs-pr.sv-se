...
description: Lär dig hur du rapporterar handel med företag i andra EU-länder med hjälp av Intrastat-systemet.
author: altotovi
ms.topic: conceptual
ms.devlang: na
ms.tgt_pltfrm: na
...
ms.author: altotovi
---
# <a name="work-with-intrastat-reporting"></a><a name="work-with-intrastat-reporting"></a><a name="work-with-intrastat-reporting"></a>Arbeta med Intrastat-rapporter
...
> [!NOTE]
> Intrastat-uppgifter gäller inte förflyttning av tjänster mellan länder, men endast varor (artiklar och anläggningstillgångar). Om den lokala regeringen kräver registrering av transport av tjänster mellan länder kan du göra detta med hjälp av funktionen **Servicedeklaration**.
>
...
## <a name="fill-in-the-intrastat-report"></a><a name="fill-in-the-intrastat-report"></a><a name="fill-in-the-intrastat-report"></a>Fyll i Intrastat-rapporten
...
4. I fältet **Statistisk period** anger du månaden som data ska rapporteras för. Ange perioden som ett fyrsiffrigt tal utan blanksteg eller symboler. Beroende på vilket land du använder, anger du månadens namn och sedan året eller tvärtom. Skriv till exempel antingen *2206* eller *0622* för juni 2022.
...
## <a name="modify-the-intrastat-report"></a><a name="modify-the-intrastat-report"></a><a name="modify-the-intrastat-report"></a>Ändra Intrastat-rapporten
...
## <a name="validate-intrastat-lines"></a><a name="validate-intrastat-lines"></a><a name="validate-intrastat-lines"></a>Validera Intrastat-raderna
...
## <a name="recalculating-weight-or-supplementary-unit-of-measure"></a><a name="recalculating-weight-or-supplementary-unit-of-measure"></a><a name="recalculating-weight-or-supplementary-unit-of-measure"></a>Omberäkning av vikt eller extra måttenhet
...
## <a name="intrastat-rules"></a><a name="intrastat-rules"></a><a name="intrastat-rules"></a>Intrastat-regler
...
### <a name="fixed-assets-reporting"></a><a name="fixed-assets-reporting"></a><a name="fixed-assets-reporting"></a>Anläggningstillgångsrapporter
...
### <a name="intrastat-report-statuses"></a><a name="intrastat-report-statuses"></a><a name="intrastat-report-statuses"></a>Intrastat-rapportstatus
