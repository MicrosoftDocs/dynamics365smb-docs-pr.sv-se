...
3. Ange valutakurser om det behövs.
    ...
    Ange valutakurser om du ska konsolidera data för affärsenheter som använder olika valutor. De tre valutakurser som du kan använda är **Genomsnittskurs (manuell)**, **Slutkurs** och **Senaste slutkurs**. Mer information om valutakurser finns i [Ange valutakurser för konsolideringar](#exchrates).
...
4. På snabbfliken **Dataimport**, i fältet **Standarddataimport** anger du hur redovisningstransaktioner sak delas med det konsoliderade företaget:
   ...
   * Om du vill dela data mellan företag i olika miljöer väljer du **API** och fyller sedan i fältet **Slutpunkt för API**.
        ...
        Om du vill hämta slutpunkts-URL, i affärsenhetens företag [!INCLUDE [prod_short](includes/prod_short.md)], öppna **sidan Konsolideringskonfiguration** och kontrollera den aktuella miljöns fältvärde för API-slutpunkt. 
...
> [!NOTE]
> Om du inte fyller i fältet **Debetkonto konsolid** och **Kreditkonto konsolid**, [!INCLUDE [prod_short](includes/prod_short.md)] förutsätter att de är mappade till samma konton i det konsoliderade företaget.
