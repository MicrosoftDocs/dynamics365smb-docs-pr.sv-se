...
# <a name="procurement-quick-start"></a><a name="procurement-quick-start"></a>Snabbstart för inköp
...
## <a name="set-up-vendors"></a><a name="set-up-vendors"></a>Ange leverantörer
...
### <a name="set-up-a-new-vendor"></a><a name="set-up-a-new-vendor"></a>Skapa en ny leverantör
...
## <a name="create-new-purchase-orders"></a><a name="create-new-purchase-orders"></a>Skapa en ny inköpsorder
...
### <a name="to-create-a-purchase-order"></a><a name="to-create-a-purchase-order"></a>Skapa en inköpsorder
...
## <a name="create-a-purchase-invoice"></a><a name="create-a-purchase-invoice"></a>Skapa en inköpsfaktura
...
### <a name="how-to-create-and-post-a-purchase-invoice"></a><a name="how-to-create-and-post-a-purchase-invoice"></a>Så här skapar och bokför du inköpsfaktura
