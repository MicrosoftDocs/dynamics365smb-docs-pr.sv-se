...
ms.author: jswymer
---
# <a name="close-accounting-periods"></a><a name="close-accounting-periods"></a>Avsluta bokföringsperioder

När ett räkenskapsår är slut måste du avsluta perioderna som året omfattar.

## <a name="to-close-accounting-periods"></a><a name="to-close-accounting-periods"></a>Så här avslutar du bokföringsperioder
