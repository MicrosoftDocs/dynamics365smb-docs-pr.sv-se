...
# <a name="integrating-with-microsoft-dataverse" />Integrera med Microsoft Dataverse
...
## <a name="bi-directional-or-uni-directional-data-synchronization" />Dubbelriktad eller enkelriktad datasynkronisering
...
## <a name="standard-and-custom-entities" />Standard- och anpassade eenheter
...
## <a name="about-the-business-central-base-integration-solution" />Om basintegreringslösningen i Business Central
