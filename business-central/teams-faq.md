...
---
# Vanliga frågor och Svar om Teams
...
### Hur loggar jag in i appen [!INCLUDE [prod_short.md](includes/prod_short.md)] i Teams?
...
### Hur loggar jag ut från appen [!INCLUDE [prod_short.md](includes/prod_short.md)] i Teams?
...
### Ansluter appen för Teams till [!INCLUDE [prod_short.md](includes/prod_short.md)] lokalt? 
...
### Fungerar appen med flera företag och miljöer? 
...
### I vilka länder eller regioner finns [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen tillgänglig? 
...
### Fungerar [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen med valfri lokalisering av [!INCLUDE [prod_short.md](includes/prod_short.md)]? 
...
### <a name="language"></a>Vilka språk stöder [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen?
...
### Fungerar [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen med branschlösningar?
...
### Fungerar [!INCLUDE [prod_short.md](includes/prod_short.md)] med mobilappen för Teams?
...
### Är appen [!INCLUDE [prod_short.md](includes/prod_short.md)] för Teams samma som appen [!INCLUDE [prod_short.md](includes/prod_short.md)] för iOS och Android?

Nej. Appen för Teams är ett tillägg till Microsoft Teams och uteslutande utformat för samarbeten i Teams. Alternativt levererar [!INCLUDE [prod_short.md](includes/prod_short.md)]-mobilappen en rik upplevelse för att arbeta med [!INCLUDE [prod_short.md](includes/prod_short.md)]-data på dina mobila enheter.
...
### Fungerar [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen i alla Teams-klienter?

Nej. [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen för Teams stöds inte när den installeras som ett paket för macOS eller Linux. På dessa plattformar använder du Teams via webbläsare som stöds.
...
### Vilken Teams-klient passar bäst för [!INCLUDE [prod_short.md](includes/prod_short.md)]?
...
### Vilket är det bästa sättet att demonstrera [!INCLUDE [prod_short.md](includes/prod_short.md)] och Microsoft Teams för potentiella kunder?
...
### Uppfyller [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen för Teams mina anpassningsbehov?
...
### Hur påverkar de behörigheter som krävs av appen min integritet?
...
### Var kan jag få veta mer om min sekretess? 
...
### Hur avinstallerar jag [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen för Teams?
...
### Kommer Microsoft att fortsätta att förbättra [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen för Teams?
...
### Var kan jag hitta Teams-integrering i Business Central-webbklienten? 
...
### <a name="who-can-view"></a>Vem kan se innehållet på en flik?
...
### <a name=#recommended-content></a>Var kommer det rekommenderade innehållet från?
...
### När jag skapar en flik ger den behörighet till personerna i kanalen eller chatten?

Nej. När du skapar flikar påverkas inte behörigheterna och användarna måste redan ha behörighet till dessa data när de öppnar fliken.

### Kan jag chatta bredvid en flik?

Ja. Använd ikonen chatt för att starta konversationen. Konversationen associeras sedan med fliken. 

### Om jag tar bort en flik från en chatt eller kanal, är alla Business Central data borttagna?

Nej.

### Kan jag byta namn på en flik?

Ja. Innehållet på fliken är inte relaterat till flikens egentliga namn. Ändra namn kommer! 

### Jag måste arbeta mellan olika uppgifter i olika fönster. Kan jag göra det?

Ja. Du kan pop ut fliken till ett eget webbläsarfönster för att visa Business Central webbklienten. 

### Kan jag lägga till eller fästa flik i Teams-möten?

Nej. Business Central-appen för Teams stöder inte flikar i möten.

### Det går inte att lägga till en flik med ISV-URL:er som *.bc.dynamics.com (men kan fästas)

Stöds inte.

### När jag gör saker på fliken, t.ex. navigera, flytta, tillämpa ett filter eller söka, kan andra se mina ändringar?

Nej. Endast fältändringar och aktiva åtgärder påverkar hur andra ser innehållet på fliken.

### Uppdateras innehållet i flikar automatiskt? Om inte, hur uppdaterar jag det?
...
### Visar du listor och poster från mina anpassningar och tilläggsprogram?

Ja. 

### Kan andra se den på mitt språk när jag lägger till en flik?

Nej. Varje användare visar flikarnas innehåll på språk-, region-och tidszons inställningarna från Business Central. 

### Kan jag ha flera flikar som pekar på ett annat innehåll?

Ja.

### Kan jag också lägga till flikar för att chatta med en enda person?
...
### Kan jag byta företag inom en flik?

Nej. 

### Är detta annat än att använda Teams allmänna möjlighet att skapa en flik som är värd för en webbplats?
...
### Vilka tabeller söker programmet?
...
### Vilka fält i tabellen kontakter kan jag söka efter?
...
### Omfattar sökresultaten företag och personer?
...
### Visas kontakter för alla affärsrelationer i resultatet?
...
### Kan jag söka efter kontaktinformation under möten?
...
### Hur visar jag de senaste interaktionerna med en kontakt?
...
### Hur registrerar jag ett Teams-samtal eller ett möte som en interaktion?
...
### Kan jag ringa en kontakt från [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen för Teams?
...
### Hur visar jag nyligen använda dokument för en kund eller leverantör?
...
### Hur söker jag efter kontakter med hjälp av specialtecken?
...
### Hur söker jag efter kontakter som är lagrade i ett annat företag?
...
### Är [!INCLUDE [prod_short.md](includes/prod_short.md)] kontakter annorlunda än de som finns på skärmen för Teams-kontakter?
...
### Synkroniserar [!INCLUDE [prod_short.md](includes/prod_short.md)]-kontakter med Teams?

Nej. Kontakter som är lagrade i [!INCLUDE [prod_short.md](includes/prod_short.md)] är fortfarande åtskilda från dina kontakter som lagras i Teams.
Det finns för närvarande inga planer på att synkronisera de båda listorna.

### Vilken är den lägsta versionen för [!INCLUDE [prod_short.md](includes/prod_short.md)] för kontaktsökning?
...
### Varför uppmanas jag ibland att ställa in appen?
...
### Jag vill söka efter objekt eller poster från andra tabeller. Kan jag göra detta från Teams?
...
### Vilka typer av länkar har appen stöd för?
...
### Hur tar jag bort ett kort som jag skickat till en chatt?
...
### Visar kort alltid aktuell information?

Nej. Fältvärdena på ett kort i Teams, inklusive eventuella bilder, baseras på de data som är tillgängliga när kortet skickades till chatten. [!INCLUDE [prod_short.md](includes/prod_short.md)]-korten uppdateras inte automatiskt i Teams. 
...
### Hur tar jag reda på vilket företag ett kort i Teams tillhör?
...
### Var finns knappen Spara i informationsfönstret Teams?
...
### Kan andra användare se mitt informationsfönster om jag väljer att visa information om ett kort?

Nej. Även om alla i chatten eller mötet kan visa själva kortet, visas informationsfönstret bara för dig på enheten när du väljer **Detaljer**. Andra användare måste välja **Detaljer** om de vill visa informationsfönstret på sina enheter.

### Kan jag starta ett Teams-samtal från informationsfönstret i Teams?
...
### Kan jag skriva ut dokument från informationsfönstret i Teams?
...
### Kan jag komma åt kameran från informationsfönstret i Teams?
...
### <a name="location"></a>Kan jag komma åt min plats från informationsfönstret i Teams?
...
### Hur gör jag för att öppna informationen i ett nytt fönster?
...
### Kan jag dela kort med användare utanför organisationen?
...
### Skiljer sig upplevelsen för gästanvändare?
...
### Hur installerar en gästanvändare [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen? 
...
### Skickar delning till Teams ett kompakt kort? 

Ja. Länken utökas automatiskt till ett kort om du har installerat Business Central-appen för Teams. 

### Kan mottagarna ta emot meddelandet från mig eller från ett konto för Business Central-tjänsten? 
...
### Är delar till Teams som finns tillgängliga i Business Central lokal? 

Nej. På samma sätt som i [!INCLUDE [prod_short.md](includes/prod_short.md)] appen för Teams kan den här funktionen bara användas för webbklienten i [!INCLUDE [prod_short.md](includes/prod_short.md)] onlineläge. Det finns inga planer på att stödja [!INCLUDE [prod_short.md](includes/prod_short.md)]-distributionstyper &mdash;t. ex. lokalt, hybridmoln eller privatmoln&mdash;som inte Microsoft är värd för eller hanterar direkt.

### Tilldelar Teams arbetsgrupper behörigheter till mottagare? 

Nej. När du delar med en person, grupp eller kanal påverkas inte behörigheterna. Användare som redan har behörighet att visa sidan och data som är riktade av länken kan göra det. Användare som inte har behörighet att visa sidor och data, eller inte har någon [!INCLUDE [prod_short.md](includes/prod_short.md)] licens, visas ett felmeddelande. 
 
### Måste jag ha Teams skrivbordsapp installerad för att kunna använda Dela till Teams? 

Nej. Allt du behöver är ett giltigt konto som har åtkomst till Microsoft Teams. 

### Är delar till Teams som finns tillgängliga i alla Business Central-klienter? 
...
### Var hittar jag dela till Teams i Business Central? 
