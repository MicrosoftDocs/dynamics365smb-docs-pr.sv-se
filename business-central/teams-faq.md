...
---
# <a name="teams-faq"></a><a name="teams-faq"></a><a name="teams-faq"></a>Vanliga frågor och Svar om Teams
...
### <a name="how-do-i-sign-in-to-the--app-in-teams"></a><a name="how-do-i-sign-in-to-the--app-in-teams"></a><a name="how-do-i-sign-in-to-the--app-in-teams"></a>Hur loggar jag in i appen [!INCLUDE [prod_short.md](includes/prod_short.md)] i Teams?
...
### <a name="how-do-i-sign-out-of-the--app-in-teams"></a><a name="how-do-i-sign-out-of-the--app-in-teams"></a><a name="how-do-i-sign-out-of-the--app-in-teams"></a>Hur loggar jag ut från appen [!INCLUDE [prod_short.md](includes/prod_short.md)] i Teams?
...
### <a name="does-the-app-for-teams-connect-to--on-premises"></a><a name="does-the-app-for-teams-connect-to--on-premises"></a><a name="does-the-app-for-teams-connect-to--on-premises"></a>Ansluter appen för Teams till [!INCLUDE [prod_short.md](includes/prod_short.md)] lokalt?
...
### <a name="does-the-app-work-with-multiple-companies-and-environments"></a><a name="does-the-app-work-with-multiple-companies-and-environments"></a><a name="does-the-app-work-with-multiple-companies-and-environments"></a>Fungerar appen med flera företag och miljöer?
...
### <a name="in-which-countries-or-regions-is-the--app-available"></a><a name="in-which-countries-or-regions-is-the--app-available"></a><a name="in-which-countries-or-regions-is-the--app-available"></a>I vilka länder eller regioner finns [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen tillgänglig?
...
### <a name="does-the--app-work-with-any-localization-of-include-prod_shortmd"></a><a name="does-the--app-work-with-any-localization-of-include-prod_shortmd"></a><a name="does-the--app-work-with-any-localization-of-include-prod_shortmd"></a>Fungerar [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen med valfri lokalisering av [!INCLUDE [prod_short.md](includes/prod_short.md)]?
...
### <a name="which-languages-does-the--app-support"></a><a name="which-languages-does-the--app-support"></a><a name="which-languages-does-the--app-support"></a><a name="language"></a>Vilka språk stöder [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen?
...
### <a name="does-the--app-work-with-industry-solutions"></a><a name="does-the--app-work-with-industry-solutions"></a><a name="does-the--app-work-with-industry-solutions"></a>Fungerar [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen med branschlösningar?
...
### <a name="does--work-with-the-teams-mobile-app"></a><a name="does--work-with-the-teams-mobile-app"></a><a name="does--work-with-the-teams-mobile-app"></a>Fungerar [!INCLUDE [prod_short.md](includes/prod_short.md)] med mobilappen för Teams?
...
### <a name="is-the--app-for-teams-the-same-as-the-include-prod_shortmd-app-for-ios-and-android"></a><a name="is-the--app-for-teams-the-same-as-the-include-prod_shortmd-app-for-ios-and-android"></a><a name="is-the--app-for-teams-the-same-as-the-include-prod_shortmd-app-for-ios-and-android"></a>Är appen [!INCLUDE [prod_short.md](includes/prod_short.md)] för Teams samma som appen [!INCLUDE [prod_short.md](includes/prod_short.md)] för iOS och Android?
...
### <a name="does-the--app-work-in-all-teams-clients"></a><a name="does-the--app-work-in-all-teams-clients"></a><a name="does-the--app-work-in-all-teams-clients"></a>Fungerar [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen i alla Teams-klienter?
...
### <a name="which-teams-client-is-best-for-"></a><a name="which-teams-client-is-best-for-"></a><a name="which-teams-client-is-best-for-"></a>Vilken Teams-klient passar bäst för [!INCLUDE [prod_short.md](includes/prod_short.md)]?
...
### <a name="what-is-the-best-way-for-me-to-demonstrate--and-microsoft-teams-to-prospective-customers"></a><a name="what-is-the-best-way-for-me-to-demonstrate--and-microsoft-teams-to-prospective-customers"></a><a name="what-is-the-best-way-for-me-to-demonstrate--and-microsoft-teams-to-prospective-customers"></a>Vilket är det bästa sättet att demonstrera [!INCLUDE [prod_short.md](includes/prod_short.md)] och Microsoft Teams för potentiella kunder?
...
### <a name="does-the--app-for-teams-cater-to-my-customization-and-personalization"></a><a name="does-the--app-for-teams-cater-to-my-customization-and-personalization"></a><a name="does-the--app-for-teams-cater-to-my-customization-and-personalization"></a>Uppfyller [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen för Teams mina anpassningsbehov?
...
### <a name="how-do-the-permissions-required-by-the-app-affect-my-privacy"></a><a name="how-do-the-permissions-required-by-the-app-affect-my-privacy"></a><a name="how-do-the-permissions-required-by-the-app-affect-my-privacy"></a>Hur påverkar de behörigheter som krävs av appen min integritet?
...
### <a name="where-can-i-learn-about-my-privacy"></a><a name="where-can-i-learn-about-my-privacy"></a><a name="where-can-i-learn-about-my-privacy"></a>Var kan jag få veta mer om min sekretess?
...
### <a name="how-do-i-uninstall-the--app-for-teams"></a><a name="how-do-i-uninstall-the--app-for-teams"></a><a name="how-do-i-uninstall-the--app-for-teams"></a>Hur avinstallerar jag [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen för Teams?
...
### <a name="will-microsoft-continue-to-improve-the--app-for-teams"></a><a name="will-microsoft-continue-to-improve-the--app-for-teams"></a><a name="will-microsoft-continue-to-improve-the--app-for-teams"></a>Kommer Microsoft att fortsätta att förbättra [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen för Teams?
...
### <a name="where-can-i-find-teams-integration-inside-the-business-central-web-client"></a><a name="where-can-i-find-teams-integration-inside-the-business-central-web-client"></a><a name="where-can-i-find-teams-integration-inside-the-business-central-web-client"></a>Var kan jag hitta Teams-integrering i Business Central-webbklienten?
...
### <a name="who-can-see-the-content-of-a-tab"></a><a name="who-can-see-the-content-of-a-tab"></a><a name="who-can-see-the-content-of-a-tab"></a><a name="who-can-view"></a>Vem kan se innehållet på en flik?
...
### <a name="where-does-the-recommended-content-come-from"></a><a name="where-does-the-recommended-content-come-from"></a><a name="where-does-the-recommended-content-come-from"></a><a name=#recommended-content></a>Var kommer det rekommenderade innehållet från?
...
### <a name="can-i-chat-alongside-a-tab"></a><a name="can-i-chat-alongside-a-tab"></a><a name="can-i-chat-alongside-a-tab"></a>Kan jag chatta bredvid en flik?

Ja. Använd ikonen chatt för att starta konversationen. Konversationen associeras sedan med fliken. 

### <a name="if-i-remove-a-tab-from-a-chat-or-channel-is-any-business-central-data-deleted"></a><a name="if-i-remove-a-tab-from-a-chat-or-channel-is-any-business-central-data-deleted"></a><a name="if-i-remove-a-tab-from-a-chat-or-channel-is-any-business-central-data-deleted"></a>Om jag tar bort en flik från en chatt eller kanal, är alla Business Central data borttagna?

Nr.

### <a name="can-i-safely-rename-a-tab"></a><a name="can-i-safely-rename-a-tab"></a><a name="can-i-safely-rename-a-tab"></a>Kan jag byta namn på en flik?

Ja. Innehållet på fliken är inte relaterat till flikens egentliga namn. Ändra namn kommer! 

### <a name="i-need-to-work-across-tasks-in-different-windows-can-i-do-this"></a><a name="i-need-to-work-across-tasks-in-different-windows-can-i-do-this"></a><a name="i-need-to-work-across-tasks-in-different-windows-can-i-do-this"></a>Jag måste arbeta mellan olika uppgifter i olika fönster. Kan jag göra det?

Ja. Du kan pop ut fliken till ett eget webbläsarfönster för att visa Business Central webbklienten. 

### <a name="can-i-add-or-pin-tab-in-team-meetings"></a><a name="can-i-add-or-pin-tab-in-team-meetings"></a><a name="can-i-add-or-pin-tab-in-team-meetings"></a>Kan jag lägga till eller fästa flik i Teams-möten?

Nr. Business Central-appen för Teams stöder inte flikar i möten.

### <a name="cant-add-a-tab-if-using-isv-urls-like-bcdynamicscom-but-can-pin"></a><a name="cant-add-a-tab-if-using-isv-urls-like-bcdynamicscom-but-can-pin"></a><a name="cant-add-a-tab-if-using-isv-urls-like-bcdynamicscom-but-can-pin"></a>Det går inte att lägga till en flik med ISV-URL:er som *.bc.dynamics.com (men kan fästas)

Stöds inte.

### <a name="when-i-do-things-in-the-tab-like-navigate-resort-apply-a-filter-or-search-do-others-see-my-changes"></a><a name="when-i-do-things-in-the-tab-like-navigate-resort-apply-a-filter-or-search-do-others-see-my-changes"></a><a name="when-i-do-things-in-the-tab-like-navigate-resort-apply-a-filter-or-search-do-others-see-my-changes"></a>När jag gör saker på fliken, t.ex. navigera, flytta, tillämpa ett filter eller söka, kan andra se mina ändringar?

Nr. Endast fältändringar och aktiva åtgärder påverkar hur andra ser innehållet på fliken.

### <a name="does-the-tab-content-refresh-automatically-if-not-how-do-i-refresh-it"></a><a name="does-the-tab-content-refresh-automatically-if-not-how-do-i-refresh-it"></a><a name="does-the-tab-content-refresh-automatically-if-not-how-do-i-refresh-it"></a>Uppdateras innehållet i flikar automatiskt? Om inte, hur uppdaterar jag det?
...
### <a name="does-this-show-lists-and-records-from-my-customizations-and-add-ons"></a><a name="does-this-show-lists-and-records-from-my-customizations-and-add-ons"></a><a name="does-this-show-lists-and-records-from-my-customizations-and-add-ons"></a>Visar du listor och poster från mina anpassningar och tilläggsprogram?

Ja. 

### <a name="when-i-add-a-tab-will-people-see-it-in-my-language"></a><a name="when-i-add-a-tab-will-people-see-it-in-my-language"></a><a name="when-i-add-a-tab-will-people-see-it-in-my-language"></a>Kan andra se den på mitt språk när jag lägger till en flik?

Nr. Varje användare visar flikarnas innehåll på språk-, region-och tidszons inställningarna från Business Central. 

### <a name="can-i-have-multiple-tabs-pointing-to-different-content"></a><a name="can-i-have-multiple-tabs-pointing-to-different-content"></a><a name="can-i-have-multiple-tabs-pointing-to-different-content"></a>Kan jag ha flera flikar som pekar på ett annat innehåll?

Ja.

### <a name="can-i-also-add-tabs-to-chat-with-a-single-person"></a><a name="can-i-also-add-tabs-to-chat-with-a-single-person"></a><a name="can-i-also-add-tabs-to-chat-with-a-single-person"></a>Kan jag också lägga till flikar för att chatta med en enda person?
...
### <a name="can-i-switch-companies-within-a-tab"></a><a name="can-i-switch-companies-within-a-tab"></a><a name="can-i-switch-companies-within-a-tab"></a>Kan jag byta företag inom en flik?

Nr. 

### <a name="is-this-different-than-using-teams-generic-ability-to-create-a-tab-that-hosts-a-website"></a><a name="is-this-different-than-using-teams-generic-ability-to-create-a-tab-that-hosts-a-website"></a><a name="is-this-different-than-using-teams-generic-ability-to-create-a-tab-that-hosts-a-website"></a>Är detta annat än att använda Teams allmänna möjlighet att skapa en flik som är värd för en webbplats?
...
### <a name="which-tables-does-the-app-search-in"></a><a name="which-tables-does-the-app-search-in"></a><a name="which-tables-does-the-app-search-in"></a>Vilka tabeller söker programmet?
...
### <a name="which-fields-in-the-contacts-table-can-i-search"></a><a name="which-fields-in-the-contacts-table-can-i-search"></a><a name="which-fields-in-the-contacts-table-can-i-search"></a>Vilka fält i tabellen kontakter kan jag söka efter?
...
### <a name="do-search-results-include-companies-and-persons"></a><a name="do-search-results-include-companies-and-persons"></a><a name="do-search-results-include-companies-and-persons"></a>Omfattar sökresultaten företag och personer?
...
### <a name="do-contacts-of-any-business-relationship-appear-in-the-results"></a><a name="do-contacts-of-any-business-relationship-appear-in-the-results"></a><a name="do-contacts-of-any-business-relationship-appear-in-the-results"></a>Visas kontakter för alla affärsrelationer i resultatet?
...
### <a name="can-i-look-up-contact-details-during-meetings"></a><a name="can-i-look-up-contact-details-during-meetings"></a><a name="can-i-look-up-contact-details-during-meetings"></a>Kan jag söka efter kontaktinformation under möten?
...
### <a name="how-do-i-view-my-last-interactions-with-a-contact"></a><a name="how-do-i-view-my-last-interactions-with-a-contact"></a><a name="how-do-i-view-my-last-interactions-with-a-contact"></a>Hur visar jag de senaste interaktionerna med en kontakt?
...
### <a name="how-do-i-register-a-teams-call-or-meeting-as-an-interaction"></a><a name="how-do-i-register-a-teams-call-or-meeting-as-an-interaction"></a><a name="how-do-i-register-a-teams-call-or-meeting-as-an-interaction"></a>Hur registrerar jag ett Teams-samtal eller ett möte som en interaktion?
...
### <a name="can-i-call-a-contact-from-the--app-for-teams"></a><a name="can-i-call-a-contact-from-the--app-for-teams"></a><a name="can-i-call-a-contact-from-the--app-for-teams"></a>Kan jag ringa en kontakt från [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen för Teams?
...
### <a name="how-do-i-view-recent-documents-for-a-customer-or-vendor"></a><a name="how-do-i-view-recent-documents-for-a-customer-or-vendor"></a><a name="how-do-i-view-recent-documents-for-a-customer-or-vendor"></a>Hur visar jag nyligen använda dokument för en kund eller leverantör?
...
### <a name="how-do-i-search-for-contacts-using-special-characters"></a><a name="how-do-i-search-for-contacts-using-special-characters"></a><a name="how-do-i-search-for-contacts-using-special-characters"></a>Hur söker jag efter kontakter med hjälp av specialtecken?
...
### <a name="how-can-i-search-contacts-stored-in-a-different-company"></a><a name="how-can-i-search-contacts-stored-in-a-different-company"></a><a name="how-can-i-search-contacts-stored-in-a-different-company"></a>Hur söker jag efter kontakter som är lagrade i ett annat företag?
...
### <a name="are--contacts-different-than-the-ones-in-the-teams-contacts-screen"></a><a name="are--contacts-different-than-the-ones-in-the-teams-contacts-screen"></a><a name="are--contacts-different-than-the-ones-in-the-teams-contacts-screen"></a>Är [!INCLUDE [prod_short.md](includes/prod_short.md)] kontakter annorlunda än de som finns på skärmen för Teams-kontakter?
...
### <a name="does--synchronize-contacts-with-teams"></a><a name="does--synchronize-contacts-with-teams"></a><a name="does--synchronize-contacts-with-teams"></a>Synkroniserar [!INCLUDE [prod_short.md](includes/prod_short.md)]-kontakter med Teams?
...
### <a name="what-is-the-minimum-version-of--for-contact-search"></a><a name="what-is-the-minimum-version-of--for-contact-search"></a><a name="what-is-the-minimum-version-of--for-contact-search"></a>Vilken är den lägsta versionen för [!INCLUDE [prod_short.md](includes/prod_short.md)] för kontaktsökning?
...
### <a name="can-i-search-from-my-mobile-device"></a><a name="can-i-search-from-my-mobile-device"></a><a name="can-i-search-from-my-mobile-device"></a>Kan jag söka från min mobila enhet?

Kontaktsökningen är inte tillgänglig från Teams för iOS och Teams för Android för tillfället.

### <a name="which-permissions-do-i-need-for-contact-search"></a><a name="which-permissions-do-i-need-for-contact-search"></a><a name="which-permissions-do-i-need-for-contact-search"></a>Vilken behörighet behöver jag för kontaktsökning?
...
### <a name="can-i-use-contact-search-if-im-a-delegated-admin"></a><a name="can-i-use-contact-search-if-im-a-delegated-admin"></a><a name="can-i-use-contact-search-if-im-a-delegated-admin"></a>Kan jag använda kontaktsökning om jag är en delegerad administratör?

Ja. Du kan också söka efter kontakter och kontaktuppgifter om du har en delegerad administratörsroll i en organisation.

### <a name="is-contact-search-affected-by-api-limits"></a><a name="is-contact-search-affected-by-api-limits"></a><a name="is-contact-search-affected-by-api-limits"></a>Påverkas kontaktsökningen av API-gränser?
...
### <a name="why-does-it-sometimes-ask-me-to-set-up-the-app"></a><a name="why-does-it-sometimes-ask-me-to-set-up-the-app"></a><a name="why-does-it-sometimes-ask-me-to-set-up-the-app"></a>Varför uppmanas jag ibland att ställa in appen?
...
### <a name="id-like-to-search-for-items-or-records-from-other-tables-can-i-do-this-from-teams"></a><a name="id-like-to-search-for-items-or-records-from-other-tables-can-i-do-this-from-teams"></a><a name="id-like-to-search-for-items-or-records-from-other-tables-can-i-do-this-from-teams"></a>Jag vill söka efter objekt eller poster från andra tabeller. Kan jag göra detta från Teams?
...
### <a name="which-types-of-links-does-the-app-support"></a><a name="which-types-of-links-does-the-app-support"></a><a name="which-types-of-links-does-the-app-support"></a>Vilka typer av länkar har appen stöd för?
...
### <a name="how-do-i-delete-a-card-i-sent-to-a-chat"></a><a name="how-do-i-delete-a-card-i-sent-to-a-chat"></a><a name="how-do-i-delete-a-card-i-sent-to-a-chat"></a>Hur tar jag bort ett kort som jag skickat till en chatt?
...
### <a name="do-cards-always-show-up-to-date-information"></a><a name="do-cards-always-show-up-to-date-information"></a><a name="do-cards-always-show-up-to-date-information"></a>Visar kort alltid aktuell information?
...
### <a name="how-do-i-find-out-which-company-a-card-in-teams-belongs-to"></a><a name="how-do-i-find-out-which-company-a-card-in-teams-belongs-to"></a><a name="how-do-i-find-out-which-company-a-card-in-teams-belongs-to"></a>Hur tar jag reda på vilket företag ett kort i Teams tillhör?
...
### <a name="where-is-the-save-button-in-the-details-window-in-teams"></a><a name="where-is-the-save-button-in-the-details-window-in-teams"></a><a name="where-is-the-save-button-in-the-details-window-in-teams"></a>Var finns knappen Spara i informationsfönstret Teams?
...
### <a name="if-i-choose-to-view-details-for-a-card-will-other-users-see-my-details-window"></a><a name="if-i-choose-to-view-details-for-a-card-will-other-users-see-my-details-window"></a><a name="if-i-choose-to-view-details-for-a-card-will-other-users-see-my-details-window"></a>Kan andra användare se mitt informationsfönster om jag väljer att visa information om ett kort?
...
### <a name="can-i-start-a-teams-call-from-the-details-window-in-teams"></a><a name="can-i-start-a-teams-call-from-the-details-window-in-teams"></a><a name="can-i-start-a-teams-call-from-the-details-window-in-teams"></a>Kan jag starta ett Teams-samtal från informationsfönstret i Teams?
...
### <a name="can-i-print-documents-from-the-details-window-in-teams"></a><a name="can-i-print-documents-from-the-details-window-in-teams"></a><a name="can-i-print-documents-from-the-details-window-in-teams"></a>Kan jag skriva ut dokument från informationsfönstret i Teams?
...
### <a name="can-i-access-the-camera-from-the-details-window-in-teams"></a><a name="can-i-access-the-camera-from-the-details-window-in-teams"></a><a name="can-i-access-the-camera-from-the-details-window-in-teams"></a>Kan jag komma åt kameran från informationsfönstret i Teams?
...
### <a name="can-i-access-my-location-from-the-details-window-in-teams"></a><a name="can-i-access-my-location-from-the-details-window-in-teams"></a><a name="can-i-access-my-location-from-the-details-window-in-teams"></a><a name="location"></a>Kan jag komma åt min plats från informationsfönstret i Teams?
...
### <a name="how-do-i-open-the-details-in-a-new-window"></a><a name="how-do-i-open-the-details-in-a-new-window"></a><a name="how-do-i-open-the-details-in-a-new-window"></a>Hur gör jag för att öppna informationen i ett nytt fönster?
...
### <a name="can-i-share-cards-with-users-outside-my-organization"></a><a name="can-i-share-cards-with-users-outside-my-organization"></a><a name="can-i-share-cards-with-users-outside-my-organization"></a>Kan jag dela kort med användare utanför organisationen?
...
### <a name="is-the-experience-any-different-for-users-that-are-guests"></a><a name="is-the-experience-any-different-for-users-that-are-guests"></a><a name="is-the-experience-any-different-for-users-that-are-guests"></a>Skiljer sig upplevelsen för gästanvändare?
...
### <a name="how-does-a-guest-user-install-the--app"></a><a name="how-does-a-guest-user-install-the--app"></a><a name="how-does-a-guest-user-install-the--app"></a>Hur installerar en gästanvändare [!INCLUDE [prod_short.md](includes/prod_short.md)]-appen?
...
### <a name="does-share-to-teams-send-a-compact-card"></a><a name="does-share-to-teams-send-a-compact-card"></a><a name="does-share-to-teams-send-a-compact-card"></a>Skickar delning till Teams ett kompakt kort?

Ja. Länken utökas automatiskt till ett kort om du har installerat Business Central-appen för Teams. 

### <a name="will-recipients-receive-the-message-from-me-or-from-a-business-central-service-account"></a><a name="will-recipients-receive-the-message-from-me-or-from-a-business-central-service-account"></a><a name="will-recipients-receive-the-message-from-me-or-from-a-business-central-service-account"></a>Kan mottagarna ta emot meddelandet från mig eller från ett konto för Business Central-tjänsten?
...
### <a name="is-share-to-teams-available-in-business-central-on-premises"></a><a name="is-share-to-teams-available-in-business-central-on-premises"></a><a name="is-share-to-teams-available-in-business-central-on-premises"></a>Är delar till Teams som finns tillgängliga i Business Central lokal?
...
### <a name="does-share-to-teams-grant-permissions-to-recipients"></a><a name="does-share-to-teams-grant-permissions-to-recipients"></a><a name="does-share-to-teams-grant-permissions-to-recipients"></a>Tilldelar Teams arbetsgrupper behörigheter till mottagare?
...
### <a name="must-i-have-the-teams-desktop-app-installed-to-use-share-to-teams"></a><a name="must-i-have-the-teams-desktop-app-installed-to-use-share-to-teams"></a><a name="must-i-have-the-teams-desktop-app-installed-to-use-share-to-teams"></a>Måste jag ha Teams skrivbordsapp installerad för att kunna använda Dela till Teams?

Nr Allt du behöver är ett giltigt konto som har åtkomst till Microsoft Teams. 

### <a name="is-share-to-teams-available-in-all-business-central-clients"></a><a name="is-share-to-teams-available-in-all-business-central-clients"></a><a name="is-share-to-teams-available-in-all-business-central-clients"></a>Är delar till Teams som finns tillgängliga i alla Business Central-klienter?
...
### <a name="where-do-i-find-share-to-teams-in-business-central"></a><a name="where-do-i-find-share-to-teams-in-business-central"></a><a name="where-do-i-find-share-to-teams-in-business-central"></a>Var hittar jag dela till Teams i Business Central?
