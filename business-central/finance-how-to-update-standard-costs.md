...
ms.author: edupont
---
# <a name="update-standard-costs"></a><a name="update-standard-costs"></a><a name="update-standard-costs"></a>Uppdatera standardkostnader
...
## <a name="to-update-standard-costs"></a><a name="to-update-standard-costs"></a><a name="to-update-standard-costs"></a>Uppdatera standardkostnader
