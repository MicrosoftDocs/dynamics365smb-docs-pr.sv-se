...
ms.author: edupont
---
# <a name="define-document-layouts-for-customers-and-vendors" />Definiera dokumentlayout för kunder och leverantörer
...
## <a name="to-load-the-standard-document-layouts-for-sales-documents-for-a-customer" />Så här laddar du standardlayouter för dokument för försäljningsdokument för en kund
...
## <a name="to-select-a-custom-report-layout-to-use-for-the-sales-document-layout" />Så här väljer du en anpassad rapportlayout som ska användas för layouter för försäljningsdokument
...
## <a name="to-specify-which-contact-will-receive-which-document-layout-for-a-customer" />Så här anger du vilken kontakt som får vilken dokumentlayout för en kund
