...
Följande steg förutsätter att du redan har en anpassad rapportlayout för dokumenttypen. Om du inte redan har en anpassad rapportlayout måste du skapa en först. Mer information finns i [Skapa och ändra anpassad rapportlayouter](ui-how-create-custom-report-layout.md).
...
3. På sidan **dokumentlayout** på raden för en rapportlayout som du vill använda en anpassad layout för, väljer du fältet **Anpassad layoutbeskrivning**.
   ...
   > [!TIP]
   > Som standard är fältet Anpassad layoutbeskrivning dolt. Om fältet inte är tillgängligt kan du anpassa sidan för att lägga till den. Om du vill anpassa sidan väljer du :::image type="content" source="media/ui-experience/settings_icon_small.png" alt-text="ikonen Inställningar."::: Och välj **sedan Anpassa**. Mer information om hur du anpassar sidor finns i [Anpassa din arbetsyta](ui-personalization-user.md).

1. På sidan **Anpassade rapportlayouter**, välj den dokumentlayout som du vill använda för försäljningsdokumenttyp. Mer information finns i [Skapa och ändra anpassad rapportlayouter](ui-how-create-custom-report-layout.md).
