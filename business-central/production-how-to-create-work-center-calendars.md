...
ms.author: edupont
---
# <a name="set-up-shop-calendars" />Så här lägger du upp fabrikskalendrar
...
## <a name="to-create-work-shifts" />Så här skapar du arbetsskift
...
## <a name="to-set-up-a-shop-calendar" />Så här skapar du en fabrikskalender
...
## <a name="to-calculate-a-work-center-calendar" />Så här beräknar du en produktionsgruppkalender
...
## <a name="to-record-work-center-absence" />Så här registrerar du frånvaro i produktionsgrupper
