...
# <a name="define-an-invoice-posting-policy-for-users" />Definiera en bokföringspolicy för faktura för användare
...
## <a name="to-specify-a-posting-policy" />Så här anger du bokföringspolicy
...
## <a name="effect-on-documents" />Inverkan på dokument
