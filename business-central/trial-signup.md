...
## <a name="to-sign-up-for-the-trial" />Registrera dig för utvärderingsversionen

[!INCLUDE [trial-get](includes/trial-get.md)]

## <a name="what-to-try" />Vad du bör prova
...
## <a name="get-started-with-a-subscription" />Komma igång med en prenumeration
