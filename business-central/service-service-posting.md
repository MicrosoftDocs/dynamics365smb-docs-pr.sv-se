...
ms.author: edupont
---
# <a name="service-posting"></a><a name="service-posting"></a>Servicebokföring
...
## <a name="ship"></a><a name="ship"></a>Leverera
...
## <a name="invoice"></a><a name="invoice"></a>Fakturera
...
## <a name="ship-and-invoice"></a><a name="ship-and-invoice"></a>Leverera och fakturera
Med alternativet leverera och fakturera kan du skapa både en serviceleverans och en faktura samtidigt.  

## <a name="ship-and-consume"></a><a name="ship-and-consume"></a>Leverera och förbruka
...
## <a name="to-view-information-about-a-posted-service-document"></a><a name="to-view-information-about-a-posted-service-document"></a>Så här visar du information om bokförda servicedokument
