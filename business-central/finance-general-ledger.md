...
ms.author: edupont
---
# <a name="understanding-the-general-ledger-and-chart-of-accounts" />Förstå redovisningen och kontoplanen
...
## <a name="general-ledger-setup-and-general-posting-setup" />Redovisningsinställning och bokföringsinställning
...
## <a name="account-categories" />Kontokategorier
...
## <a name="get-a-quick-overview" />Få en snabböversikt
...
## <a name="access-to-create-and-edit-accounts-and-account-categories" />Åtkomst för att skapa och redigera konton och kontokategorier
...
## <a name="see-related-microsoft-trainingtrainingmodulesbusiness-central-configure-general-ledger-setup" />Se relaterad [Microsoft utbildning](/training/modules/business-central-configure-general-ledger-setup/)
