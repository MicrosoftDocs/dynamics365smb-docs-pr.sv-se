...
ms.author: edupont
---
# <a name="block-customers"></a><a name="block-customers"></a><a name="block-customers"></a>Spärra kunder
...
## <a name="to-block-a-customer"></a><a name="to-block-a-customer"></a><a name="to-block-a-customer"></a>Om du vill spärra en kund
