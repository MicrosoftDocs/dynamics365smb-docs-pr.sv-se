...
ms.author: jswymer
---
# <a name="get-the-business-central-add-in-for-excel" />Hämta Business Central-tillägget för Excel
...
### <a name="about-the-add-in" />Om tillägget
...
### <a name="about-deployment-as-an-admin" />Om distribution som administratör
...
## <a name="preparation-on-premises-only" />Förberedelse (endast lokalt)
...
## <a name="deploy-the-add-in-by-using-centralized-deployment" />Distribuera tillägget med hjälp av centraliserad distribution
...
### <a name="before-you-begin" />Innan du börjar
...
### <a name="set-up-centralized-deployment-of-the-add-in" />Konfigurera centraliserad distribution för tillägg
...
### <a name="configure-the-business-central-connection" />Konfigurera Business Central anslutning
...
## <a name="prepare-devices-and-network-for-the-excel-add-in" />Förbereda enheter och nätverk för Excel-tillägget
