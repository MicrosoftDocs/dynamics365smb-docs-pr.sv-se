...
# <a name="consolidating-financial-data-from-multiple-companies" />Konsolidera ekonomiska data från flera företag
...
## <a name="use-the-consolidated-trial-balance-report" />Använd rapporten Konsoliderad råbalans
...
## <a name="consolidate-data" />Konsolidera data
...
### <a name="to-test-the-data-before-you-consolidate" />Så här testar du data före konsolidering
...
### <a name="run-the-consolidation" />Kör konsolideringen
...
## <a name="eliminate-repeated-transactions" />Eliminera upprepade transaktioner
...
## <a name="export-and-import-consolidated-data-between-databases" />Exportera och importera konsoliderade data mellan databaser
