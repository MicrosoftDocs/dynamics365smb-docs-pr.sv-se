...
ms.author: jswymer
---
# <a name="report-and-document-layouts-overview"></a><a name="report-and-document-layouts-overview"></a><a name="report-and-document-layouts-overview"></a>Rapport- och dokumentlayouter, översikt
...
## <a name="layout-types"></a><a name="layout-types"></a><a name="layout-types"></a>Layouttyper

Det finns fyra typer av rapportlayouter som du kan använda i rapporter: Word, RDLC, Excel och extern.

### <a name="word"></a><a name="word"></a><a name="word"></a>Word
...
### <a name="rdlc"></a><a name="rdlc"></a><a name="rdlc"></a>RDLC
...
### <a name="external"></a><a name="external"></a><a name="external"></a>Externt
...
## <a name="layout-sources"></a><a name="layout-sources"></a><a name="layout-sources"></a>Layoutkällor
...
<!--
### <a name="built-in-and-custom-report-layouts"></a><a name="built-in-and-custom-report-layouts"></a><a name="built-in-and-custom-report-layouts"></a>Built-in and custom report layouts
