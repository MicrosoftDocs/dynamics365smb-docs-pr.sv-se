...
ms.author: jswymer
---
# <a name="report-and-document-layouts-overview"></a><a name="report-and-document-layouts-overview"></a>Rapport- och dokumentlayouter, översikt
...
## <a name="layout-types"></a><a name="layout-types"></a>Layouttyper
...
### <a name="external"></a><a name="external"></a>Externt
...
## <a name="layout-sources"></a><a name="layout-sources"></a>Layoutkällor
