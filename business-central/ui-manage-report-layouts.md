---
title: Anpassade och inbyggda layouter för rapporter och dokument
...
En Word-rapportlayout är baserad på Word-dokument (filtypen .docx). Word-rapportlayouter gör att du kan utforma rapportlayouter med hjälp av Microsoft Word. En Word-rapportlayout bestämmer rapportens innehåll – styr hur innehållselement organiseras och hur de ser ut. Ett Word-dokument med rapportlayout använder vanligtvis tabeller för att ordna innehållet, där cellerna kan innehålla datafält, text eller bilder.

 ![Exempel på ett rapportlayoutdokument för NAV.](media/nav_wordreportlayout_edit_in_word_example.png "NAV_WordReportLayout_Edit_In_Word_Example")  
