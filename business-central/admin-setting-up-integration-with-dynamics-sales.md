...
> [!IMPORTANT]
> Under installationen ombeds du ange autentiseringsuppgifter för [!INCLUDE[prod_short](includes/cds_long_md.md)] miljön. Ange autentiseringsuppgifterna för ett konto som är en licensierad användare och tilldelat **säkerhetsrollen Systemadministratör** i miljön [!INCLUDE[prod_short](includes/cds_long_md.md)] och [rollen Användaradministratör](/entra/identity/role-based-access-control/permissions-reference#user-administrator) i den klientorganisation som miljön tillhör. Det här kontot behöver ingen licens för [!INCLUDE[prod_short](includes/prod_short.md)], eftersom det endast används för att ställa in uppgifter i [!INCLUDE[prod_short](includes/cds_long_md.md)]-miljö.
>
