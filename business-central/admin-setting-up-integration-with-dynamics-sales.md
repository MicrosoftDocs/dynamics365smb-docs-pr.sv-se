...
## <a name="permissions-and-security-roles-for-user-accounts-in-" />Behörigheter och säkerhetsroller för användarkonton i [!INCLUDE[prod_short](includes/cds_long_md.md)]
