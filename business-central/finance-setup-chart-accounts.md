...
ms.author: edupont
---
# <a name="set-up-or-change-the-chart-of-accounts"></a><a name="set-up-or-change-the-chart-of-accounts"></a>Ställa in eller ändra kontoplanen
...
## <a name="add-or-change-accounts"></a><a name="add-or-change-accounts"></a>Lägga till eller ändra konton
...
## <a name="delete-accounts"></a><a name="delete-accounts"></a>Ta bort konton
...
## <a name="block-deletion-of-gl-accounts"></a><a name="block-deletion-of-gl-accounts"></a>Spärra borttagning av redovisningskonton
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relaterad [Microsoft utbildning](/training/modules/chart-accounts-dynamics-365-business-central/index)
