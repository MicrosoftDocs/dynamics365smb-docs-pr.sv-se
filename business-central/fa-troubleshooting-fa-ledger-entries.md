...
ms.author: bholtorf
---
# <a name="the-troubleshooting-fa-ledger-entries-extension" />Tillägget Felsöka poster i redovisningen för fasta anläggningstillgångar
...
## <a name="troubleshooting-fixed-asset-ledger-entries" />Felsöka redovisningsposter för fasta anläggningstillgångar
