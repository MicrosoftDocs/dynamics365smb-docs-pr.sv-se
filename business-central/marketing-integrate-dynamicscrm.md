...
## <a name="couple-records"></a>Kopplingsposter
...
## <a name="fully-synchronize-records"></a>Synkronisera poster helt
...
## <a name="handle-sales-order-data"></a>Hantering av försäljningsorderdata
...
## <a name="handle-sales-quotes-data"></a>Hantering av försäljningsoffertdata
...
## <a name="handle-posted-sales-invoices-customer-payments-and-statistics"></a>Hantera bokförda försäljningsfakturor, kundbetalningar och statistik
...
## <a name="handle-sales-prices"></a>Hantera försäljningspriser
> [!NOTE]
