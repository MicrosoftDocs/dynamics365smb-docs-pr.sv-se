...
Du kan också skapa (och koppla) ett konto i Sales baserat på till exempel kundposter i [!INCLUDE[d365fin](includes/d365fin_md.md)] med **skapa konto i Dynamics 365 for Sales**, eller vice versa med hjälp av **Skapa kund i [!INCLUDE[d365fin](includes/d365fin_md.md)]**.
...
I slutet av den assisterade konfigurationsguiden kan du välja åtgärden **kör fullständig synkronisering** för att starta synkronisering av alla [!INCLUDE[d365fin](includes/d365fin_md.md)]-poster med alla relaterade poster i Sales. På sidan **Dynamics 365 for Sales Fullständig synk.granskning** väljer du åtgärden **Starta**. Fyll synkronisering kan ta en stund, men du kan fortsätta att arbeta i [!INCLUDE[d365fin](includes/d365fin_md.md)] när det körs i bakgrunden.

Så här kontrollerar du status på enskilda projekt i en fullständig synkronisering på sidan **Dynamics 365 for Sales Fullständig synk.granskning** väljer du en post om du vill visa information. Uppdatera sidan om du vill uppdatera status under synkroniseringen.
