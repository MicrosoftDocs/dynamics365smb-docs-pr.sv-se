...
ms.author: bholtorf
---
# <a name="use-dynamics-365-sales-from-business-central" />Använda Dynamics 365 Sales från Business Central
...
## <a name="coupling-records" />Kopplingsposter
...
## <a name="fully-synchronizing-records" />Synkronisera poster helt
...
## <a name="handling-sales-order-data" />Hantering av försäljningsorderdata
...
## <a name="handling-sales-quotes-data" />Hantering av försäljningsoffertdata
...
## <a name="handling-posted-sales-invoices-customer-payments-and-statistics" />Hantera bokförda försäljningsfakturor, kundbetalningar och statistik
...
## <a name="handling-sales-prices" />Hantera försäljningspriser
> [!NOTE]
