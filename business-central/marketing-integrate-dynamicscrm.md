...
ms.author: bholtorf
---
# <a name="use-dynamics-365-sales-from-business-central"></a><a name="use-dynamics-365-sales-from-business-central"></a><a name="use-dynamics-365-sales-from-business-central"></a>Använda Dynamics 365 Sales från Business Central
...
## <a name="coupling-records"></a><a name="coupling-records"></a><a name="coupling-records"></a>Kopplingsposter
...
## <a name="fully-synchronizing-records"></a><a name="fully-synchronizing-records"></a><a name="fully-synchronizing-records"></a>Synkronisera poster helt
...
## <a name="handling-sales-order-data"></a><a name="handling-sales-order-data"></a><a name="handling-sales-order-data"></a>Hantering av försäljningsorderdata
...
## <a name="handling-sales-quotes-data"></a><a name="handling-sales-quotes-data"></a><a name="handling-sales-quotes-data"></a>Hantering av försäljningsoffertdata
...
## <a name="handling-posted-sales-invoices-customer-payments-and-statistics"></a><a name="handling-posted-sales-invoices-customer-payments-and-statistics"></a><a name="handling-posted-sales-invoices-customer-payments-and-statistics"></a>Hantera bokförda försäljningsfakturor, kundbetalningar och statistik
...
## <a name="handling-sales-prices"></a><a name="handling-sales-prices"></a><a name="handling-sales-prices"></a>Hantera försäljningspriser
> [!NOTE]
