...
ms.author: soalex
---
# <a name="manage-user-settings-and-preferences" />Hantera användarinställningar och inställningar
...
## <a name="types-of-user-settings" />Typer av användarinställningar
...
## <a name="overview-of-all-user-specific-changes" />Översikt över alla användarspecifika ändringar
...
## <a name="to-review-or-delete-user-personalizations" />Så här granskar eller tar du bort användaranpassningar
