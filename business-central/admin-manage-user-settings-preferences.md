...
ms.author: soalex
---
# Hantera användarinställningar och inställningar
...
## Typer av användarinställningar
...
## Översikt över alla användarspecifika ändringar
...
## Så här granskar eller tar du bort användaranpassningar
