...
ms.author: edupont
---
# <a name="design-details-production-order-posting"></a><a name="design-details-production-order-posting"></a>Designdetaljer: Bokföring av produktionsorder
...
## <a name="posting-structure"></a><a name="posting-structure"></a>Bokföringsstruktur
...
## <a name="capacity-posting"></a><a name="capacity-posting"></a>Kapacitetsbokföring
...
## <a name="production-order-costing"></a><a name="production-order-costing"></a>Kostnadskalkylering för tillverkningsorder
