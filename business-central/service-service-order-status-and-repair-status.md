...
ms.author: edupont
---
# <a name="service-order-status-and-repair-status" />Tjänsteorderstatus och reparationsstatus
...
## <a name="specifying-service-order-status-for-repair-status" />Ange serviceorderstatus för reparationsstatus
...
## <a name="assigning-priority-to-service-order-status" />Tilldela en serviceorderstatus prioritet
