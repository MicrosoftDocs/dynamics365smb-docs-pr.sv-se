...
ms.author: edupont
---
# <a name="setting-up-cost-accounting"></a><a name="setting-up-cost-accounting"></a>Ställa in kostnadsredovisning

Innan du börjar arbeta med kostnadsredovisning, måste du utföra inställningsuppgifter.

## <a name="balances-between-cost-type-cost-center-and-cost-object"></a><a name="balances-between-cost-type-cost-center-and-cost-object"></a>Saldon mellan kostnadstyp, kostnadsställe och kostnadsbärare
...
## <a name="setting-up-cost-types"></a><a name="setting-up-cost-types"></a>Lägga upp kostnadstyper
...
### <a name="to-transfer-the-general-ledger-chart-of-accounts-to-the-chart-of-cost-types"></a><a name="to-transfer-the-general-ledger-chart-of-accounts-to-the-chart-of-cost-types"></a>Överföra kontoplanen i redovisningen till redovisningsplanen över kostnadstyper
...
### <a name="to-set-up-new-cost-types-in-the-chart-of-cost-types-page"></a><a name="to-set-up-new-cost-types-in-the-chart-of-cost-types-page"></a>Så här skapar du nya kostnadstyper på sidan Lista över kostnadsbärare.
...
### <a name="to-update-cost-types"></a><a name="to-update-cost-types"></a>Uppdatera kostnadstyper
...
## <a name="defining-the-relationship-between-cost-types-and-general-ledger-accounts"></a><a name="defining-the-relationship-between-cost-types-and-general-ledger-accounts"></a>Definiera relationen mellan kostnadstyper och redovisningskonton
...
### <a name="relationship-between-general-ledger-accounts-and-cost-types"></a><a name="relationship-between-general-ledger-accounts-and-cost-types"></a>Relationen mellan redovisningskonton och kostnadstyper
...
### <a name="cost-types-without-a-relationship-to-the-general-ledger"></a><a name="cost-types-without-a-relationship-to-the-general-ledger"></a>Kostnadstyper utan en relation till redovisningen
...
## <a name="setting-up-cost-centers"></a><a name="setting-up-cost-centers"></a>Lägga upp kostnadsställen
...
### <a name="to-transfer-dimension-values-in-the-general-ledger-to-the-chart-of-cost-centers"></a><a name="to-transfer-dimension-values-in-the-general-ledger-to-the-chart-of-cost-centers"></a>Överföra dimensionsvärden i redovisningen till planen för kostnadsställen
...
### <a name="to-create-new-cost-centers-in-the-chart-of-cost-centers-page"></a><a name="to-create-new-cost-centers-in-the-chart-of-cost-centers-page"></a>Så här skapar du nya kostnadsställen på sidan Lista över kostnadsställen.
...
## <a name="setting-up-cost-objects"></a><a name="setting-up-cost-objects"></a>Lägga upp kostnadsbärare
...
### <a name="to-transfer-dimension-values-from-the-general-ledger-to-the-chart-of-cost-objects"></a><a name="to-transfer-dimension-values-from-the-general-ledger-to-the-chart-of-cost-objects"></a>Så här överför du dimensionsvärden från redovisningen till kontoplanen för kostnadsbärare
...
### <a name="to-create-new-cost-objects-in-the-chart-of-cost-objects-page"></a><a name="to-create-new-cost-objects-in-the-chart-of-cost-objects-page"></a>Så här skapar du nya kostnadsbärare på sidan Lista över kostnadsbärare.
...
## <a name="defining-cost-centers-and-cost-objects-for-chart-of-accounts"></a><a name="defining-cost-centers-and-cost-objects-for-chart-of-accounts"></a>Definiera kostnadsställen och kostnadsbärare för kontoplanen
...
### <a name="defining-default-dimension-values-for-general-ledger-accounts"></a><a name="defining-default-dimension-values-for-general-ledger-accounts"></a>Ange standarddimensionsvärden för redovisningskonton
...
### <a name="defining-dimension-values-for-overhead-costs-and-direct-costs"></a><a name="defining-dimension-values-for-overhead-costs-and-direct-costs"></a>Definiera dimensionsvärden för omkostnader och direkta kostnader
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relaterad [Microsoft utbildning](/training/modules/cost-accounting-dynamics-365-business-central/)
