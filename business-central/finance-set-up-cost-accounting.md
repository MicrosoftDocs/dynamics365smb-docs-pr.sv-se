...
ms.author: edupont
---
# <a name="setting-up-cost-accounting" />Ställa in kostnadsredovisning

Innan du börjar arbeta med kostnadsredovisning, måste du utföra inställningsuppgifter.

## <a name="balances-between-cost-type-cost-center-and-cost-object" />Saldon mellan kostnadstyp, kostnadsställe och kostnadsbärare
...
## <a name="setting-up-cost-types" />Lägga upp kostnadstyper
...
### <a name="to-transfer-the-general-ledger-chart-of-accounts-to-the-chart-of-cost-types" />Överföra kontoplanen i redovisningen till redovisningsplanen över kostnadstyper
...
### <a name="to-set-up-new-cost-types-in-the-chart-of-cost-types-page" />Så här skapar du nya kostnadstyper på sidan Lista över kostnadsbärare.
...
### <a name="to-update-cost-types" />Uppdatera kostnadstyper
...
## <a name="defining-the-relationship-between-cost-types-and-general-ledger-accounts" />Definiera relationen mellan kostnadstyper och redovisningskonton
...
### <a name="relationship-between-general-ledger-accounts-and-cost-types" />Relationen mellan redovisningskonton och kostnadstyper
...
### <a name="cost-types-without-a-relationship-to-the-general-ledger" />Kostnadstyper utan en relation till redovisningen
...
## <a name="setting-up-cost-centers" />Lägga upp kostnadsställen
...
### <a name="to-transfer-dimension-values-in-the-general-ledger-to-the-chart-of-cost-centers" />Överföra dimensionsvärden i redovisningen till planen för kostnadsställen
...
### <a name="to-create-new-cost-centers-in-the-chart-of-cost-centers-page" />Så här skapar du nya kostnadsställen på sidan Lista över kostnadsställen.
...
## <a name="setting-up-cost-objects" />Lägga upp kostnadsbärare
...
### <a name="to-transfer-dimension-values-from-the-general-ledger-to-the-chart-of-cost-objects" />Så här överför du dimensionsvärden från redovisningen till kontoplanen för kostnadsbärare
...
### <a name="to-create-new-cost-objects-in-the-chart-of-cost-objects-page" />Så här skapar du nya kostnadsbärare på sidan Lista över kostnadsbärare.
...
## <a name="defining-cost-centers-and-cost-objects-for-chart-of-accounts" />Definiera kostnadsställen och kostnadsbärare för kontoplanen
...
### <a name="defining-default-dimension-values-for-general-ledger-accounts" />Ange standarddimensionsvärden för redovisningskonton
...
### <a name="defining-dimension-values-for-overhead-costs-and-direct-costs" />Definiera dimensionsvärden för omkostnader och direkta kostnader
...
## <a name="see-related-microsoft-training" />Se relaterad [Microsoft utbildning](/training/modules/cost-accounting-dynamics-365-business-central/)
