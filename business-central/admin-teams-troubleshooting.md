...
## <a name="the-sign-in-link-doesnt-work" />Inloggningslänken fungerar inte
...
## <a name="the-settings-page-is-empty" />Sidan Inställningar är tom.
...
## <a name="i-changed-company-but-it-didnt-seem-to-work" />Jag ändrade företaget, men det verkar inte fungera
...
## <a name="something-went-wrong-error-when-searching-for-contacts" />"Något gick fel" visas vid sökning efter kontakter
...
## <a name="cannot-find-the-contactcontact-summary-api-error-when-searching-for-contacts" />Felmeddelandet "Det gick inte att hitta kontakt-/kontaktsammanfattnings-API" visas vid sökning efter kontakter
...
## <a name="none-of-my-links-expand-into-a-card" />Ingen av länkarna expanderas till ett kort
...
## <a name="my-link-sometimes-doesnt-expand-into-a-card" />Länken utökas ibland inte till ett kort
...
## <a name="the-details-window-opens-but-shows-an-error-before-details-are-shown" />Informationsfönstret öppnas, men visar ett fel innan informationen visas
...
## <a name="im-having-problems-with-the-camera-or-location-in-teams" />Jag har problem med kameran eller platsen i Teams
...
## <a name="teams-displays-mixed-languages-for-my-cards-and-card-details" />Teams visar blandade språk för mina kort och kortuppgifter
...
## <a name="i-edited-a-field-in-the-details-window-but-my-change-wasnt-saved" />Jag har redigerat ett fält i informationsfönstret, men ändringen sparades inte
...
## <a name="a-new-tile-appeared-in-the-app-launcher-how-do-i-remove-it" />En ny panel dök upp i startprogrammet. Hur tar jag bort den?
...
## <a name="duplicate-text-in-the-share-to-teams-window" />Duplicera text i fönstret Dela till Teams
...
## <a name="unable-to-sign-into-the-share-to-teams-window" />Det gick inte att logga in i fönstret Dela till Teams
...
## <a name="my-cards-no-longer-have-a-popout-button" />Mina kort har inte längre någon popout-knapp
...
## <a name="cant-pin-a-card-to-tab" />Det går inte att fästa kort på fliken
...
## <a name="someone-added-a-tab-but-the-tab-doesnt-show-up-for-me" />Någon har lagt till en flik, men fliken visas inte för mig
...
## <a name="others-see-different-sorting-or-column-layout-than-what-the-tab-author-sees" />Andra ser annan sorterings- eller kolumnlayout än vad som författaren ser
