...
2. Välj sökknappen i fältet **Kod för överinleverans**.
3. Välj åtgärden **Ny**.
4. På sidan **Koder för överinleverans** skapar du en eller flera nya rader som definierar olika principer för överinleverans. [!INCLUDE[tooltip-inline-tip](includes/tooltip-inline-tip_md.md)].
5. Markera en rad och välj sedan knappen **OK**.
...
> [!NOTE]
> Du kan ställa in ett arbetsflöde för godkännande för att kräva att överinleveranser måste godkännas innan de kan hanteras. I så fall måste du markera kryssrutan **Godkännande krävs** på sidan **Koder för överinleverans**. Ett dedikerat arbetsflödessvar, **Godkänn överinleverans** finns i standardarbetsflödesdatan för detta ändamål. Mer information finns i [Skapa arbetsflöden](across-how-to-create-workflows.md).
