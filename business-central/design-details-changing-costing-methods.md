...
# <a name="design-details-change-the-costing-method-for-items" />Designinformation: ändra värderingsprinciper för artiklar
...
## <a name="about-costing-methods" />Om värderingsprinciper
...
## <a name="use-assembly-orders-to-change-costing-method-assignments" />Använda monteringsorder för att ändra tilldelningar av värderingsprincipen
...
### <a name="define-a-default-costing-method" />Definiera standardvärderingsprincip
...
### <a name="identify-the-items-to-change-the-costing-method-for-and-renumber-them" />Identifiera de artiklar som du vill ändra värderingsprincipen för och numrera om dem
...
### <a name="create-new-items-with-the-old-numbering-scheme-and-copy-the-master-data-in-a-batch" />Skapa nya objekt med det gamla numreringsschema och kopiera huvuddata i en batch
...
### <a name="manually-copy-related-master-data-from-the-original-item-to-the-new-item" />Manuellt kopiera relaterade huvuddata från det ursprungliga objektet till det nya.
...
### <a name="determine-the-inventory-quantity-to-convert-from-the-original-item-to-the-new-item" />Bestämma lagerkvantiteten som ska konverteras från den ursprungliga artikeln till den nya artikeln
...
### <a name="transfer-the-inventory-to-the-new-item" />Överföra lagret till den nya artikeln
...
### <a name="handle-inventory-quantities-that-are-allocated-to-demand" />Hantera lagerkvantiteter som har allokerats till behov
...
### <a name="block-the-original-item-from-further-use" />Blockera det ursprungliga artikel från att användas
