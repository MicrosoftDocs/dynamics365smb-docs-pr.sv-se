...
ms.author: jswymer
---
# <a name="overview-of-tasks-to-close-accounting-periods" />Översikt över uppgifter för att avsluta bokföringsperioder
...
## <a name="general-ledger" />Redovisning
...
## <a name="sales-and-receivables" />Försäljning
...
## <a name="purchases-and-payables" />Inköp
...
## <a name="fixed-assets" />Anläggningstillgångar
...
## <a name="intercompany" />Koncernintern

* Behandla koncerninterna transaktioner.

## <a name="calculate-and-process-sales-tax" />Beräkna och bearbeta omsättningsskatt

* Fyll i skattmeddelanden.  

## <a name="see-related-microsoft-training" />Se relaterad [Microsoft utbildning](/training/modules/close-fiscal-year-dynamics-365-business-central/)
