...
---
# <a name="monitor-job-progress-and-performance"></a><a name="monitor-job-progress-and-performance"></a>Övervaka projektframsteg och -resultat
...
## <a name="create-a-job-wip-method"></a><a name="create-a-job-wip-method"></a>Skapa en PIA-metod
...
## <a name="define-a-wip-method-for-a-job"></a><a name="define-a-wip-method-for-a-job"></a>Definiera en PIA-metod för ett projekt
...
### <a name="define-a-wip-method-for-a-job-task"></a><a name="define-a-wip-method-for-a-job-task"></a>Definiera du en PIA-metod för ett projekt
...
## <a name="calculate-wip"></a><a name="calculate-wip"></a>Beräkna PIA
...
## <a name="post-wip"></a><a name="post-wip"></a>Bokföra PIA
...
## <a name="calculate-and-post-job-completion-entries"></a><a name="calculate-and-post-job-completion-entries"></a>Beräkna och bokföra slutförda projekt
...
## <a name="view-job-ledger-entries"></a><a name="view-job-ledger-entries"></a>Visa projekttransaktioner
...
## <a name="find-related-microsoft-training"></a><a name="find-related-microsoft-training"></a>Se relaterad [Microsoft utbildning](/training/paths/calculate-post-job-wip/)
