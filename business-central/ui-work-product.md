...
ms.author: edupont
---
# <a name="work-with-"></a><a name="work-with-"></a>Arbeta med [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="tips-and-tricks"></a><a name="tips-and-tricks"></a><a name="cheatsheet"></a>Tips och råd
...
## <a name="links-to-learn-more"></a><a name="links-to-learn-more"></a>Länkar till mer information
...
## <a name="getting-around-in-business-central"></a><a name="getting-around-in-business-central"></a>Hitta rätt i Business Central
Här följer en kort video om hur du navigerar i [!INCLUDE[prod_short](includes/prod_short.md)].

> [!VIDEO https://www.youtube.com/embed/zqz03iMihx0]

## <a name="choosing-a-desktop-browser"></a><a name="choosing-a-desktop-browser"></a>Välja en webbläsare för skrivbordet
...
## <a name="action-bars"></a><a name="action-bars"></a>Åtgärdsfält
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relaterad [Microsoft utbildning](/training/paths/work-pro-data-dynamics-365-business-central/)
