...
ms.author: edupont
---
# <a name="add-comments-to-cards-and-documents"></a><a name="add-comments-to-cards-and-documents"></a>Lägga till kommentarer i kort och dokument
...
## <a name="to-add-a-comments-to-an-item-card"></a><a name="to-add-a-comments-to-an-item-card"></a>Att lägga till kommentarer till ett artikelkort
