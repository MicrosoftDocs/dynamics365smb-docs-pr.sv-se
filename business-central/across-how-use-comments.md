...
ms.author: edupont
---
# <a name="add-comments-to-cards-and-documents" />Lägga till kommentarer i kort och dokument
...
## <a name="to-add-a-comments-to-an-item-card" />Att lägga till kommentarer till ett artikelkort
