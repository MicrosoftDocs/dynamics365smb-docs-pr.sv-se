...
ms.author: edupont
---
# <a name="correct-or-cancel-unpaid-sales-invoices" />Korrigera eller makulera obetalda försäljningsfakturor
...
## <a name="to-cancel-a-posted-sales-invoice" />Avbryta en bokförd försäljningsfaktura
...
## <a name="to-correct-a-posted-sales-invoice" />Korrigera en bokförd försäljningsfaktura
