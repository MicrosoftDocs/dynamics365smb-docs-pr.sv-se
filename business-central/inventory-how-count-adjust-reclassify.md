...
---
# <a name="count-adjust-and-reclassify-inventory-using-journals" />Inventera, justera och gruppera lager med hjälp av journaler
...
## <a name="to-count-physical-inventory" />Att göra fysisk inventering
...
### <a name="to-calculate-expected-inventory-in-basic-warehouse-configurations" />Beräkna förväntat lager i grundläggande distributionslagerkonfiguration
...
### <a name="to-print-the-report-to-be-used-when-counting" />Skriv ut rapporten som ska användas i samband med räkning
...
### <a name="to-enter-and-post-the-actual-counted-inventory-in-basic-warehouse-configurations" />Om du vill ange och bokföra det verkliga inventerade lagret i grundläggande konfigurationer
...
### <a name="to-calculate-the-expected-inventory-in-advanced-warehouse-configurations" />Beräkna förväntat lager i avancerad distributionslagerkonfiguration.
...
### <a name="to-enter-and-post-the-actual-counted-inventory-in-advanced-warehouse-configurations" />Om du vill ange och bokföra det verkliga inventerade lagret i avancerade lagerkonfigurationer
...
## <a name="to-do-cycle-counting" />Utför cyklisk inventering
...
### <a name="to-set-up-counting-periods" />Så här ställer du in cykliska inventeringsperioder
...
### <a name="to-assign-a-counting-period-to-an-item" />Så här tilldelar du en cyklisk inventeringsperiod till en artikel
...
### <a name="to-start-a-count-based-on-counting-periods-in-basic-warehouse-configurations" />Så här börjar du en inventering baserat på den cykliska inventeringsperioder i grundläggande konfigurationer
...
### <a name="to-start-a-count-based-on-counting-periods-in-advanced-warehouse-configurations" />Så här börjar du en inventering baserat på den cykliska inventeringsperioder i avancerade konfigurationer
...
## <a name="to-adjust-the-quantity-of-one-item" />Justera antalet för en artikel
...
### <a name="to-adjust-the-quantities-of-multiple-items-in-basic-warehouse-configurations" />Så här justerar du antalen på flera objekt i grundläggande konfigurationer
...
### <a name="to-adjust-bin-quantities-in-advanced-warehouse-configurations" />Så här justerar du lagerplatskvantiteter i avancerad distributionslagerkonfiguration
...
## <a name="to-synchronize-the-adjusted-warehouse-entries-with-the-related-item-ledger-entries" />Så här synkroniserar du justerade lagertransaktioner med tillhörande artikeltransaktioner
