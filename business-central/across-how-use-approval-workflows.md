...
ms.author: edupont
---
# <a name="how-to-use-approval-workflows"></a><a name="how-to-use-approval-workflows"></a>Så här använder du godkännande av arbetsflöden
...
## <a name="request-a-record-approval"></a><a name="request-a-record-approval"></a>Begära du godkännande av en post
...
## <a name="cancel-approval-requests"></a><a name="cancel-approval-requests"></a>Annullera godkännandebegäran
...
## <a name="approve-or-reject-approval-requests"></a><a name="approve-or-reject-approval-requests"></a>Godkänna eller avvisa begäranden om godkännande
...
## <a name="delegate-approval-requests"></a><a name="delegate-approval-requests"></a>Delegera godkännandebegäranden
...
## <a name="manage-overdue-approval-requests"></a><a name="manage-overdue-approval-requests"></a>Hantera förfallna begäranden om godkännande
