...
ms.author: edupont
---
# <a name="available-fonts"></a><a name="available-fonts"></a><a name="available-fonts"></a>Tillgängliga teckensnitt
...
## <a name="document-fonts"></a><a name="document-fonts"></a><a name="document-fonts"></a>Dokumentteckensnitt
...
## <a name="fonts-for-checks"></a><a name="fonts-for-checks"></a><a name="fonts-for-checks"></a>Teckensnitt för kontroller
...
## <a name="fonts-for-barcodes"></a><a name="fonts-for-barcodes"></a><a name="fonts-for-barcodes"></a>Teckensnitt för streckkoder
