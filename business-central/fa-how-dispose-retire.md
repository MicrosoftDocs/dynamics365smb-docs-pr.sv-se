...
ms.author: edupont
---
# <a name="dispose-of-or-retire-fixed-assets" />Avyttra eller ställa av anläggningstillgångar
...
## <a name="to-post-a-disposal-from-the-fixed-asset-gl-journal" />Bokföra en avyttringstransaktion i redovisningsjournalen för anläggningstillgångar.
...
## <a name="to-view-disposal-ledger-entries" />Så här visar du avyttringstransaktioner
...
## <a name="see-related-microsoft-trainingtrainingmodulesdispose-fixed-assets" />Se relaterad [Microsoft utbildning](/training/modules/dispose-fixed-assets/)
