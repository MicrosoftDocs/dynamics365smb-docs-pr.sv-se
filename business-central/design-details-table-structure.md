...
## <a name="transaction-and-budget-tables" />Transaktions- och budgettabeller
...
### <a name="tables-that-contain-the-dimension-set-id-field" />Tabeller som innehåller fältet dimensionsuppsättning-ID
