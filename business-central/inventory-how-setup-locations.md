...
ms.author: bholtorf
---
# <a name="set-up-locations"></a><a name="set-up-locations"></a><a name="set-up-locations"></a>Konfigurera platser
...
## <a name="location-cards"></a><a name="location-cards"></a><a name="location-cards"></a>Lagerställekort
...
### <a name="to-set-up-a-location"></a><a name="to-set-up-a-location"></a><a name="to-set-up-a-location"></a>Så här skapar du lagerställen
...
### <a name="to-create-a-transfer-route"></a><a name="to-create-a-transfer-route"></a><a name="to-create-a-transfer-route"></a>Så här skapar du ett överföringsflöde
...
## <a name="bins"></a><a name="bins"></a><a name="bins"></a>Lagerställen
...
## <a name="zones"></a><a name="zones"></a><a name="zones"></a>Zoner
...
## <a name="default-dimensions-for-locations"></a><a name="default-dimensions-for-locations"></a><a name="default-dimensions-for-locations"></a>Standarddimensioner för platser
...
### <a name="example-of-default-dimensions-on-locations"></a><a name="example-of-default-dimensions-on-locations"></a><a name="example-of-default-dimensions-on-locations"></a>Exempel på standardmått på lagerställen
...
## <a name="see-related-training-at-microsoft-learn"></a><a name="see-related-training-at-microsoft-learn"></a><a name="see-related-training-at-microsoft-learn"></a>Se relaterad utbildning på [Microsoft Learn](/learn/modules/trade-set-up-dynamics-365-business-central/)
