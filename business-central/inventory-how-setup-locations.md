...
ms.author: bholtorf
---
# <a name="set-up-locations" />Konfigurera platser
...
## <a name="location-cards" />Lagerställekort
...
### <a name="to-set-up-a-location" />Så här skapar du lagerställen
...
### <a name="to-create-a-transfer-route" />Så här skapar du ett överföringsflöde
...
## <a name="default-dimensions-for-locations" />Standarddimensioner för platser
...
### <a name="example-of-default-dimensions-on-locations" />Exempel på standardmått på lagerställen
...
## <a name="see-related-training-at-microsoft-learnlearnmodulestrade-set-up-dynamics--business-central" />Se relaterad utbildning på [Microsoft Learn](/learn/modules/trade-set-up-dynamics-365-business-central/)
