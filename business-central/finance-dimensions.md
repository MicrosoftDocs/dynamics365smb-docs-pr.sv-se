...
---
# <a name="work-with-dimensions"></a><a name="work-with-dimensions"></a><a name="work-with-dimensions"></a>Arbeta med dimensioner
...
## <a name="analyzing-by-dimensions"></a><a name="analyzing-by-dimensions"></a><a name="analyzing-by-dimensions"></a>Analys per dimension
...
## <a name="dimension-sets"></a><a name="dimension-sets"></a><a name="dimension-sets"></a>Dimensionsuppsättningar
...
## <a name="setting-up-dimensions"></a><a name="setting-up-dimensions"></a><a name="setting-up-dimensions"></a>Lägga upp dimensioner
...
### <a name="to-set-up-default-dimension-priorities"></a><a name="to-set-up-default-dimension-priorities"></a><a name="to-set-up-default-dimension-priorities"></a>Så här anger du standarddimensionsprioritet
...
### <a name="to-set-up-dimension-combinations"></a><a name="to-set-up-dimension-combinations"></a><a name="to-set-up-dimension-combinations"></a>Så här definierar du dimensionskombinationer
...
### <a name="to-set-up-global-and-shortcut-dimensions"></a><a name="to-set-up-global-and-shortcut-dimensions"></a><a name="to-set-up-global-and-shortcut-dimensions"></a>För att ställa in globala och genvägsdimensioner
...
#### <a name="to-change-global-dimensions"></a><a name="to-change-global-dimensions"></a><a name="to-change-global-dimensions"></a>Ändra globala dimensioner
...
### <a name="example-of-dimension-setup"></a><a name="example-of-dimension-setup"></a><a name="example-of-dimension-setup"></a>Exempel på dimensionsinställningarna
...
## <a name="getting-an-overview-of-dimensions-used-multiple-times"></a><a name="getting-an-overview-of-dimensions-used-multiple-times"></a><a name="getting-an-overview-of-dimensions-used-multiple-times"></a>Få en översikt över dimensioner som används flera gånger
...
## <a name="use-dimensions"></a><a name="use-dimensions"></a><a name="use-dimensions"></a>Använda dimensioner
...
### <a name="to-view-global-dimensions-in-ledger-entry-pages"></a><a name="to-view-global-dimensions-in-ledger-entry-pages"></a><a name="to-view-global-dimensions-in-ledger-entry-pages"></a>Så här visar du globala dimensioner på transaktionssidor
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relaterad [Microsoft utbildning](/training/modules/dimensions-dynamics-365-business-central/index)
