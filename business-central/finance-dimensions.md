...
5. Om du vill verifiera korrigeringen väljer du **Validera dimensionsändringar**. Mer information finns i [Validera dimensionskorrigeringar](finance-dimensions.md#validating-dimension-corrections).
6. Välj **Kör**.
