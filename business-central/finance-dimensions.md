...
description: Du kan använda dimensioner för att kategorisera poster, till exempel efter avdelning eller projekt, så att du enklare kan spåra och analysera data för att hjälpa dig att fatta bra affärsbeslut.
author: edupont04
ms.topic: conceptual
ms.devlang: na
ms.tgt_pltfrm: na
