...
ms.author: edupont
---
# <a name="work-with-inventory-periods"></a><a name="work-with-inventory-periods"></a><a name="work-with-inventory-periods"></a>Arbeta med lagerperioder
...
## <a name="to-create-an-inventory-period"></a><a name="to-create-an-inventory-period"></a><a name="to-create-an-inventory-period"></a>Skapa en lagerperiod
...
## <a name="closing-inventory-periods"></a><a name="closing-inventory-periods"></a><a name="closing-inventory-periods"></a>Stänga lagerperioder
...
### <a name="to-close-an-inventory-period"></a><a name="to-close-an-inventory-period"></a><a name="to-close-an-inventory-period"></a>Stänga en lagerperiod
...
## <a name="reopening-inventory-periods"></a><a name="reopening-inventory-periods"></a><a name="reopening-inventory-periods"></a>Öppna lagerperioder igen
...
### <a name="to-reopen-an-inventory-period"></a><a name="to-reopen-an-inventory-period"></a><a name="to-reopen-an-inventory-period"></a>Öppna en lagerperiod igen
1. Välj den ![Glödlampa som öppnar funktionen Berätta.](media/ui-search/search_small.png "Berätta för mig vad du vill göra") anger du **lagerperioder** och väljer sedan relaterad länk.  
