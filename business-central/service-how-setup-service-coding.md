...
# <a name="set-up-standard-service-codes" />Skapa standardtjänstekoder
...
## <a name="to-set-up-a-standard-service-code" />Så här skapar du standardtjänstkoder
...
## <a name="to-assign-a-standard-service-code-to-a-service-item-group" />Så här tilldelar du en standardtjänstkod till en serviceartikelgrupp
