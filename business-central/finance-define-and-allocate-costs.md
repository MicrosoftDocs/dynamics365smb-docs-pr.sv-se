...
ms.author: edupont
---
# <a name="defining-and-allocating-costs" />Definiera och fördela kostnader
...
## <a name="setting-up-allocation-source-and-targets" />Ställa in fördelningskälla och mål
...
### <a name="to-set-up-cost-allocations" />Så här lägger du upp kostnadsfördelningar
...
## <a name="setting-filters-for-dynamic-allocation-bases" />Skapa filter för dynamiska fördelningsbaser
...
### <a name="setting-filters" />Ställa in filter
...
### <a name="to-define-the-allocation-source-prod-cost-center-on-the-general-fasttab" />Så här definierar du fördelningskällan PROD-kostnadsstället på snabbfliken Allmänt
...
### <a name="to-define-the-allocation-target-cost-objects-on-the-lines-fasttab" />Då här definierar du kostnadsbärarna som är fördelningsmål på snabbfliken Rader
...
### <a name="to-define-dynamic-allocations-based-on-items-sold-in-the-previous-year" />Så här definierar du dynamisk fördelning beräknad på sålda artiklar under föregående år
