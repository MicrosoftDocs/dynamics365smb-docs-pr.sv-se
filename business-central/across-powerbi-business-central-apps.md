...
ms.author: jswymer
---
# <a name="use-the--apps-in-power-bi"></a><a name="use-the--apps-in-power-bi"></a>Använda [!INCLUDE [prod_short](includes/prod_short.md)]-apparna i Power BI
...
## <a name="install-a--app-in-power-bi"></a><a name="install-a--app-in-power-bi"></a>Installera en [!INCLUDE[prod_short](includes/prod_short.md)]-app i Power BI
...
## <a name="connect-the--app-to-your-data"></a><a name="connect-the--app-to-your-data"></a>Ansluta [!INCLUDE[prod_short](includes/prod_short.md)]-appen till dina data
...
### <a name="you-dont-have-a-power-bi-account"></a><a name="you-dont-have-a-power-bi-account"></a>Du har inget Power BI-konto
...
### <a name="message-there-are-no-enabled-reports-choose-select-report-to-see-a-list-of-reports-that-you-can-display"></a><a name="message-there-are-no-enabled-reports-choose-select-report-to-see-a-list-of-reports-that-you-can-display"></a>Meddelande: det finns inga aktiverade rapporter. Visa en lista med rapporter du kan visa med Välj rapport.
...
### <a name="you-need-a-power-bi-pro-license-to-install-the--app-in-power-bi"></a><a name="you-need-a-power-bi-pro-license-to-install-the--app-in-power-bi"></a>Du behöver en Power BI Pro-licens för att installera [!INCLUDE[prod_short](includes/prod_short.md)]-appen i Power BI
...
### <a name="parameter-validation-failed-please-make-sure-all-parameters-are-valid"></a><a name="parameter-validation-failed-please-make-sure-all-parameters-are-valid"></a>"Parametervalidering misslyckades. Se till att alla parametrar är giltiga"
...
### <a name="cant-sign-in"></a><a name="cant-sign-in"></a>Det går inte att logga in
...
### <a name="incorrect-company-name"></a><a name="incorrect-company-name"></a>Felaktigt företagsnamn
...
### <a name="the-key-didnt-match-any-rows-in-the-table"></a><a name="the-key-didnt-match-any-rows-in-the-table"></a>Nyckeln matchade inte några rader i tabellen
...
### <a name="historical-data-appears-to-be-missing"></a><a name="historical-data-appears-to-be-missing"></a>Historiska data saknas
...
### <a name="i-only-see-data-for-a-single-company"></a><a name="i-only-see-data-for-a-single-company"></a>Jag ser endast data för ett enskilt företag
...
### <a name="what-now"></a><a name="what-now"></a>Vad nu?
