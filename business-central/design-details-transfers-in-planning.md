...
---
# <a name="design-details-transfers-in-planning"></a><a name="design-details-transfers-in-planning"></a>Designdetaljer: Överföringar i planering
...
## <a name="why-is-a-transfer-a-special-case"></a><a name="why-is-a-transfer-a-special-case"></a>Varför är överföring ett specialfall?
...
## <a name="transfers-are-dependent-demand"></a><a name="transfers-are-dependent-demand"></a>Överföringar är härledd efterfrågan
...
## <a name="planning-sequence"></a><a name="planning-sequence"></a>Planera sekvens
...
## <a name="transfer-level-code"></a><a name="transfer-level-code"></a>Överföringsnivåkod
...
## <a name="planning-transfers-without-sku"></a><a name="planning-transfers-without-sku"></a>Planera överföringar utan lagerställeenhet
...
## <a name="changing-quantity-with-reservations"></a><a name="changing-quantity-with-reservations"></a>Ändra antal med reservationer
...
## <a name="changing-quantity-in-a-transfer-chain"></a><a name="changing-quantity-in-a-transfer-chain"></a>Ändra antal i en överföringskedja
...
## <a name="lead-time-calculation"></a><a name="lead-time-calculation"></a>Ledtidsberäkning
...
## <a name="safety-lead-time"></a><a name="safety-lead-time"></a>Säkerhetsledtid
...
## <a name="reschedule"></a><a name="reschedule"></a>Omplanera
...
## <a name="serial-and-lot-numbers-in-transfer-chains"></a><a name="serial-and-lot-numbers-in-transfer-chains"></a>Serie- och partinummer i överföringskedjor
