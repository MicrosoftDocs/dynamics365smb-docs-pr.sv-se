...
ms.author: bholtorf
---
# <a name="use-the-same-microsoft-365-account-in--and-microsoft-invoicing"></a><a name="use-the-same-microsoft-365-account-in--and-microsoft-invoicing"></a><a name="use-the-same-microsoft-365-account-in--and-microsoft-invoicing"></a>Använda samma Microsoft 365-konto i [!INCLUDE[prod_short](includes/prod_long.md)] och Microsoft Invoicing
...
## <a name="workaround"></a><a name="workaround"></a><a name="workaround"></a>Lösning
...
### <a name="to-rename-your-company"></a><a name="to-rename-your-company"></a><a name="to-rename-your-company"></a>Byta namn på ditt företag
...
### <a name="what-about-my-data"></a><a name="what-about-my-data"></a><a name="what-about-my-data"></a>Om mina data
