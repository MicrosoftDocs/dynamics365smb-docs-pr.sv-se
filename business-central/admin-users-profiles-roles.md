...
ms.search.form: 9171
---
# <a name="manage-user-profiles"></a><a name="manage-user-profiles"></a><a name="manage-user-profiles"></a>Hantera användarprofiler
...
## <a name="page-customization"></a><a name="page-customization"></a><a name="page-customization"></a>Sidanpassning
...
## <a name="to-create-a-profile"></a><a name="to-create-a-profile"></a><a name="to-create-a-profile"></a>Så här skapar du en profil:
...
## <a name="to-copy-a-profile"></a><a name="to-copy-a-profile"></a><a name="to-copy-a-profile"></a>Så här kopierar du en profil
...
## <a name="to-edit-a-profile"></a><a name="to-edit-a-profile"></a><a name="to-edit-a-profile"></a>Så här redigerar du en profil
...
## <a name="to-assign-a-profile-to-a-user"></a><a name="to-assign-a-profile-to-a-user"></a><a name="to-assign-a-profile-to-a-user"></a>Så här tilldelar du en profil till en användare:
...
## <a name="to-define-user-settings-for-a-profile"></a><a name="to-define-user-settings-for-a-profile"></a><a name="to-define-user-settings-for-a-profile"></a>Så här definierar du användarinställningar för en profil
...
## <a name="to-activate-a-profile"></a><a name="to-activate-a-profile"></a><a name="to-activate-a-profile"></a>Så här aktiverar du en profil
...
## <a name="to-export-profiles"></a><a name="to-export-profiles"></a><a name="to-export-profiles"></a>För att exportera profiler
...
## <a name="to-import-profiles"></a><a name="to-import-profiles"></a><a name="to-import-profiles"></a>För att importera profiler
...
## <a name="to-delete-a-profile"></a><a name="to-delete-a-profile"></a><a name="to-delete-a-profile"></a>Så här tar du bort en profil
...
## <a name="to-delete-all-personalizations-made-by-a-user"></a><a name="to-delete-all-personalizations-made-by-a-user"></a><a name="to-delete-all-personalizations-made-by-a-user"></a>Ta bort alla anpassningar som användaren har gjort
...
## <a name="to-delete-personalizations-for-specific-pages"></a><a name="to-delete-personalizations-for-specific-pages"></a><a name="to-delete-personalizations-for-specific-pages"></a>Så här tar du bort anpassningar för specifika sidor
...
## <a name="managing-user-sessions"></a><a name="managing-user-sessions"></a><a name="managing-user-sessions"></a>Hantera användarsessioner
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relaterad [Microsoft utbildning](/training/modules/users-security-dynamics-365-business-central/)
