...
ms.author: jswymer
---
# <a name="enabling-power-bi-integration-with-"></a><a name="enabling-power-bi-integration-with-"></a><a name="enabling-power-bi-integration-with-"></a>Aktivera Power BI-integrering med [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="power-bi-licensing"></a><a name="power-bi-licensing"></a><a name="power-bi-licensing"></a><a name="license"></a>Power BI-licenser
...
## <a name="expose-data-through-api-or-odata-web-services"></a><a name="expose-data-through-api-or-odata-web-services"></a><a name="expose-data-through-api-or-odata-web-services"></a><a name="exposedata"></a>Visa data via API eller OData-webbtjänster
...
### <a name="api-pages-and-queries"></a><a name="api-pages-and-queries"></a><a name="api-pages-and-queries"></a>API-sidor och frågor
...
### <a name="odata-web-services"></a><a name="odata-web-services"></a><a name="odata-web-services"></a>OData-webbtjänst
...
### <a name="choosing-whether-to-use-api-pages-or-odata-web-services"></a><a name="choosing-whether-to-use-api-pages-or-odata-web-services"></a><a name="choosing-whether-to-use-api-pages-or-odata-web-services"></a>Välja om API-sidor eller OData-webbtjänster ska användas
...
## <a name="set-up--on-premises-for-power-bi-integration"></a><a name="set-up--on-premises-for-power-bi-integration"></a><a name="set-up--on-premises-for-power-bi-integration"></a><a name="setup"></a>Konfigurera [!INCLUDE[prod_short](includes/prod_short.md)] lokalt för Power BI-integrering
