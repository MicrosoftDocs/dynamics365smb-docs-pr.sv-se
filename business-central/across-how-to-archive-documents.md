...
ms.author: bholtorf
---
# <a name="archive-documents"></a><a name="archive-documents"></a><a name="archive-documents"></a>Arkivera dokument
...
## <a name="to-set-up-automatic-document-archiving"></a><a name="to-set-up-automatic-document-archiving"></a><a name="to-set-up-automatic-document-archiving"></a>Så här ställer du in automatisk dokumentarkivering
...
## <a name="to-manually-archive-a-sales-order"></a><a name="to-manually-archive-a-sales-order"></a><a name="to-manually-archive-a-sales-order"></a>För att arkivera en försäljningsorder
...
## <a name="to-restore-a-non-posted-sales-order-from-the-archive"></a><a name="to-restore-a-non-posted-sales-order-from-the-archive"></a><a name="to-restore-a-non-posted-sales-order-from-the-archive"></a>Så här återställer du en icke-bokförd försäljningsorder från arkivet
...
## <a name="to-delete-archived-sales-orders"></a><a name="to-delete-archived-sales-orders"></a><a name="to-delete-archived-sales-orders"></a>Ta bort arkiverade förs.orderversioner
