...
ms.author: bholtorf
---
# <a name="pick-for-production-assembly-or-jobs-in-advanced-warehouse-configurations" />Plocka för produktion, montering eller jobb i avancerade distributionslagerkonfigurationer
...
## <a name="to-pick-items-for-a-productions-order-assembly-order-job" />Så här plockar du artiklar för en produktionorder, monteringsorder, projekt
...
## <a name="flushing-production-components-in-a-advanced-warehouse-configuration" />Bokföring av produktionskomponenter i en avancerad distributionslagerkonfiguration
