...
7. Välj åtgärden **Skapa plockning**. Sidan **Skapa plockning** öppnas, där du kan lägga till mer information till valet.  
    ...
    |Max. Antal plock.källdok.|Skapar plockningsdokument som inte täcker antalet källdokument som ställts in.|
...
## <a name="flushing-production-components-in-a-advanced-warehouse-configuration"></a>Bokföring av produktionskomponenter i en avancerad distributionslagerkonfiguration
