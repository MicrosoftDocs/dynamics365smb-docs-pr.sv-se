...
# <a name="need-more-time-to-decide-whether-to-subscribe"></a><a name="need-more-time-to-decide-whether-to-subscribe"></a><a name="need-more-time-to-decide-whether-to-subscribe"></a>Behöver du mer tid för att bestämma om du ska prenumerera?
...
## <a name="to-extend-your-trial-period"></a><a name="to-extend-your-trial-period"></a><a name="to-extend-your-trial-period"></a>Så här utökar du utvärderingsperioden
...
## <a name="what-happens-if-my-trial-period-is-expired"></a><a name="what-happens-if-my-trial-period-is-expired"></a><a name="what-happens-if-my-trial-period-is-expired"></a>Vad händer om min utvärderingsperiod är slut?
