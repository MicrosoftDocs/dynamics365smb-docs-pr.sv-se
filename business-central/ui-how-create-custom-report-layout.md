...
ms.author: edupont
---
# <a name="legacy-create-and-modify-custom-report-layouts" />(Äldre) Skapa och ändra anpassade rapportlayouter
...
## <a name="create-a-custom-layout" />Skapa en anpassad layout
...
## <a name="a-namemodifycustomlayoutamodifying-a-custom-layout" /><a name="ModifyCustomLayout"></a>Ändra en anpassad layout
...
### <a name="modify-a-custom-layout" />Ändra en anpassad layout
