...
ms.author: jswymer
---
# <a name="managing-onedrive-integration-with-business-central" />Hantera OneDrive-integrering med Business Central
...
## <a name="configure-onedrive-for-integration-with-business-central" />Konfigurera OneDrive för integrering med Business Central
...
### <a name="managing-privacy" />Hantera sekretess
...
## <a name="configure-business-central" />Konfigurera Business Central
...
### <a name="about-multiple-environments" />Om flera miljöer
...
### <a name="configure-onedrive-using-onedrive-setup" />Konfigurera OneDrive med OneDrive-konfiguration
...
### <a name="switching-to-new-onedrive-integration-after-upgrade" />Växla till ny OneDrive-integration efter uppgradering
