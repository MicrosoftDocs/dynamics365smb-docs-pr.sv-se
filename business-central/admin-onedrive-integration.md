...
ms.author: jswymer
---
# <a name="managing-onedrive-integration-with-business-central"></a><a name="managing-onedrive-integration-with-business-central"></a>Hantera OneDrive-integrering med Business Central
...
## <a name="configure-onedrive-for-integration-with-business-central"></a><a name="configure-onedrive-for-integration-with-business-central"></a>Konfigurera OneDrive för integrering med Business Central
...
### <a name="managing-privacy"></a><a name="managing-privacy"></a>Hantera sekretess
...
## <a name="configure-business-central"></a><a name="configure-business-central"></a>Konfigurera Business Central
...
### <a name="about-multiple-environments"></a><a name="about-multiple-environments"></a>Om flera miljöer
...
### <a name="configure-onedrive-using-onedrive-setup"></a><a name="configure-onedrive-using-onedrive-setup"></a>Konfigurera OneDrive med OneDrive-konfiguration
...
### <a name="switching-to-new-onedrive-integration-after-upgrade"></a><a name="switching-to-new-onedrive-integration-after-upgrade"></a>Växla till ny OneDrive-integration efter uppgradering
...
## <a name="restoring-onedrive-and-"></a><a name="restoring-onedrive-and-"></a>Återställa OneDrive och [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="governance"></a><a name="governance"></a>Styrelse
