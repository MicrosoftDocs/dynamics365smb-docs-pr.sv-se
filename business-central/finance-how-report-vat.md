...
# <a name="report-vat-to-tax-authorities" />Rapportera moms till skattemyndigheterna
...
### <a name="submit-an-ec-sales-list-report" />Skicka in en rapport med EU-försäljningslista
...
## <a name="to-connect-to-your-tax-authoritys-web-service" />Ansluta till webbtjänsten för lokal skattemyndighet
...
### <a name="to-set-up-vat-return-periods" />Så här ställer du in momsreturperioder
...
## <a name="to-prepare-and-submit-a-vat-report" />Förbereda och skicka en momsrapport
...
### <a name="vat-return-statuses" />Momsreturstatus
...
## <a name="viewing-communications-with-your-tax-authority" />Visa kommunikationen med skattemyndigheten.
...
## <a name="submitting-vat-reports-manually" />Skicka momsrapporter manuellt
...
## <a name="vat-settlement" />Momsavräkning
...
## <a name="configuring-your-own-vat-reports" />Skapa egna momsrapporter.
