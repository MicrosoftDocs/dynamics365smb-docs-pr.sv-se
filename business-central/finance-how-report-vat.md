...
## <a name="ecsaleslist"></a>Om rapporten med EU-försäljningslista
...
### Skicka in en rapport med EU-försäljningslista

[!INCLUDE [finance-ecsaleslist](includes/finance-ecsaleslist.md)]

## <a name="vatreturn"></a>Om rapporten Momsretur
...
## Så här ställer du in momsrapporter i [!INCLUDE[prod_short](includes/prod_short.md)]

[!INCLUDE [vat-report-setup](includes/vat-report-setup.md)]

### Så här ställer du in momsreturperioder
