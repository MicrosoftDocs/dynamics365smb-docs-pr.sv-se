...
description: Beskriver hur du använder företagets SMTP-server för att skicka och ta emot e-postmeddelanden inom Business Central, alternativt hur du använder e-postserverinställningarna som skapats med Microsoft 365-prenumerationen.
author: SorenGP
...
I stället för att ange information för SMTP-server manuellt kan du använda funktionen **Använd Microsoft 365-serverinställningar** för att mata in information från din Microsoft 365-prenumeration.
...
2. Fyll i fälten om det behövs. [!INCLUDE[tooltip-inline-tip](includes/tooltip-inline-tip_md.md)]
    ...
    > [!NOTE]
    > Om du använder ett konto som kräver tvåfaktorautentisering måste lösenordet som du anger i fältet **Lösenord** vara samma som du använder för Microsoft 365-prenumerationen och det måste vara av typen **applösenord**. Mer information finns i [hantera applösenord för tvåstegsverifiering](/azure/active-directory/user-help/multi-factor-authentication-end-user-app-passwords).
3. Du kan också välja åtgärden **Använd Microsoft 365-serverinställningar** för att infoga information som redan har definierats för din Microsoft 365-prenumeration.
