...
# <a name="set-up-email"></a><a name="set-up-email"></a>Konfigurera e-post
...
## <a name="adding-email-accounts"></a><a name="adding-email-accounts"></a>Lägga till e-postkonton
...
## <a name="using-smtp"></a><a name="using-smtp"></a>Använda SMTP
...
## <a name="add-email-accounts"></a><a name="add-email-accounts"></a>Lägg till e-postkonton
...
is this still true?-->
## <a name="assign-email-scenarios-to-email-accounts"></a><a name="assign-email-scenarios-to-email-accounts"></a>Tilldela e-postscenarier till e-postkonton
...
## <a name="set-up-view-policies"></a><a name="set-up-view-policies"></a>Konfigurera visningspolicyer
...
## <a name="specify-how-many-messages-an-account-can-send-per-minute"></a><a name="specify-how-many-messages-an-account-can-send-per-minute"></a>Ange hur många meddelanden ett konto får skicka per minut
...
## <a name="set-up-reusable-email-texts-and-layouts"></a><a name="set-up-reusable-email-texts-and-layouts"></a>Konfigurera återanvändbara texter och layouter för e-post
...
## <a name="use-a-substitute-sender-address-on-outbound-email-messages"></a><a name="use-a-substitute-sender-address-on-outbound-email-messages"></a>Använda en adress för ersättningsavsändare för avgående e-postmeddelanden
...
## <a name="set-up-document-sending-profiles"></a><a name="set-up-document-sending-profiles"></a>Konfigurera dokumentutskicksprofiler
...
## <a name="optional-set-up-email-logging-in-exchange-online"></a><a name="optional-set-up-email-logging-in-exchange-online"></a>Tillval: Konfigurera e-postloggning i Exchange Online
...
## <a name="setting-up-email-for-business-central-on-premises"></a><a name="setting-up-email-for-business-central-on-premises"></a>Konfigurera e-post för Business Central lokalt
...
### <a name="create-an-app-registration-for-business-central-in-azure-portal"></a><a name="create-an-app-registration-for-business-central-in-azure-portal"></a>Skapa en programregistrering för Business Central i Azure-portalen
...
### <a name="connect--to-your-app-registration"></a><a name="connect--to-your-app-registration"></a>Anslut [!INCLUDE[prod_short](includes/prod_short.md)] till din app-registrering
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relaterad [Microsoft utbildning](/training/modules/set-up-email/)
