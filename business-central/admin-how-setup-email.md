...
# <a name="set-up-email" />Konfigurera e-post
...
## <a name="adding-email-accounts" />Lägga till e-postkonton
...
## <a name="using-smtp" />Använda SMTP
...
## <a name="add-email-accounts" />Lägg till e-postkonton
...
is this still true?-->
## <a name="assign-email-scenarios-to-email-accounts" />Tilldela e-postscenarier till e-postkonton
...
## <a name="set-up-view-policies" />Konfigurera visningspolicyer
...
## <a name="specify-how-many-messages-an-account-can-send-per-minute" />Ange hur många meddelanden ett konto får skicka per minut
...
## <a name="set-up-reusable-email-texts-and-layouts" />Konfigurera återanvändbara texter och layouter för e-post
...
## <a name="use-a-substitute-sender-address-on-outbound-email-messages" />Använda en adress för ersättningsavsändare för avgående e-postmeddelanden
...
## <a name="set-up-document-sending-profiles" />Konfigurera dokumentutskicksprofiler
...
## <a name="optional-set-up-email-logging-in-exchange-online" />Tillval: Konfigurera e-postloggning i Exchange Online
...
## <a name="setting-up-email-for-business-central-on-premises" />Konfigurera e-post för Business Central lokalt
...
### <a name="create-an-app-registration-for-business-central-in-azure-portal" />Skapa en programregistrering för Business Central i Azure-portalen
