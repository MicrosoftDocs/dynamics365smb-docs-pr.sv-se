...
---
# <a name="switching-to-another-company-or-environment"></a><a name="switching-to-another-company-or-environment"></a>Byta till ett annat företag eller annan miljö
...
## <a name="about-companies-and-environments"></a><a name="about-companies-and-environments"></a>Om företag och miljöer
...
## <a name="features-for-switching-company-or-environment"></a><a name="features-for-switching-company-or-environment"></a>Funktioner för att byta företag eller miljö
...
## <a name="use-the-company-switcher"></a><a name="use-the-company-switcher"></a>Använd företagsväxlaren
...
## <a name="use-the-app-launcher"></a><a name="use-the-app-launcher"></a>Använd appstartaren
...
-->
## <a name="use-my-settings"></a><a name="use-my-settings"></a>Använd Mina inställningar
...
## <a name="use-company-hub"></a><a name="use-company-hub"></a>Använd företagsnav
