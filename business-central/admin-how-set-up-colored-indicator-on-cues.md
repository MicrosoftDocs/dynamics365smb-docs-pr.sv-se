...
ms.author: jswymer
---
# <a name="set-up-a-colored-indicator-on-cues-for-the-company-or-individual-users" />Skapa en färglagd indikator på stack-ikoner för företaget eller enskilda användare
...
### <a name="to-set-up-colored-indicators-on-cues" />Så här ställer du in kulörta indikatorer på stack-ikoner
