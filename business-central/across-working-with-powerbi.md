...
ms.author: jswymer
---
# <a name="work-with-power-bi-reports-in-"></a><a name="work-with-power-bi-reports-in-"></a><a name="work-with-power-bi-reports-in-"></a>Arbeta med Power BI-rapporter i [!INCLUDE [prod_short](includes/prod_short.md)]
...
### <a name="sign-up-power-bi"></a><a name="sign-up-power-bi"></a><a name="sign-up-power-bi"></a>Registrera dig för Power BI
...
## <a name="connect-to-power-bi---one-time-only"></a><a name="connect-to-power-bi---one-time-only"></a><a name="connect-to-power-bi---one-time-only"></a><a name="connect"></a>Anslut till Power BI – endast en gång
...
#### <a name="from--on-premises"></a><a name="from--on-premises"></a><a name="from--on-premises"></a>Från [!INCLUDE [prod_short](includes/prod_short.md)] lokalt
...
## <a name="work-with-power-bi-reports"></a><a name="work-with-power-bi-reports"></a><a name="work-with-power-bi-reports"></a>Arbeta med Power BI-rapporter

### <a name="show-reports-on-list-pages"></a><a name="show-reports-on-list-pages"></a><a name="show-reports-on-list-pages"></a>Visa rapporter på listsidor
...
### <a name="switch-reports"></a><a name="switch-reports"></a><a name="switch-reports"></a>Växla rapporter
...
### <a name="get-more-reports"></a><a name="get-more-reports"></a><a name="get-more-reports"></a>Få fler rapporter
...
### <a name="manage-and-modify-reports"></a><a name="manage-and-modify-reports"></a><a name="manage-and-modify-reports"></a>Hantera och ändra rapporter
...
### <a name="upload-reports"></a><a name="upload-reports"></a><a name="upload-reports"></a><a name="upload"></a>Ladda upp rapporter
...
### <a name="message-there-are-no-enabled-reports-choose-select-report-to-see-a-list-of-reports-that-you-can-display"></a><a name="message-there-are-no-enabled-reports-choose-select-report-to-see-a-list-of-reports-that-you-can-display"></a><a name="message-there-are-no-enabled-reports-choose-select-report-to-see-a-list-of-reports-that-you-can-display"></a>Meddelande: Det finns inga aktiverade rapporter. markera Välj rapport för att visa en lista över rapporter som kan visas.
...
#### <a name="you-cant-see-a-report-on-the-select-report-page-on-a-list-page"></a><a name="you-cant-see-a-report-on-the-select-report-page-on-a-list-page"></a><a name="you-cant-see-a-report-on-the-select-report-page-on-a-list-page"></a>Du kan inte se en rapport på sidan Välj rapport på en listsida
