...
ms.author: jswymer
---
# <a name="work-with-power-bi-reports-in-include-prodshortincludesprodshortmd" />Arbeta med Power BI-rapporter i [!INCLUDE [prod_short](includes/prod_short.md)]
...
### <a name="sign-up-power-bi" />Registrera dig för Power BI
...
## <a name="a-nameconnectaconnect-to-power-bi---one-time-only" /><a name="connect"></a>Anslut till Power BI – endast en gång
...
#### <a name="from-include-prodshortincludesprodshortmd-on-premises" />Från [!INCLUDE [prod_short](includes/prod_short.md)] lokalt
...
## <a name="work-with-power-bi-reports" />Arbeta med Power BI-rapporter

### <a name="show-reports-on-list-pages" />Visa rapporter på listsidor
...
### <a name="switch-reports" />Växla rapporter
...
### <a name="get-more-reports" />Få fler rapporter
...
### <a name="manage-and-modify-reports" />Hantera och ändra rapporter
...
### <a name="a-nameuploadaupload-reports" /><a name="upload"></a>Ladda upp rapporter
...
### <a name="message-there-are-no-enabled-reports-choose-select-report-to-see-a-list-of-reports-that-you-can-display" />Meddelande: Det finns inga aktiverade rapporter. markera Välj rapport för att visa en lista över rapporter som kan visas.
...
#### <a name="you-cant-see-a-report-on-the-select-report-page-on-a-list-page" />Du kan inte se en rapport på sidan Välj rapport på en listsida
