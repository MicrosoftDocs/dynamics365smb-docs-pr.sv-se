...
ms.author: edupont
---
# <a name="create-analysis-reports"></a><a name="create-analysis-reports"></a>Skapa analysrapporter
...
## <a name="setting-up-line-and-column-layouts"></a><a name="setting-up-line-and-column-layouts"></a>Lägga upp rad- och kolumnlayouter
...
## <a name="set-up-analysis-column-templates"></a><a name="set-up-analysis-column-templates"></a>Skapa analyskolumnmallar
...
## <a name="set-up-analysis-line-templates"></a><a name="set-up-analysis-line-templates"></a>Skapa analysradmallar
...
## <a name="create-a-new-sales-analysis-report"></a><a name="create-a-new-sales-analysis-report"></a>Skapa en ny försäljningsanalysrapport
