...
ms.author: bholtorf
---
# <a name="block-vendors"></a><a name="block-vendors"></a><a name="block-vendors"></a>Spärrade leverantörer
...
## <a name="to-block-a-vendor"></a><a name="to-block-a-vendor"></a><a name="to-block-a-vendor"></a>Om du vill spärra en leverantör
