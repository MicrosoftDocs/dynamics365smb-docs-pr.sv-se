...
> [!NOTE]
> Förutom vad som administratörer kan anpassa kan användare anpassa sina sidor genom att lägga till, flytta, eller ta bort fält, låsa rutor och delar. Mer information finns i [Anpassa arbetsytan](ui-personalization-user.md).
...
|Hantera användares anpassningar.|Kontrollera och hantera användares anpassning genom att inaktivera möjligheten att anpassa sidor och ta bort alla anpassningar på sidan.|Alla användare i ett visst företag.|[Hantera anpassning som administratör](ui-personalization-manage.md)|
