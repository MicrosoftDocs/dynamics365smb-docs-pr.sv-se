...
ms.author: edupont
---
# <a name="register-new-items"></a><a name="register-new-items"></a><a name="register-new-items"></a>Registrera nya artiklar
...
## <a name="to-create-a-new-item-card"></a><a name="to-create-a-new-item-card"></a><a name="to-create-a-new-item-card"></a>Skapa ett nytt artikelkort
...
### <a name="to-save-the-item-card-as-a-template"></a><a name="to-save-the-item-card-as-a-template"></a><a name="to-save-the-item-card-as-a-template"></a>Om du vill spara artikelkortet som en mall
...
### <a name="items-used-in-production-orders"></a><a name="items-used-in-production-orders"></a><a name="items-used-in-production-orders"></a>Artiklar som används i produktionsorder
...
## <a name="to-set-up-multiple-vendors-for-an-item"></a><a name="to-set-up-multiple-vendors-for-an-item"></a><a name="to-set-up-multiple-vendors-for-an-item"></a>Så här lägger du upp flera leverantörer för artiklar
...
## <a name="set-up-item-substitutions"></a><a name="set-up-item-substitutions"></a><a name="set-up-item-substitutions"></a>Ställa in artikelersättningar
...
### <a name="to-make-an-item-substitution"></a><a name="to-make-an-item-substitution"></a><a name="to-make-an-item-substitution"></a>Så här gör du en artikelersättning
...
## <a name="categories-attributes-and-variants"></a><a name="categories-attributes-and-variants"></a><a name="categories-attributes-and-variants"></a>Kategorier, attribut och varianter

[!INCLUDE[inventory_variant](includes/inventory_variant.md)]

Läs mer om varianter på [Hantera produktvarianter](inventory-item-variants.md).  

## <a name="deleting-item-cards"></a><a name="deleting-item-cards"></a><a name="deleting-item-cards"></a>Ta bort artikelkort
...
## <a name="manage-inventory-in-warehouses"></a><a name="manage-inventory-in-warehouses"></a><a name="manage-inventory-in-warehouses"></a>Hantera lager i distributionslager
