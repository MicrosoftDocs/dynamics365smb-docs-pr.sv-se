...
Artiklar, bland andra produkter, är grunden för ditt företag, de varor eller tjänster som du handlar med. Varje artiklar måste registreras som ett artikelkort.
...
3. Om du vill återanvända dimensioner i mallar väljer du Relaterad **åtgärd**, Artikel **och sedan** Dimensioner **·**.  **Standarddimensionerna** för den valda artikeln öppnas och alla dimensionskoder som har ställts in för artikeln visas.
...
4.  **Välj Nr.** Och Välj sedan den leverantör som du vill ställa in för artikeln.  
...
1. Välj den ![Glödlampa som öppnar funktionen Berätta.](media/ui-search/search_small.png "Berätta för mig vad du vill göra") och ange **Artiklar** och välj sedan relaterad länk.  
2. Hitta relevant artikel och välj sedan Nr **.** För att öppna kort.  
...
[Lägga upp måttenheter](inventory-how-setup-units-of-measure.md)    
[Hantera produktvarianter](inventory-item-variants.md)    
[Ställa in intrastatrapportering](finance-how-setup-report-intrastat.md#other-intrastat-configurations)    
...
[Metodtips för inställningar: Planeringsparametrar](setup-best-practices-planning-parameters.md)    
[Metodtips för inställningar: Leveransplanering](setup-best-practices-supply-planning.md)    
[Designdetaljer: Centrala begrepp i planeringssystemet](design-details-central-concepts-of-the-planning-system.md)    
[Designdetaljer: Balansera tillgång och efterfrågan](design-details-balancing-demand-and-supply.md)    
