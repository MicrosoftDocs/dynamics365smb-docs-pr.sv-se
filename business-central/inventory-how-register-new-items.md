...
ms.author: edupont
---
# <a name="register-new-items" />Registrera nya artiklar
...
## <a name="to-create-a-new-item-card" />Skapa ett nytt artikelkort
...
### <a name="to-save-the-item-card-as-a-template" />Om du vill spara artikelkortet som en mall
...
### <a name="items-used-in-production-orders" />Artiklar som används i produktionsorder
...
## <a name="to-set-up-multiple-vendors-for-an-item" />Så här lägger du upp flera leverantörer för artiklar
...
## <a name="set-up-item-substitutions" />Ställa in artikelersättningar
...
### <a name="to-make-an-item-substitution" />Så här gör du en artikelersättning
...
## <a name="deleting-item-cards" />Ta bort artikelkort
...
## <a name="manage-inventory-in-warehouses" />Hantera lager i distributionslager
