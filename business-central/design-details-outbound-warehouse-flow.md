...
---
# <a name="outbound-warehouse-processes"></a><a name="outbound-warehouse-processes"></a>Processer för avgående distributionslager
...
### <a name="1-release-a-source-document"></a><a name="1-release-a-source-document"></a>1: Släpp källdokument
...
### <a name="2-create-an-inventory-pick"></a><a name="2-create-an-inventory-pick"></a>2. Skapa lagerplockning
...
### <a name="3-post-an-inventory-pick"></a><a name="3-post-an-inventory-pick"></a>3. Bokföra lagerplockning
...
### <a name="1-release-a-source-document-1"></a><a name="1-release-a-source-document-1"></a>1: Släpp källdokument
...
### <a name="2-create-a-warehouse-shipment"></a><a name="2-create-a-warehouse-shipment"></a>2. Skapa en distributionslagerutleverans
...
### <a name="3-create-a-warehouse-pick"></a><a name="3-create-a-warehouse-pick"></a>3: Skapa distributionslagerplockning
...
### <a name="4-register-a-warehouse-pick"></a><a name="4-register-a-warehouse-pick"></a>4: Registrera dist.lagerplockning
...
### <a name="5-post-the-warehouse-shipment"></a><a name="5-post-the-warehouse-shipment"></a>5: Bokför dist.lager utleverans
