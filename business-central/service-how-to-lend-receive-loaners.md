...
ms.author: bholtorf
---
# <a name="lend-and-receive-loaners"></a><a name="lend-and-receive-loaners"></a><a name="lend-and-receive-loaners"></a>Låna ut och ta emot låneartiklar
Du kan låna ut kundlåneartiklar för att tillfälligt ersätta serviceartiklar som du har tagit emot för service.  
  
## <a name="to-lend-a-loaner-item"></a><a name="to-lend-a-loaner-item"></a><a name="to-lend-a-loaner-item"></a>Så här lånar du ut låneartiklar
...
## <a name="to-receive-a-loaner"></a><a name="to-receive-a-loaner"></a><a name="to-receive-a-loaner"></a>Så här tar du emot låneartiklar
...
## <a name="to-register-loaner-comments"></a><a name="to-register-loaner-comments"></a><a name="to-register-loaner-comments"></a>Så här registrerar du lånekommentarer
