...
ms.author: bholtorf
---
# <a name="lend-and-receive-loaners" />Låna ut och ta emot låneartiklar
Du kan låna ut kundlåneartiklar för att tillfälligt ersätta serviceartiklar som du har tagit emot för service.  
  
## <a name="to-lend-a-loaner-item" />Så här lånar du ut låneartiklar
...
## <a name="to-receive-a-loaner" />Så här tar du emot låneartiklar
...
## <a name="to-register-loaner-comments" />Så här registrerar du lånekommentarer
