...
ms.author: edupont
---
# <a name="set-up-multiple-interest-rates-for-delayed-payment" />Ställa in flera räntesatser för fördröjd betalning
...
## <a name="to-set-up-multiple-interest-rates" />Så här ställer du in flera räntesatser
