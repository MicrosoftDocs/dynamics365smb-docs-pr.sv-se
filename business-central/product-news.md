...
ms.locfileid: "5388441"
---
# <a name="new-and-planned-for-dynamics-365-business-central"></a>Nytt och planerat för Dynamics 365 Business Central

[!INCLUDE[release notes](includes/release-notes.md)]

Du kan alltid hänvisa till viktig information om du vill ha en översikt över nya och kommande funktioner. I dokumentationen kan du sedan söka efter avsnitt som du kan använda för att lära dig mer om nya och befintliga funktioner i [!INCLUDE[prod_long](includes/prod_long.md)]. 
