...
# <a name="move-items-in-advanced-warehouse-configurations-that-use-directed-put-away-and-pick"></a>Flytta artiklar i avancerad distributionslagerkonfigurationer med dirigerad plockning och artikelinförsel
...
## <a name="warehouse-movement-worksheet"></a>Kalkylark för dist.lager transport
...
## <a name="internal-pick"></a>Intern plockning
...
### <a name="to-register-the-warehouse-pick"></a>Så här registrerar du dist.lager plockning
...
## <a name="internal-put-away"></a>Intern artikelinförsel
...
### <a name="to-register-the-warehouse-put-away"></a>Fortsätt med att registrera artikelinförsel för distributionslager
...
3. Om det krävs anger du ditt användar-ID när du börjar arbeta med artikelinförsel.  
  ...
  > [!NOTE]  
  > Raderna sorteras i stigande ordning efter det valda kriteriet. Om du sorterar efter dokument görs sorteringen först efter dokumenttyp baserat på uppräkningen **Källdokument för distributionslageraktivitet**. Om du sorterar efter leverans görs sorteringen efter destinationstyp baserat på fältet **Destinationstyp för distributionslager**.
...
## <a name="to-register-a-movement-that-has-already-happened"></a>Så här registrerar du en transport som redan har hänt
