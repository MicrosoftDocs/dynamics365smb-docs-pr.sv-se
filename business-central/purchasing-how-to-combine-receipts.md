...
ms.author: edupont
---
# <a name="combine-receipts-on-a-single-invoice" />Kombinera inleveranser på en enda faktura
...
## <a name="to-combine-receipts" />Så här kombinerar du inleveranser:
...
## <a name="to-remove-open-purchase-orders-after-combined-receipt-posting" />Så här tar du bort öppna inköpsorder efter kombinerad inleveransbokföring
