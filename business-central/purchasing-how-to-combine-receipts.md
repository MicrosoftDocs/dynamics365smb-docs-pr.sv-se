...
ms.author: edupont
---
# <a name="combine-receipts-on-a-single-invoice"></a><a name="combine-receipts-on-a-single-invoice"></a>Kombinera inleveranser på en enda faktura
...
## <a name="to-combine-receipts"></a><a name="to-combine-receipts"></a>Så här kombinerar du inleveranser:
...
## <a name="to-remove-open-purchase-orders-after-combined-receipt-posting"></a><a name="to-remove-open-purchase-orders-after-combined-receipt-posting"></a>Så här tar du bort öppna inköpsorder efter kombinerad inleveransbokföring
