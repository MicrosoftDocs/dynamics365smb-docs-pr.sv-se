---
title: Skapa produktionsstrukturlistor
...
[!INCLUDE[prod_short](includes/prod_short.md)] stödjer även monteringsstrukturer. Använda sammansättningsorder för att skapa slutartiklar av komponenter i en process som en eller flera grundläggande resurser, som inte är maskin- eller produktionsgrupper, kan utföra. Eller en process som kan slutföras utan resurser. Det kan exempelvis vara en monteringsprocess att välja två som vinflaska och en kaffesäck och sedan packa dem som presentartiklar. Mer information finns i [Monteringsstrukturer eller produktionsstrukturer](inventory-how-work-boms.md#assembly-boms-or-production-boms).  
...
Relationen i en enskild komponent definieras av en beräkningsformel. Följande alternativ kan ingå i beräkningsformeln:  
