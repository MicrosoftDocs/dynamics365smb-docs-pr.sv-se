...
ms.author: bholtorf
---
# <a name="create-production-boms"></a><a name="create-production-boms"></a>Skapa produktionsstrukturer
...
## <a name="to-create-a-production-bom"></a><a name="to-create-a-production-bom"></a>Skapa en ny produktionsstruktur.
...
## <a name="to-create-a-new-version-of-a-production-bom"></a><a name="to-create-a-new-version-of-a-production-bom"></a>Så här skapar du nya versioner av produktionsstrukturer
...
## <a name="quantity-calculation-formula-on-production-boms"></a><a name="quantity-calculation-formula-on-production-boms"></a>Antal beräkningsformel på produktionsstrukturer
