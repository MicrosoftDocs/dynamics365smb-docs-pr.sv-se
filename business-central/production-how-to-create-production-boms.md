...
ms.author: bholtorf
---
# <a name="create-production-boms" />Skapa produktionsstrukturer
...
## <a name="to-create-a-production-bom" />Skapa en ny produktionsstruktur.
...
## <a name="to-create-a-new-version-of-a-production-bom" />Så här skapar du nya versioner av produktionsstrukturer
...
## <a name="quantity-calculation-formula-on-production-boms" />Antal beräkningsformel på produktionsstrukturer
