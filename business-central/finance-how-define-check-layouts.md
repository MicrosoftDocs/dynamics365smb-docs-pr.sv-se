...
ms.author: edupont
---
# <a name="select-a-check-layout" />Välj en checklayout
...
## <a name="to-select-a-check-layout" />Välj en checklayout genom att
...
## <a name="use-micr-and-security-fonts" />Använda MICR och säkerhetsteckensnitt
...
### <a name="secure-font-specifications" />Specifikationer för säkra teckensnitt
