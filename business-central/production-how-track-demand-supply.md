...
ms.author: edupont
---
# <a name="track-relations-between-demand-and-supply" />Spåra relationer mellan tillgång och efterfrågan
...
## <a name="to-track-linked-items" />Så här spårar du länkade artiklar
...
## <a name="untracked-planning-elements" />Ej spårade planeringselement
