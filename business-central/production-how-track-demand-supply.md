...
ms.author: edupont
---
# <a name="track-relations-between-demand-and-supply"></a><a name="track-relations-between-demand-and-supply"></a><a name="track-relations-between-demand-and-supply"></a>Spåra relationer mellan tillgång och efterfrågan
...
## <a name="to-track-linked-items"></a><a name="to-track-linked-items"></a><a name="to-track-linked-items"></a>Så här spårar du länkade artiklar
...
## <a name="untracked-planning-elements"></a><a name="untracked-planning-elements"></a><a name="untracked-planning-elements"></a>Ej spårade planeringselement
