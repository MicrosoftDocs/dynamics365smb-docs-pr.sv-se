...
ms.author: edupont
---
# <a name="track-document-lines" />Spåra dokumentrader
...
## <a name="to-track-documents-related-to-a-sales-order-line" />Spåra dokument som är kopplade till en försäljningsorderrad
