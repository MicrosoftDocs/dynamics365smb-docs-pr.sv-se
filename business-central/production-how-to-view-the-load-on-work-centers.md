...
ms.author: edupont
---
# <a name="view-load-on-work-and-machine-centers"></a><a name="view-load-on-work-and-machine-centers"></a>Så här visar du beläggning på produktions- och maskingrupper
...
## <a name="to-view-the-load-on-work-centers"></a><a name="to-view-the-load-on-work-centers"></a>Så här visar du produktionsgruppsbeläggningen
