...
ms.author: jswymer
---
# <a name="viewing-database-locks"></a><a name="viewing-database-locks"></a><a name="viewing-database-locks"></a>Visa databaslås
...
## <a name="to-view-database-locks"></a><a name="to-view-database-locks"></a><a name="to-view-database-locks"></a>För att visa databaslås
