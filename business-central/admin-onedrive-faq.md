...
description: Få svar på några vanliga frågor om att arbeta med OneDrive för arbete och skola (tidigare kallat OneDrive för företag) och Business Central.
author: brentholtorf
...
---
# Vanliga frågor och svar om OneDrive för företag
...
## Fungerar detta hos alla [!INCLUDE[prod_short](includes/prod_short.md)] klienter?
...
## Är OneDrive det samma som SharePoint för att lagra filer?
...
## Var kan jag se en OneDrive tjänsthälsa?
...
## Är OneDrive integrering tillgänglig för [!INCLUDE[prod_short](includes/prod_short.md)] lokala platser?
...
## Ansluter [!INCLUDE[prod_short](includes/prod_short.md)] lokal med SharePoint server?

Nr. Den här distributionskombinationen stöds inte även om SharePoint-servern har aktiverat Mina webbplatser.  

## Ansluter [!INCLUDE[prod_short](includes/prod_short.md)] online med SharePoint server?

Nr. Den här distributionskombinationen stöds inte även om SharePoint-servern har aktiverat Mina webbplatser.  

## Hur fungerar det här i en organisation med flera miljöer?
...
## Vi har bytt företagsnamn. Vad händer med mina tidigare filer?
...
## När filer bifogas till [!INCLUDE[prod_short](includes/prod_short.md)], hur väljer jag en fil från OneDrive?
...
## Jag vill öppna filer i SharePoint i stället. Hur gör jag detta?
...
## Hur stänger jag av integreringen OneDrive?
...
## Ska jag använda sidan SharePoint anslutningsinställningar för att ansluta till SharePoint?
...
## Vilken version av [!INCLUDE[prod_short](includes/prod_short.md)] support OneDrive?

Integrationen med OneDrive blev tillgänglig i 2021 utgivningscykel 2.  

## <a name="features"></a>Vilka funktioner påverkas av OneDrive-integrationen?
...
### Business Central kan inte hitta mitt OneDrive
...
### Jag får problem när jag delar från Outlook
...
### Åtgärderna Öppna i OneDrive och Dela saknas
