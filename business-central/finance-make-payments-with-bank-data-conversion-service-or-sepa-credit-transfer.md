...
ms.author: bholtorf
---
# <a name="make-payments-with-the-amc-banking-365-fundamentals-extension-or-sepa-credit-transfer"></a><a name="make-payments-with-the-amc-banking-365-fundamentals-extension-or-sepa-credit-transfer"></a><a name="make-payments-with-the-amc-banking-365-fundamentals-extension-or-sepa-credit-transfer"></a>Gör betalningar med tillägget AMC Banking 365 Fundamentals eller SEPA-kreditöverföring
...
## <a name="setting-up-the-amc-banking-365-fundamentals-extension"></a><a name="setting-up-the-amc-banking-365-fundamentals-extension"></a><a name="setting-up-the-amc-banking-365-fundamentals-extension"></a>Konfigurera tillägget AMC Banking 365 Fundamentals
...
## <a name="setting-up-sepa-credit-transfer"></a><a name="setting-up-sepa-credit-transfer"></a><a name="setting-up-sepa-credit-transfer"></a>Ställa in SEPA-kreditöverföring
...
### <a name="to-set-up-a-bank-account-for-sepa-credit-transfer"></a><a name="to-set-up-a-bank-account-for-sepa-credit-transfer"></a><a name="to-set-up-a-bank-account-for-sepa-credit-transfer"></a>Så här lägger du upp ett bankkonto för SEPA-kreditöverföring
...
### <a name="to-set-up-a-vendor-card-for-sepa-credit-transfer"></a><a name="to-set-up-a-vendor-card-for-sepa-credit-transfer"></a><a name="to-set-up-a-vendor-card-for-sepa-credit-transfer"></a>Så här lägger du upp ett leverantörskort för SEPA-kreditöverföring
...
### <a name="to-set-the-payment-journal-up-to-export-payment-files"></a><a name="to-set-the-payment-journal-up-to-export-payment-files"></a><a name="to-set-the-payment-journal-up-to-export-payment-files"></a>Så här anger du utbetalningsjournalen för att exportera betalningsfiler
...
### <a name="to-connect-the-data-exchange-definition-for-one-or-more-payment-types-with-the-relevant-payment-method-or-methods"></a><a name="to-connect-the-data-exchange-definition-for-one-or-more-payment-types-with-the-relevant-payment-method-or-methods"></a><a name="to-connect-the-data-exchange-definition-for-one-or-more-payment-types-with-the-relevant-payment-method-or-methods"></a>Så här kan du ansluta datautbytesdefinitionen för en eller flera betalningstyper till lämpliga betalningsmetoder
...
## <a name="preparing-the-payment-journal"></a><a name="preparing-the-payment-journal"></a><a name="preparing-the-payment-journal"></a>Förbereda utbetalningsjournalen
...
## <a name="exporting-payments-to-a-bank-file"></a><a name="exporting-payments-to-a-bank-file"></a><a name="exporting-payments-to-a-bank-file"></a>Exportera betalningar till en bankfil
...
### <a name="to-export-payments-to-a-bank-file"></a><a name="to-export-payments-to-a-bank-file"></a><a name="to-export-payments-to-a-bank-file"></a>Exportera betalningar till en bankfil
...
### <a name="to-plan-when-to-post-exported-payments"></a><a name="to-plan-when-to-post-exported-payments"></a><a name="to-plan-when-to-post-exported-payments"></a>Så här planerar du när du vill bokföra exporterad betalning
...
### <a name="to-re-export-payments-to-a-bank-file"></a><a name="to-re-export-payments-to-a-bank-file"></a><a name="to-re-export-payments-to-a-bank-file"></a>Så här återexporterar du betalningar till en bankfil
...
## <a name="posting-the-payments"></a><a name="posting-the-payments"></a><a name="posting-the-payments"></a>Förhandsgranska betalningarna
