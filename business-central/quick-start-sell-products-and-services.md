...
# <a name="sales-quick-start"></a><a name="sales-quick-start"></a><a name="sales-quick-start"></a>Försäljning snabbstart
...
## <a name="set-up-items-to-sell"></a><a name="set-up-items-to-sell"></a><a name="set-up-items-to-sell"></a>Ställ in objekt att sälja
...
### <a name="set-up-a-new-item"></a><a name="set-up-a-new-item"></a><a name="set-up-a-new-item"></a>Skapa en ny artikel
...
## <a name="set-up-customers"></a><a name="set-up-customers"></a><a name="set-up-customers"></a>Ställ in kunder
...
### <a name="set-up-a-new-customer"></a><a name="set-up-a-new-customer"></a><a name="set-up-a-new-customer"></a>Skapa en ny kund
...
## <a name="create-a-sales-order"></a><a name="create-a-sales-order"></a><a name="create-a-sales-order"></a>Skapa en försäljningsorder
...
### <a name="to-create-a-sales-order"></a><a name="to-create-a-sales-order"></a><a name="to-create-a-sales-order"></a>Så här skapar du försäljningsorder
...
## <a name="create-a-sales-invoice"></a><a name="create-a-sales-invoice"></a><a name="create-a-sales-invoice"></a>Skapa en försäljningsfaktura
...
### <a name="to-create-and-post-a-sales-invoice"></a><a name="to-create-and-post-a-sales-invoice"></a><a name="to-create-and-post-a-sales-invoice"></a>Så här skapar och bokför du en försäljningsfaktura
