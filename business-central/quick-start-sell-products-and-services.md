...
# <a name="sales-quick-start" />Försäljning snabbstart
...
## <a name="set-up-items-to-sell" />Ställ in objekt att sälja
...
### <a name="set-up-a-new-item" />Skapa en ny artikel
...
## <a name="set-up-customers" />Ställ in kunder
...
### <a name="set-up-a-new-customer" />Skapa en ny kund
...
### <a name="to-create-a-sales-order" />Så här skapar du försäljningsorder
...
## <a name="create-a-sales-invoice" />Skapa en försäljningsfaktura
...
### <a name="to-create-and-post-a-sales-invoice" />Så här skapar och bokför du en försäljningsfaktura
