...
## <a name="inventory-picks"></a>Lagerplockningar
...
## <a name="pick-or-move-for-production-assembly-and-projects-in-a-basic-warehouse-configuration"></a>Plocka eller flytta för produktion, montering och projekt i en grundläggande lagerkonfiguration
...
### <a name="to-create-an-inventory-movement-from-the-source-document"></a>Så här skapar du en lagerförflyttning från källdokumentet
...
### <a name="to-create-multiple-inventory-picks-or-movements-with-a-batch-job"></a>Så här skapar du flera lagerplockningar eller transport med batch-jobbet
...
### <a name="to-create-inventory-picks-or-movements-in-two-steps"></a>Så här skapar du lagerplockningar eller rörelser i två steg
...
## <a name="to-record-the-inventory-pick"></a>När du vill registrera lagerplockning
...
## <a name="flushing-production-components-in-a-basic-warehouse-configuration"></a>Bokföra komponenter för produktion i en grundläggande lagerkonfiguration
