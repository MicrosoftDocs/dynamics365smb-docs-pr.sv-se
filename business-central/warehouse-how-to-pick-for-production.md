...
## <a name="pick-or-move-for-production-assembly-and-jobs-in-a-basic-warehouse-configuration"></a>Plocka eller flytta för produktion, montering och projekt i en grundläggande lagerkonfiguration
