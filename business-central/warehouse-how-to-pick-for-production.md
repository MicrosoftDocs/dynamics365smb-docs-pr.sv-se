...
---
# <a name="pick-for-production-assembly-or-jobs-in-basic-warehouse-configurations"></a><a name="pick-for-production-assembly-or-jobs-in-basic-warehouse-configurations"></a>Plocka för produktion, montering eller jobb i grundläggande distributionslagerkonfigurationer
...
## <a name="inventory-picks"></a><a name="inventory-picks"></a>Lagerplockningar
...
## <a name="inventory-movements"></a><a name="inventory-movements"></a>Lagerförflyttningar
...
### <a name="production"></a><a name="production"></a>Produktion
...
### <a name="assembly"></a><a name="assembly"></a>Montering
...
### <a name="project-management"></a><a name="project-management"></a>Projekthantering
...
## <a name="pick-or-move-for-production-assembly-and-jobs-in-a-basic-warehouse-configuration"></a><a name="pick-or-move-for-production-assembly-and-jobs-in-a-basic-warehouse-configuration"></a>Plocka eller flytta för produktion, montering och projekt i en grundläggande lagerkonfiguration
...
### <a name="to-create-an-inventory-pick-from-the-source-document"></a><a name="to-create-an-inventory-pick-from-the-source-document"></a>Så här skapar du en lagerplockning från källdokumentet
...
### <a name="to-create-an-inventory-movement-from-the-source-document"></a><a name="to-create-an-inventory-movement-from-the-source-document"></a>Så här skapar du en lagerförflyttning från källdokumentet
...
### <a name="to-create-multiple-inventory-picks-or-movements-with-a-batch-job"></a><a name="to-create-multiple-inventory-picks-or-movements-with-a-batch-job"></a>Så här skapar du flera lagerplockningar eller transport med batch-jobbet
...
### <a name="to-create-inventory-picks-or-movements-in-two-steps"></a><a name="to-create-inventory-picks-or-movements-in-two-steps"></a>Så här skapar du lagerplockningar eller rörelser i två steg
...
## <a name="to-record-the-inventory-pick"></a><a name="to-record-the-inventory-pick"></a>När du vill registrera lagerplockning
...
## <a name="flushing-production-components-in-a-basic-warehouse-configuration"></a><a name="flushing-production-components-in-a-basic-warehouse-configuration"></a>Bokföra komponenter för produktion i en grundläggande lagerkonfiguration
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relaterad [Microsoft utbildning](/training/paths/pick-ship-items-business-central/)
