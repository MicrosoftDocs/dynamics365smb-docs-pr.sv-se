...
ms.author: edupont
---
# <a name="set-up-purchasers" />Konfigurera inköpare
...
## <a name="to-set-up-purchasers" />Så här skapar du inköpare:
...
## <a name="to-assign-purchasers-to-vendors" />Så här kopplar du inköpare till leverantörer:
