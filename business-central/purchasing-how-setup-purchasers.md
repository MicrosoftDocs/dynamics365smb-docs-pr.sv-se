...
ms.author: edupont
---
# <a name="set-up-purchasers"></a><a name="set-up-purchasers"></a><a name="set-up-purchasers"></a>Konfigurera inköpare
...
## <a name="to-set-up-purchasers"></a><a name="to-set-up-purchasers"></a><a name="to-set-up-purchasers"></a>Så här skapar du inköpare:
...
## <a name="to-assign-purchasers-to-vendors"></a><a name="to-assign-purchasers-to-vendors"></a><a name="to-assign-purchasers-to-vendors"></a>Så här kopplar du inköpare till leverantörer:
