...
ms.author: edupont
---
# <a name="purchase-items-for-a-sale-by-creating-purchase-invoices" />Köpa artiklar till försäljning genom att skapa inköpsfakturor
...
## <a name="to-create-one-or-more-purchase-orders-from-a-sales-order" />Så här skapar du inköpsorder för en eller flera serviceorder från en försäljningsorder
...
## <a name="to-create-a-purchase-invoice-from-a-sales-order-or-sales-invoice" />Så här skapar du en försäljningsorder från en försäljningsfaktura
