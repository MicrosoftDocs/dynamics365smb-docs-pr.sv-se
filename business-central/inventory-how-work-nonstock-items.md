...
# <a name="work-with-catalog-items" />Arbeta med katalogartiklar
...
## <a name="create-a-catalog-item" />Skapar du en katalogartikel
...
## <a name="specify-how-catalog-item-numbers-are-converted-to-your-own-numbering" />Ställ in katalogartikelnummer konverteras till ditt eget nummer
...
## <a name="convert-a-catalog-item-to-a-normal-item" />Om du vill omvandla en katalogartikel till en normal artikel
...
## <a name="to-sell-a-catalog-item-and-convert-it-to-a-normal-item" />Om du vill sälja en katalogartikel och konvertera den till en normal artikel
