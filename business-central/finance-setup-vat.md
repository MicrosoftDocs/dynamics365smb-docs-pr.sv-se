...
# <a name="set-up-calculations-and-posting-methods-for-value-added-tax" />Konfigurera beräknings- och bokföringsmetoder för moms
...
## <a name="set-up-vat-using-the-assisted-setup-guide-recommended" />Ställ in moms med hjälp av guiden för assisterad konfiguration (rekommenderas)
...
### <a name="check-the-vat-posting-setup" />Kontrollera bokföringsinställningar för moms
...
## <a name="set-up-a-default-vat-date-for-documents-and-journals" />Ställ in ett standarddatum för moms för dokument och journaler
...
### <a name="enabling-or-disabling-the-vat-date-feature" />Aktivera eller inaktivera funktionen momsdatum
...
### <a name="limiting-periods-for-posting-and-changing-the-vat-date" />Begränsa perioder för bokföring och ändring av momsdatumet
...
#### <a name="to-limit-posting-based-on-vat-return-period" />Så här begränsar du bokföring baserat på momsreturperiod
...
#### <a name="to-limit-posting-based-on-allow-fromto-period" />Så här begränsar du bokföring baserat på tillåt från/till-period
...
## <a name="set-up-vat-registration-numbers-for-your-country-or-region" />Så här skapar du momsregistreringsnummer för land / region
...
## <a name="set-up-vat-business-posting-groups" />Skapa rörelsebokföringsmallar för moms
...
## <a name="set-up-vat-product-posting-groups" />Skapa produktbokföringsmallar för moms
...
## <a name="combine-vat-posting-groups-in-vat-posting-setups" />Kombinera momsbokföringsmallar i momsbokföringsinställningar
...
## <a name="assign-vat-posting-groups-by-default-to-multiple-entities" />Tilldela momsbokföringsmallar som standard till flera enheter
...
## <a name="assign-vat-posting-groups-to-accounts-customers-vendors-items-and-resources" />Tilldela momsbokföringsmallar till konton, kunder, leverantörer, artiklar och resurser

I följande avsnitt beskrivs hur du tilldelar momsbokföringsmallar till enskilda enheter.

### <a name="to-assign-vat-posting-groups-to-individual-general-ledger-accounts" />Så här tilldelar du momsbokföringsmallar till individuella redovisningskonton
...
### <a name="to-assign-vat-business-posting-groups-to-customers-and-vendors" />För att tilldela rörelsebokföringsmallar för moms till kunder och leverantörer
...
### <a name="to-assign-vat-product-posting-groups-to-individual-items-and-resources" />För att tilldela produktbokföringsmallar till individuella artiklar och resurser
...
## <a name="set-up-clauses-to-explain-vat-exemption-or-non-standard-vat-rates" />Ange satser som förklarar momsbefrielse eller icke-standardiserade momssatser
...
### <a name="to-set-up-vat-clauses" />Så här konfigurerar du momsklausuler
...
### <a name="to-assign-a-vat-clause-to-a-vat-posting-setup" />Så här tilldelar du en momsklausul till en momsbokföringsinställning
...
### <a name="to-specify-translations-for-vat-clauses" />Att ange översättningar för momsklausuler
...
### <a name="to-specify-extended-text-for-vat-clauses" />För att ange utökad text för momsklausuler
...
## <a name="create-a-vat-posting-setup-to-handle-import-vat" />Skapa en momsbokföringsinställning för hantering av importmoms
...
## <a name="use-reverse-charge-vat-for-trade-between-eu-countries-or-regions" />Använda omvänd moms för handel mellan länder/regioner inom EU
...
### <a name="sales-to-eu-countries-or-regions" />Försäljning till länder eller regioner inom EU
...
## <a name="vat-rounding-for-documents" />Momsavrundning för dokument
...
## <a name="set-up-vat-reporting" />Konfigurera momsrapportering
