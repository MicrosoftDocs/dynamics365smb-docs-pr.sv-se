...
#### <a name="limit-posting-based-on-allow-fromto-period"></a>Begränsa bokföring baserat på tillåt från/till-period
...
##### <a name="version-231-or-newer"></a>Version 23.1 eller nyare
...
##### <a name="versions-before-231"></a>Versioner före 23.1
...
## <a name="use-reverse-charge-vat-for-trade-between-eu-countriesregions"></a>Använd omvänd moms för handel mellan länder/regioner inom EU
...
### <a name="sales-to-eu-countriesregions"></a>Försäljning till andra länder/regioner inom EU
