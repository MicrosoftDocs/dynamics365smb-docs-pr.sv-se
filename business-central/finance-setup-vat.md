...
# <a name="set-up-calculations-and-posting-methods-for-value-added-tax"></a><a name="set-up-calculations-and-posting-methods-for-value-added-tax"></a><a name="set-up-calculations-and-posting-methods-for-value-added-tax"></a>Konfigurera beräknings- och bokföringsmetoder för moms
...
## <a name="set-up-vat-using-the-assisted-setup-guide-recommended"></a><a name="set-up-vat-using-the-assisted-setup-guide-recommended"></a><a name="set-up-vat-using-the-assisted-setup-guide-recommended"></a>Ställ in moms med hjälp av guiden för assisterad konfiguration (rekommenderas)
...
### <a name="check-the-vat-posting-setup"></a><a name="check-the-vat-posting-setup"></a><a name="check-the-vat-posting-setup"></a>Kontrollera bokföringsinställningar för moms
...
## <a name="set-up-a-default-vat-date-for-documents-and-journals"></a><a name="set-up-a-default-vat-date-for-documents-and-journals"></a><a name="set-up-a-default-vat-date-for-documents-and-journals"></a>Ställ in ett standarddatum för moms för dokument och journaler
...
### <a name="enabling-or-disabling-the-vat-date-feature"></a><a name="enabling-or-disabling-the-vat-date-feature"></a><a name="enabling-or-disabling-the-vat-date-feature"></a>Aktivera eller inaktivera funktionen momsdatum

För vissa länder krävs att företag använder ett visst momsdatum, men andra länder är inte det. Vissa länder kräver också att företag ändrar moms datumet i särskilda situationer efter att de har bokförts, men andra länder tillåter inte ändringar av momsdatum. Om du vill tillåta olika kontexter kan du välja om du vill använda den här funktionen och i så fall i vilken grad.
...
### <a name="limiting-periods-for-posting-and-changing-the-vat-date"></a><a name="limiting-periods-for-posting-and-changing-the-vat-date"></a><a name="limiting-periods-for-posting-and-changing-the-vat-date"></a>Begränsa perioder för bokföring och ändring av momsdatumet
...
#### <a name="to-limit-posting-based-on-vat-return-period"></a><a name="to-limit-posting-based-on-vat-return-period"></a><a name="to-limit-posting-based-on-vat-return-period"></a>Så här begränsar du bokföring baserat på momsreturperiod
...
#### <a name="to-limit-posting-based-on-allow-fromto-period"></a><a name="to-limit-posting-based-on-allow-fromto-period"></a><a name="to-limit-posting-based-on-allow-fromto-period"></a>Så här begränsar du bokföring baserat på tillåt från/till-period
...
## <a name="set-up-vat-registration-numbers-for-your-country-or-region"></a><a name="set-up-vat-registration-numbers-for-your-country-or-region"></a><a name="set-up-vat-registration-numbers-for-your-country-or-region"></a>Så här skapar du momsregistreringsnummer för land / region
...
## <a name="set-up-vat-business-posting-groups"></a><a name="set-up-vat-business-posting-groups"></a><a name="set-up-vat-business-posting-groups"></a>Skapa rörelsebokföringsmallar för moms
...
## <a name="set-up-vat-product-posting-groups"></a><a name="set-up-vat-product-posting-groups"></a><a name="set-up-vat-product-posting-groups"></a>Skapa produktbokföringsmallar för moms
...
## <a name="combine-vat-posting-groups-in-vat-posting-setups"></a><a name="combine-vat-posting-groups-in-vat-posting-setups"></a><a name="combine-vat-posting-groups-in-vat-posting-setups"></a>Kombinera momsbokföringsmallar i momsbokföringsinställningar
...
## <a name="assign-vat-posting-groups-by-default-to-multiple-entities"></a><a name="assign-vat-posting-groups-by-default-to-multiple-entities"></a><a name="assign-vat-posting-groups-by-default-to-multiple-entities"></a>Tilldela momsbokföringsmallar som standard till flera enheter
...
### <a name="to-assign-vat-business-posting-groups-to-customers-and-vendors"></a><a name="to-assign-vat-business-posting-groups-to-customers-and-vendors"></a><a name="to-assign-vat-business-posting-groups-to-customers-and-vendors"></a>För att tilldela rörelsebokföringsmallar för moms till kunder och leverantörer
...
### <a name="to-assign-vat-product-posting-groups-to-individual-items-and-resources"></a><a name="to-assign-vat-product-posting-groups-to-individual-items-and-resources"></a><a name="to-assign-vat-product-posting-groups-to-individual-items-and-resources"></a>För att tilldela produktbokföringsmallar till individuella artiklar och resurser
...
## <a name="set-up-clauses-to-explain-vat-exemption-or-non-standard-vat-rates"></a><a name="set-up-clauses-to-explain-vat-exemption-or-non-standard-vat-rates"></a><a name="set-up-clauses-to-explain-vat-exemption-or-non-standard-vat-rates"></a>Ange satser som förklarar momsbefrielse eller icke-standardiserade momssatser
...
### <a name="to-set-up-vat-clauses"></a><a name="to-set-up-vat-clauses"></a><a name="to-set-up-vat-clauses"></a>Så här konfigurerar du momsklausuler
...
### <a name="to-assign-a-vat-clause-to-a-vat-posting-setup"></a><a name="to-assign-a-vat-clause-to-a-vat-posting-setup"></a><a name="to-assign-a-vat-clause-to-a-vat-posting-setup"></a>Så här tilldelar du en momsklausul till en momsbokföringsinställning
...
### <a name="to-specify-translations-for-vat-clauses"></a><a name="to-specify-translations-for-vat-clauses"></a><a name="to-specify-translations-for-vat-clauses"></a>Att ange översättningar för momsklausuler
...
### <a name="to-specify-extended-text-for-vat-clauses"></a><a name="to-specify-extended-text-for-vat-clauses"></a><a name="to-specify-extended-text-for-vat-clauses"></a>För att ange utökad text för momsklausuler
...
## <a name="create-a-vat-posting-setup-to-handle-import-vat"></a><a name="create-a-vat-posting-setup-to-handle-import-vat"></a><a name="create-a-vat-posting-setup-to-handle-import-vat"></a>Skapa en momsbokföringsinställning för hantering av importmoms
...
## <a name="use-reverse-charge-vat-for-trade-between-eu-countries-or-regions"></a><a name="use-reverse-charge-vat-for-trade-between-eu-countries-or-regions"></a><a name="use-reverse-charge-vat-for-trade-between-eu-countries-or-regions"></a>Använda omvänd moms för handel mellan länder/regioner inom EU
...
### <a name="sales-to-eu-countries-or-regions"></a><a name="sales-to-eu-countries-or-regions"></a><a name="sales-to-eu-countries-or-regions"></a>Försäljning till länder eller regioner inom EU
...
## <a name="vat-rounding-for-documents"></a><a name="vat-rounding-for-documents"></a><a name="vat-rounding-for-documents"></a>Momsavrundning för dokument
...
## <a name="set-up-vat-reporting"></a><a name="set-up-vat-reporting"></a><a name="set-up-vat-reporting"></a>Konfigurera momsrapportering
