...
# <a name="the-vat-group-management-extension-for-the-united-kingdom"></a><a name="the-vat-group-management-extension-for-the-united-kingdom"></a>Tillägget Momsgruppshantering för Storbritannien
...
## <a name="forming-a-vat-group"></a><a name="forming-a-vat-group"></a>Skapa en momsgrupp
...
### <a name="license-requirements"></a><a name="license-requirements"></a>Licenskrav
...
## <a name="set-up-a-vat-group"></a><a name="set-up-a-vat-group"></a>Ställ in en momsgrupp
...
### <a name="azure-active-directory-setup-for-group-members"></a><a name="azure-active-directory-setup-for-group-members"></a>Azure Active Directory inställning för gruppmedlemmar
...
### <a name="group-api-setup"></a><a name="group-api-setup"></a>Konfigurera grupp-API
...
## <a name="set-up-vat-group-members"></a><a name="set-up-vat-group-members"></a>Ställ in medlemmar i momsgruppen
...
### <a name="vat-group-representative-uses-business-central-online"></a><a name="vat-group-representative-uses-business-central-online"></a>Momsgrupprepresentant använder Business Central online
...
### <a name="vat-group-representative-uses-business-central-on-premises"></a><a name="vat-group-representative-uses-business-central-on-premises"></a>Momsgrupprepresentant som använder Business Central lokal
...
## <a name="set-up-the-vat-group-representative"></a><a name="set-up-the-vat-group-representative"></a>Skapa en momsgruppsrepresentant
...
## <a name="use-the-vat-group-management-features"></a><a name="use-the-vat-group-management-features"></a>Använda funktionerna för momsgruppshantering
...
### <a name="review-vat-member-submissions"></a><a name="review-vat-member-submissions"></a>Granska överföringar från gruppmedlemmar
...
### <a name="create-a-group-vat-return"></a><a name="create-a-group-vat-return"></a>Skapa en gruppmomsretur
