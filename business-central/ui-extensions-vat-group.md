...
# <a name="the-vat-group-management-extension-for-the-united-kingdom" />Tillägget Momsgruppshantering för Storbritannien
...
## <a name="forming-a-vat-group" />Skapa en momsgrupp
...
### <a name="license-requirements" />Licenskrav
...
## <a name="set-up-a-vat-group" />Ställ in en momsgrupp
...
### <a name="azure-active-directory-setup-for-group-members" />Azure Active Directory inställning för gruppmedlemmar
...
### <a name="group-api-setup" />Konfigurera grupp-API
...
## <a name="set-up-vat-group-members" />Ställ in medlemmar i momsgruppen
...
### <a name="vat-group-representative-uses-business-central-online" />Momsgrupprepresentant använder Business Central online
...
### <a name="vat-group-representative-uses-business-central-on-premises" />Momsgrupprepresentant som använder Business Central lokal
...
## <a name="set-up-the-vat-group-representative" />Skapa en momsgruppsrepresentant
...
## <a name="use-the-vat-group-management-features" />Använda funktionerna för momsgruppshantering
...
### <a name="review-vat-member-submissions" />Granska överföringar från gruppmedlemmar
...
### <a name="create-a-group-vat-return" />Skapa en gruppmomsretur
