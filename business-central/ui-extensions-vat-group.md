...
### <a name="microsoft-entra-id-setup-for-group-members"></a>Microsoft Entra ID-konfiguration för gruppmedlemmar
...
6. I fältet **API URL** anger du API URL för momsgruppens representant. URL:en formateras vanligen så här: `https://api.businesscentral.dynamics.com/v2.0/[TENANT-ID]/[ENVIRONMENTNAME]`. Till exempel `https://api.businesscentral.dynamics.com/v2.0/aaaabbbb-0000-cccc-1111-dddd2222eeee/UKRepresentative`.
...
4. I fältet **OAuth 2.0 Slutpunkt** för utfärdare anger du `https://login.microsoftonline.com/common/oauth2`.
5. I fältet **OAuth Resurs-URL** för 2.0 anger du `https://api.businesscentral.dynamics.com/`.
6. I fältet **OAuth 2.0-omdirigerings-URL** anger du `https://businesscentral.dynamics.com/OAuthLanding.htm`.
...
## <a name="issue-with-enabling-multifactor-authentication-mfa"></a>Problem med att aktivera multifaktorautentisering (MFA)
