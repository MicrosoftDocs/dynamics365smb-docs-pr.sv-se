...
ms.author: edupont
---
# <a name="customizing-business-central-online-with-apps"></a><a name="customizing-business-central-online-with-apps"></a>Anpassa Business Central Online med appar
...
## <a name="manage-apps"></a><a name="manage-apps"></a>Hantera appar
...
## <a name="apps-and-data-transfer"></a><a name="apps-and-data-transfer"></a>Appar och dataöverföring
...
## <a name="connect-your-business"></a><a name="connect-your-business"></a>Anslut företaget
...
## <a name="recommended-apps"></a><a name="recommended-apps"></a>Rekommenderade appar
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relaterad [Microsoft utbildning](/training/modules/customize-dynamics-365-business-central/)
