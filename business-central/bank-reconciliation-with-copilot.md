...
- För att kassera alla föreslagna matchningar och stänga Copilot-fönstret, välj knappen Kasta (papperskorgen) ![Visar papperskorgsikonen för att radera alla Copilot-förslag för bankkontoavstämning](media/copilot-delete-trash-can.png) bredvid knappen **Behåll detta** längst ned i fönstret.
   ...
   > [!NOTE]
   > Om du startade Copilot från kortet **bankkontoavstämning** för en ny eller befintlig avstämning tas endast de föreslagna Copilot-matchningarna bort. Matchningarna som gjordes av åtgärden automatisk matchning har redan sparats.
   > 
   > Om du startade Copilot från listan **Bankkontoavstämningar** sparas ingenting, inklusive importerade kontoutdragsrader, automater och föreslagna matchningar av Copilot.
