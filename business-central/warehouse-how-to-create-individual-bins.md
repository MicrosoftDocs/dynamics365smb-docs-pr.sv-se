...
ms.author: edupont
---
# <a name="create-bins" />Skapa lagerställen
...
## <a name="to-create-a-bin-from-the-location-card" />Så här skapar du en lagerplats från lagerställekortet:
...
### <a name="the-dedicated-field" />Fältet Dedikerad
...
## <a name="to-create-bins-individually-in-the-bin-creation-worksheet" />Så här skapar du enstaka lagerställen i lagerplatsuppläggningskalkylark:
...
## <a name="to-make-bins-automatically-in-the-bin-creation-worksheet" />Så här skapar du lagerställen automatiskt i lagerplatsuppläggningskalkylarket:
