...
ms.author: edupont
---
# <a name="design-details-cost-adjustment"></a><a name="design-details-cost-adjustment"></a>Designdetaljer: Kostnadsjustering
...
## <a name="detecting-the-adjustment"></a><a name="detecting-the-adjustment"></a>Identifiera justeringen
...
### <a name="item-application-entry"></a><a name="item-application-entry"></a>Artikelkopplingstransaktion
...
### <a name="average-cost-adjustment-entry-point"></a><a name="average-cost-adjustment-entry-point"></a>Ingångspunkt för genomsnittlig kostnadsjustering
...
### <a name="order-level"></a><a name="order-level"></a>Ordernivå
...
## <a name="manual-versus-automatic-cost-adjustment"></a><a name="manual-versus-automatic-cost-adjustment"></a>Manuell kontra automatisk kostnadsjustering
...
## <a name="adjust-cost---item-entries-batch-job"></a><a name="adjust-cost---item-entries-batch-job"></a>Batch-jobbet Justera kost. – artikeltrans.
...
#### <a name="value-entries-1"></a><a name="value-entries-1"></a>Värdetransaktioner (1)
...
#### <a name="relation-entries-in-the-gl--item-ledger-relation-table-1"></a><a name="relation-entries-in-the-gl--item-ledger-relation-table-1"></a>Relationstransaktioner i redovisning – tabellen Artikeltransaktionsrelation (1)
...
#### <a name="general-ledger-entries-1"></a><a name="general-ledger-entries-1"></a>Redovisningstransaktioner (1)
...
#### <a name="value-entries-2"></a><a name="value-entries-2"></a>Värdetransaktioner (2)
...
#### <a name="relation-entries-in-the-gl--item-ledger-relation-table-2"></a><a name="relation-entries-in-the-gl--item-ledger-relation-table-2"></a>Relationstransaktioner i redovisning – tabellen Artikeltransaktionsrelation (2)
...
#### <a name="general-ledger-entries-2"></a><a name="general-ledger-entries-2"></a>Redovisningstransaktioner (2)
...
## <a name="automatic-cost-adjustment"></a><a name="automatic-cost-adjustment"></a>Automatisk kostnadsjustering
...
### <a name="example-1"></a><a name="example-1"></a>Exempel
