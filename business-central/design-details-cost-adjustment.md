...
ms.author: edupont
---
# <a name="design-details-cost-adjustment" />Designdetaljer: Kostnadsjustering
...
### <a name="item-application-entry" />Artikelkopplingstransaktion
...
### <a name="average-cost-adjustment-entry-point" />Ingångspunkt för genomsnittlig kostnadsjustering
...
## <a name="manual-versus-automatic-cost-adjustment" />Manuell kontra automatisk kostnadsjustering
...
## <a name="adjust-cost---item-entries-batch-job" />Batch-jobbet Justera kost. – artikeltrans.
...
## <a name="automatic-cost-adjustment" />Automatisk kostnadsjustering
