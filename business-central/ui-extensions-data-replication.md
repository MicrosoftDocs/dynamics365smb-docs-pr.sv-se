...
# <a name="cloud-migration-extensions-for-migrating-to-business-central-online" />Tillägg för molnflyttning för migrering till Business Central Online
...
## <a name="business-central-on-premises" />Business Central lokalt
