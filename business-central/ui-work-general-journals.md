...
---
# <a name="work-with-general-journals" />Arbeta med redovisningsjournaler
...
## <a name="use-journal-templates-and-batches" />Använd journalmallar och journaler
...
### <a name="validating-general-journal-batches" />Validera redovisningsjournaler
...
## <a name="understanding-main-accounts-and-balancing-accounts" />Förstå huvudkonton och motkonton
...
## <a name="work-with-recurring-journals" />Arbeta med återkommande journaler
...
### <a name="recurring-method-field" />Fält för återkommande metod
...
### <a name="recurring-frequency-field" />Fält för återkommande frekvens
...
### <a name="expiration-date-field" />Fält för utgångsdatum
...
### <a name="allocating-recurring-journal-amounts-to-several-accounts" />Fördela återkommande journalbelopp på flera konton
...
#### <a name="example-allocating-rent-payments-to-different-departments" />Exempel: Fördela hyresinbetalningar på olika avdelningar
...
### <a name="calculate-the-reversal-date" />Beräkning av återföringsdatum
...
## <a name="work-with-standard-journals" />Arbeta med standardjournaler
...
### <a name="to-save-a-standard-journal" />Så här sparar du som en standardjournal
...
### <a name="to-reuse-a-standard-journal" />Så här återanvänder du standardjournaler
...
## <a name="to-renumber-document-numbers-in-journals" />Numrera om verifikationsnummer i journaler
...
### <a name="to-renumber-documents-in-journals" />Numrera om dokument i journaler
...
## <a name="see-related-microsoft-trainingtrainingpathsuse-journals-dynamics--business-central" />Se relaterad [Microsoft utbildning](/training/paths/use-journals-dynamics-365-business-central/)
