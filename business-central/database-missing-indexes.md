...
ms.date: 06/09/2022
---
# <a name="database-missing-indexes-in-"></a><a name="database-missing-indexes-in-"></a><a name="database-missing-indexes-in-"></a>Databasens index saknas i [!INCLUDE[prod_long](includes/prod_long.md)]
