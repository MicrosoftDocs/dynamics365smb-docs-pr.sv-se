...
ms.author: edupont
---
# <a name="use-xml-schemas-to-prepare-data-exchange-definitions" />Använd XML-scheman för att förbereda definitioner för databyten
...
## <a name="to-load-an-xml-schema-file" />Så här läser du in en XML-schemafil
...
### <a name="to-select-or-clear-nodes-in-an-xml-schema" />Så här markerar eller avmarkerar du noder i ett XML-schema
...
### <a name="to-generate-a-data-exchange-definition-that-is-based-on-an-xml-schema" />Så här skapar du en definition för datautbyte baserat på ett XML-schema
