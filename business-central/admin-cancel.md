...
ms.author: edupont
---
# <a name="unsubscribe-or-remove-"></a><a name="unsubscribe-or-remove-"></a><a name="unsubscribe-or-remove-"></a>Avbryta prenumerationen eller ta bort [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="removing--from-your-app-launcher"></a><a name="removing--from-your-app-launcher"></a><a name="removing--from-your-app-launcher"></a>Ta bort [!INCLUDE[prod_short](includes/prod_short.md)] från din programmarstartbild
