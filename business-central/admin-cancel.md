...
För att stänga kontot måste du för närvarande kontakta [!INCLUDE[d365fin](includes/d365fin_md.md)]-teamet genom att skicka ett e-postmeddelande till cancelbusinesscentra@microsoft.com. Du måste inkludera namnet på din [!INCLUDE[d365fin](includes/d365fin_md.md)]innehavare i meddelandet så att vi kan identifiera dig. Det enklaste sättet att göra detta är att kopiera URL:en från din [!INCLUDE[d365fin](includes/d365fin_md.md)]-startsida.  
...
Om du registrerade dig på [!INCLUDE[d365fin](includes/d365fin_md.md)] utan ett Office 365 -företagskonto, har du inte en Office 365-administratör. Istället måste du avbryta prenumerationen genom att kontakta [!INCLUDE[d365fin](includes/d365fin_md.md)]-teamet genom att skicka ett e-postmeddelande till cancelbusinesscentra@microsoft.com. Du måste inkludera namnet på din [!INCLUDE[d365fin](includes/d365fin_md.md)]-innehavare i meddelandet så att vi kan identifiera dig. Det enklaste sättet att göra detta är att kopiera URL:en från din [!INCLUDE[d365fin](includes/d365fin_md.md)]-startsida.  
