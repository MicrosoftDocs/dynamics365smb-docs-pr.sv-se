...
ms.author: edupont
---
# <a name="unsubscribe-or-remove-includeprodshortincludesprodshortmd" />Avbryta prenumerationen eller ta bort [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="removing-includeprodshortincludesprodshortmd-from-your-app-launcher" />Ta bort [!INCLUDE[prod_short](includes/prod_short.md)] från din programmarstartbild
