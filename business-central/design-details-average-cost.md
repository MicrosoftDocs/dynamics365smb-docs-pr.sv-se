...
ms.author: bholtorf
---
# <a name="design-details-average-cost" />Designdetaljer: Genomsnittskostnad
...
## <a name="setting-up-average-cost-calculation" />Ställa in beräkning av genomsnittskostnad
...
## <a name="calculating-average-cost" />Beräkna genomsnittskostnad
...
### <a name="example-average-cost-period--day" />Exempel: Period för genomsnittskostnad = Dag
...
### <a name="example-average-cost-period--month" />Exempel: Period för genomsnittskostnad = Månad
...
## <a name="setting-the-valuation-date" />Ange värderingsdatum
...
## <a name="recalculating-average-cost" />Beräkna om genomsnittskostnad
...
### <a name="example-of-recalculated-average-cost" />Exempel på omräknad genomsnittlig kostnad
