...
description: Innehåller en översikt över alla funktioner som kan användas för ad hoc-dataanalyser i Business Central-produkten.
author: edupont04
...
ms.locfileid: "8146089"
---
# <a name="ad-hoc-data-analysis"></a>Ad hoc-dataanalys

Ibland behöver du analysera data i [!INCLUDE[prod_short](includes/prod_short.md)] på ett sätt som inte finns i en standardrapport.

Denna uppgift kallas ibland ad hoc-analys. 
...
| Visa och analysera data från en sida i Excel | [Visa och redigera i Excel](across-work-with-excel.md) |
...
| Visa och analysera ekonomiska data med hjälp av kontouppställningar. | [Ekonomisk analys](bi.md) |
