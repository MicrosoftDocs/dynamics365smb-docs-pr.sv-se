...
# <a name="the-c5-data-migration-extension"></a><a name="the-c5-data-migration-extension"></a>Tillägget C5 Datamigrering
...
## <a name="what-data-is-migrated"></a><a name="what-data-is-migrated"></a>Vilka data migreras?

Följande data överförs för respektive enhet:

### <a name="customers"></a><a name="customers"></a>Kunder
...
### <a name="vendors"></a><a name="vendors"></a>Leverantör
...
### <a name="chart-of-accounts"></a><a name="chart-of-accounts"></a>Kontoplan
...
## <a name="file-size-requirements"></a><a name="file-size-requirements"></a>Storlekskraven i filen
...
## <a name="to-migrate-data"></a><a name="to-migrate-data"></a>Migrera data
...
## <a name="viewing-the-status-of-the-migration"></a><a name="viewing-the-status-of-the-migration"></a>Visa status för migreringen
...
## <a name="how-to-avoid-double-posting"></a><a name="how-to-avoid-double-posting"></a>Så här undviker du dubbel bokföring
...
## <a name="correcting-errors"></a><a name="correcting-errors"></a>Felkorrigering
...
## <a name="verifying-data-after-migrating"></a><a name="verifying-data-after-migrating"></a>Kontrollera data efter migrering
...
## <a name="stopping-data-migration"></a><a name="stopping-data-migration"></a>Stoppa datamigrering
