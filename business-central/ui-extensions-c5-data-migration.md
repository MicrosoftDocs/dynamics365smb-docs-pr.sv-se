...
# <a name="the-c5-data-migration-extension" />Tillägget C5 Datamigrering
...
## <a name="what-data-is-migrated" />Vilka data migreras?
...
## <a name="file-size-requirements" />Storlekskraven i filen
...
## <a name="to-migrate-data" />Migrera data
...
## <a name="viewing-the-status-of-the-migration" />Visa status för migreringen
...
## <a name="how-to-avoid-double-posting" />Så här undviker du dubbel bokföring
...
## <a name="correcting-errors" />Felkorrigering
...
## <a name="verifying-data-after-migrating" />Kontrollera data efter migrering
...
## <a name="stopping-data-migration" />Stoppa datamigrering
