...
ms.author: bholtorf
---
# <a name="integrating-with-dynamics-365-sales"></a><a name="integrating-with-dynamics-365-sales"></a>Integrering med Dynamics 365 Sales
...
## <a name="integrating-through-dataverse"></a><a name="integrating-through-dataverse"></a>Integrera via Dataverse
...
## <a name="integration-settings-that-are-specific-to-a--integration"></a><a name="integration-settings-that-are-specific-to-a--integration"></a>Integreringsinställningar som är specifika för en [!INCLUDE[crm_md](includes/crm_md.md)]-integrering
...
## <a name="permissions-and-security-roles-for-user-accounts-in-sales"></a><a name="permissions-and-security-roles-for-user-accounts-in-sales"></a>Behörigheter och säkerhetsroller för användarkonton i Sales
...
### <a name="connection-settings-in-the-setup-guide"></a><a name="connection-settings-in-the-setup-guide"></a>Anslutningsinställningar i installationsguiden
...
### <a name="connection-settings-on-the-microsoft-dynamics-365-connection-setup-page"></a><a name="connection-settings-on-the-microsoft-dynamics-365-connection-setup-page"></a>Anslutningsinställningar på inställningssidan för Microsoft Dynamics 365-anslutningar
...
### <a name="standard-sales-entity-mapping-for-synchronization"></a><a name="standard-sales-entity-mapping-for-synchronization"></a>Standardinställd försäljningsenhetsmappningar för synkronisering
...
## <a name="synchronizing-items-and-resources-with-products-with-different-units-of-measure"></a><a name="synchronizing-items-and-resources-with-products-with-different-units-of-measure"></a>Synkronisera artiklar och resurser med produkter i andra måttenheter
...
### <a name="mapping-items-and-resources-to-products"></a><a name="mapping-items-and-resources-to-products"></a>Mappa artiklar och resurser till produkter
...
### <a name="synchronization-jobs-for-a-sales-integration"></a><a name="synchronization-jobs-for-a-sales-integration"></a>Synkroniseringsjobb för Sales-integrering
...
## <a name="connecting-to-on-premises-versions-of-business-central-2019-release-wave-1-and-microsoft-dynamics-nav-2018"></a><a name="connecting-to-on-premises-versions-of-business-central-2019-release-wave-1-and-microsoft-dynamics-nav-2018"></a>Ansluter till lokala versioner av Business Central 2019 utgivningscykel 1 och Microsoft Dynamics NAV 2018
...
### <a name="to-connect-business-central-2019-release-wave-1-and-dynamics-nav-2018"></a><a name="to-connect-business-central-2019-release-wave-1-and-dynamics-nav-2018"></a>Så här ansluter du Business Central 2019 utgivningscykel 1 och Dynamics NAV 2018
