...
ms.author: bholtorf
---
# <a name="integrating-with-dynamics-365-sales" />Integrering med Dynamics 365 Sales
...
## <a name="integrating-through-dataverse" />Integrera via Dataverse
...
## <a name="integration-settings-that-are-specific-to-a-includecrmmdincludescrmmdmd-integration" />Integreringsinställningar som är specifika för en [!INCLUDE[crm_md](includes/crm_md.md)]-integrering
...
## <a name="permissions-and-security-roles-for-user-accounts-in-sales" />Behörigheter och säkerhetsroller för användarkonton i Sales
...
### <a name="connection-settings-in-the-setup-guide" />Anslutningsinställningar i installationsguiden
...
### <a name="connection-settings-on-the-microsoft-dynamics-365-connection-setup-page" />Anslutningsinställningar på inställningssidan för Microsoft Dynamics 365-anslutningar
...
### <a name="standard-sales-entity-mapping-for-synchronization" />Standardinställd försäljningsenhetsmappningar för synkronisering
...
## <a name="synchronizing-items-and-resources-with-products-with-different-units-of-measure" />Synkronisera artiklar och resurser med produkter i andra måttenheter
...
### <a name="mapping-items-and-resources-to-products" />Mappa artiklar och resurser till produkter
...
### <a name="synchronization-jobs-for-a-sales-integration" />Synkroniseringsjobb för Sales-integrering
...
## <a name="connecting-to-on-premises-versions-of-business-central-2019-release-wave-1-and-microsoft-dynamics-nav-2018" />Ansluter till lokala versioner av Business Central 2019 utgivningscykel 1 och Microsoft Dynamics NAV 2018
...
### <a name="to-connect-business-central-2019-release-wave-1-and-dynamics-nav-2018" />Så här ansluter du Business Central 2019 utgivningscykel 1 och Dynamics NAV 2018
