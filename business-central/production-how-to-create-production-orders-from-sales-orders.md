...
---
# <a name="create-production-orders-from-sales-orders" />Så här skapar du produktionsorder från försäljningsorder

Du kan skapa produktionsorder för producerade artiklar direkt från försäljningsorder.  

## <a name="to-create-a-production-order-from-a-sales-order" />Så här skapar du produktionsorder från försäljningsorder
