...
# <a name="the-data-archive-extension" />Tillägget Dataarkiv
...
## <a name="start-archiving-data" />Starta arkivering av data
...
## <a name="storage-considerations" />Överväganden vid lagring
