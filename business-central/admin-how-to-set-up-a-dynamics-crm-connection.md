...
ms.author: bholtorf
---
# <a name="connect-to-microsoft-dataverse" />Anslut till Microsoft Dataverse
...
### <a name="to-use-the-dataverse-connection-setup-assisted-setup-guide" />Så här använder du den assisterade guiden Konfiguration av anslutning till Dataverse
...
### <a name="to-create-or-maintain-the-connection-manually" />Om du vill skapa eller hantera anslutningen manuellt
...
## <a name="customize-the-match-based-coupling" />Anpassa matchningsbaserad koppling
...
### <a name="view-the-results-of-the-coupling-job" />Visa resultatet av kopplingsjobbet
...
## <a name="upgrade-connections-from-business-central-online-to-use-certificate-based-authentication" />Uppgradera anslutningar från Business Central Online till använda certifikatbaserad autentisering
...
### <a name="to-upgrade-your-business-central-online-connection-to-use-certificate-based-authentication" />För att uppgradera din Business Central online-anslutning för att använda certifikatbaserad autentisering
...
## <a name="connecting-on-premises-versions" />Ansluta lokala versioner
...
### <a name="to-register-an-application-in-azure-ad-for-connecting-from-business-central-to-dataverse" />Så här registrerar du ett program i Azure AD för att ansluta från Business Central till Dataverse
