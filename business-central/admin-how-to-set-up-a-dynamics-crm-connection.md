...
## <a name="set-up-a-connection-to-"></a>Konfigurera en anslutning till [!INCLUDE[cds_long_md](includes/cds_long_md.md)]
...
### <a name="to-disconnect-from-"></a>Koppla bort från [!INCLUDE[cds_long_md](includes/cds_long_md.md)]
