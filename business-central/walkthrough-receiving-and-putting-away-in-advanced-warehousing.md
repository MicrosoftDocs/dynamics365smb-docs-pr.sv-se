...
2.  Välj det enda distributionslagerinförseldokumentet i listan, och välj sedan åtgärden **Redigera**.  
    ...
    Lagerarbetaren har fått informationen att 40 gångjärn behövs i monteringavdelningen, och han fortsätter att dela upp den enda placeraraden för lagerstället W-02-0001 i monteringavdelningen där han placerar den delen av de inlevererade gångjärnen.  
