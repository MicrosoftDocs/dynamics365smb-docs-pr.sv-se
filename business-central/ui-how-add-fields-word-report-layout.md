...
# <a name="work-with-word-layouts" />Arbeta med Word-layouter
...
## <a name="embedding-fonts-in-word-layouts-for-consistency" />Inbäddade teckensnitt i Word-ayouter för konsistens
...
## <a name="adding-data-fields" />Lägga till datafält
...
### <a name="to-add-a-label-or-data-field" />Så här lägger du till en rubrik eller ett datafält
...
### <a name="to-add-repeating-rows-of-data-fields-to-create-a-list" />Så här lägger du till upprepande rader med datafält för att skapa en lista
...
## <a name="adding-image-fields" />Lägga till bildfält
...
### <a name="to-add-an-image" />Så här lägger du till en bild
...
### <a name="to-remove-a-label-or-data-field" />Så här tar du bort en rubrik eller ett datafält
...
## <a name="custom-xml-part-overview" />Översikt över anpassad XML-del
...
### <a name="xml-structure-of-custom-xml-part" />XML-struktur för anpassad XML-del
...
### <a name="custom-xml-part-in-word" />Anpassad XML-del i Word
