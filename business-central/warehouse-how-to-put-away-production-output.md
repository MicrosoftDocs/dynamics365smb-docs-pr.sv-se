...
---
# <a name="put-away-production-or-assembly-output" />Föra in produktions- eller monteringsutflöde
...
## <a name="to-put-away-production-output-with-an-inventory-put-away" />Så här för du in produktionsutflöde med lagerartikelinförsel
...
### <a name="to-create-the-inbound-warehouse-request" />Så här skapar du det inkommande distributionslagerkravet
...
### <a name="to-put-output-away-with-an-inventory-put-away" />Så här för du in utflöde med Lagerartikelinförsel:
...
## <a name="to-put-assembly-and-production-output-away-in-advanced-warehouse-configurations" />För att föra in monterings- eller produktionsutflöde i avancerade distributionslagerkonfigurationer
