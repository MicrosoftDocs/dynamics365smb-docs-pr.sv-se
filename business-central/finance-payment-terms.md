...
ms.author: edupont
---
# <a name="set-up-payment-terms"></a><a name="set-up-payment-terms"></a>Ställa in betalningsvillkor
...
## <a name="to-set-up-payment-terms"></a><a name="to-set-up-payment-terms"></a>Så här definierar du betalningsvillkor
