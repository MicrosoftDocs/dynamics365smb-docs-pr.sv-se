...
---
# <a name="mapping-the-tables-and-fields-to-synchronize"></a><a name="mapping-the-tables-and-fields-to-synchronize"></a>Mappa register och fält som ska synkroniseras
...
## <a name="mapping-integration-tables"></a><a name="mapping-integration-tables"></a>Integreringsregister för mappning
...
### <a name="additional-mappings"></a><a name="additional-mappings"></a>Ytterligare mappningar
...
### <a name="strategies-for-auto-resolving-conflicts"></a><a name="strategies-for-auto-resolving-conflicts"></a>Strategier för att lösa konflikter automatiskt
...
## <a name="mapping-integration-fields"></a><a name="mapping-integration-fields"></a>Mappa integreringsfält
...
### <a name="handle-differences-in-field-values"></a><a name="handle-differences-in-field-values"></a>Hantera skillnader i fältvärden
...
### <a name="handle-missing-option-values"></a><a name="handle-missing-option-values"></a>Hantera alternativvärden som saknas
...
## <a name="couple-records"></a><a name="couple-records"></a>Koppla poster
...
## <a name="filter-records-and-rows"></a><a name="filter-records-and-rows"></a>Filtrera poster och rader
...
## <a name="create-new-records"></a><a name="create-new-records"></a>Skapa nya poster
...
### <a name="to-create-new-records-during-synchronization"></a><a name="to-create-new-records-during-synchronization"></a>Så här skapar du nya poster under synkroniseringen
...
## <a name="use-configuration-templates-on-table-mappings"></a><a name="use-configuration-templates-on-table-mappings"></a>Använda konfigurationsmallar på registermappningar
...
### <a name="to-specify-configuration-templates-on-a-table-mapping"></a><a name="to-specify-configuration-templates-on-a-table-mapping"></a>Ange konfigurationsmallar på en registermappning
