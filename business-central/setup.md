...
ms.author: edupont
---
# <a name="overview-of-tasks-to-set-up-includeprodshortincludesprodshortmd" />Översikt över arbetsuppgifter för att ställa in [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="set-up-apps" />Konfigurera appar
