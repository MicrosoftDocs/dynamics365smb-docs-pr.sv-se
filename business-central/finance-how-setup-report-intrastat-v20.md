...
ms.author: bholtorf
---
# <a name="set-up-and-report-intrastat" />Skapa och rapportera Intrastat
...
## <a name="required-and-optional-setups" />Nödvändiga och frivilliga inställningar
...
### <a name="to-set-up-intrastat-templates-and-batches" />Så här ställer du in intrastatjournalmallar och intrastatjournaler
...
### <a name="to-set-up-transport-methods" />Så här ställer du in transportsätt
...
### <a name="to-set-up-which-intrastat-report-fields-are-mandatory" />Om du vill ställa in vilka Intrastatrapportfält som är obligatoriska
...
#### <a name="to-set-up-transaction-nature-codes" />Så här skapar du koder av transaktionstyp
...
## <a name="to-report-intrastat" />Att rapportera intrastat
...
### <a name="to-fill-in-intrastat-journals" />Så här fyller du i intrastatjournaler
...
### <a name="to-modify-intrastat-journals-lines" />Så här ändrar du Intrastatjournalens rader
...
### <a name="report-intrastat-on-a-form-or-a-file" />Rapportera intrastat på ett formulär eller en fil
...
## <a name="reorganize-intrastat-journals" />Omorganisera intrastatjournaler
...
## <a name="tariff-numbers" />EU tull statistiknr
