...
## <a name="to-add-prepayment-accounts-to-the-general-posting-setup" />Så här lägger du till konton för förutbetalda poster i bokföringsinställningarna
...
## <a name="to-set-up-number-series-for-prepayment-documents" />Så här skapar du nummerserier för dokument för förskottsbetalning
...
## <a name="to-set-up-prepayment-percentages-for-items-customers-and-vendors" />Ställa in Procentandelar, förskottsbetalning för artiklar, kunder och leverantörer
...
### <a name="to-determine-which-prepayment-percentage-has-first-priority" />Så här fastställer du vilken förskottsbetalda procentandel som har första prioritet
...
## <a name="to-automatically-release-sales-orders-when-prepayments-are-applied" />Så här släpper du försäljningsorder automatiskt när förskottsbetalningar används
