...
---
# <a name="transfer-inventory-between-locations" />Överföra lager mellan olika lagerställen
...
## <a name="transfer-orders" />Överföringsorder
...
## <a name="item-reclassification-journals" />Artikelgrupperingsjournaler
...
## <a name="to-transfer-items-with-a-transfer-order" />För att överföra artiklar med en överföringsorder.
...
### <a name="post-multiple-transfer-orders-in-a-batch" />Bokföra flera överföringsorder i en batch
...
### <a name="schedule-a-job-queue-entry-to-post-multiple-documents-in-a-batch" />Tidsplanera en jobbkötransaktion för att bokföra flera dokument i en batch
...
## <a name="to-transfer-items-with-the-item-reclassification-journal" />Så här överför du artiklar med artikelgrupperingsjournalen
...
## <a name="undo-a-transfer-shipment" />Ångra överföringsutleverans
