...
> [!NOTE]
> Om du vill överföra artiklar måste lägerställen och överföringsflöden ställas in. Mer information om hur du konfigurerar platser finns i [Konfigurera platser](inventory-how-setup-locations.md). Det går inte att använda överföringsorder för *tomma* platser.
...
5.  **Välj åtgärden Bokför** och välj **sedan Bokför batch**.
