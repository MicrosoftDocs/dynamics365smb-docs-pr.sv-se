...
ms.author: bholtorf
---
# <a name="register-new-vendors" />Registrera nya leverantörer
...
## <a name="adding-new-vendors" />Lägga till nya leverantörer
...
### <a name="to-create-a-new-vendor" />Skapa en ny leverantör
...
### <a name="deleting-and-editing-vendor-information" />Ta bort och redigera leverantörsinformation
...
## <a name="to-save-the-vendor-card-as-a-template" />Om du vill spara leverantörskortet som en mall
