...
# <a name="troubleshooting-accessing-camera-and-location" />Felsökning: komma åt kamera och plats
...
## <a name="device-must-have-camera-and-location-capabilities" />Enheten måste ha kamera och platsfunktioner
...
## <a name="access-permissions-not-enabled" />Åtkomstbehörighet är inte aktiverad
...
## <a name="web-client-connection-not-secure" />Webbklient anslutning inte säker
...
## <a name="work-with-virtualization-technologies" />Arbeta med virtualiseringsteknik
...
## <a name="antivirus-software" />Antivirusprogram
