...
### <a name="FilterCriteria"> </a>Filterkriterier och operatorer
...
### <a name="symbols"></a>Filtrera värden som innehåller symboler
...
#### (%me eller %user) poster som har tilldelats dig

Använd `%me` eller `%user` när du filtrerar i fält som innehåller användar-ID såsom fältet **Tilldelats användar-ID** om du vill visa alla poster som har tilldelats dig.

|Exempel|Poster som visas|  
|-----------------------|-----------------------|  
|`%me`<br />eller<br />`%user`|Poster som är tilldelade till ditt användarkonto. |  
