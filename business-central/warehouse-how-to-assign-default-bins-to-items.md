...
ms.author: edupont
---
# <a name="assign-default-bins-to-items" />Tilldela standardlagerställen till artiklar
...
## <a name="to-assign-a-default-bin-to-an-item" />Så här tilldelar du en standardlagerplats till en artikel
...
## <a name="to-change-the-default-bin-for-an-item" />Så här ändrar du standardlagerställen en artikel
