...
ms.author: bholtorf
---
# Spärra artiklar för försäljning eller inköp
...
## Så här spärrar du en artikel så att den inte kan registreras på försäljningsrader  
...
## Så här spärrar du en artikel så att den inte kan registreras på inköpsrader  

1. Välj den ![Glödlampa som öppnar funktionen Berätta.](media/ui-search/search_small.png "Berätta vad du vill göra") anger du **Artiklar** och väljer sedan relaterad länk.  
2. Välj den artikel som du vill spärra och markera sedan kryssrutan **Spärrad för inköp**.  

## Så här spärrar du en artikel så att den inte kan bokföras
