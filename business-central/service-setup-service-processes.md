...
ms.author: bholtorf
---
# <a name="configure-service-processes" />Konfigurera serviceprocesser
...
## <a name="to-enter-general-and-mandatory-settings" />Så här anger du allmänna och obligatoriska inställningar
