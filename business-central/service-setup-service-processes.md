...
ms.author: bholtorf
---
# <a name="configure-service-processes"></a><a name="configure-service-processes"></a><a name="configure-service-processes"></a>Konfigurera serviceprocesser
...
## <a name="to-enter-general-and-mandatory-settings"></a><a name="to-enter-general-and-mandatory-settings"></a><a name="to-enter-general-and-mandatory-settings"></a>Så här anger du allmänna och obligatoriska inställningar
