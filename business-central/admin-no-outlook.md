...
ms.author: edupont
---
# <a name="use-business-central-without-outlook"></a><a name="use-business-central-without-outlook"></a><a name="use-business-central-without-outlook"></a>Använda Business Central utan Outlook
...
## <a name="sending-email"></a><a name="sending-email"></a><a name="sending-email"></a>Skicka e-post
