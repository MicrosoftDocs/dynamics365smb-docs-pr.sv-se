...
ms.author: bholtorf
---
# <a name="the-quickbooks-payroll-file-import-extension" />QuickBook-tillägg för import av lönefil
...
## <a name="steps-to-import-payroll-data" />Steg för att importera lönedata
