...
ms.author: edupont
---
# <a name="enable-approval-workflows"></a><a name="enable-approval-workflows"></a>Aktivera arbetsflöden för godkännande
...
## <a name="enable-a-workflow"></a><a name="enable-a-workflow"></a>Aktivera ett arbetsflöde
