...
# <a name="record-special-sales-prices-and-discounts" />Registrera speciella försäljningspriser och rabatter
...
## <a name="to-set-up-a-sales-price-for-a-customer" />Så här skapar du försäljningspriser för en kund:
...
## <a name="using-sales-and-purchase-price-lists" />Använda försäljnings- och inköpsprislistor
...
### <a name="converting-existing-prices-when-you-turn-on-the-pricing-feature-update" />Konvertera befintliga priser när du aktiverar prisfunktionsuppdateringen
...
### <a name="editing-active-price-lists" />Redigera aktiva prislistor
...
#### <a name="create-sales-price-lines-based-on-the-unit-price" />Skapa försäljningsprisrader baserat på enhetspriset
...
#### <a name="create-sales-price-lines-based-on-existing-price-lists" />Skapa försäljningsprisrader baserat på befintliga prislistor
...
## <a name="best-price-calculation" />Bästa prisberäkning
...
## <a name="sales-invoice-discounts-and-service-charges" />Försäljningsfakturarabatter och faktureringsavgifter
...
## <a name="see-related-microsoft-trainingtrainingmodulesmanage-sales-prices-dynamics-365-business-centralindex" />Se relaterad [Microsoft utbildning](/training/modules/manage-sales-prices-dynamics-365-business-central/index)
