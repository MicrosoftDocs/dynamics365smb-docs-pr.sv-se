...
---
# <a name="assemble-items"></a><a name="assemble-items"></a><a name="assemble-items"></a>Montera Artiklar
...
## <a name="to-assemble-an-item-to-stock"></a><a name="to-assemble-an-item-to-stock"></a><a name="to-assemble-an-item-to-stock"></a>Om du vill att sammanställa en artikel till lager
