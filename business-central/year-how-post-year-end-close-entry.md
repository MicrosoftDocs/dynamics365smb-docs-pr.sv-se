...
ms.author: edupont
---
# <a name="posting-the-year-end-closing-entry" />Bokför du årsslutstransaktionen
...
## <a name="to-post-the-year-end-closing-entry" />Så här bokför du årsslutstransaktionen
