...
ms.author: edupont
---
# <a name="work-with-payment-tolerances-and-payment-discount-tolerances"></a><a name="work-with-payment-tolerances-and-payment-discount-tolerances"></a>Arbeta med betalningstoleranser och kassarabattstoleranser
...
## <a name="applying-payment-tolerance-to-multiple-documents"></a><a name="applying-payment-tolerance-to-multiple-documents"></a>Använda betalningstolerans på flera dokument
...
## <a name="to-set-up-tolerances"></a><a name="to-set-up-tolerances"></a>Så här lägger du upp toleranser
...
## <a name="to-enable-or-disable-payment-tolerance-warnings"></a><a name="to-enable-or-disable-payment-tolerance-warnings"></a>Så här aktiverar eller inaktiverar du betalningstoleransvarningen:
...
## <a name="to-block-payment-tolerance-for-customers"></a><a name="to-block-payment-tolerance-for-customers"></a>Så här spärrar du betalningstolerans för kunder
...
## <a name="example-1---tolerance-calculations-for-a-single-document"></a><a name="example-1---tolerance-calculations-for-a-single-document"></a>Exempel 1 – toleransberäkningar för enstaka dokument
...
### <a name="payment-range-diagrams"></a><a name="payment-range-diagrams"></a>Betalningsintervalldiagram

I relation till scenariot ovan kan betalningsintervallen illustreras på följande sätt:  

#### <a name="1-payment-date-011503-scenarios-1-3"></a><a name="1-payment-date-011503-scenarios-1-3"></a>(1) Betalningsdatum <=03-01-15 (scenarier 1–3)
...
#### <a name="2-payment-date-is-between-011603-and-012003-scenarios-4-9"></a><a name="2-payment-date-is-between-011603-and-012003-scenarios-4-9"></a>(2) Betalningsdatumet infaller mellan 03-01-16 och 03-01-20 (scenario 4-9)
...
#### <a name="3-payment-date-is-after-012003-scenarios-10-15"></a><a name="3-payment-date-is-after-012003-scenarios-10-15"></a>(3) Betalningsdatum infaller efter 03-01-20 (scenario 10-15)
...
## <a name="example-2---tolerance-calculations-for-multiple-documents"></a><a name="example-2---tolerance-calculations-for-multiple-documents"></a>Exempel 2 – toleransberäkningar för flera dokument
...
### <a name="payment-range-diagrams-1"></a><a name="payment-range-diagrams-1"></a>Betalningsintervalldiagram

I relation till scenariot ovan kan betalningsintervallen illustreras på följande sätt:  

#### <a name="1-payment-date-011503-scenarios-1-3-1"></a><a name="1-payment-date-011503-scenarios-1-3-1"></a>(1) Betalningsdatum <=03-01-15 (scenarier 1–3)
...
#### <a name="2-payment-date-is-between-011603-and-011703-scenarios-4-9"></a><a name="2-payment-date-is-between-011603-and-011703-scenarios-4-9"></a>(2) Betalningsdatumet infaller mellan 03-01-16 och 03-01-17 (scenario 4-9)
...
#### <a name="3-payment-date-is-between-011803-and-012003-scenarios-10-21"></a><a name="3-payment-date-is-between-011803-and-012003-scenarios-10-21"></a>(3) Betalningsdatumet infaller mellan 03-01-18 och 03-01-20 (scenario 10-21)
...
#### <a name="4-payment-date-is-between-012103-and-012203-scenarios-22-27"></a><a name="4-payment-date-is-between-012103-and-012203-scenarios-22-27"></a>(4) Betalningsdatumet infaller mellan 03-01-21 och 03-01-22 (scenario 22-27)
...
#### <a name="5-payment-date-is-after-012203-scenarios-28-30"></a><a name="5-payment-date-is-after-012203-scenarios-28-30"></a>(5) Betalningsdatum infaller efter 03-01-22 (scenario 28-30)
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relaterad [Microsoft utbildning](/training/modules/enter-payments-dynamics-365-business-central/)
