...
9. Fyll i fälten **Betalningsrabatt**, **Betalningsfristperiod** **och** Betalningstoleransbokföring på snabbfliken Koppling **.**    
...
11. På sidan **Ändra betalningstolerans** fyller du i fälten **Betalningstolerans %**  och **Max betalttoleransbelopp** och väljer **sedan knappen OK** .
...
### <a name="payment-range-diagrams-1"></a>Betalningsintervalldiagram

I relation till scenariot ovan kan betalningsintervallen illustreras på följande sätt:  

#### <a name="1-payment-date-011503-scenarios-1-3-1"></a>(1) Betalningsdatum <=03-01-15 (scenarier 1–3)
