...
ms.author: edupont
---
# <a name="add-extended-text" />Lägg till extratext
...
## <a name="to-define-extended-text-for-an-description" />Om du vill definiera extratexten för en beskrivning
...
## <a name="to-add-an-extended-item-text-on-a-sales-order-line" />För att lägga till en utökad artikeltext på en försäljningsorderrad.
