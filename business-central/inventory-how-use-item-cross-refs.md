...
ms.author: edupont
---
# <a name="use-item-references"></a><a name="use-item-references"></a>Använd artikelreferenser
...
## <a name="to-start-using-item-references"></a><a name="to-start-using-item-references"></a>Börja använda artikelreferenser
...
## <a name="to-set-up-an-item-reference"></a><a name="to-set-up-an-item-reference"></a>Så här ställer du in en artikelreferens
...
## <a name="to-enter-a-vendors-item-description-on-a-document"></a><a name="to-enter-a-vendors-item-description-on-a-document"></a>Ange leverantörens artikelbeskrivning på ett dokument
