...
---
# <a name="overview-of-ai-powered-item-marketing-text-preview-with-copilot"></a><a name="overview-of-ai-powered-item-marketing-text-preview-with-copilot"></a>Översikt över marknadsföringstext för AI-baserad artikel (förhandsversion) med Copilot

[!INCLUDE[ai-preview](includes/ai-preview.md)]

I den här artikeln får du en översikt över den AI-drivna kapacitet som medföljer Copilot i Business Central.

## <a name="what-is-ai-powered-item-marketing-text-with-copilot"></a><a name="what-is-ai-powered-item-marketing-text-with-copilot"></a>Vad är marknadsföringstext för AI-baserad artikel med Copilot
...
## <a name="where-its-used"></a><a name="where-its-used"></a>Där den används
...
## <a name="why-and-how-to-use-it"></a><a name="why-and-how-to-use-it"></a>Varför använda den och hur
...
## <a name="current-limitations"></a><a name="current-limitations"></a>Vilka är de aktuella begränsningarna?
