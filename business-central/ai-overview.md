...
---
# <a name="overview-of-ai-powered-item-marketing-text-preview-with-copilot" />Översikt över marknadsföringstext för AI-baserad artikel (förhandsversion) med Copilot

[!INCLUDE[ai-preview](includes/ai-preview.md)]

I den här artikeln får du en översikt över den AI-drivna kapacitet som medföljer Copilot i Business Central.

## <a name="what-is-ai-powered-item-marketing-text-with-copilot" />Vad är marknadsföringstext för AI-baserad artikel med Copilot
...
## <a name="where-its-used" />Där den används
...
## <a name="why-and-how-to-use-it" />Varför använda den och hur
...
## <a name="current-limitations" />Vilka är de aktuella begränsningarna?
