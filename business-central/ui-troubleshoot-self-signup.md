...
ms.author: edupont
---
# <a name="troubleshooting-self-service-sign-up" />Felsöka registrering av Self Service
...
## <a name="what-email-address-can-i-use-with-business-central" />Vilken e-postadress kan jag använda med Business Central?
...
## <a name="regional-availability" />Regional tillgänglighet
