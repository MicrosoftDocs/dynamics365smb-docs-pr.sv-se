...
ms.author: bholtorf
---
# <a name="work-with-responsibility-centers" />Arbeta med ansvarsenheter
...
## <a name="to-set-up-a-responsibility-center" />Så här skapar du en ansvarsenhet
...
## <a name="to-assign-responsibility-centers-to-users" />Så här tilldelar du ansvarsenheter till användare
