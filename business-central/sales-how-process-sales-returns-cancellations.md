...
ms.author: edupont
---
# <a name="process-sales-returns-or-cancellations" />Behandla försäljningsreturer eller annulleringar
...
## <a name="to-create-a-sales-credit-memo-from-a-posted-sales-invoice" />Skapa en ny försäljningskreditnota från en bokförd försäljningsfaktura.
...
## <a name="to-create-a-sales-credit-memo-by-copying-a-posted-sales-invoice" />Skapa en ny försäljningskreditnota genom att kopiera en bokförd försäljningsfaktura.
...
## <a name="to-create-a-sales-allowance" />Så här skapar du ett förs. tillägg
...
## <a name="to-combine-return-receipts" />Så här kombinerar du returinleveranser
...
### <a name="to-manually-combine-return-receipts" />Så här kombinerar du returinleveranser manuellt
...
### <a name="to-automatically-combine-return-receipts" />Så här kombinerar du returinleveranser automatiskt
...
### <a name="to-remove-a-received-and-invoiced-return-order" />Så här tar du bort en inlevererad och fakturerad returorder
