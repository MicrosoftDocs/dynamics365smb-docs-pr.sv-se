...
ms.author: bholtorf
---
# <a name="work-with-service-contracts-and-service-contract-quotes" />Så här arbetar du med servicekontrakt och servicekontraktsofferter
...
## <a name="to-create-a-service-contract-or-service-contract-quote" />Så här skapar du ett servicekontrakt eller en servicekontraktsoffert
...
## <a name="to-convert-a-service-contract-quote-to-service-contract" />Så här omvandlar du en servicekontraktsoffert till ett servicekontrakt
...
## <a name="to-create-contract-service-credit-memos" />Så här skapar du servicekreditnotor för kontrakt:
...
## <a name="updating-and-evaluating-contracts" />Uppdatera och utvärdera kontrakt
...
## <a name="to-add-a-contract-line-to-a-service-contract-or-contract-quote" />Så här lägger du till en kontraktsrad i ett servicekontrakt eller en kontraktsoffert
...
## <a name="to-remove-contract-lines" />Så här tar du bort kontraktsrader
...
## <a name="service-line-cost-and-value" />Kostnaden för serviceraden och värde
...
## <a name="to-add-a-contract-discount-to-service-contract-quotes" />Så här lägger du till kontraktsrabatter för servicekontraktsofferter
...
## <a name="to-change-the-owner-of-a-service-contract" />Så här ändrar du ägare till servicekontrakt
...
## <a name="to-update-a-service-contract-price" />Så här uppdaterar du ett servicekontraktspris
...
## <a name="to-post-prepaid-contract-entries" />Så här bokför du förutbetalda kontraktstransaktioner
...
## <a name="changing-the-service-contract-status" />Ändra servicekontraktstatus
...
## <a name="to-cancel-a-service-contract" />Så här makulerar du kontrakt
...
## <a name="filing-a-service-contract-or-contract-quote" />Så här arkiverar du servicekontrakt och kontraktsofferter
