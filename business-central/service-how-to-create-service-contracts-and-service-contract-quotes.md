...
ms.author: bholtorf
---
# <a name="work-with-service-contracts-and-service-contract-quotes"></a><a name="work-with-service-contracts-and-service-contract-quotes"></a><a name="work-with-service-contracts-and-service-contract-quotes"></a>Så här arbetar du med servicekontrakt och servicekontraktsofferter
...
## <a name="to-create-a-service-contract-or-service-contract-quote"></a><a name="to-create-a-service-contract-or-service-contract-quote"></a><a name="to-create-a-service-contract-or-service-contract-quote"></a>Så här skapar du ett servicekontrakt eller en servicekontraktsoffert
...
## <a name="to-convert-a-service-contract-quote-to-service-contract"></a><a name="to-convert-a-service-contract-quote-to-service-contract"></a><a name="to-convert-a-service-contract-quote-to-service-contract"></a>Så här omvandlar du en servicekontraktsoffert till ett servicekontrakt
...
## <a name="to-create-contract-service-credit-memos"></a><a name="to-create-contract-service-credit-memos"></a><a name="to-create-contract-service-credit-memos"></a>Så här skapar du servicekreditnotor för kontrakt:
...
## <a name="updating-and-evaluating-contracts"></a><a name="updating-and-evaluating-contracts"></a><a name="updating-and-evaluating-contracts"></a>Uppdatera och utvärdera kontrakt
...
## <a name="to-add-a-contract-line-to-a-service-contract-or-contract-quote"></a><a name="to-add-a-contract-line-to-a-service-contract-or-contract-quote"></a><a name="to-add-a-contract-line-to-a-service-contract-or-contract-quote"></a>Så här lägger du till en kontraktsrad i ett servicekontrakt eller en kontraktsoffert
...
## <a name="to-remove-contract-lines"></a><a name="to-remove-contract-lines"></a><a name="to-remove-contract-lines"></a>Så här tar du bort kontraktsrader
...
## <a name="service-line-cost-and-value"></a><a name="service-line-cost-and-value"></a><a name="service-line-cost-and-value"></a>Kostnaden för serviceraden och värde
...
## <a name="to-add-a-contract-discount-to-service-contract-quotes"></a><a name="to-add-a-contract-discount-to-service-contract-quotes"></a><a name="to-add-a-contract-discount-to-service-contract-quotes"></a>Så här lägger du till kontraktsrabatter för servicekontraktsofferter
...
## <a name="to-change-the-owner-of-a-service-contract"></a><a name="to-change-the-owner-of-a-service-contract"></a><a name="to-change-the-owner-of-a-service-contract"></a>Så här ändrar du ägare till servicekontrakt
...
## <a name="to-update-a-service-contract-price"></a><a name="to-update-a-service-contract-price"></a><a name="to-update-a-service-contract-price"></a>Så här uppdaterar du ett servicekontraktspris
...
## <a name="to-post-prepaid-contract-entries"></a><a name="to-post-prepaid-contract-entries"></a><a name="to-post-prepaid-contract-entries"></a>Så här bokför du förutbetalda kontraktstransaktioner
...
## <a name="changing-the-service-contract-status"></a><a name="changing-the-service-contract-status"></a><a name="changing-the-service-contract-status"></a>Ändra servicekontraktstatus
...
## <a name="to-cancel-a-service-contract"></a><a name="to-cancel-a-service-contract"></a><a name="to-cancel-a-service-contract"></a>Så här makulerar du kontrakt
...
## <a name="filing-a-service-contract-or-contract-quote"></a><a name="filing-a-service-contract-or-contract-quote"></a><a name="filing-a-service-contract-or-contract-quote"></a>Så här arkiverar du servicekontrakt och kontraktsofferter
