...
4. I fältet **Kundnr.** anger du numret på kunden i servicekontraktet.  
    ...
    > [!NOTE]  
    >  Du kan jämföra kreditnotan med det bokförda originaldokumentet på sidan **Bokförda servicefakturor**. Välj ikonen ![Glödlampa som öppnar funktionen Berätta](media/ui-search/search_small.png "Berätta vad du vill göra"), ange **Bokförda servicefakturor** och välj sedan relaterad länk.  
...
1. Välj ikonen ![Glödlampa som öppnar funktionen Berätta](media/ui-search/search_small.png "Berätta vad du vill göra"), ange **servicekontrakt** och välj sedan relaterad länk. Öppna relevant servicekontrakt där du vill ändra ägare.  
...
1. Välj ikonen ![Glödlampa som öppnar funktionen Berätta](media/ui-search/search_small.png "Berätta vad du vill göra"), ange **Uppdatera servicekontraktspriser** och välj sedan relaterad länk.
...
1. Välj ikonen ![Glödlampa som öppnar funktionen Berätta](media/ui-search/search_small.png "Berätta vad du vill göra"), ange **bokföra förutbetalda kontraktstransaktioner** och välj sedan relaterad länk.  
