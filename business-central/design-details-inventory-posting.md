...
ms.author: edupont
---
# <a name="design-details-inventory-posting"></a><a name="design-details-inventory-posting"></a>Designdetaljer: Lagerbokföring
...
### <a name="item-ledger-entries-1"></a><a name="item-ledger-entries-1"></a>Artikeltransaktioner (1)
...
### <a name="item-application-entries-1"></a><a name="item-application-entries-1"></a>Kopplingstransaktioner för artikel (1)
...
### <a name="item-ledger-entries-2"></a><a name="item-ledger-entries-2"></a>Artikeltransaktioner (2)
...
### <a name="item-application-entries-2"></a><a name="item-application-entries-2"></a>Kopplingstransaktioner för artikel (2)
...
### <a name="value-entries-3"></a><a name="value-entries-3"></a>Värdetransaktioner (3)
...
### <a name="general-ledger-entries-3"></a><a name="general-ledger-entries-3"></a>Redovisningstransaktioner (3)
...
### <a name="relation-entries-in-the-gl--item-ledger-relation-table-3"></a><a name="relation-entries-in-the-gl--item-ledger-relation-table-3"></a>Relationstransaktioner i redovisning – tabellen Artikeltransaktionsrelation (3)
...
## <a name="assembly-and-production-posting"></a><a name="assembly-and-production-posting"></a>Montering- och produktionsbokföring
