...
# <a name="set-up-fixed-asset-depreciation" />Skapa avskrivning för anläggningstillgång
...
## <a name="to-create-a-depreciation-book" />Att skapa en avskrivningsregel
...
## <a name="to-assign-a-depreciation-book-to-a-fixed-asset" />Att tilldela en avskrivningsregel till en anläggningstillgång.
...
## <a name="to-assign-a-depreciation-book-to-multiple-fixed-assets-with-a-batch-job" />Att tilldela en avskrivningsregel till åtskilliga anläggningstillgångar med hjälp av ett batch-jobb
...
## <a name="to-set-up-depreciation-posting-types" />Så här skapar du bokföringstyper för avskrivning
...
## <a name="to-set-up-default-templates-and-batches-for-fixed-asset-depreciation" />Så här ställer du in standardmallar och journaler för avskrivningsregler för anläggningstillgångar.
