...
---
# Konvertera befintliga lagerställen till distributionslagerställen
...
Du kan skapa zoner och lagerplatser före eller efter konverteringen. Den enda lagerstället som du måste skapa före konverteringen är den som ska användas som en framtida justeringslagerplats.  
...
## Så här aktiverar du ett befintligt lagerställe att fungera som ett distributionslager  
