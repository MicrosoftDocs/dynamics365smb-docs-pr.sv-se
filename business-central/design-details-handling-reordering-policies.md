...
---
# <a name="design-details-handling-reordering-policies"></a><a name="design-details-handling-reordering-policies"></a>Designdetaljer: Hantera partiformningsmetoder
...
## <a name="the-role-of-the-reorder-point"></a><a name="the-role-of-the-reorder-point"></a>Beställningspunktens roll
...
## <a name="monitoring-the-projected-inventory-level-and-the-reorder-point"></a><a name="monitoring-the-projected-inventory-level-and-the-reorder-point"></a>Övervaka den planerade lagernivån och beställningspunkten
...
### <a name="projected-inventory"></a><a name="projected-inventory"></a>Planerat lager
...
### <a name="projected-available-inventory"></a><a name="projected-available-inventory"></a>Planerat tillgängligt lager
...
### <a name="time-buckets"></a><a name="time-buckets"></a>Tidsenheter
...
### <a name="determining-the-projected-inventory-level"></a><a name="determining-the-projected-inventory-level"></a>Fastställa den planerade lagernivån
...
## <a name="the-role-of-the-time-bucket"></a><a name="the-role-of-the-time-bucket"></a>Tidsenhetens roll
...
## <a name="stay-below-the-overflow-level"></a><a name="stay-below-the-overflow-level"></a>Stanna under överflödesnivån
...
### <a name="calculating-the-overflow-level"></a><a name="calculating-the-overflow-level"></a>Beräknar överflödesnivån

Överflödesnivån beräknas på olika sätt beroende på partiformningsmetoden.  

#### <a name="maximum-qty"></a><a name="maximum-qty"></a>Maximalt antal
...
#### <a name="fixed-reorder-qty"></a><a name="fixed-reorder-qty"></a>Fast orderkvantitet
...
#### <a name="order-multiple"></a><a name="order-multiple"></a>Partistorleksmultipel

Om en ordermultipel finns justerar den överflödesnivån för partiformningsmetoderna Maximalt antal och fast partistorlek.  

### <a name="creating-the-planning-line-with-an-overflow-warning"></a><a name="creating-the-planning-line-with-an-overflow-warning"></a>Skapa planeringsraden med överflödesvarning
...
#### <a name="calculating-the-planning-line-quantity"></a><a name="calculating-the-planning-line-quantity"></a>Beräknar antal för planeringsraden
...
#### <a name="defining-the-action-message-type"></a><a name="defining-the-action-message-type"></a>Definiera typen av åtgärdsmeddelande
...
#### <a name="composing-the-warning-message"></a><a name="composing-the-warning-message"></a>Skapar varningsmeddelandet
...
#### <a name="item-setup"></a><a name="item-setup"></a>Inställningar för artiklar
...
#### <a name="situation-before-sales-decrease"></a><a name="situation-before-sales-decrease"></a>Läge före försäljningsminskning
...
#### <a name="situation-after-sales-decrease"></a><a name="situation-after-sales-decrease"></a>Läge efter försäljningsminskning
...
#### <a name="resulting-planning-lines"></a><a name="resulting-planning-lines"></a>Uppdaterar planeringsrader
...
## <a name="handling-projected-negative-inventory"></a><a name="handling-projected-negative-inventory"></a>Hantera planerat negativt lager
...
## <a name="reordering-policies"></a><a name="reordering-policies"></a>Partiformningsmetoder
...
### <a name="fixed-reorder-quantity"></a><a name="fixed-reorder-quantity"></a>Fast orderkvantitet
...
#### <a name="calculated-per-time-bucket"></a><a name="calculated-per-time-bucket"></a>Beräknat per tidsenhet
...
#### <a name="creates-only-necessary-supply"></a><a name="creates-only-necessary-supply"></a>Skapar bara nödvändigt tillgång
...
#### <a name="combines-with-order-modifiers"></a><a name="combines-with-order-modifiers"></a>Kombineras med ordermodifierare
...
#### <a name="combines-with-calendars"></a><a name="combines-with-calendars"></a>Kombineras med kalendrar
...
#### <a name="shouldnt-be-used-with-forecasts"></a><a name="shouldnt-be-used-with-forecasts"></a>Ska inte användas med prognos
...
#### <a name="must-not-be-used-with-reservations"></a><a name="must-not-be-used-with-reservations"></a>Får inte användas med reservationer
...
### <a name="maximum-quantity"></a><a name="maximum-quantity"></a>Maximalt antal
...
#### <a name="calculate-per-time-bucket"></a><a name="calculate-per-time-bucket"></a>Beräknat per tidsenhet
...
#### <a name="combine-with-order-modifiers"></a><a name="combine-with-order-modifiers"></a>Kombineras med ordermodifierare
...
### <a name="combine-with-calendars"></a><a name="combine-with-calendars"></a>Kombineras med kalendrar

Innan en ny leveransorder föreslås för att uppfylla en beställningspunkt, kontrollerar planeringssystemet om ordern är schemalagd för en ledig dag. De kalendrar som du anger i fältet **Baskalenderkod** på sidorna **Företagsinformation** och **Lagerställekort**.  

Om det planerade datumet är ett ickearbetsdag flyttar planeringssystemet ordern framåt till nästa arbetsdag. Om du flyttar datumet kan det leda till att en order som uppfyller en beställningspunkt, inte uppfyller vissa specifika behov. För sådan ej balanserad efterfrågan skapar planeringssystemet en extra leverans.

### <a name="order"></a><a name="order"></a>Order
...
#### <a name="order-to-order-links-and-past-due-dates"></a><a name="order-to-order-links-and-past-due-dates"></a>Order-till-order-länkar och utgångna förfallodatum
...
### <a name="lot-for-lot"></a><a name="lot-for-lot"></a>Parti-för-parti
