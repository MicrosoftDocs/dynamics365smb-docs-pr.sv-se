...
---
# <a name="design-details-handling-reordering-policies" />Designdetaljer: Hantera partiformningsmetoder
...
## <a name="the-role-of-the-reorder-point" />Beställningspunktens roll
...
## <a name="monitoring-the-projected-inventory-level-and-the-reorder-point" />Övervaka den planerade lagernivån och beställningspunkten
...
### <a name="projected-inventory" />Planerat lager
...
### <a name="projected-available-inventory" />Planerat tillgängligt lager
...
### <a name="time-buckets" />Tidsenheter
...
### <a name="determining-the-projected-inventory-level" />Fastställa den planerade lagernivån
...
## <a name="the-role-of-the-time-bucket" />Tidsenhetens roll
...
## <a name="stay-below-the-overflow-level" />Stanna under överflödesnivån
...
### <a name="calculating-the-overflow-level" />Beräknar överflödesnivån

Överflödesnivån beräknas på olika sätt beroende på partiformningsmetoden.  

#### <a name="maximum-qty" />Maximalt antal
...
#### <a name="fixed-reorder-qty" />Fast orderkvantitet
...
#### <a name="order-multiple" />Partistorleksmultipel

Om en ordermultipel finns justerar den överflödesnivån för partiformningsmetoderna Maximalt antal och fast partistorlek.  

### <a name="creating-the-planning-line-with-an-overflow-warning" />Skapa planeringsraden med överflödesvarning
...
#### <a name="calculating-the-planning-line-quantity" />Beräknar antal för planeringsraden
...
#### <a name="defining-the-action-message-type" />Definiera typen av åtgärdsmeddelande
...
#### <a name="composing-the-warning-message" />Skapar varningsmeddelandet
...
### <a name="example-scenario" />Exempelscenario
...
#### <a name="item-setup" />Inställningar för artiklar
...
#### <a name="situation-before-sales-decrease" />Läge före försäljningsminskning
...
#### <a name="situation-after-sales-decrease" />Läge efter försäljningsminskning
...
#### <a name="resulting-planning-lines" />Uppdaterar planeringsrader
...
## <a name="handling-projected-negative-inventory" />Hantera planerat negativt lager
...
## <a name="reordering-policies" />Partiformningsmetoder
...
### <a name="fixed-reorder-quantity" />Fast orderkvantitet
...
#### <a name="calculated-per-time-bucket" />Beräknat per tidsenhet
...
#### <a name="creates-only-necessary-supply" />Skapar bara nödvändigt tillgång
...
#### <a name="combines-with-order-modifiers" />Kombineras med ordermodifierare
...
#### <a name="combines-with-calendars" />Kombineras med kalendrar
...
#### <a name="shouldnt-be-used-with-forecasts" />Ska inte användas med prognos
...
#### <a name="must-not-be-used-with-reservations" />Får inte användas med reservationer
...
### <a name="maximum-quantity" />Maximalt antal
...
#### <a name="calculate-per-time-bucket" />Beräknat per tidsenhet
...
#### <a name="combine-with-order-modifiers" />Kombineras med ordermodifierare
...
### <a name="combine-with-calendars" />Kombineras med kalendrar
...
#### <a name="order-to-order-links-and-past-due-dates" />Order-till-order-länkar och utgångna förfallodatum
...
### <a name="lot-for-lot" />Parti-för-parti
