...
ms.author: bholtorf
---
# <a name="design-details-costing-methods" />Designdetaljer: Värderingsprinciper
...
### <a name="effect-of-costing-methods-on-valuing-inventory-increases" />Effekt av värderingsprinciper på att värdering av lagerökningar
...
### <a name="effect-of-costing-methods-on-valuing-inventory-decreases" />Effekt av värderingsprinciper på att värdering av lagerminskningar
