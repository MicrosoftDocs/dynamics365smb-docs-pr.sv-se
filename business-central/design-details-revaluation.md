...
ms.author: edupont
---
# <a name="design-details-revaluation"></a><a name="design-details-revaluation"></a><a name="design-details-revaluation"></a>Designdetaljer: Omvärdering
...
## <a name="calculating-the-revaluable-quantity"></a><a name="calculating-the-revaluable-quantity"></a><a name="calculating-the-revaluable-quantity"></a>Beräknar antal som kan omvärderas
...
## <a name="expected-cost-in-revaluation"></a><a name="expected-cost-in-revaluation"></a><a name="expected-cost-in-revaluation"></a>Förväntade kostnader i omvärdering
...
När du beräknar det omvärderingsbara antalet för artiklar som använder värderingsprincipen Standard, tas artikeltransaktioner som inte har fakturerats helt och hållet med i beräkningen. Dessa transaktioner omvärderas sedan när du bokför omvärderingen. När du fakturerar den omvärderade transaktionen skapas följande värdetransaktioner:  
...
## <a name="determining-whether-an-inventory-decrease-is-affected-by-revaluation"></a><a name="determining-whether-an-inventory-decrease-is-affected-by-revaluation"></a><a name="determining-whether-an-inventory-decrease-is-affected-by-revaluation"></a>Fastställa huruvida en lagerminskning påverkas av omvärderingen
...
### <a name="example-2"></a><a name="example-2"></a><a name="example-2"></a>Exempel
...
## <a name="wip-inventory-revaluation"></a><a name="wip-inventory-revaluation"></a><a name="wip-inventory-revaluation"></a>PIA – Omvärdering av lager
...
-   En inköpt/detaljmonterad komponent ingår i PIA-lagret från tidpunkten då dess förbrukning bokförs i samband med en produktionsorder.  
-   En inköpt/detaljmonterad komponent ingår i PIA-lagret tills en produktionsorder (tillverkad artikel) faktureras.  

Sättet som värderingsdatumet för värdetransaktionen av förbrukning har angetts följer samma regler som för icke-PIA-lager. Mer information finns i [Fastställa om en lagerminskning påverkas av en omvärdering](design-details-revaluation.md#determining-whether-an-inventory-decrease-is-affected-by-revaluation).  
