...
ms.author: edupont
---
# <a name="design-details-revaluation"></a><a name="design-details-revaluation"></a>Designdetaljer: Omvärdering
...
## <a name="calculating-the-revaluable-quantity"></a><a name="calculating-the-revaluable-quantity"></a>Beräknar antal som kan omvärderas
...
## <a name="expected-cost-in-revaluation"></a><a name="expected-cost-in-revaluation"></a>Förväntade kostnader i omvärdering
...
## <a name="determining-whether-an-inventory-decrease-is-affected-by-revaluation"></a><a name="determining-whether-an-inventory-decrease-is-affected-by-revaluation"></a>Fastställa huruvida en lagerminskning påverkas av omvärderingen
...
### <a name="example-2"></a><a name="example-2"></a>Exempel
...
## <a name="wip-inventory-revaluation"></a><a name="wip-inventory-revaluation"></a>PIA – Omvärdering av lager
