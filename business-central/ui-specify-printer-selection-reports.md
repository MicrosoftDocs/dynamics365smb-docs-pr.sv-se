...
ms.author: jswymer
---
# <a name="specify-a-default-printer"></a><a name="specify-a-default-printer"></a><a name="specify-a-default-printer"></a><a name="default"></a>Ange en standardskrivare
...
## <a name="set-a-printer-as-a-default-printer-for-all-print-jobs"></a><a name="set-a-printer-as-a-default-printer-for-all-print-jobs"></a><a name="set-a-printer-as-a-default-printer-for-all-print-jobs"></a>Ange en skrivare som standardskrivare för alla utskriftsjobb
...
## <a name="set-a-default-printer-for-specific-reports"></a><a name="set-a-default-printer-for-specific-reports"></a><a name="set-a-default-printer-for-specific-reports"></a>Ange standardskrivaren för specifika rapporter
...
## <a name="choosing-the-printer-when-running-a-report"></a><a name="choosing-the-printer-when-running-a-report"></a><a name="choosing-the-printer-when-running-a-report"></a>Välja skrivare när en rapport körs
...
## <a name="sizing-print-jobs"></a><a name="sizing-print-jobs"></a><a name="sizing-print-jobs"></a>Ändra storlek på utskriftsjobb
