...
ms.author: jswymer
---
# <a name="a-namedefaultaspecify-a-default-printer" /><a name="default"></a>Ange en standardskrivare
...
## <a name="set-a-printer-as-a-default-printer-for-all-print-jobs" />Ange en skrivare som standardskrivare för alla utskriftsjobb
...
## <a name="set-a-default-printer-for-specific-reports" />Ange standardskrivaren för specifika rapporter
...
## <a name="choosing-the-printer-when-running-a-report" />Välja skrivare när en rapport körs
...
## <a name="sizing-print-jobs" />Ändra storlek på utskriftsjobb
