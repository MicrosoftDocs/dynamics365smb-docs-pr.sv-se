...
description: Lär dig mer om hur du konfigurerar skrivare för rapporter och dokument samt vilka utskriftsfunktioner som är tillgänglig i Business Central.
author: jswymer
ms.topic: conceptual
ms.devlang: na
ms.tgt_pltfrm: na
...
- Du har rollerna **Utskriftshantering** och **Global administratör** i Azure.
    ...
    För att kunna hantera Universell utskrift måste ditt konto ha rollerna **Utskriftshantering** and **Global administratör** i Azure AD. Dessa roller behövs bara för att hantera Universell utskrift. De krävs inte av de som använder skrivarna från [!INCLUDE[prod_short](includes/prod_short.md)].
...
5. Dela skrivarna.
    ...
    Läs mer i [Dela en skrivare](/universal-print/portal/share-printers).
...
6. Ge användarna behörighet till de delade skrivarna.
    ...
    Läs mer i [Skrivarbehörigheter](/universal-print/portal/share-printers#configure-user-permissions-for-a-printer-share).
...
### <a name="add-universal-print-printers-to-business-central"></a>Lägga till Universell skrivare till Business Central

När du har skapat och delat skrivare i Universell utskrift kan du börja lägga till dem i Business Central. Det finns två sätt att lägga till skrivare på Universell skrivare. Du kan lägga till alla skrivarna på en gång eller individuellt, en i taget.

När du lägger till skrivare individuellt kan du konfigurera samma Universell utskrift-skrivare i Business Central mer än en gång. För varje skrivare som har lagts till kan du ändra utskriftsinställningarna, t.ex. papperskassett, storlek och orientering. På så sätt kan du konfigurera skrivare för olika rapporter och dokument som har särskilda krav på utdata.
...
3. Följ instruktionerna på skärmen.
    ...
    - Om du väljer **Lägg till alla skrivare för Universell utskrift**, sedan visas sidan av **Skrivare för Universell utskrift**. Fyll i fältet **Namn**, välj **...** bredvid fältet **Utskriftsdelning i Universell utskrift** för att välja skrivare i Universell utskrift. Fyll i återstående fält om det behövs. [!INCLUDE[tooltip-inline-tip](includes/tooltip-inline-tip_md.md)].
  
    Med de här åtgärderna kan du verifiera konfigurationen av Azure AD (lokalt), kontrollera att du har Universell utskrift-licens och sedan lägga till skrivarna.
...
- Tillägget **Skicka till e-postskrivare** är installerat
    ...
    Detta tillägg instalelras dessutom som standard. Läs mer om hur du installerar tillägg i<!--see what?--> 
...
Det finns ett par sätt att konfigurera skrivare som ska användas som standard för utskriftsjobb. En standardskrivare är användbar om du arbetar med olika rapporter som kräver olika skrivare på grund av sin placering i företaget eller deras utskriftskapacitet.
