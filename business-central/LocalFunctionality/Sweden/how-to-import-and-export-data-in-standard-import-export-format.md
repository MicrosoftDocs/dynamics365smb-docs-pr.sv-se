...
# <a name="import-and-export-data-in-standard-import-export-format-in-the-swedish-version" />Importera och exportera data i SIE-format (Standard Import Export) i svenska versionen
...
## <a name="to-import-data-in-sie-format" />Så här importerar du data i SIE-format
...
## <a name="to-export-data-in-sie-format" />Så här exporterar du data i SIE-format
