...
ms.author: edupont
---
# <a name="print-balance-sheet-and-income-statement-reports"></a><a name="print-balance-sheet-and-income-statement-reports"></a><a name="print-balance-sheet-and-income-statement-reports"></a>Skriv ut rapporterna Balansräkning och Resultaträkning
...
## <a name="to-print-a-balance-sheet-report"></a><a name="to-print-a-balance-sheet-report"></a><a name="to-print-a-balance-sheet-report"></a>Så här skriver du ut en balansräkningsrapport
...
## <a name="to-print-an-income-statement-report"></a><a name="to-print-an-income-statement-report"></a><a name="to-print-an-income-statement-report"></a>Så här skriver du ut en resultaträkningsrapport
