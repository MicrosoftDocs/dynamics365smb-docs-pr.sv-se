...
## <a name="to-set-up-automatic-account-posting-groups" /><a name="to-set-up-automatic-account-posting-groups"></a>Så här ställer du in automatiska kontobokföringsmallar
