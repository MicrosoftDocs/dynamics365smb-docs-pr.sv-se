...
ms.author: bholtorf
---
# <a name="personalize-your-workspace"></a><a name="personalize-your-workspace"></a><a name="personalize-your-workspace"></a>Anpassa din arbetsyta
...
## <a name="to-change-the-width-of-a-column"></a><a name="to-change-the-width-of-a-column"></a><a name="to-change-the-width-of-a-column"></a>För att ändra bredden på en kolumn
...
## <a name="to-start-personalizing-a-page-through-the-personalizing-banner"></a><a name="to-start-personalizing-a-page-through-the-personalizing-banner"></a><a name="to-start-personalizing-a-page-through-the-personalizing-banner"></a>För at börja anpassa en sida via banderollen **Anpassa**
...
## <a name="what-you-can-personalize"></a><a name="what-you-can-personalize"></a><a name="what-you-can-personalize"></a><a name="What"></a>Detta kan du anpassa
...
## <a name="personalizing-the-action-bar-and-menus"></a><a name="personalizing-the-action-bar-and-menus"></a><a name="personalizing-the-action-bar-and-menus"></a><a name="Actions"></a>Anpassa åtgärdsfältet och menyer
...
### <a name="to-remove-hide-and-show-actions-and-action-groups"></a><a name="to-remove-hide-and-show-actions-and-action-groups"></a><a name="to-remove-hide-and-show-actions-and-action-groups"></a>Om du vill ta bort, dölja och visa åtgärder och åtgärdsgrupper
...
### <a name="to-move-actions-and-action-groups"></a><a name="to-move-actions-and-action-groups"></a><a name="to-move-actions-and-action-groups"></a>Flytta åtgärder och åtgärdsgrupper
...
## <a name="personalizing-parts"></a><a name="personalizing-parts"></a><a name="personalizing-parts"></a><a name="Parts"></a>Anpassa delar
...
## <a name="to-clear-personalization"></a><a name="to-clear-personalization"></a><a name="to-clear-personalization"></a>Rensa anpassning
...
## <a name="other-points-of-interest"></a><a name="other-points-of-interest"></a><a name="other-points-of-interest"></a>Andra punkter av intresse
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relaterad [Microsoft utbildning](/training/modules/personalize-ui-dynamics-365-business-central/index)
