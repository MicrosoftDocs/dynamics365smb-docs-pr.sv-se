...
---
# <a name="set-up-intercompany-transactions"></a><a name="set-up-intercompany-transactions"></a>Ställ in koncerninterna transaktioner
...
## <a name="overview-of-the-steps-to-get-started"></a><a name="overview-of-the-steps-to-get-started"></a>Översikt över steg för att komma igång
...
## <a name="set-up-a-synchronization-partner"></a><a name="set-up-a-synchronization-partner"></a>Konfigurera synkroniseringspartner
...
## <a name="set-up-the-intercompany-charts-of-accounts"></a><a name="set-up-the-intercompany-charts-of-accounts"></a>Ställa in den koncerninterna kontoplanen
...
### <a name="import-or-export-an-intercompany-chart-of-accounts"></a><a name="import-or-export-an-intercompany-chart-of-accounts"></a>Importera eller exportera en koncernintern kontoplan
...
## <a name="map-the-intercompany-chart-of-accounts-to-your-companys-chart-of-accounts"></a><a name="map-the-intercompany-chart-of-accounts-to-your-companys-chart-of-accounts"></a>Koppla du den koncerninterna kontoplanen till företagets kontoplan
...
## <a name="set-up-intercompany-dimensions"></a><a name="set-up-intercompany-dimensions"></a>Ställ in koncerninterna dimensioner
...
### <a name="import-or-export-intercompany-dimensions"></a><a name="import-or-export-intercompany-dimensions"></a>Importera eller exportera koncerninterna dimensioner
...
### <a name="map-intercompany-dimensions-to-your-companys-dimensions"></a><a name="map-intercompany-dimensions-to-your-companys-dimensions"></a>Koppla koncerninterna dimensioner till företagets dimensioner
...
## <a name="set-up-intercompany-general-journal-templates-and-batches"></a><a name="set-up-intercompany-general-journal-templates-and-batches"></a>Ställ in koncerninterna journalmallar och journaler
...
## <a name="set-up-a-company-for-intercompany-transactions"></a><a name="set-up-a-company-for-intercompany-transactions"></a>Konfigurera företag för koncerninterna transaktioner
...
## <a name="set-up-intercompany-partners"></a><a name="set-up-intercompany-partners"></a>Konfigurera koncerninterna partner
...
### <a name="set-up-intercompany-partners-as-customers-and-vendors"></a><a name="set-up-intercompany-partners-as-customers-and-vendors"></a>Skapa koncerninterna partner som kunder och leverantörer
...
### <a name="set-up-default-intercompany-partner-general-ledger-accounts"></a><a name="set-up-default-intercompany-partner-general-ledger-accounts"></a>Ställ in standardredovisningskonton för koncernintern partner
...
### <a name="auto-accept-transactions-from-intercompany-partners"></a><a name="auto-accept-transactions-from-intercompany-partners"></a>Acceptera transaktioner automatiskt från koncerninterna partner
...
### <a name="specify-the-bank-accounts-to-use-for-intercompany-partners"></a><a name="specify-the-bank-accounts-to-use-for-intercompany-partners"></a>Ange vilka bankkonton som ska användas för koncerninterna partner
...
## <a name="troubleshoot-your-intercompany-setup"></a><a name="troubleshoot-your-intercompany-setup"></a>Felsöka koncernintern inställning
