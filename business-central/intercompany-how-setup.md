...
---
# <a name="set-up-intercompany-transactions" />Ställ in koncerninterna transaktioner
...
## <a name="overview-of-the-steps-to-get-started" />Översikt över steg för att komma igång
...
## <a name="set-up-a-synchronization-partner" />Konfigurera synkroniseringspartner
...
## <a name="set-up-the-intercompany-charts-of-accounts" />Ställa in den koncerninterna kontoplanen
...
### <a name="import-or-export-an-intercompany-chart-of-accounts" />Importera eller exportera en koncernintern kontoplan
...
## <a name="map-the-intercompany-chart-of-accounts-to-your-companys-chart-of-accounts" />Koppla du den koncerninterna kontoplanen till företagets kontoplan
...
## <a name="set-up-intercompany-dimensions" />Ställ in koncerninterna dimensioner
...
### <a name="import-or-export-intercompany-dimensions" />Importera eller exportera koncerninterna dimensioner
...
### <a name="map-intercompany-dimensions-to-your-companys-dimensions" />Koppla koncerninterna dimensioner till företagets dimensioner
...
## <a name="set-up-intercompany-general-journal-templates-and-batches" />Ställ in koncerninterna journalmallar och journaler
...
## <a name="set-up-a-company-for-intercompany-transactions" />Konfigurera företag för koncerninterna transaktioner
...
## <a name="set-up-intercompany-partners" />Konfigurera koncerninterna partner
...
### <a name="set-up-intercompany-partners-as-customers-and-vendors" />Skapa koncerninterna partner som kunder och leverantörer
...
### <a name="set-up-default-intercompany-partner-general-ledger-accounts" />Ställ in standardredovisningskonton för koncernintern partner
...
### <a name="auto-accept-transactions-from-intercompany-partners" />Acceptera transaktioner automatiskt från koncerninterna partner
...
### <a name="specify-the-bank-accounts-to-use-for-intercompany-partners" />Ange vilka bankkonton som ska användas för koncerninterna partner
...
## <a name="troubleshoot-your-intercompany-setup" />Felsöka koncernintern inställning
