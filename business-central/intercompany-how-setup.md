...
---
# <a name="set-up-intercompany-transactions"></a>Ställ in koncerninterna transaktioner
...
## <a name="overview-of-the-steps-to-get-started"></a>Översikt över steg för att komma igång
...
## <a name="set-up-a-synchronization-partner"></a>Konfigurera synkroniseringspartner
...
### <a name="connect-with-partners-in-another-tenant-or-environment"></a>Få kontakt med partner i en annan klientorganisation eller miljö
...
* Utbyta information om sina koncerninterna inställningar. Varje partner kan hämta den här informationen från den assisterade konfigurationsguiden för **Konfiguration av koncernintern partner i andra miljöer**.
...
Kör den assisterade konfigurationsguiden för **Konfiguration av koncernintern partner i andra miljöer** i alla företag för att ange informationen. Starta guiden på sidan **Koncernintern partner**, använd åtgärden **Anslut extern installation**.

#### <a name="create-a-registered-app-in-azure-portal"></a>Skapa en registrerad app i Azure-portalen
...
> [!TIP]
> Det är en bra idé att ha en textredigerare öppen, till exempel Anteckningar, medan du skapar din registrerade app. Du behöver en del av informationen när du kör den assisterade konfigurationsguiden för **Konfiguration av koncernintern partner i andra miljöer** så det är bra att ha informationen till hands.
...
#### <a name="add-and-enable-your-registered-app-in-business-central"></a>Lägg till och aktivera din registrerade app i Business Central
...
5. I fältet **Behörighetsgrupp** väljer du behörighetsgrupp **API – Koncernintern över flera miljöer**.

## <a name="set-up-the-intercompany-charts-of-accounts"></a>Ställa in den koncerninterna kontoplanen
...
### <a name="import-or-export-an-intercompany-chart-of-accounts"></a>Importera eller exportera en koncernintern kontoplan
...
## <a name="map-the-intercompany-chart-of-accounts-to-your-companys-chart-of-accounts"></a>Koppla du den koncerninterna kontoplanen till företagets kontoplan
...
## <a name="set-up-intercompany-dimensions"></a>Ställ in koncerninterna dimensioner
...
### <a name="import-or-export-intercompany-dimensions"></a>Importera eller exportera koncerninterna dimensioner
...
### <a name="map-intercompany-dimensions-to-your-companys-dimensions"></a>Koppla koncerninterna dimensioner till företagets dimensioner
...
## <a name="set-up-intercompany-general-journal-templates-and-batches"></a>Ställ in koncerninterna journalmallar och journaler
...
## <a name="set-up-a-company-for-intercompany-transactions"></a>Konfigurera företag för koncerninterna transaktioner
...
## <a name="set-up-intercompany-partners"></a>Konfigurera koncerninterna partner
...
### <a name="set-up-intercompany-partners-as-customers-and-vendors"></a>Skapa koncerninterna partner som kunder och leverantörer
...
### <a name="set-up-default-intercompany-partner-general-ledger-accounts"></a>Ställ in standardredovisningskonton för koncernintern partner
...
### <a name="specify-the-bank-accounts-to-use-for-intercompany-partners"></a>Ange vilka bankkonton som ska användas för koncerninterna partner
...
## <a name="troubleshoot-your-intercompany-setup"></a>Felsöka koncernintern inställning
