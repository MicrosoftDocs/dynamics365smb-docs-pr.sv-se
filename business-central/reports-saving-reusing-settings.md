...
ms.author: edupont
---
# <a name="manage-saved-settings-for-reports-and-batch-jobs" />Hantera sparade inställningar för rapporter och batch-jobb
...
## <a name="manage-saved-settings" />Hantera sparade inställningar
...
## <a name="create-or-modify-saved-settings-for-all-users" />Skapa eller ändra inställningarna för alla användare
