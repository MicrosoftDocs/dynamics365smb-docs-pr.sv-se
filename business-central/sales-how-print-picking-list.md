...
ms.author: edupont
---
# <a name="print-the-picking-list"></a><a name="print-the-picking-list"></a>Skriv ut plocklistan
...
## <a name="to-print-a-picking-list-from-a-sales-order"></a><a name="to-print-a-picking-list-from-a-sales-order"></a>För att skriva ut en plockningslista från en försäljningsorder
