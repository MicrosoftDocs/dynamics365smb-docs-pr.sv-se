...
---
# <a name="record-consumption-or-usage-for-jobs" />Registrera förbrukning eller användning för projekt
...
## <a name="to-record-usage-for-a-job-planning-line-of-type-budget" />Registrera förbrukning på en projektplaneringsrad av typen Budget
...
## <a name="to-create-job-journal-lines-manually" />Så här skapar du projektjournalrader manuellt
...
## <a name="to-view-job-usage-estimates-and-post-updates" />Så här visar du projektförbrukning och uppskattningar och bokföruppdateringar
...
## <a name="create-inventory-and-warehouse-pick-documents-for-a-job" />Skapa dokument för lager och distributionslagerplockning för ett jobb
...
## <a name="to-review-planning-lines-for-a-job-ledger-entry" />Granska planeringsrader för en projekttransaktion
