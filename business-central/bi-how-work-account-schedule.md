...
---
# <a name="prepare-financial-reporting-with-financial-data-and-account-categories"></a><a name="prepare-financial-reporting-with-financial-data-and-account-categories"></a><a name="prepare-financial-reporting-with-financial-data-and-account-categories"></a>Förbereda Financial Reporting med ekonomiska data och kontokategorier
...
## <a name="financial-reports"></a><a name="financial-reports"></a><a name="financial-reports"></a>Ekonomiska rapporter
...
## <a name="gl-account-categories"></a><a name="gl-account-categories"></a><a name="gl-account-categories"></a>Redovisningskontokategorier
...
## <a name="create-a-new-financial-report"></a><a name="create-a-new-financial-report"></a><a name="create-a-new-financial-report"></a>Skapa en ny ekonomisk rapport
...
### <a name="edit-a-column-definition"></a><a name="edit-a-column-definition"></a><a name="edit-a-column-definition"></a>Redigera en kolumndefinition
...
### <a name="create-a-column-that-calculates-percentages"></a><a name="create-a-column-that-calculates-percentages"></a><a name="create-a-column-that-calculates-percentages"></a>Skapa en kolumn för att beräkna procentsatser
...
## <a name="set-up-financial-reports-with-overviews"></a><a name="set-up-financial-reports-with-overviews"></a><a name="set-up-financial-reports-with-overviews"></a>Ställa in ekonomiska rapporter med översikter
...
## <a name="comparing-accounting-periods-using-period-formulas"></a><a name="comparing-accounting-periods-using-period-formulas"></a><a name="comparing-accounting-periods-using-period-formulas"></a>Jämföra bokföringsperioder med hjälp av periodformler
...
## <a name="print-and-save-financial-reports"></a><a name="print-and-save-financial-reports"></a><a name="print-and-save-financial-reports"></a>Skriva ut och spara ekonomiska rapporter
...
### <a name="schedule-a-financial-report-or-save-as-a-pdf-word-or-excel-document"></a><a name="schedule-a-financial-report-or-save-as-a-pdf-word-or-excel-document"></a><a name="schedule-a-financial-report-or-save-as-a-pdf-word-or-excel-document"></a>Schemalägga en ekonomisk rapport eller spara som ett PDF-, Word- eller Excel-dokument
...
## <a name="importing-or-exporting-financial-reports"></a><a name="importing-or-exporting-financial-reports"></a><a name="importing-or-exporting-financial-reports"></a>Importera eller exportera ekonomiska rapporter
...
### <a name="import-and-export-financial-reports"></a><a name="import-and-export-financial-reports"></a><a name="import-and-export-financial-reports"></a>Importera och exportera ekonomiska rapporter
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relaterad [Microsoft-utbildning](/training/modules/configure-financial-reports-dynamics-365-business-central/index).
