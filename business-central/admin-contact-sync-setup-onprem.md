...
# <a name="set-up-contact-sync-with-outlook-for-business-central-on-premises" />Konfigurera synkronisering av kontakter med Outlook för Business Central lokal
...
## <a name="set-up-contact-sync" />Ställ in synkronisering av kontakter
