...
ms.author: edupont
---
# <a name="view-archived-workflow-step-instances" />Visa arkiverade instanser för arbetsflödessteg
...
## <a name="to-view-archived-workflow-step-instances" />Så här visar du arkiverade instanser för arbetsflödessteg
