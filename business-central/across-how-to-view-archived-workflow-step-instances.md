...
ms.author: edupont
---
# <a name="view-archived-workflow-step-instances"></a><a name="view-archived-workflow-step-instances"></a><a name="view-archived-workflow-step-instances"></a>Visa arkiverade instanser för arbetsflödessteg
...
## <a name="to-view-archived-workflow-step-instances"></a><a name="to-view-archived-workflow-step-instances"></a><a name="to-view-archived-workflow-step-instances"></a>Så här visar du arkiverade instanser för arbetsflödessteg
