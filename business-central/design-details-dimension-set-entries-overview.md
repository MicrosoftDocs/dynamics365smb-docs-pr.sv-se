...
ms.author: edupont
---
# <a name="dimension-set-entries-overview"></a><a name="dimension-set-entries-overview"></a><a name="dimension-set-entries-overview"></a>Översikt över dimensionsuppsättningstransaktioner
...
## <a name="dimension-set-entries"></a><a name="dimension-set-entries"></a><a name="dimension-set-entries"></a>Dimensionsuppsättningstrans.
...
## <a name="codeunit-408-dimension-management"></a><a name="codeunit-408-dimension-management"></a><a name="codeunit-408-dimension-management"></a>Codeunit 408 Dimensionshantering
...
## <a name="performance-improvement"></a><a name="performance-improvement"></a><a name="performance-improvement"></a>Prestandaförbättring
