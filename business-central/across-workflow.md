...
---
# <a name="workflows-in-dynamics-365-business-central"></a><a name="workflows-in-dynamics-365-business-central"></a><a name="workflows-in-dynamics-365-business-central"></a>Arbetsflöden i Dynamics 365 Business Central
...
## <a name="power-automate-flows"></a><a name="power-automate-flows"></a><a name="power-automate-flows"></a>Power Automate-flöden
...
## <a name="approval-workflows"></a><a name="approval-workflows"></a><a name="approval-workflows"></a>Arbetsflöden för godkännande
