...
ms.author: edupont
---
# <a name="set-up-incoming-documents"></a><a name="set-up-incoming-documents"></a>Ställa in inkommande dokument
...
## <a name="to-set-up-the-incoming-documents-feature"></a><a name="to-set-up-the-incoming-documents-feature"></a>Så här konfigurerar du funktionen för inkommande dokument
...
## <a name="to-set-up-approvers-of-incoming-document-records"></a><a name="to-set-up-approvers-of-incoming-document-records"></a>Så här konfigurerar du godkännare för inkommande dokument
...
## <a name="to-set-up-an-ocr-service"></a><a name="to-set-up-an-ocr-service"></a>Så här konfigurerar du en OCR-tjänst
