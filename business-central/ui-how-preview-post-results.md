...
ms.author: solsen
---
# <a name="preview-posting-results" />Förhandsgranska resultat
...
## <a name="to-preview-gl-entries-that-will-result-from-posting-a-purchase-invoice" />Om du vill granska redovisningstransaktioner som resulterar från bokföring av inköpsfaktura
