...
ms.author: solsen
---
# <a name="preview-posting-results"></a><a name="preview-posting-results"></a><a name="preview-posting-results"></a>Förhandsgranska resultat
...
## <a name="to-preview-gl-entries-that-will-result-from-posting-a-purchase-invoice"></a><a name="to-preview-gl-entries-that-will-result-from-posting-a-purchase-invoice"></a><a name="to-preview-gl-entries-that-will-result-from-posting-a-purchase-invoice"></a>Om du vill granska redovisningstransaktioner som resulterar från bokföring av inköpsfaktura
