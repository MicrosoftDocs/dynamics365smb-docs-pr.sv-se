---
title: Definiera en säljare (innehåller video) | Microsoft Docs
...
ms.author: edupont
---
# <a name="set-up-salespeople"></a><a name="set-up-salespeople"></a><a name="set-up-salespeople"></a>Skapa säljare
...
## <a name="to-set-up-a-salesperson-code"></a><a name="to-set-up-a-salesperson-code"></a><a name="to-set-up-a-salesperson-code"></a>Så här skapar du en säljarkod
