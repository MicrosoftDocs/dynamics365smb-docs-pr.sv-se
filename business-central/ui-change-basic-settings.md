...
ms.author: jswymer
---
# <a name="change-basic-settings"></a><a name="change-basic-settings"></a>Ändra grundinställningar
...
## <a name="role"></a><a name="role"></a><a name="role-center"></a>Roll
...
### <a name="change-the-role"></a><a name="change-the-role"></a>Ändra rollen
...
## <a name="company"></a><a name="company"></a><a name="company"></a>Företag
...
### <a name="work-date-indication"></a><a name="work-date-indication"></a>Indikering av arbetsdatum
...
## <a name="region"></a><a name="region"></a><a name="region"></a> Region
...
## <a name="language"></a><a name="language"></a><a name="language"></a> Språk
...
## <a name="time-zone"></a><a name="time-zone"></a>Tidszon
...
## <a name="notifications"></a><a name="notifications"></a>Meddelanden
...
## <a name="teaching-tips"></a><a name="teaching-tips"></a>Undervisningstips
