...
ms.author: jswymer
---
# <a name="change-basic-settings" />Ändra grundinställningar
...
### <a name="change-the-role" />Ändra rollen
...
### <a name="work-date-indication" />Indikering av arbetsdatum
...
## <a name="notifications" />Meddelanden
...
## <a name="teaching-tips" />Undervisningstips
