...
> [!NOTE]
> Analyser för anläggningstillgångar är lite annorlunda än andra områden. Du måste analysera data som redan finns, till exempel tillgångsförvärv, utfasningar och försäkringar, men även data om framtiden, till exempel avskrivningar och tillbakadragna tillgångar. För den senare typen av analys,har [!INCLUDE[prod_short](includes/prod_short.md)] inbyggda rapporter som kan beräkna dessa siffror.
...
För anläggningstillgångar kan du skapa en vy på sidan Kontoplan som bara visar de konton som du använder för att bokföra transaktioner för anläggningstillgångar.
