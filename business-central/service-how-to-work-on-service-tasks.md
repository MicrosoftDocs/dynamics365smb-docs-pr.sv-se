...
ms.author: edupont
---
# <a name="work-on-service-tasks" />Arbeta med tjänsteuppgifter
...
## <a name="to-work-on-a-service-task" />Så här arbetar du med serviceuppgifter
...
## <a name="to-register-service-operations" />Så här registrerar du serviceoperationer
...
## <a name="to-register-spare-parts" />Så här registrerar du reservdelar
...
## <a name="to-register-spare-parts-from-a-service-order" />Registrera reservdelar från en serviceorder
...
## <a name="to-replace-a-service-item-or-a-service-item-component" />Så här ersätter du en serviceartikel eller en Serviceartikelkomponent
...
## <a name="to-change-the-response-time-for-a-service-item-line" />Så här ändrar du svarstid för en serviceartikelrad
...
## <a name="to-register-faultresolution-codes" />Så här registrerar du fel/åtgärdskoder
