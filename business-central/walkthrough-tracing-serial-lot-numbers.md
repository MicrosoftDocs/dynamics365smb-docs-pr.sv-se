...
ms.author: bholtorf
---
# <a name="walkthrough-tracing-seriallot-numbers" />Genomgång: Spåra serienummer/partinummer
...
### <a name="to-create-the-items" />Så här skapar du serviceartiklar
...
### <a name="to-purchase-components" />Så här kan du köpa komponenter
...
### <a name="to-produce-end-items" />Så här kan du producera slutartiklar
...
### <a name="to-sell-the-end-items" />Sälja slutartiklarna
...
## <a name="tracing-from-usage-to-origin" />Spåra från förbrukning till ursprung
...
### <a name="to-determine-which-lot-included-the-faulty-frame-and-who-supplied-it" />Så här fastställer du vilket parti den defekta ramen förekom i och vem som levererade den
...
## <a name="tracing-from-origin-to-usage" />Spåra från ursprung till förbrukning
...
### <a name="to-find-all-usage-of-the-faulty-lot" />Så här hittar du all förbrukning som använder det defekta partiet
...
## <a name="finding-all-records-of-a-seriallot-number" />Hitta alla poster som innehåller ett serienummer/partinummer
