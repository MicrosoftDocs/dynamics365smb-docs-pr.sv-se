...
ms.author: bholtorf
---
# <a name="walkthrough-tracing-seriallot-numbers"></a><a name="walkthrough-tracing-seriallot-numbers"></a><a name="walkthrough-tracing-seriallot-numbers"></a>Genomgång: Spåra serienummer/partinummer
...
### <a name="to-create-the-items"></a><a name="to-create-the-items"></a><a name="to-create-the-items"></a>Så här skapar du serviceartiklar
...
### <a name="to-purchase-components"></a><a name="to-purchase-components"></a><a name="to-purchase-components"></a>Så här kan du köpa komponenter
...
### <a name="to-produce-end-items"></a><a name="to-produce-end-items"></a><a name="to-produce-end-items"></a>Så här kan du producera slutartiklar
...
### <a name="to-sell-the-end-items"></a><a name="to-sell-the-end-items"></a><a name="to-sell-the-end-items"></a>Sälja slutartiklarna
...
## <a name="tracing-from-usage-to-origin"></a><a name="tracing-from-usage-to-origin"></a><a name="tracing-from-usage-to-origin"></a>Spåra från förbrukning till ursprung
...
### <a name="to-determine-which-lot-included-the-faulty-frame-and-who-supplied-it"></a><a name="to-determine-which-lot-included-the-faulty-frame-and-who-supplied-it"></a><a name="to-determine-which-lot-included-the-faulty-frame-and-who-supplied-it"></a>Så här fastställer du vilket parti den defekta ramen förekom i och vem som levererade den
...
## <a name="tracing-from-origin-to-usage"></a><a name="tracing-from-origin-to-usage"></a><a name="tracing-from-origin-to-usage"></a>Spåra från ursprung till förbrukning
...
### <a name="to-find-all-usage-of-the-faulty-lot"></a><a name="to-find-all-usage-of-the-faulty-lot"></a><a name="to-find-all-usage-of-the-faulty-lot"></a>Så här hittar du all förbrukning som använder det defekta partiet
...
## <a name="finding-all-records-of-a-seriallot-number"></a><a name="finding-all-records-of-a-seriallot-number"></a><a name="finding-all-records-of-a-seriallot-number"></a>Hitta alla poster som innehåller ett serienummer/partinummer
...
### <a name="to-find-all-occurrences-of-lot1-in-non-posted-records-such-as-open-orders"></a><a name="to-find-all-occurrences-of-lot1-in-non-posted-records-such-as-open-orders"></a><a name="to-find-all-occurrences-of-lot1-in-non-posted-records-such-as-open-orders"></a>Så här hittar du alla förekomster av PARTI1 i icke-bokförda poster, t. ex. öppna order
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relaterad [Microsoft utbildning](/training/paths/use-serial-lot-numbers/)
