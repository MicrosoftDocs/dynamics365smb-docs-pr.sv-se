...
ms.author: edupont
---
# <a name="manage-employee-absence" />Hantera personalfrånvaro
...
## <a name="to-register-employee-absence" />Så här registrerar du personalfrånvaro
...
## <a name="to-view-an-individual-employees-absence" />Så här visar du frånvaron för en enskild anställd
...
## <a name="to-view-an-employees-absence-by-categories" />Så här visar du en anställds frånvaro per kategori
1. Välj ikonen **Söka efter sida eller rapport** i det övre högra hörnet, ställ in **Personal** och välj sedan relaterad länk.
...
## <a name="to-view-all-employee-absences-by-category" />Så här visar du alla anställdas frånvaro per kategori
1. Välj ikonen **Söka efter sida eller rapport** i det övre högra hörnet, ställ in **Frånvaroregistrering** och välj sedan relaterad länk.
...
## <a name="to-view-all-employee-absences-by-period" />Så här visar du alla anställdas frånvaro per period
1. Välj ikonen **Söka efter sida eller rapport** i det övre högra hörnet, ställ in **Frånvaroregistrering** och välj sedan relaterad länk.
