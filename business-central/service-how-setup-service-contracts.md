...
# <a name="set-up-service-contracts" />Skapa servicekontrakt
...
## <a name="to-set-up-a-service-contract-group" />Så här skapar du en servicekontraktsgrupp
...
## <a name="to-set-up-a-service-contract-account-group" />Så här skapar du servicekontraktskontogrupper
...
## <a name="to-set-up-a-contract-template" />Så här skapar du en kontraktsmall
...
## <a name="to-set-up-a-customer-template" />Så här skapar du en kundmall
