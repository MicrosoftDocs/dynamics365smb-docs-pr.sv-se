...
ms.author: edupont
---
# <a name="multiple-contracts"></a><a name="multiple-contracts"></a><a name="multiple-contracts"></a>Flera kontrakt
...
## <a name="creating-multiple-contracts-per-service-item"></a><a name="creating-multiple-contracts-per-service-item"></a><a name="creating-multiple-contracts-per-service-item"></a>Skapa flera kontrakt per serviceartikel
...
## <a name="copying-documents"></a><a name="copying-documents"></a><a name="copying-documents"></a>Kopiera dokument
...
## <a name="creating-service-orders-for-multiple-contracts"></a><a name="creating-service-orders-for-multiple-contracts"></a><a name="creating-service-orders-for-multiple-contracts"></a>Skapa serviceorder för flera kontrakt
