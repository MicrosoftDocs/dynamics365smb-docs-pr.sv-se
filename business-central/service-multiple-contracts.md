...
ms.author: edupont
---
# <a name="multiple-contracts" />Flera kontrakt
...
## <a name="creating-multiple-contracts-per-service-item" />Skapa flera kontrakt per serviceartikel
...
## <a name="copying-documents" />Kopiera dokument
...
## <a name="creating-service-orders-for-multiple-contracts" />Skapa serviceorder för flera kontrakt
