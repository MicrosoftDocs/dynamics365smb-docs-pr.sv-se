...
ms.author: soalex
---
# <a name="application-compliance" />Programmets regelefterlevnad
...
## <a name="data-privacy" />Datasekretess
...
## <a name="accounting-processes-and-controls-to-aid-compliance" />Bokföringsprocesser och kontroller som gör regelefterlevnad enklare
...
## <a name="enhance-people-practices-with-technology" />Förbättra personpraxis med teknik
...
## <a name="realize-the-benefits-of-an-integrated-business-management-solution" />Dra nytta av en integrerad affärslösning
...
## <a name="gain-control-of-critical-information-processes-and-reports" />Justering av viktig information, processer och rapporter
...
### <a name="manage-compliance-to-the-standards-that-matter" />Hantera regelefterlevnad till de standarder som är viktiga
...
### <a name="tailor-financial-reports-to-your-needs" />Skräddarsy ekonomiska rapporter till dina behov
...
### <a name="improve-information-validity" />Förbättra giltigheten av information
...
### <a name="comply-quickly-with-discovery-requests-and-reporting-demands" />Snabbt följa begäranden för identifiering och rapporteringskrav
...
### <a name="help-ensure-clear-audit-trails" />Hjälper till att rensa granskningshistorik
...
## <a name="compliance-and-local-functionality" />Regelefterlevnad och lokala funktioner
