...
ms.author: edupont
---
# <a name="manage-job-supplies"></a><a name="manage-job-supplies"></a>Hantera projektleveranser
...
## <a name="to-purchase-items-or-services-for-a-job"></a><a name="to-purchase-items-or-services-for-a-job"></a>Köpa artiklar eller tjänster till ett projekt
...
## <a name="to-view-the-value-of-purchases-for-a-job"></a><a name="to-view-the-value-of-purchases-for-a-job"></a>Visa värdet på inköp till ett projekt
...
## <a name="to-post-a-job-related-expense"></a><a name="to-post-a-job-related-expense"></a>Så här bokför du en projektrelaterad utgift
