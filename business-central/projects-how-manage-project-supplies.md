...
ms.author: edupont
---
# <a name="manage-job-supplies" />Hantera projektleveranser
...
## <a name="to-purchase-items-or-services-for-a-job" />Köpa artiklar eller tjänster till ett projekt
...
## <a name="to-view-the-value-of-purchases-for-a-job" />Visa värdet på inköp till ett projekt
...
## <a name="to-post-a-job-related-expense" />Så här bokför du en projektrelaterad utgift
