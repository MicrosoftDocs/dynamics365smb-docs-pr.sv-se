...
ms.author: edupont
---
# <a name="work-with-blanket-sales-orders-or-blanket-purchase-orders" />Arbeta med avropsorder, försäljning eller inköpsavropsorder
...
## <a name="to-create-a-blanket-sales-order" />Så här skapar du en avropsorder
...
## <a name="to-create-a-sales-order-from-a-blanket-sales-order" />Så här skapar du en försäljningsorder från en avropsorder
...
## <a name="to-view-the-status-of-a-blanket-sales-order" />Så här visar du status för en avropsorder
...
## <a name="to-view-unposted-and-posted-blanket-sales-order-lines" />Så här väljer du att visa ej bokförda och bokförda försäljningsavropsorderrader
