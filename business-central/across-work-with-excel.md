...
ms.author: jswymer
---
# <a name="viewing-and-editing-in-excel-from-business-central"></a><a name="viewing-and-editing-in-excel-from-business-central"></a>Visa och redigera i Excel från Business Central
...
## <a name="open-in-excel"></a><a name="open-in-excel"></a>Öppna i Excel
...
## <a name="edit-in-excel"></a><a name="edit-in-excel"></a>Redigera i Excel
...
### <a name="first-time-sign-in"></a><a name="first-time-sign-in"></a>Första inloggningen
...
### <a name="work-across-environments-and-companies"></a><a name="work-across-environments-and-companies"></a>Arbeta i flera miljöer och företag
...
### <a name="limits-when-using-excel-for-the-web"></a><a name="limits-when-using-excel-for-the-web"></a>Begränsningar när du använder Excel för webben
...
## <a name="see-the-differences-between-the-options"></a><a name="see-the-differences-between-the-options"></a>Se skillnaden mellan alternativen
<br><br>  
