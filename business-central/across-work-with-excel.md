...
---
# <a name="view-and-edit-in-excel-from-business-central"></a>Visa och redigera i Excel från Business Central
...
### <a name="work-across-environments-and-companies"></a>Arbeta i flera miljöer och företag
...
### <a name="limits-when-using-excel-for-the-web"></a>Begränsningar när du använder Excel för webben
