...
---
# <a name="use-power-automate-flows-in-"></a><a name="use-power-automate-flows-in-"></a><a name="use-power-automate-flows-in-"></a>Använda Power Automate-flöden i [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="about-power-automate-flows"></a><a name="about-power-automate-flows"></a><a name="about-power-automate-flows"></a>Om Power Automate-flöden
...
## <a name="run-instant-flows"></a><a name="run-instant-flows"></a><a name="run-instant-flows"></a>Kör direktflöden
...
## <a name="create-edit-and-manage-flows"></a><a name="create-edit-and-manage-flows"></a><a name="create-edit-and-manage-flows"></a>Skapa, redigera och hantera flöden
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relaterad [Microsoft utbildning](/training/modules/use-power-automate/)
