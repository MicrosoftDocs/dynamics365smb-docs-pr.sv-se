...
ms.author: edupont
---
# <a name="record-payments-and-refunds-in-the-payment-journal"></a><a name="record-payments-and-refunds-in-the-payment-journal"></a>Registrera betalningar och återbetalningar i betalningsjournalen
...
## <a name="to-make-payments-in-the-payment-journal"></a><a name="to-make-payments-in-the-payment-journal"></a>Göra betalningar i betalningsjournal
...
## <a name="to-issue-a-refund-check"></a><a name="to-issue-a-refund-check"></a>Så här skickar du en återbetalningscheck
