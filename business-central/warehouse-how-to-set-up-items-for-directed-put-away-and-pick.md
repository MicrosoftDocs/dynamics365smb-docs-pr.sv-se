...
ms.author: bholtorf
---
# <a name="set-up-items-and-locations-for-directed-put-away-and-pick" />Registrera artiklar och platser för dirigerad artikelinförsel och plockning
...
## <a name="to-set-up-an-item-for-directed-put-away-and-pick" />Så här skapar du artiklar för dirigerad artikelinförsel och plockning
...
## <a name="to-start-using-directed-put-away-and-pick" />För att börja använda dirigerad artikelinförsel och plockning
...
## <a name="to-set-up-a-zone-in-your-warehouse" />Så här skapar du en zon i distributionslagret
