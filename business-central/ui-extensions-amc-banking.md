...
# <a name="use-the-amc-banking-365-fundamentals-extension"></a><a name="use-the-amc-banking-365-fundamentals-extension"></a>Använda AMC Banking 365 Fundamentals tillägget
...
## <a name="use-our-demonstration-account"></a><a name="use-our-demonstration-account"></a>Använda vårt demonstrationskonto
...
## <a name="setting-up-the-extension"></a><a name="setting-up-the-extension"></a>Konfigurera tillägget
...
### <a name="to-set-up-the-required-permission-sets"></a><a name="to-set-up-the-required-permission-sets"></a>Ange de behörighetsuppsättningar som krävs
...
### <a name="to-connect-the-extension-to-amc-banking"></a><a name="to-connect-the-extension-to-amc-banking"></a>Ansluta tillägget till AMC Banking
...
### <a name="to-connect-bank-accounts-to-the-extension"></a><a name="to-connect-bank-accounts-to-the-extension"></a>Koppla bankkonton till tillägget
...
## <a name="use-the-extension"></a><a name="use-the-extension"></a>Använda tillägget
...
### <a name="to-export-data-and-submit-it-to-your-bank"></a><a name="to-export-data-and-submit-it-to-your-bank"></a>Exportera data och skicka dem till din bank
...
### <a name="to-import-and-apply-the-converted-file"></a><a name="to-import-and-apply-the-converted-file"></a>Importera och använda den konverterade filen
