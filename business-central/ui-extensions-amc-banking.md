...
# <a name="use-the-amc-banking-365-fundamentals-extension" />Använda AMC Banking 365 Fundamentals tillägget
...
## <a name="use-our-demonstration-account" />Använda vårt demonstrationskonto
...
## <a name="setting-up-the-extension" />Konfigurera tillägget
...
### <a name="to-set-up-the-required-permission-sets" />Ange de behörighetsuppsättningar som krävs
...
### <a name="to-connect-the-extension-to-amc-banking" />Ansluta tillägget till AMC Banking
...
### <a name="to-connect-bank-accounts-to-the-extension" />Koppla bankkonton till tillägget
...
## <a name="use-the-extension" />Använda tillägget
...
### <a name="to-export-data-and-submit-it-to-your-bank" />Exportera data och skicka dem till din bank
...
### <a name="to-import-and-apply-the-converted-file" />Importera och använda den konverterade filen
