...
## Så här tilldelar du industrigrupper till en kontakt
...
## Så här tilldelar du utskicksgrupp till en kontakt
...
## Så här definierar du en kontakts alternativa adress
...
## Så här tilldelar du kontakter arbetsansvar
...
## För att tilldela befattningsnivåer till en kontakt
...
## För att tilldela webbadresser till en kontakt
...
## Så här tilldelar du affärsrelationer till kontakter
...
## Synkronisera kontakter med kunder, leverantörer och bankkonton
