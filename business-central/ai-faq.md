...
# <a name="ai-powered-item-marketing-text-preview-with-copilot-faq" />Marknadsföringstext för AI-baserad artikel (förhandsversion) med vanliga frågor och svar om Copilot
...
### <a name="what-is-copilot" />Vad är Copilot?
...
### <a name="why-isnt-copilot-available-for-marketing-text-on-my-items-in-business-central" />Varför är inte Copilot tillgängliga för marknadsföringstext på mina artiklar på Business Central?
...
### <a name="is-copilot-available-for-preview-in-business-central-on-premises" />Är Copilot tillgänglig för förhandsversion i Business Central lokal?

Nej, den stöds inte för närvarande i Business Central lokal.

### <a name="how-does-copilot-work-where-does-the-suggested-text-come-from" />Hur fungerar Copilot, var kommer den föreslagna texten från?
...
### <a name="whats-the-quality-of-the-text-suggested-by-copilot" />Vilken är kvaliteten på den text som föreslås av Copilot?
...
### <a name="how-can-i-improve-the-suggestions-i-get-from-copilot" />Hur kan jag förbättra de förslag jag får från en Copilot?
...
### <a name="what-if-im-not-satisfied-with-the-generated-text" />Vad händer om jag inte är nöjd med den genererade texten?
...
### <a name="can-admins-disable-copilot-if-so-how" />Kan administratörer inaktivera Copilot? Hur gör jag?
...
### <a name="does-copilot-work-with-languages-other-than-english" />Fungerar Copilot med andra språk än engelska?
...
### <a name="whats-done-about-abusive-and-harmful-text-suggestions" />Vad har man gjort åt kränkande och skadliga textförslag?
...
### <a name="can-i-opt-out-of-the-logging-and-human-review-process" />Kan jag välja bort processen för loggning och mänsklig granskning?
...
### <a name="what-data-does-the-capability-collect-how-is-the-data-used" />Vilken data samlar kapaciteten in? Hur används uppgifterna?
