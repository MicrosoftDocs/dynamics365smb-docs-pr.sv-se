...
ms.author: edupont
---
# <a name="map-text-on-recurring-payments-to-accounts-for-automatic-reconciliation" />Så här mappar du text på återkommande betalningar till konton för automatisk avstämning
...
## <a name="to-map-text-on-recurring-payments-to-accounts-for-automatic-reconciliation" />Så här mappar du text på återkommande betalningar till konton för automatisk avstämning
...
## <a name="example-text-to-account-mapping-for-bank-fees" />Exempel: Text-till-konto-mappning för bankavgifter
