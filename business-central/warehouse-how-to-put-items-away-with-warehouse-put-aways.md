...
---
# <a name="put-items-away-with-warehouse-put-aways" />Föra in artiklar med lagerartikelinförsel
...
## <a name="to-create-put-away-documents-in-bulk-with-the-put-away-worksheet" />Så här skapar du artikelinförseldokumenten i bulk med artikelinförselkalkylarket
...
## <a name="to-create-a-put-away-from-a-posted-receipt" />Att skapa en artikelinförsel från en bokförd inleveransen
...
## <a name="to-put-items-away" />Att införa artiklar
