...
ms.author: edupont
---
# <a name="post-service-orders-and-credit-memos"></a><a name="post-service-orders-and-credit-memos"></a>Bokföra tjänsteorder och kreditnotor
...
## <a name="to-post-a-service-order"></a><a name="to-post-a-service-order"></a>Så här bokför du serviceorder
...
## <a name="to-batch-post-service-orders"></a><a name="to-batch-post-service-orders"></a>Så här batch-bokför du serviceorder
1. Välj den ![Glödlampa som öppnar funktionen Berätta.](media/ui-search/search_small.png "Berätta vad du vill göra") anger du **Serviceorder** och väljer sedan relaterad länk.  
...
## <a name="to-post-a-service-credit-memo"></a><a name="to-post-a-service-credit-memo"></a>Så här bokför du servicekreditnotor
...
## <a name="to-post-consumption-from-a-service-order"></a><a name="to-post-consumption-from-a-service-order"></a>Så här bokför du förbrukning från en serviceorder
...
## <a name="to-post-shipments-from-service-orders"></a><a name="to-post-shipments-from-service-orders"></a>Så här bokför du utleveranser från serviceorder
...
## <a name="to-undo-posted-consumption"></a><a name="to-undo-posted-consumption"></a>Så här ångrar du bokförd förbrukning
...
## <a name="to-post-service-lines"></a><a name="to-post-service-lines"></a>Så här bokför du servicerader
