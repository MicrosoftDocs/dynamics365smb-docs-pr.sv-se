...
Det finns några funktioner som du kan använda för att växla mellan företag medan du arbetar, som företagsväxlaren (Ctrl + O). Läs mer i [Byta till ett annat företag eller en annan miljö](ui-organization-switch.md).
...
2. När du är klar uppdaterar du webbläsaren (tryck på Ctrl + F5) för att uppdatera brickan i klienten.  
