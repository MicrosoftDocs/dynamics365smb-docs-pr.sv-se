...
ms.author: edupont
---
# <a name="create-incoming-document-records"></a><a name="create-incoming-document-records"></a><a name="create-incoming-document-records"></a>Skapa inkommande dokumentposter
...
## <a name="approve-or-reject-an-incoming-document"></a><a name="approve-or-reject-an-incoming-document"></a><a name="approve-or-reject-an-incoming-document"></a>Så här Godkänn eller avvisa ett inkommande dokument.
...
## <a name="create-an-incoming-document-record-by-taking-a-photo"></a><a name="create-an-incoming-document-record-by-taking-a-photo"></a><a name="create-an-incoming-document-record-by-taking-a-photo"></a>Så här skapar du en inkommande dokumentpost genom att ta ett foto
...
## <a name="create-an-incoming-document-record-manually"></a><a name="create-an-incoming-document-record-manually"></a><a name="create-an-incoming-document-record-manually"></a>Så här skapar du en inkommande dokumentpost manuellt
