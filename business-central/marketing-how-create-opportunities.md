...
ms.author: jswymer
---
# <a name="create-sales-opportunities" />Skapa affärsmöjligheter
...
## <a name="to-create-an-opportunity-from-a-salesperson" />Så här skapar du en affärsmöjlighet från en säljare
...
## <a name="to-create-an-opportunity-from-a-contact" />Så här skapar du en affärsmöjlighet från en kontakt
