...
ms.author: jswymer
---
# <a name="create-sales-opportunities"></a><a name="create-sales-opportunities"></a><a name="create-sales-opportunities"></a>Skapa affärsmöjligheter
...
## <a name="to-create-an-opportunity-from-a-salesperson"></a><a name="to-create-an-opportunity-from-a-salesperson"></a><a name="to-create-an-opportunity-from-a-salesperson"></a>Så här skapar du en affärsmöjlighet från en säljare
...
## <a name="to-create-an-opportunity-from-a-contact"></a><a name="to-create-an-opportunity-from-a-contact"></a><a name="to-create-an-opportunity-from-a-contact"></a>Så här skapar du en affärsmöjlighet från en kontakt
