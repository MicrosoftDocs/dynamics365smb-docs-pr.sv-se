...
1. Tilldela behörigheter på följande sätt:
    ...
    * Om du vill tilldela flera behörighetsuppsättningar väljer du åtgärden **Lägg till flera** och väljer vilka uppsättningar som ska tilldelas.
1. Om du vill att behörighetsuppsättningen endast ska gälla för ett specifikt företag, ställ in kolumnen **Företag** för det företaget. Om du vill att behörighetsuppsättningen ska gälla för alla företag lämnar du kolumn **Företag** tomt. [Läs mer](ui-define-granular-permissions.md#control-access-to-specific-companies).
