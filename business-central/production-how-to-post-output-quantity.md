...
ms.author: edupont
---
# <a name="batch-post-output-and-run-times" />Batch-bokför utflöde och körtider
...
## <a name="to-post-output-quantities-andor-register-run-times-for-one-or-more-production-order-lines" />Om du vill bokföra utflödeskvantiteter och/eller registrera körtider för en eller flera produktionsorderrader
