...
ms.author: edupont
---
# <a name="import-business-data-from-other-finance-systems"></a><a name="import-business-data-from-other-finance-systems"></a>Importera affärsdata från andra finanssystem
...
## <a name="work-with-data-in-excel"></a><a name="work-with-data-in-excel"></a>Arbeta med data i Excel
...
## <a name="import-data-from-configuration-packages"></a><a name="import-data-from-configuration-packages"></a>Importera data från konfigurationspaket
...
### <a name="tables-in-the-default-configuration-package"></a><a name="tables-in-the-default-configuration-package"></a>Tabellerna i standardkonfigurationspaketet
