...
# <a name="setting-up-troubleshooting-for-service-items" />Ställa in felsökning av serviceartiklar.
...
## <a name="to-set-up-troubleshooting-guidelines" />Så här skapar du felsökningsriktlinjer
...
## <a name="to-assign-troubleshooting-guidelines-to-items-service-items-or-service-item-groups" />För att koppla riktlinjer för felsökning till artiklar, serviceartiklar eller serviceartikelgrupper.
