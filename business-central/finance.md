---
title: Ekonomisk förvaltning (innehåller Video)
...
# <a name="financial-management"></a>Ekonomisk förvaltning
...
I följande avsnitt beskrivs en sekvens med uppgifter, med länkar till artiklarna där de beskrivs.  
...
| Till... | Gå till |
| --- | --- |
| Läs mer om funktionerna för att analysera ekonomiska data. | [Översikt över ekonomisk analys](bi.md) |
| Ställ in ekonomisk rapportering mellan affärsenheter eller juridiska personer. | [Hantera ekonomisk rapportering mellan affärsenheter eller juridiska personer](finance-consolidated-company-reporting.md) |
| Ställ in och använd ekonomisk rapportering för att göra rapporter och översikter | [Förbereda ekonomisk rapportering](bi-how-work-account-schedule.md) |
| Utför ad hoc-analys av ekonomiska data direkt på listsidor och frågor. | [Ad hoc-analys av ekonomiska data](ad-hoc-analysis-finance.md) |
| Analysera ekonomiska data från kontoplanen. | [Analysera ekonomiska data från kontoplaner](finance-general-ledger.md) |
| Analysera faktiska belopp kontra budgeterade belopp. | [Analysera faktiska belopp kontra budgeterade belopp](bi-how-analyze-actual-versus-budget.md) |
| Analysera kassaflöde. | [Analysera kassaflöde](finance-analyze-cash-flow.md) |
| Utforska inbyggda viktiga ekonomiska rapporter. | [Inbyggda viktiga ekonomiska rapporter](finance-reports.md) |
