---
title: Ange när och hur aviseringar om arbetsflöde ska tas emot
...
---
# <a name="specify-when-and-how-to-receive-workflow-notifications"></a>Ange när och hur aviseringar om arbetsflöde ska tas emot

I arbetsflöden som kräver att någon godkänner ändringar måste du ställa in de godkännandeanvändare som godkänner eller avvisar ändringar. Du kanske till exempel vill att någon ska godkänna nya poster. En viktig del av användarinställningarna för godkännande är att ange hur och när användaren ska meddelas om ändringen. Du kan t.ex. ange att en godkännandeanvändare direkt får ett e-postmeddelande när någon skapar en ny kund. Du kan också schemalägga aviseringar att meddelanden ska levereras, t.ex. en gång per vecka eller per månad.
...
3. På sidan **Konfigurera arbetsflödesavisering** kan du fylla i fälten enligt beskrivningen i följande tabell.  
   ...
   Du har registrerat hur användaren ska meddelas. Ange nu när användaren ska meddelas.  
