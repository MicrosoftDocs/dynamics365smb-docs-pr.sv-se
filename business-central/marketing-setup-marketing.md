...
ms.author: edupont
---
# <a name="setting-up-relationship-management" />Ställa in Kundhantering
...
## <a name="automatically-recording-interactions" />Automatiskt registrerade interaktioner
...
## <a name="synchronizing-contacts-with-customers-and-more" />Synkronisera kontakter med kunder och fler
...
## <a name="assigning-a-number-series-to-contacts-and-opportunities" />Tilldela en nummerserie för kontakter och affärsmöjligheter
...
## <a name="searching-for-duplicate-contacts-when-contacts-are-created" />Söka efter dubbelkontakter, när kontakter skapas
