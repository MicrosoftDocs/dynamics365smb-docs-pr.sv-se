...
ms.author: edupont
---
# <a name="adjust-item-costs"></a><a name="adjust-item-costs"></a>Justera artikelkostnader
...
## <a name="to-adjust-item-costs-manually"></a><a name="to-adjust-item-costs-manually"></a>Så här justerar du artikelkostnader manuellt
...
## <a name="to-make-general-changes-in-the-direct-unit-cost"></a><a name="to-make-general-changes-in-the-direct-unit-cost"></a>Så här gör du generella ändringar i inköpspris
...
## <a name="understanding-unit-cost-calculation"></a><a name="understanding-unit-cost-calculation"></a>Förstå beräkning av styckkostnad
