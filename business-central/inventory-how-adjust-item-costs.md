...
ms.author: edupont
---
# <a name="adjust-item-costs" />Justera artikelkostnader
...
## <a name="to-adjust-item-costs-manually" />Så här justerar du artikelkostnader manuellt
...
## <a name="to-make-general-changes-in-the-direct-unit-cost" />Så här gör du generella ändringar i inköpspris
...
## <a name="understanding-unit-cost-calculation" />Förstå beräkning av styckkostnad
