...
ms.author: jswymer
---
# <a name="configuring-onedrive-integration-with-business-central-on-premises" />Konfigurera OneDrive-integration med Business Central lokalt
...
### <a name="run-onedrive-setup" />Kör OneDrive-konfiguration
...
## <a name="switching-from-legacy-sharepoint-to-new-onedrive-integration" />Växla från äldre SharePoint till ny OneDrive-integration
...
#### <a name="how-the-changes-affect-the-integration" />Så påverkar ändringarna integrationen
...
### <a name="run-onedrive-setup-to-switch-to-the-new-onedrive-integration" />Kör OneDrive-konfigurationen för att växla till den nya OneDrive-integrationen
