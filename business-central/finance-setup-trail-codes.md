...
ms.author: edupont
---
# <a name="setting-up-source-codes-and-reason-codes-for-audit-trails"></a><a name="setting-up-source-codes-and-reason-codes-for-audit-trails"></a><a name="setting-up-source-codes-and-reason-codes-for-audit-trails"></a>Ställa in ursprungskoder och orsakskoder för granskningshistorik
...
## <a name="define-source-codes"></a><a name="define-source-codes"></a><a name="define-source-codes"></a>Definiera ursprungskoder
...
### <a name="to-define-source-codes"></a><a name="to-define-source-codes"></a><a name="to-define-source-codes"></a>Så här definierar du ursprungskoder
...
## <a name="change-source-codes"></a><a name="change-source-codes"></a><a name="change-source-codes"></a>Ändra ursprungskoder

Det kan hända att du vill ändra en ursprungskod. Du kanske t. ex. vill ändra ursprungskoden *GENJNL* till *GNJ*.

### <a name="to-change-source-codes"></a><a name="to-change-source-codes"></a><a name="to-change-source-codes"></a>Så här ändrar du ursprungskoder
...
## <a name="define-reason-codes"></a><a name="define-reason-codes"></a><a name="define-reason-codes"></a>Definiera uppföljningskoder
...
### <a name="to-set-up-reason-codes"></a><a name="to-set-up-reason-codes"></a><a name="to-set-up-reason-codes"></a>Så här lägger du upp uppföljningskoder
...
### <a name="to-assign-reason-codes-to-journal-templates"></a><a name="to-assign-reason-codes-to-journal-templates"></a><a name="to-assign-reason-codes-to-journal-templates"></a>Så här tilldelar du uppföljningskoder till journalmallar
...
### <a name="to-use-reason-codes-on-sales-and-purchase-documents"></a><a name="to-use-reason-codes-on-sales-and-purchase-documents"></a><a name="to-use-reason-codes-on-sales-and-purchase-documents"></a>Så här använder du uppföljningskoder i försäljnings- och inköpsdokument
