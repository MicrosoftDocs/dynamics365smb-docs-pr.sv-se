...
ms.author: edupont
---
# <a name="transferring-and-posting-cost-entries" />Överföra och bokföra kostnadstransaktioner
...
## <a name="criteria-for-transferring-general-ledger-entries-to-cost-entries" />Villkor för överföring av redovisningstransaktioner till kostnadstransaktioner
...
## <a name="transferring-general-ledger-entries-to-cost-entries" />Överföring av redovisningstransaktioner till kostnadstransaktioner
...
### <a name="to-prepare-the-transfer" />Så här förbereder du överföringen
...
### <a name="to-transfer-general-ledger-entries-to-cost-entries" />Så här överför du redovisningstransaktioner till kostnadstransaktioner
...
## <a name="automatic-transfer-and-combined-entries" />Automatisk överföring och kombinerade transaktioner
...
## <a name="results-of-transferring-general-ledger-entries-to-cost-entries" />Resultat av överföring av redovisningstransaktioner till kostnadstransaktioner
...
### <a name="general-ledger-entries" />Redovisningstransaktioner
...
### <a name="cost-entries" />Kostnadstransaktioner
...
### <a name="cost-register" />Bokförd journal för kostnad
...
## <a name="see-related-microsoft-trainingtrainingmodulestransfer-gl-entries-dynamics-365-business-central" />Se relaterad [Microsoft utbildning](/training/modules/transfer-gl-entries-dynamics-365-business-central/)
