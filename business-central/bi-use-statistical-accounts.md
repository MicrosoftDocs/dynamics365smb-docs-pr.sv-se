...
---
# <a name="analyze-data-with-statistical-accounts" />Analysera data med statistiska konton
...
## <a name="set-up-a-statistical-account" />Skapa ett statistiskt konton
...
## <a name="post-amounts-to-a-statistical-account" />Bokföra belopp till ett statistik konto
...
## <a name="verify-statistical-account-amounts" />Verifiera belopp till ett statistik konto
...
## <a name="include-the-statistical-account-in-a-financial-report" />Ta med statistiskt kontot i en finansiell rapport
