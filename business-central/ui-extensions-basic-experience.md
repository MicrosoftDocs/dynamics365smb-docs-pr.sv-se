...
# <a name="the-basic-experience-extension"></a><a name="the-basic-experience-extension"></a>Basic Experience-tillägget
...
## <a name="whats-available"></a><a name="whats-available"></a>Vad som finns
...
## <a name="getting-started"></a><a name="getting-started"></a>Kom i gång
...
## <a name="migrating-data"></a><a name="migrating-data"></a>Migrera data
