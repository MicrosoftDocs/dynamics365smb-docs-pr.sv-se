...
ms.author: edupont
---
# <a name="count-and-adjust-inventory-using-documents" />Beräkna och justera lager med hjälp av dokument
...
## <a name="to-create-a-physical-inventory-order" />Skapa en inventeringsorder
...
## <a name="to-create-a-physical-inventory-recording" />Skapa en inventeringsregistrering
...
## <a name="to-finish-a-physical-inventory-recording" />Slutför en inventeringsregistrering
...
## <a name="to-complete-a-physical-inventory-order" />Slutför en inventeringsorder
...
### <a name="to-find-duplicate-physical-inventory-order-lines" />Hitta dubbla inventeringsorderrader
...
### <a name="to-post-a-physical-inventory-order" />Bokför en inventeringsorder
...
### <a name="to-view-posted-physical-inventory-orders" />För att visa bokförda inventeringsorder
...
## <a name="handling-item-tracking-when-counting-inventory" />Hantera artikelspårning vid inventering
...
### <a name="example---prepare-a-physical-inventory-recording-for-an-item-tracked-item" />Exempel – Förbered en inventeringsregistrering för en artikelspårad artikel
...
### <a name="example---record-and-post-counted-lot-number-differences" />Exempel – registrera och bokföra inventerat partinummeravvikelser
...
## <a name="inventory-documents" />Inventariedokument
...
### <a name="to-set-up-numbering-for-inventory-documents" />Så här ställer du in numrering för lagerdokument
...
### <a name="to-create-and-post-an-inventory-document" />Så här skapar och bokför du ett lagerdokument
...
## <a name="printing-inventory-documents" />Skriva ut lagerdokument
