...
ms.author: bholtorf
---
# <a name="set-up-a-loaner-program"></a><a name="set-up-a-loaner-program"></a>Lägga upp program för låneartiklar
...
## <a name="to-set-up-a-loaner"></a><a name="to-set-up-a-loaner"></a>Så här skapar du en låneartikel
