...
När du skapar ett nytt företag får du hjälp med de grundläggande inställningarna av en assisterad konfiguration. Du kan sedan importera data från ditt gamla system eller från något annat företag i [!INCLUDE[prod_short](includes/prod_short.md)].  
...
- **Utvärdering – exempeldata**  
    Skapa ett företag som liknar demonstrationsföretaget med exempeldata och inställningsdata. Denna typ av företag är tillgänglig för dig utan att du behöver växla till en 30-dagars provperiod som de andra typerna gör.  
- **Avancerad utvärdering – fullständiga exempeldata** Skapa ett företag med omfattningen Avancerad funktion, som har allt du behöver för att utvärdera produkten för företag med avancerade processer. Denna typ av företag är tillgänglig för dig utan att du behöver växla till en 30-dagars provperiod som de andra typerna gör.
- **Produktion – enbart inställningsdata**  
    Skapa ett företag som liknar **Mitt företag**, med inställningsdata som kontoplan, betalningsmetoder och definitioner av ekonomiska rapporter, men utan exempeldata. Du kan använda detta företag under en provperiod på 30 dagar.
- **Skapa nya – inga data**  
    Skapa ett tomt företag utan inställningsdata. Du kan använda detta företag under en provperiod på 30 dagar.  
...
På sidan **Företag** kan du använda åtgärden **Kopiera** för att skapa ett andra företag baserat på innehållet i ett befintligt företag. Detta är användbart att kopiera ett företag om du t.ex. vill testa ett företag utan att störa produktionsdata.
...
När du loggar in på ett nytt företag kan guiden för assisterad konfiguration för **företagsinställningar** hjälpa dig att komma igång. Guden frågar efter information om företaget, till exempel adress, bankuppgifter och lagervärderingsprincip. Den här informationen utgör grunden för många områden i [!INCLUDE[prod_short](includes/prod_short.md)] så att du inte behöver ställa in dem manuellt.  
