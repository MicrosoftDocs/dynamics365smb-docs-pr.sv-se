...
>
> Den här funktionen är tillgänglig som en app som du kan hämta från [AppSource](https://go.microsoft.com/fwlink/?linkid=2081646). För att använda den här funktionen måste du först installera den på sidan **Tilläggshantering**.
...
1. Välj ikonen :::image type="icon" source="media/ui-search/search_small.png" border="false":::, ange **Funktionshantering** och väljer sedan relaterad länk.
...
2.  På snabbfliken **Allmänt** väljer du eller anger fältinformation om det behövs. [!INCLUDE[tooltip-inline-tip](includes/tooltip-inline-tip_md.md)] Följande tabell beskriver några av nyckelfälten.
   ...
   | **Inkludera direktutleverans** | Anger om direktutleveranstransaktioner ingår i Intrastat-rapporter. Mer information finns i [Arbeta med Intrastat-rapportering](finance-how-report-intrastat.md).  |  
...
4.  På snabbfliken **standardtransaktioner** väljer du eller anger fältinformation om det behövs. [!INCLUDE[tooltip-inline-tip](includes/tooltip-inline-tip_md.md)] Följande tabell beskriver några av nyckelfälten.
...
5.  På snabbfliken **Rapportering** väljer du eller anger fältinformation om det behövs. [!INCLUDE[tooltip-inline-tip](includes/tooltip-inline-tip_md.md)] Följande tabell beskriver några av nyckelfälten.
...
6. På snabbfliken **Numrering**, ange ett värde i **Intrastat-nr**.
...
Om det finns en orsak till att en viss artikel eller anläggningstillgång ska uteslutas från Intrastat-rapportering måste du ändra ett alternativ på deras kort och markera fältet **Exkludera från Intrastat-rapport**. Använd det här fältet på kortet **Artikelmall** om du vill skapa fler artiklar som undantas från Intrastat-rapporteringen. 
...
## <a name="enter-countryregion-intrastat-settings"></a>Ange land-/regionsspecifika Intrastat-inställningar
