...
## <a name="to-add-bank-statement-lines-by-importing-a-bank-statement"></a>Lägg till bankutdragsrader genom att importera ett kontoutdrag
...
## <a name="to-validate-your-bank-reconciliation"></a>Så här validerar du bankavstämningen
