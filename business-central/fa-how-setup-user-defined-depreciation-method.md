...
# <a name="set-up-fixed-assets-with-user-defined-depreciation-methods" />Skapa anläggningstillgångar med användardefinierade avskrivningsmetoder
...
## <a name="to-assign-a-depreciation-book-to-a-fixed-asset-with-a-user-defined-depreciation-method" />Så här tilldelar du en avskrivningsregel till en anläggningstillgång med en användardefinierad avskrivningsmetod
...
## <a name="to-set-up-user-defined-depreciation-methods" />Så här skapar du användardefinierade avskrivningsmetoder
...
### <a name="depreciation-based-on-number-of-units" />Avskrivning baserad på antal enheter
...
### <a name="example---user-defined-depreciation" />Exempel – Användardefinierad avskrivning
