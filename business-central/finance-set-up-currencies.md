...
ms.author: edupont
---
# <a name="set-up-currencies"></a><a name="set-up-currencies"></a>Konfigurera valutor
...
## <a name="currencies"></a><a name="currencies"></a><a name="curr"></a>Valutor
...
### <a name="available-currency-functions"></a><a name="available-currency-functions"></a>Tillgängliga valutafunktioner
...
## <a name="lcy-and-other-currencies"></a><a name="lcy-and-other-currencies"></a>BVA och andra valutor

[!INCLUDE [finance-currencies-lcy-def](includes/finance-currencies-lcy-def.md)]

## <a name="rounding-currencies"></a><a name="rounding-currencies"></a>Avrunda valutor
...
### <a name="unit-amount-rounding"></a><a name="unit-amount-rounding"></a>Enhetspris-avrundning
...
### <a name="amount-rounding"></a><a name="amount-rounding"></a>Beloppavrundning
...
## <a name="general-ledger-accounts"></a><a name="general-ledger-accounts"></a>Redovisningskonton
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relaterad [Microsoft utbildning](/training/modules/currencies-exchange-rates-dynamics-365-business-central/)
