...
Använd en extern tjänst för att hämta de senaste valutakurserna till listan **Valutor**. Mer information finns i [Så här konfigurerar du en valutakurstjänst](finance-how-update-currencies.md#set-up-a-currency-exchange-rate-service).  
