...
ms.author: edupont
---
# <a name="set-up-currencies" />Konfigurera valutor
...
## <a name="a-namecurracurrencies" /><a name="curr"></a>Valutor
...
### <a name="available-currency-functions" />Tillgängliga valutafunktioner
...
## <a name="lcy-and-other-currencies" />BVA och andra valutor

[!INCLUDE [finance-currencies-lcy-def](includes/finance-currencies-lcy-def.md)]

## <a name="rounding-currencies" />Avrunda valutor
...
### <a name="unit-amount-rounding" />Enhetspris-avrundning
...
### <a name="amount-rounding" />Beloppavrundning
...
## <a name="general-ledger-accounts" />Redovisningskonton
...
## <a name="see-related-microsoft-trainingtrainingmodulescurrencies-exchange-rates-dynamics-365-business-central" />Se relaterad [Microsoft utbildning](/training/modules/currencies-exchange-rates-dynamics-365-business-central/)
