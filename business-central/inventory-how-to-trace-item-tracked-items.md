...
ms.author: edupont
---
# <a name="trace-item-tracked-items" />Spåra artiklar med artikelspårning
...
## <a name="to-trace-item-tracked-items" />Se spårade artiklar
...
## <a name="to-find-item-tracked-items-with-find-entries" />Så här hittar du spårade artiklar med Hitta transaktioner
