...
ms.author: edupont
---
# <a name="trace-item-tracked-items"></a><a name="trace-item-tracked-items"></a><a name="trace-item-tracked-items"></a>Spåra artiklar med artikelspårning
...
## <a name="to-trace-item-tracked-items"></a><a name="to-trace-item-tracked-items"></a><a name="to-trace-item-tracked-items"></a>Se spårade artiklar
...
## <a name="to-find-item-tracked-items-with-find-entries"></a><a name="to-find-item-tracked-items-with-find-entries"></a><a name="to-find-item-tracked-items-with-find-entries"></a>Så här hittar du spårade artiklar med Hitta transaktioner
