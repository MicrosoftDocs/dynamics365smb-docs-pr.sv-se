...
# <a name="cash-flow-overview"></a><a name="cash-flow-overview"></a><a name="cash-flow-overview"></a>Kassaflöde, översikt
...
## <a name="definition-of-cash-flow"></a><a name="definition-of-cash-flow"></a><a name="definition-of-cash-flow"></a>Definition av kassaflöde
...
## <a name="work-with-cash-flow"></a><a name="work-with-cash-flow"></a><a name="work-with-cash-flow"></a>Arbeta med kassaflöde
...
## <a name="making-a-cash-flow-forecast"></a><a name="making-a-cash-flow-forecast"></a><a name="making-a-cash-flow-forecast"></a>Göra en prognos för kassaflöde
