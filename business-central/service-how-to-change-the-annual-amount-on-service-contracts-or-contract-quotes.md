...
ms.author: bholtorf
---
# <a name="change-the-annual-amount-on-service-contracts-or-contract-quotes" />Ändra det årliga beloppet på servicekontrakt eller kontraktofferter
...
## <a name="to-change-the-annual-amount-of-the-service-contract-or-contract-quote" />Så här ändrar du det årliga beloppet på ett servicekontrakt eller en kontraktsoffert
...
## <a name="distributing-differences-between-new-and-calculated-annual-amounts" />Fördela skillnaden mellan nya och beräknade årliga belopp
...
### <a name="even-distribution" />Jämn fördelning
...
### <a name="distribution-based-on-line-amount" />Fördelning baserad på radbelopp
...
### <a name="distribution-based-on-profit" />Fördelning baserad på vinst
