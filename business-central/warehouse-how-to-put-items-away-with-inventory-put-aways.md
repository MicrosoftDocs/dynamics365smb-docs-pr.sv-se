...
---
# <a name="put-items-away-with-inventory-put-aways" />Föra in artiklar med lagerartikelinförsel
...
## <a name="to-create-an-inventory-put-away-from-the-source-document" />Så här skapar du en lagerartikelinförsel från källdokumentet
...
## <a name="to-create-multiple-inventory-put-aways-with-a-batch-job" />Så här skapar du flera lagerartikelinförslar med batch-jobbet:
...
## <a name="to-create-the-put-away-in-two-steps" />Så här skapar du artikelinförseln i två steg

### <a name="to-request-an-inventory-put-away-by-releasing-the-source-document" />Så här begär du en lagerinförsel genom att släppa källdokumentet
...
### <a name="to-create-an-inventory-put-away-based-on-the-source-document" />Så här skapar du en lagerartikelinförsel från källdokumentet
...
## <a name="to-record-the-inventory-put-away" />När du vill registrera lagerinförsel.
