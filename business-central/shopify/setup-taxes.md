...
# <a name="set-up-taxes-for-the-shopify-connection" />Ställa in moms för Shopify anslutning
...
## <a name="if-you-sell-domestically" />Om du säljer inrikes
...
## <a name="if-you-sell-internationally" />Om du säljer internationellt
...
## <a name="dynamic-tax-inclusive-pricing" />Dynamisk moms, inklusive prissättning
...
## <a name="if-you-sell-to-eu-customers" />Om du säljer till EU-kunder
...
### <a name="collect-vat-set-to-one-stop-shop-registration" />Använder moms ställs in på registrering av kontaktpunkt
...
### <a name="collect-vat-set-to-micro-business-exemption" />Använder moms ställs in på undantag för mikroföretag
...
## <a name="importing-shopify-orders-sold-to-international-customers" />Importera Shopify order som har sålts till internationella kunder
...
## <a name="other-tax-remarks" />Andra skatteanmärkningar
