...
# <a name="set-up-taxes-for-the-shopify-connection"></a>Konfigurera moms för Shopify-anslutningen
...
På marknader som sådana är det ett pris av 100 EUR som definierats på produktkortet redan innehåller moms (VAT). Priset, inklusive moms, visas för kunden i skyltfönstret och i kassan.  

I USA och Kanada förväntar sig kunderna inte att se priser med skatter eftersom den slutliga skatten beror på vart produkterna skickas till. Skatt läggs till i kassan, så växlingsknappen **Alla priser inkluderar skatt** är vanligtvis inaktiverad. I det här fallet är ett pris på $100 definierat på produkten kort priset utan skatt. I kassan läggs momsen till i priset.
...
Shopify Skattesatsen i det andra landet/den utländska regionen används när slutpriserna beräknas.
