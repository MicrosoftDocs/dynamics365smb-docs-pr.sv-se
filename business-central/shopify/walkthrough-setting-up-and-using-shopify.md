...
# <a name="walkthrough-set-up-and-use-the-shopify-connector"></a><a name="walkthrough-set-up-and-use-the-shopify-connector"></a><a name="walkthrough-set-up-and-use-the-shopify-connector"></a>Genomgång: ställa in och använda Shopify anslutningsprogram
...
## <a name="connect-business-central-to-the-shopify-shop"></a><a name="connect-business-central-to-the-shopify-shop"></a><a name="connect-business-central-to-the-shopify-shop"></a>Ansluta Business Central till butiken på Shopify
...
## <a name="walkthrough-start-selling-products-online"></a><a name="walkthrough-start-selling-products-online"></a><a name="walkthrough-start-selling-products-online"></a>Genom gång: börja sälja produkter online
...
## <a name="walkthrough-invite-your-customers-to-your-new-online-store"></a><a name="walkthrough-invite-your-customers-to-your-new-online-store"></a><a name="walkthrough-invite-your-customers-to-your-new-online-store"></a>Genomgång: Bjud in dina kunder till din nya onlinebutik
...
## <a name="walkthrough-fine-tuning-of-item-management"></a><a name="walkthrough-fine-tuning-of-item-management"></a><a name="walkthrough-fine-tuning-of-item-management"></a>Genomgång: finjustering av artikelhantering
...
### <a name="steps-2"></a><a name="steps-2"></a><a name="steps-2"></a>Steg
...
## <a name="walkthrough-import-items-from-shopify"></a><a name="walkthrough-import-items-from-shopify"></a><a name="walkthrough-import-items-from-shopify"></a>Genomgång: Importera artiklar från Shopify
...
### <a name="steps-3"></a><a name="steps-3"></a><a name="steps-3"></a>Steg
...
#### <a name="prepare-data"></a><a name="prepare-data"></a><a name="prepare-data"></a>Förbereda data
...
#### <a name="run-the-synchronization"></a><a name="run-the-synchronization"></a><a name="run-the-synchronization"></a>Kör synkronisering
