...
# <a name="create-and-set-up-a-shopify-account" />Skapa och ställa in ett Shopify konto
...
## <a name="trial-end-user" />Utvärderingsversion (slutanvändare)
...
## <a name="development-store" />Utvecklingsbutik
