...
## <a name="advanced-details"></a>Avancerade detaljer
...
### <a name="price-synchronization-for-b2b"></a>Prissynkronisering för B2B
...
#### <a name="synchronize-catalogs-from-the-shopify"></a>Synkronisera kataloger från Shopify
...
#### <a name="sync-prices-for-b2b-catalog"></a>Synkronisera priser för B2B Catalog
