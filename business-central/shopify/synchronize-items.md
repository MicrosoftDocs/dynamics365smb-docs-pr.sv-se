...
|Lager kommer att lagras på| Beror på var Shopify-butikerna finns. Om fältet **Standard** har aktiverats för **Effektueringstjänsten Business Central** kommer laret att fyllas på och skickas från **Effektueringstjänsten Business Central**, i annat fall kommer primär Shopify-plats eller flera platser att användas.
| Inte använd.|
