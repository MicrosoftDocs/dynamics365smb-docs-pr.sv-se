...
|Lager kommer att lagras på| Beror på var Shopify-butikerna finns. Om fältet **Standard** har aktiverats för **Effektueringstjänsten Business Central** kommer laret att fyllas på och skickas från **Effektueringstjänsten Business Central**, i annat fall kommer primär Shopify-plats eller flera platser att användas.| Inte använd.|
...
### <a name="url-and-preview-url"></a>URL och förhandsgransknings-URL
...
* När du exporterar bilder från [!INCLUDE[prod_short](../includes/prod_short.md)] till Shopify ersätter bilderna de som du exporterade tidigare. De tidigare bilderna är inte längre avialble.
...
* Både **Effektueringstjänsten Business Central** och vanliga lagerställan stöds och kan användas för leverans och lager.
