...
# <a name="synchronize-items-and-inventory" />Synkronisera artiklar och lager
...
## <a name="define-item-synchronizations" />Definiera artikelsynkronisering
...
## <a name="import-items-from-shopify" />Importera artiklar från Shopify
...
### <a name="effect-of-shopify-product-skus-and-barcodes-on-mapping-and-creating-items-and-variants-in-business-central" />Påverkan av Shopify produkt-SKU:er och streckkoder för att mappa och skapa artiklar och varianter i Business Central
...
## <a name="export-items-to-shopify" />Exportera artiklar till Shopify
...
### <a name="fields-mapping-overview" />Översikt över fältmappning
...
## <a name="run-item-synchronization" />Kör atikelsynkronisering

Fullständig eller delvis synkronisering av artiklar kan utföras på många olika sätt.

### <a name="initial-sync-of-items-from-business-central-to-shopify" />Inledande synkronisering av artiklar från Business Central till Shopify
...
### <a name="sync-products-from-shopify-to-business-central" />Synkronisera produkter från Shopify till Business Central
...
### <a name="ad-hoc-updates-of-shopify-products" />Ad-hoc-uppdateringar av Shopify-produkter
...
## <a name="sync-item-images" />Synkronisera artikelbilder
...
### <a name="sync-product-images-from-the-shopify-shop-page" />Synkronisera produktbilder från sidan Shopify-butik
...
### <a name="sync-product-images-from-the-shopify-products-page" />Synkronisera produktbilder från sidan Shopify-produkter
...
### <a name="image-synchronization-remarks" />Anmärkningar om bildsynkronisering
...
## <a name="sync-prices-with-shopify" />Synkronisera priser med Shopify
...
### <a name="sync-prices-from-the-shopify-products-page" />Synkronisera priser från sidan Shopify-produkter

1. Gå till ikonen med ![glödlampan som öppnar funktionen Berätta](../media/ui-search/search_small.png "Berätta vad du vill göra") och ange **Shopify-produkter** och välj relaterad länk.
2. Välj åtgärden **Synkronisera priser med Shopify**.

### <a name="price-calculation-remarks" />Anmärkningar om prisberäkning
...
## <a name="sync-inventory-to-shopify" />Synkronisera lager med Shopify
...
### <a name="to-enable-inventory-sync" />Aktivera lagersynkronisering
...
### <a name="sync-inventory-from-the-shopify-shop-page" />Synkronisera lager från sidan Shopify-butik

1. Gå till ikonen med ![glödlampan som öppnar funktionen Berätta](../media/ui-search/search_small.png "Berätta vad du vill göra") och ange **Shopify-butiker** och välj relaterad länk.
2. Välj den butik som du vill synkronisera lager för och öppna sidan **Shopify-butikskort**.
3. Välj åtgärden **Synkronisera lager**.

### <a name="sync-inventory-from-the-shopify-products-page" />Synkronisera lager från sidan Shopify-produkter

1. Gå till ikonen med ![glödlampan som öppnar funktionen Berätta](../media/ui-search/search_small.png "Berätta vad du vill göra") och ange **Shopify-produkter** och välj relaterad länk.
2. Välj åtgärden **Synkronisera lager**.

### <a name="inventory-remarks" />Lageranmärkningar
...
* Lager och leverans på **Effektueringstjänsten Business Central** stöds inte, använd inte vanliga platser i stället.

#### <a name="example-of-calculation-of-projected-available-balance" />Exempel på beräkning av planerad disponibel balans
