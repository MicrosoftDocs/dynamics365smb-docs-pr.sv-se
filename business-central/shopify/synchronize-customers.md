---
title: Synkronisera kunder och företag
...
# Synkronisera kunder och företag
...
Medan Shopify har två enheter, kund och företag, har [!INCLUDE[prod_short](../includes/prod_short.md)] bara kundenheten, vilket påverkar hur synkroniseringen fungerar.
...
Om du vill exportera en kund från [!INCLUDE[prod_short](../includes/prod_short.md)] till Shopify är stegen olika beroende på vad du vill göra:

* Exportera en kund som Shopify-kund för DTC.
* Exportera en kund som företag och kundpar för B2B-flödet.

## Viktiga inställningar när du importerar DTC-kunder från Shopify
