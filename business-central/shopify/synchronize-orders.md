...
# <a name="synchronize-and-fulfill-sales-orders" />Synkronisera och uppfylla försäljningsordrar
...
## <a name="set-the-import-of-orders-on-the-shopify-shop-card" />Ange import av ordrar på Shopify-butikskortet
...
### <a name="shipment-method-mapping" />Mappning av utleveransmetoder
...
### <a name="location-mapping" />Mappning av platser
...
## <a name="run-the-order-synchronization" />Kör ordersynkronisering
...
## <a name="review-imported-orders" />Granska importerade order
...
## <a name="create-sales-documents-in-business-central" />Skapa försäljningsdokument i Business Central
...
### <a name="to-create-sales-documents" />Skapa försäljningsdokument
...
### <a name="manage-missing-customers" />Hantera saknade kunder
...
### <a name="how-the-connector-chooses-which-customer-to-use" />Så väljer kopplingen vilken kund som ska användas
...
### <a name="different-processing-rules-for-orders" />Olika bearbetningsregler för order
...
### <a name="impact-of-order-editing" />Effekten av orderredigering
...
## <a name="synchronize-shipments-to-shopify" />Synkronisera försändelser till Shopify
...
### <a name="shipping-agents-and-tracking-url" />Speditörer och spårnings-URL
...
## <a name="returns-and-refunds" />Returer och återbetalningar
