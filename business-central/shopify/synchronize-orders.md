...
I den här artikeln beskrivs nödvändiga inställningar och steg som måste utföras för att synkronisera och uppfylla försäljningsordrar.

## <a name="set-import-of-orders-on-the-shopify-shop-card"></a>Ange import av ordrar på Shopify-butikskortet
...
Aktivera **Skapa ordrar automatiskt** för att auktomatiskt skapa försäljningsdokument i [!INCLUDE[prod_short](../includes/prod_short.md)] när Shopify-ordern har importerats.
...
## <a name="run-order-synchronization"></a>Kör ordersynkronisering
...
1. Gå till ikonen med ![glödlampan som öppnar funktionen Berätta](../media/ui-search/search_small.png "Berätta vad du vill göra") och ange **Synkronisera försändelser till Shopify** och välj relaterad länk.
...
För att granska alla transaktioner väljer du ikonen med ![glödlampan som öppnar funktionen Berätta](../media/ui-search/search_small.png "Berätta vad du vill göra") och anger **Transaktioner** och väljer sedan relaterad länk.
