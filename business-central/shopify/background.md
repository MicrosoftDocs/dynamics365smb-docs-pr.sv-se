...
# <a name="run-tasks-in-the-background" />Kör uppgifter i bakgrunden
...
## <a name="run-tasks-in-the-background-for-a-specific-shop" />Kör uppgifter i bakgrunden för en specifik butik
...
## <a name="to-schedule-recurring-tasks" />Så här schemalägger du återkommande uppgifter
