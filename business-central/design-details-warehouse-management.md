...
# <a name="warehouse-management-overview"></a><a name="warehouse-management-overview"></a><a name="warehouse-management-overview"></a>Warehouse Management – översikt
...
## <a name="modeling-the-physical-warehouse"></a><a name="modeling-the-physical-warehouse"></a><a name="modeling-the-physical-warehouse"></a>Modellering av det fysiska lagerstället
...
### <a name="locations-and-bins"></a><a name="locations-and-bins"></a><a name="locations-and-bins"></a>Lagerställen och lagerplatser
...
### <a name="shelves-and-bins"></a><a name="shelves-and-bins"></a><a name="shelves-and-bins"></a>Hyllor och lagerplatser
...
## <a name="typical-warehouse-workflow"></a><a name="typical-warehouse-workflow"></a><a name="typical-warehouse-workflow"></a>Vanligt arbetsflöde för distributionslager
...
## <a name="terminology-related-to-warehouse-management"></a><a name="terminology-related-to-warehouse-management"></a><a name="terminology-related-to-warehouse-management"></a>Terminologi relaterad till Warehouse Management

### <a name="complexity-levels"></a><a name="complexity-levels"></a><a name="complexity-levels"></a>Komplexitetsnivåer
...
### <a name="warehouse-flows"></a><a name="warehouse-flows"></a><a name="warehouse-flows"></a>Distributionslagerflöden
...
### <a name="basic-documents"></a><a name="basic-documents"></a><a name="basic-documents"></a>Grundläggande dokument
...
### <a name="advanced-documents"></a><a name="advanced-documents"></a><a name="advanced-documents"></a>Avancerade dokument
...
### <a name="pages-and-settings"></a><a name="pages-and-settings"></a><a name="pages-and-settings"></a>Sidor och inställningar

I det här avsnittet beskrivs begreppen bakom nyckelsidorna och lagerinställningarna.

#### <a name="bins-and-bin-content"></a><a name="bins-and-bin-content"></a><a name="bins-and-bin-content"></a>Lagerplatser och lagerplatsinnehåll
...
#### <a name="bin-type"></a><a name="bin-type"></a><a name="bin-type"></a>Lagerplatstyp
...
#### <a name="bin-ranking"></a><a name="bin-ranking"></a><a name="bin-ranking"></a>Lagerplatsordning
...
#### <a name="bin-setup"></a><a name="bin-setup"></a><a name="bin-setup"></a>Lagerplatsinställning
...
#### <a name="zone"></a><a name="zone"></a><a name="zone"></a>Zon
...
#### <a name="warehouse-class"></a><a name="warehouse-class"></a><a name="warehouse-class"></a>Dist.lagerklass
...
#### <a name="location"></a><a name="location"></a><a name="location"></a>Lagerställe
...
#### <a name="first-expired-first-out"></a><a name="first-expired-first-out"></a><a name="first-expired-first-out"></a>First Expiry First Out
...
#### <a name="put-away-template"></a><a name="put-away-template"></a><a name="put-away-template"></a>Artikelinförselmall
