...
ms.author: edupont
---
# <a name="make-sales-quotes"></a><a name="make-sales-quotes"></a><a name="make-sales-quotes"></a>Gör försäljningsofferter
...
## <a name="to-create-a-sales-quote"></a><a name="to-create-a-sales-quote"></a><a name="to-create-a-sales-quote"></a>Så här skapar du en försäljningsoffert
