...
---
# <a name="flows-for-production-assembly-and-jobs"></a><a name="flows-for-production-assembly-and-jobs"></a>Flöden för produktion, montering och projekt
...
## <a name="overview-of-different-configuration-options"></a><a name="overview-of-different-configuration-options"></a>Översikt över olika konfigurationsalternativ
...
### <a name="inbound-flow-put-away"></a><a name="inbound-flow-put-away"></a>Ankommande flöde (artikelinförsel)
...
### <a name="outbound-flow-pick"></a><a name="outbound-flow-pick"></a>Avgående flöde (plockning)
...
## <a name="warehouses-without-dedicated-warehouse-activity"></a><a name="warehouses-without-dedicated-warehouse-activity"></a>Distributionslager utan särskild distributionslageraktivitet
...
## <a name="basic-warehouse-configuration"></a><a name="basic-warehouse-configuration"></a>Grundläggande distributionslagerkonfiguration
...
### <a name="flows-to-and-from-production-in-a-basic-warehouse-configuration"></a><a name="flows-to-and-from-production-in-a-basic-warehouse-configuration"></a>Flöden till och från produktion i en grundläggande lagerkonfiguration
...
### <a name="flows-to-and-from-assembly-in-a-basic-warehouse-configuration"></a><a name="flows-to-and-from-assembly-in-a-basic-warehouse-configuration"></a>Flöden till och från montering i en grundläggande lagerkonfiguration
...
### <a name="flows-for-project-management-in-a-basic-warehouse-configuration"></a><a name="flows-for-project-management-in-a-basic-warehouse-configuration"></a>Flöden för projekthantering i en grundläggande lagerkonfiguration
...
## <a name="advanced-warehouse-configurations"></a><a name="advanced-warehouse-configurations"></a>Avancerad distributionslagerkonfiguration
...
### <a name="flows-to-and-from-production-in-advanced-warehouse-configurations"></a><a name="flows-to-and-from-production-in-advanced-warehouse-configurations"></a>Flöden till och från produktion i en avancerad lagerkonfiguration
...
### <a name="flows-to-and-from-assembly-in-advanced-warehouse-configurations"></a><a name="flows-to-and-from-assembly-in-advanced-warehouse-configurations"></a>Flöden till och från montering i en avancerad lagerkonfiguration
...
### <a name="flows-to-project-management-in-advanced-warehouse-configurations"></a><a name="flows-to-project-management-in-advanced-warehouse-configurations"></a>Flöden för projekthantering i en avancerad lagerkonfiguration
