...
---
# <a name="flows-for-production-assembly-and-jobs" />Flöden för produktion, montering och projekt
...
### <a name="inbound-flow-put-away" />Ankommande flöde (artikelinförsel)
...
### <a name="outbound-flow-pick" />Avgående flöde (plockning)
...
## <a name="warehouses-without-dedicated-warehouse-activity" />Distributionslager utan särskild distributionslageraktivitet
...
## <a name="basic-warehouse-configuration" />Grundläggande distributionslagerkonfiguration
...
### <a name="flows-to-and-from-production-in-a-basic-warehouse-configuration" />Flöden till och från produktion i en grundläggande lagerkonfiguration
...
### <a name="flows-to-and-from-assembly-in-a-basic-warehouse-configuration" />Flöden till och från montering i en grundläggande lagerkonfiguration
...
### <a name="flows-for-project-management-in-a-basic-warehouse-configuration" />Flöden för projekthantering i en grundläggande lagerkonfiguration
...
### <a name="flows-to-and-from-production-in-advanced-warehouse-configurations" />Flöden till och från produktion i en avancerad lagerkonfiguration
...
### <a name="flows-to-and-from-assembly-in-advanced-warehouse-configurations" />Flöden till och från montering i en avancerad lagerkonfiguration
...
### <a name="flows-to-project-management-in-advanced-warehouse-configurations" />Flöden för projekthantering i en avancerad lagerkonfiguration
