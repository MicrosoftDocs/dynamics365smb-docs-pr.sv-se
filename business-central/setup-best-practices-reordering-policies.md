...
ms.author: edupont
---
# <a name="setup-best-practices-reordering-policies" />Skapa metodtips: partiformningsmetoder
...
## <a name="see-related-microsoft-trainingtrainingpathsreplenish-items-dynamics-365-business-central" />Se relaterad [Microsoft utbildning](/training/paths/replenish-items-dynamics-365-business-central/)
