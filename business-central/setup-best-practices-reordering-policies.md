...
---
# <a name="setup-best-practices-reordering-policies"></a>Konfigurera bästa praxis: partiformningsmetoder

**Partiformningsmetod**-fältet på artikelkort har planeringsmetoder som bestämmer hur de enskilda planeringsparametrarna kommunicerar.  

En grund för bästa metod för val av en partiformningsmetod är artikelns ABC-klassificering. När du använder ABC-klassificering hanterar du artiklar enligt tre klasser. Vilken klass du använder beror på artikelns värde och volym i förhållande till det totala lagret. Volymfördelning av de tre indelningar visas i följande tabell.
