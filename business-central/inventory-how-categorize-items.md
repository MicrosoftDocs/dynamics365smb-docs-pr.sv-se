...
ms.author: edupont
---
# <a name="categorize-items"></a><a name="categorize-items"></a><a name="categorize-items"></a>Kategorisera artiklar
...
## <a name="to-create-an-item-category"></a><a name="to-create-an-item-category"></a><a name="to-create-an-item-category"></a>Så här skapar du ett artikelkategori
...
## <a name="to-assign-an-item-category-to-an-item"></a><a name="to-assign-an-item-category-to-an-item"></a><a name="to-assign-an-item-category-to-an-item"></a>Så här tilldelar du en artikelkategori till en artikel
