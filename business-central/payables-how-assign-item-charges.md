...
ms.author: edupont
---
# <a name="use-item-charges-to-account-for-additional-trade-costs" />Använda artikelomkostnader till kontot för ytterligare verksamhetskostnader
...
## <a name="to-set-up-item-charge-numbers" />Så här skapar du artikelomkostnadsnummer
...
## <a name="to-assign-an-item-charge-directly-to-the-purchase-invoice-for-the-item" />För att tilldela artikelomkostnader direkt till inköpsfakturan för artikeln
...
## <a name="to-assign-an-item-charge-from-a-separate-invoice-to-the-purchase-invoice-for-the-item" />För att tilldela artikelomkostnader från en separat faktura till inköpsfakturan för artikeln
...
## <a name="handle-item-charges-for-partial-receipts" />Hantera artikelomkostnader för delinleveranser
...
## <a name="see-related-microsoft-trainingtrainingmodulespost-purchase-item-charges-dynamics-365-business-central" />Se relaterad [Microsoft utbildning](/training/modules/post-purchase-item-charges-dynamics-365-business-central/)
