...
ms.author: edupont
---
# <a name="set-up-base-calendars"></a><a name="set-up-base-calendars"></a>Skapa baskalendrar
...
## <a name="to-set-up-a-base-calendar"></a><a name="to-set-up-a-base-calendar"></a>Så här lägger du upp en baskalender
...
## <a name="to-customize-a-calendar"></a><a name="to-customize-a-calendar"></a>Så här anpassar du en kalender
...
## <a name="to-assign-a-base-calendar"></a><a name="to-assign-a-base-calendar"></a>Så här tilldelar du en baskalender
