...
ms.author: edupont
---
# <a name="about-item-types" />Om artikeltyper
...
## <a name="costing-methods-for-types-of-items" />Värderingsprinciper för olika typer av artiklar
...
## <a name="catalog-and-service-items" />Katalog- och tjänstartiklar
