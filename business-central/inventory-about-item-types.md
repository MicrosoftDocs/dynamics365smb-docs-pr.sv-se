...
ms.author: edupont
---
# <a name="about-item-types"></a><a name="about-item-types"></a>Om artikeltyper
...
## <a name="costing-methods-for-types-of-items"></a><a name="costing-methods-for-types-of-items"></a>Värderingsprinciper för olika typer av artiklar
...
## <a name="catalog-and-service-items"></a><a name="catalog-and-service-items"></a>Katalog- och tjänstartiklar
