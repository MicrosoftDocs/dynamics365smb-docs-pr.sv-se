...
# <a name="walkthrough-of-inbound-and-outbound-flow-in-mixed-warehouse-configurations" />Genomgång av ankommande och avgående flöde i blandade distributionslagerkonfigurationer
...
## <a name="inbound-flow-receiving-and-putting-away-in-basic-warehouse-configurations" />Inkommande flöde: Inleverera och införa utflöde i grundläggande lagerkonfigurationer
...
## <a name="outbound-flow-picking-and-shipping-in-advanced-warehouse-configurations" />Utgående flöde: plockning och leverans i avancerade lagerkonfigurationer
