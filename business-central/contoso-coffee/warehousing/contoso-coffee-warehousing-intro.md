...
# <a name="introduction-to-contoso-coffee-warehousing" />Introduktion till lagerstyrning för Contoso Coffee
...
## <a name="set-up-contoso-coffee-warehousing-data" />Konfigurera lagerstyrningsdata för Contoso Coffee
