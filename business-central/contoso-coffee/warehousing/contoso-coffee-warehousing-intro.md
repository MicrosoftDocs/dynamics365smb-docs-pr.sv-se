...
# <a name="introduction-to-contoso-coffee-warehousing"></a><a name="introduction-to-contoso-coffee-warehousing"></a>Introduktion till lagerstyrning för Contoso Coffee
...
## <a name="set-up-contoso-coffee-warehousing-data"></a><a name="set-up-contoso-coffee-warehousing-data"></a>Konfigurera lagerstyrningsdata för Contoso Coffee
