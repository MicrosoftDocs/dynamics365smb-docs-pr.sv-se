...
# <a name="introduction-to-contoso-coffee-demo-data" />Introduktion till demonstrationsdata för Contoso Coffee
...
## <a name="set-up-contoso-coffee-data" />Konfigurera data för Contoso Coffee
...
## <a name="warehousing-scenarios" />Lagerstyrningsscenarier
