...
ms.author: edupont
---
# <a name="get-ready-for-doing-business"></a><a name="get-ready-for-doing-business"></a>Gör dig redo för affärer
...
## <a name="teaching-tips-and-tours"></a><a name="teaching-tips-and-tours"></a>Undervisningstips och turer
...
## <a name="role-specific-home-pages"></a><a name="role-specific-home-pages"></a>Rollspecifika startsidor
...
## <a name="company-information"></a><a name="company-information"></a>Företagsinformation
...
## <a name="adding-users-and-permissions"></a><a name="adding-users-and-permissions"></a>Lägga till användare och behörigheter
...
## <a name="product-help"></a><a name="product-help"></a>Produkthjälpen
...
### <a name="set-up-your-company-in-"></a><a name="set-up-your-company-in-"></a>Konfigurera ditt företag i [!INCLUDE[prod_short](includes/prod_short.md)]
