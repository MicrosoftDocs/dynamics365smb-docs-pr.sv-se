...
ms.author: edupont
---
# <a name="export-and-import-approval-workflows" />Exportera och importera godkännandearbetsflöden
...
## <a name="export-a-workflow" />Exportera ett arbetsflöde
...
## <a name="import-a-workflow" />Importera ett arbetsflöde
