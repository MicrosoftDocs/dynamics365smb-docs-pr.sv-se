...
ms.author: edupont
---
# <a name="delete-approval-workflows"></a><a name="delete-approval-workflows"></a>Ta bort arbetsflöden för godkännande
...
## <a name="delete-a-workflow"></a><a name="delete-a-workflow"></a>Ta bort arbetsflödet
