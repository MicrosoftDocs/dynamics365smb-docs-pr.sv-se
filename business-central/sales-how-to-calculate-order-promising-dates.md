...
ms.author: edupont
---
# <a name="calculate-order-promising-dates"></a><a name="calculate-order-promising-dates"></a>Beräkna orderlöftesdatum
...
## <a name="about-order-promising"></a><a name="about-order-promising"></a>Om Orderlöfte
...
### <a name="available-to-promise"></a><a name="available-to-promise"></a>Disponibelt att lova
...
### <a name="capable-to-promise"></a><a name="capable-to-promise"></a>Kapabel att lova
...
### <a name="calculations"></a><a name="calculations"></a>Beräkningar
...
## <a name="to-set-up-order-promising"></a><a name="to-set-up-order-promising"></a>Så här skapar du orderlöfte
...
### <a name="inbound-and-outbound-warehouse-handling-times-in-order-promising"></a><a name="inbound-and-outbound-warehouse-handling-times-in-order-promising"></a>Ankommande och avgående lagerhanteringstider i order löftet
...
#### <a name="to-enter-inbound-and-outbound-warehouse-handling-times-on-locations"></a><a name="to-enter-inbound-and-outbound-warehouse-handling-times-on-locations"></a>Att ange inkommande och utgående lagerhanteringstider på platser
...
## <a name="to-make-an-item-critical"></a><a name="to-make-an-item-critical"></a>Så här gör du en artikel kritisk
...
## <a name="to-calculate-an-order-promising-date"></a><a name="to-calculate-an-order-promising-date"></a>Så här beräknar du ett orderlöftesdatum
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relaterad [Microsoft utbildning](/training/modules/promising-sales-order-delivery-dynamics-365-business-central/)
