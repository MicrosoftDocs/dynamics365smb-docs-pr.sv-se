...
---
# <a name="set-up-jobs-prices-and-job-posting-groups" />Ställ in projekt, priser och projektbokföringsmallar
...
## <a name="to-set-general-information-for-jobs" />Så här anger du allmän information för projekt
...
### <a name="to-set-up-job-usage-tracking" />Så här anger du projektförbrukningsspårning
...
## <a name="to-set-up-prices-for-resources-items-and-general-ledger-accounts-for-jobs" />För att skapa priser för resurser, artiklar och redovisningskonton för jobb
...
## <a name="to-set-up-job-posting-groups" />Så här lägger du upp projektbokföringsmallar
