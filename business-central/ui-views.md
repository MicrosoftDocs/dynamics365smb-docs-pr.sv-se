...
ms.author: edupont
---
# <a name="save-and-personalize-list-views" />Spara och anpassa listvyer
...
## <a name="to-save-a-view" />För att spara en vy
...
## <a name="to-rename-or-remove-a-view" />Så här byter du namn på eller tar bort en vy
...
## <a name="managing-many-views" />Hantera många vyer
