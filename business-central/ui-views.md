...
ms.author: edupont
---
# <a name="save-and-personalize-list-views"></a><a name="save-and-personalize-list-views"></a><a name="save-and-personalize-list-views"></a>Spara och anpassa listvyer
...
## <a name="to-save-a-view"></a><a name="to-save-a-view"></a><a name="to-save-a-view"></a>För att spara en vy
...
## <a name="to-rename-or-remove-a-view"></a><a name="to-rename-or-remove-a-view"></a><a name="to-rename-or-remove-a-view"></a>Så här byter du namn på eller tar bort en vy
...
## <a name="managing-many-views"></a><a name="managing-many-views"></a><a name="managing-many-views"></a>Hantera många vyer
