...
ms.author: edupont
---
# <a name="convert-service-contracts-that-include-vat-amounts" />Så här omvandlar du servicekontrakt som innehåller momsbelopp
...
### <a name="to-correct-an-invoice-for-a-prepaid-service-contract" />Så här korrigerar du en faktura för ett förskottsbetalt servicekontrakt
...
### <a name="to-create-a-credit-memo-for-vat-difference" />Så här skapar du en kreditnota för momsdifferens
...
### <a name="to-create-contract-expiration-dates-in-contract-lines" />Så här skapar du utgångsdatum på kontraktsrader
...
### <a name="to-create-a-new-credit-memo" />Så är skapar du en ny kreditnota
