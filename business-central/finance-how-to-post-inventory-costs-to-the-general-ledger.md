...
ms.author: edupont
---
# <a name="reconcile-inventory-costs-with-the-general-ledger" />Stämma av lagerkostnader med redovisningen
...
## <a name="to-post-inventory-costs-manually" />Bokföra lagerkostnader manuellt
...
## <a name="to-audit-the-reconciliation-between-the-inventory-ledger-and-the-general-ledger" />För att granska avstämningen mellan inventeringen och redovisningen.
...
## <a name="reporting-costs-and-reconciling-with-the-general-ledger" />Rapportera kostnader och stämma av med redovisningen
