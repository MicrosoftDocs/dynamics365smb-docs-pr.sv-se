...
ms.author: bholtorf
---
# <a name="set-up-payment-methods"></a><a name="set-up-payment-methods"></a>Ange betalsätt
...
## <a name="to-set-up-a-payment-method"></a><a name="to-set-up-a-payment-method"></a>Så här definierar du betalningssätt:
...
## <a name="to-assign-a-payment-method-to-a-customer-or-vendor"></a><a name="to-assign-a-payment-method-to-a-customer-or-vendor"></a>Så här kopplar du betalningssätt till en kund eller leverantör
