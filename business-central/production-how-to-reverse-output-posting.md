...
ms.author: edupont
---
# <a name="reverse-output-posting"></a><a name="reverse-output-posting"></a><a name="reverse-output-posting"></a>Återföra bokföring av utflöde
...
## <a name="to-reverse-an-output-posting"></a><a name="to-reverse-an-output-posting"></a><a name="to-reverse-an-output-posting"></a>Så här återför du en utflödesbokföring
