...
---
# <a name="pick-items-with-inventory-picks" />Plocka artiklar med lagerplockning
...
## <a name="to-create-multiple-inventory-picks-with-a-batch-job" />Så här skapar du flera lagerplockningar med batch-jobbet
...
## <a name="to-create-the-pick-in-two-steps" />Så här skapar du plockningen i två steg

### <a name="to-request-an-inventory-pick-by-releasing-the-source-document" />Så här begär du en lagerplockning genom att släppa källdokumentet
...
### <a name="to-create-an-inventory-pick-based-on-the-source-document" />Så här skapar du en lagerplockning från källdokumentet:
...
## <a name="to-record-inventory-picks" />När du vill registrera lagerplockning
...
## <a name="handling-assemble-to-order-items-with-inventory-picks" />Hantering av artikel för montering mot kundorder i lagerplockningar
