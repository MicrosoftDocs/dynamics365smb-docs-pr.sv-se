...
ms.author: edupont
---
# <a name="walkthrough-calculating-work-in-process-for-a-job"></a><a name="walkthrough-calculating-work-in-process-for-a-job"></a>Genomgång: Beräkna produkter i arbete för ett projekt
...
## <a name="calculating-wip"></a><a name="calculating-wip"></a>Beräkna PIA
...
### <a name="to-calculate-wip"></a><a name="to-calculate-wip"></a>Så här beräknar du PIA
...
### <a name="to-review-wip-warnings"></a><a name="to-review-wip-warnings"></a>Så här kan du granska PIA-varningar
...
### <a name="to-recalculate-wip"></a><a name="to-recalculate-wip"></a>Så här beräknar du PIA på nytt
...
## <a name="posting-wip-to-general-ledger"></a><a name="posting-wip-to-general-ledger"></a>Bokföra PIA i reodvisningen

 Nu när Tricia har beräknat PIA för det här projektet kan hon bokföra det i redovisningen.  

### <a name="to-post-wip-to-general-ledger"></a><a name="to-post-wip-to-general-ledger"></a>Så här bokför du PIA i redovisningen
...
## <a name="reversing-a-wip-posting"></a><a name="reversing-a-wip-posting"></a>Återföra en PIA-bokning
...
### <a name="to-reverse-a-wip-posting"></a><a name="to-reverse-a-wip-posting"></a>Så här återför du en PIA-transaktioner
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relaterad [Microsoft utbildning](/training/paths/calculate-post-job-wip/)
