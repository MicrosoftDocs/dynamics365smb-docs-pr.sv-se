...
ms.author: edupont
---
# <a name="revalue-fixed-assets" />Omvärdera anläggningstillgångar
...
## <a name="to-post-an-appreciation-from-the-fixed-asset-gl-journal" />Att bokföra uppskrivning från en redovisningsjournal.
...
## <a name="to-post-a-write-down-from-the-fixed-asset-gl-journal" />Att bokföra en nedskrivning från en redovisningsjournalen för anläggningstillgångar.
...
## <a name="to-perform-general-revaluation-of-fixed-assets" />Om du vill utföra allmän omvärdering av anläggningstillgångar
...
## <a name="to-post-additional-acquisition-costs" />Att bokföra ytterligare anskaffningskostnader
...
### <a name="example---posting-additional-acquisition-costs" />Exempel – bokföra ytterligare anskaffningskostnader
