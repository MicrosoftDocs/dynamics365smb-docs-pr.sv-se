...
## <a name="to-post-appreciation-from-the-fixed-asset-gl-journal"></a>Att bokföra uppskrivning från en redovisningsjournal
...
## <a name="to-post-other-acquisition-costs"></a>Att bokföra ytterligare anskaffningskostnader
...
### <a name="example---posting-other-acquisition-costs"></a>Exempel – bokföra ytterligare anskaffningskostnader
