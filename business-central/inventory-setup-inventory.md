...
| Organisera ditt lager på flera lägerställen, inklusive överföringsflöden. |[Konfigurera lagerställen](inventory-how-register-new-items.md) |
...
|Ange flera måttenheter (UOM) för en artikel som kan användas som alternativa enheter till exempel för försäljning, inköp eller produkttransaktioner.|[Ställa in måttenheter för artikel](inventory-how-setup-units-of-measure.md)|
|Som ett tillägg till artikelkort kan du registrera artikelinformation i ett visst lagerställe eller en viss variant.|[Konfigurera lagerställeenheter](inventory-how-to-set-up-stockkeeping-units.md)|
