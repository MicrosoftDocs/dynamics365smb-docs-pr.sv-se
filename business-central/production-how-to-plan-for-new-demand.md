...
ms.author: edupont
---
# <a name="plan-for-new-demand-order-by-order"></a><a name="plan-for-new-demand-order-by-order"></a><a name="plan-for-new-demand-order-by-order"></a>Planera ny behovsorder efter order
...
## <a name="to-plan-for-new-production-order-demand"></a><a name="to-plan-for-new-production-order-demand"></a><a name="to-plan-for-new-production-order-demand"></a>Så här planerar du för ett nytt produktionsorderbehov
...
## <a name="to-plan-for-any-new-demand"></a><a name="to-plan-for-any-new-demand"></a><a name="to-plan-for-any-new-demand"></a>Så här planerar du för valfritt nytt behov
...
## <a name="to-make-supply-orders"></a><a name="to-make-supply-orders"></a><a name="to-make-supply-orders"></a>Så här skapar du leveransorder
