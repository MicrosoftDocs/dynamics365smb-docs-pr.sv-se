...
ms.author: edupont
---
# <a name="plan-for-new-demand-order-by-order" />Planera ny behovsorder efter order
...
## <a name="to-plan-for-new-production-order-demand" />Så här planerar du för ett nytt produktionsorderbehov
...
## <a name="to-plan-for-any-new-demand" />Så här planerar du för valfritt nytt behov
...
## <a name="to-make-supply-orders" />Så här skapar du leveransorder
