...
ms.author: edupont
---
# <a name="process-purchase-returns-or-cancellations" />Behandla inköpsreturer eller annulleringar
...
## <a name="inventory-costing" />Lagerkostnad
...
## <a name="to-create-a-purchase-credit-memo-from-a-posted-purchase-invoice" />Skapa en ny inköpskreditnota från en bokförd inköpsfaktura.
...
## <a name="to-create-a-purchase-credit-memo-by-copying-a-posted-purchase-invoice" />Skapa en ny inköpskreditnota genom att kopiera en bokförd inköpsfaktura.
...
## <a name="to-create-a-purchase-return-order-based-on-one-or-more-posted-purchase-documents" />Att skapa en inköpsreturorder baserat på minst ett bokfört inköpsdokument.
...
## <a name="to-create-a-replacement-purchase-order-from-a-purchase-return-order" />Skapa en ersättningsinköpsorder från en inköpsreturorder
...
## <a name="to-create-a-purchase-allowance" />Så här skapar du ett prisavdrag vid inköp:
...
## <a name="to-combine-return-shipments" />Så här kombinerar du returutleveranser
...
### <a name="to-remove-open-purchase-return-orders-after-combined-return-shipment-posting" />Så här tar du bort öppna inköpsreturorder efter kombinerad returutleverans bokföring
...
## <a name="see-related-microsoft-training" />Se relaterad [Microsoft utbildning](/training/paths/return-items-dynamics-365-business-central/)
