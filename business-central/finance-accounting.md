...
## <a name="accountant-role-center" />Rollcentret Revisor
...
## <a name="company-hub" />Företagsnav
...
#### <a name="to-add-your-accountant-as-a-guest-user" />Så här lägger du till din revisor som gästanvändare
...
#### <a name="to-add-the-accountant-to-the-right-company" />Så här lägger du till revisorn till rätt företag
