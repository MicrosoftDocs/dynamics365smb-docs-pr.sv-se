...
ms.author: edupont
---
# <a name="accountant-experiences-in-"></a><a name="accountant-experiences-in-"></a><a name="accountant-experiences-in-"></a>Revisorupplevelse i Financials [!INCLUDE[prod_long](includes/prod_long.md)]
...
## <a name="accountant-role-center"></a><a name="accountant-role-center"></a><a name="accountant-role-center"></a>Rollcentret Revisor
...
## <a name="company-hub"></a><a name="company-hub"></a><a name="company-hub"></a>Företagsnav
...
## <a name="inviting-your-external-accountant-to-your-"></a><a name="inviting-your-external-accountant-to-your-"></a><a name="inviting-your-external-accountant-to-your-"></a><a name="inviteaccountant"></a>Bjud in din externa revisorn till [!INCLUDE[prod_short](includes/prod_short.md)]
...
### <a name="adding-your-accountant-to-your-microsoft-365-in-the-azure-portal"></a><a name="adding-your-accountant-to-your-microsoft-365-in-the-azure-portal"></a><a name="adding-your-accountant-to-your-microsoft-365-in-the-azure-portal"></a>Lägga till din revisor i Microsoft 365 i Azure Portal
...
#### <a name="to-add-your-accountant-as-a-guest-user"></a><a name="to-add-your-accountant-as-a-guest-user"></a><a name="to-add-your-accountant-as-a-guest-user"></a>Så här lägger du till din revisor som gästanvändare
...
#### <a name="to-give-your-accountant-access-to-your-"></a><a name="to-give-your-accountant-access-to-your-"></a><a name="to-give-your-accountant-access-to-your-"></a>För att ge din revisor åtkomst till ditt [!INCLUDE[prod_short](includes/prod_short.md)]
...
### <a name="importing-the-new-user-into-"></a><a name="importing-the-new-user-into-"></a><a name="importing-the-new-user-into-"></a>Importera den nya användaren till [!INCLUDE[prod_short](includes/prod_short.md)]
...
#### <a name="to-add-the-accountant-to-the-right-company"></a><a name="to-add-the-accountant-to-the-right-company"></a><a name="to-add-the-accountant-to-the-right-company"></a>Så här lägger du till revisorn till rätt företag
