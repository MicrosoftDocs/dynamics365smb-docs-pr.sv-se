...
ROBOTS: NOINDEX
---
# <a name="troubleshoot-connectivity-for-business-central"></a><a name="troubleshoot-connectivity-for-business-central"></a>Felsökning: anslutning för Business Central
...
## <a name="start-the-connectivity-check"></a><a name="start-the-connectivity-check"></a>Starta anslutningskontrollen
...
## <a name="basic-internet-connectivity"></a><a name="basic-internet-connectivity"></a>Grundläggande internetanslutning
...
## <a name="cdn-content-delivery-network-resources-loading"></a><a name="cdn-content-delivery-network-resources-loading"></a>CDN (Content Delivery Network) inläsning av resurser
...
## <a name="user-authentication"></a><a name="user-authentication"></a>Användarautentisering
...
## <a name="business-central-environments-discovery"></a><a name="business-central-environments-discovery"></a>Identifiering av Business Central-miljöer
...
## <a name="application-service-connectivity"></a><a name="application-service-connectivity"></a>Appens tjänstanslutning
...
## <a name="web-server-connectivity"></a><a name="web-server-connectivity"></a>Webbserveranslutning
...
## <a name="service-health-status"></a><a name="service-health-status"></a>Status för tjänstens hälsotillstånd
