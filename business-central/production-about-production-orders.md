...
ms.author: edupont
---
# <a name="about-production-orders"></a><a name="about-production-orders"></a>Om produktionsorder
...
## <a name="production-order-creation"></a><a name="production-order-creation"></a>Skapa produktionsorder
...
## <a name="limitations-on-production-order-creation"></a><a name="limitations-on-production-order-creation"></a>Begränsningar vid skapande av produktionsorder
...
## <a name="production-order-status"></a><a name="production-order-status"></a>Status för produktionsorder
...
### <a name="simulated-production-order"></a><a name="simulated-production-order"></a>Simulerad produktionsorder
...
### <a name="planned-production-order"></a><a name="planned-production-order"></a>Planerad produktionsorder
...
### <a name="firm-planned-production-order"></a><a name="firm-planned-production-order"></a>Fast planerad produktionsorder
...
### <a name="released-production-order"></a><a name="released-production-order"></a>Släppt produktionsorder
...
### <a name="finished-production-order"></a><a name="finished-production-order"></a>Färdiga produktionsorder
...
## <a name="production-order-execution"></a><a name="production-order-execution"></a>Utföra en produktionsorder
...
### <a name="material-consumption"></a><a name="material-consumption"></a>Materialförbrukning
...
### <a name="production-output"></a><a name="production-output"></a>Produktionsutflöde
...
### <a name="posting-consumption-and-output"></a><a name="posting-consumption-and-output"></a>Bokföra förbrukning och utflöde
...
### <a name="production-journal"></a><a name="production-journal"></a>Produktionsjournal
