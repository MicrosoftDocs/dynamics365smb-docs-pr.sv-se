...
Produktionsorder är centrala komponenter i produktionsfunktion och de innehåller följande information:  

- Produkter planerade för produktion  
- Material som krävs för planerade produktionsorder  
- Produkter som har tillverkats  
...
Du skapar produktionsorder med hjälp av information från:  
...
- Skapad från [planeringsförslaget](production-how-to-run-mps-and-mrp.md)  
- Skapas från sidan [Försäljningsorderplanering](production-how-to-create-production-orders-from-sales-orders.md)  
- Skapade från sidan [Orderplanering](production-how-to-plan-for-new-demand.md)  
- Du använder funktionen för [omplanering](production-how-to-replan-refresh-production-orders.md) i produktionsorder  
...
- Att färdigställa produktionsordern är en viktig uppgift när det gäller att slutföra livscykeln för kostnadsberäkning för artikeln som tillverkas. När du har avslutat en produktionsorder kan du justera och stämma av kostnaden.  
...
Förbrukningen av material kan bearbetas via [förbrukningsjournalen](production-how-to-post-consumption.md), men kan även registreras automatiskt av [!INCLUDE [prod_short](includes/prod_short.md)], även kallat för automatisk rapportering (bokföring). Rapporteringsmetoderna Manuell, Framåt och Bakåt är tillgängliga.
...
Utflöde kan bearbetas via [utflödesjournalen](production-how-to-post-output-quantity.md), men kan även registreras automatiskt. [!INCLUDE [prod_short](includes/prod_short.md)] kopierar bokföringsprogrammet automatiskt från produktionsgrupps- eller maskingruppskortet till verksamhetsföljden för produktionsordern när du uppdaterar. Precis som för materialförbrukning, finns det Manuell, Framåt och Bakåt rapporteringsmetoder för utflöde.

Den manuella metoden använder utflödesjournalen för att ange den tid som har förbrukats och producerat antal.  
...
Med produktionsjournalen kan du utföra många av de funktionerna som du kan med förbruknings- och utflödesjournalen. Dimensioner, artikelspårning och lagerplatsinnehåll hanteras på samma sätt.  
...
- Kvantiteter och tidpunkter som redan har bokförts för ordern visas längst ned i journalen som faktiska poster.  
