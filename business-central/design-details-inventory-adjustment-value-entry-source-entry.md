...
# <a name="posting-date-on-adjustment-value-entry-compared-to-the-source-entry"></a><a name="posting-date-on-adjustment-value-entry-compared-to-the-source-entry"></a>Bokförings datumet på justeringsvärde transaktionen jämfört med källtransaktionen
...
## <a name="revaluation-scenario"></a><a name="revaluation-scenario"></a>Omvärderingsscenario
...
### <a name="to-test-the-scenario"></a><a name="to-test-the-scenario"></a>För att testa scenariot
...
### <a name="conclusion"></a><a name="conclusion"></a>Slutsats
...
## <a name="item-charge-scenario"></a><a name="item-charge-scenario"></a>Artikelomkostnadsscenario
...
### <a name="to-test-the-scenario-1"></a><a name="to-test-the-scenario-1"></a>För att testa scenariot
