...
# <a name="posting-date-on-adjustment-value-entry-compared-to-the-source-entry" />Bokförings datumet på justeringsvärde transaktionen jämfört med källtransaktionen
...
## <a name="revaluation-scenario" />Omvärderingsscenario
