...
ms.author: jswymer
---
# <a name="legacy-set-the-layout-used-by-a-report" />(Äldre) Ange layout för en rapport
...
## <a name="to-change-which-report-layout-to-use-for-a-report-or-document" />Ändra vilken rapportlayout som ska användas för en rapport eller ett dokument
...
## <a name="to-change-the-custom-layout-to-use-for-a-report-layout" />Så här ändrar du den anpassade layouten som ska användas för en rapportlayout
