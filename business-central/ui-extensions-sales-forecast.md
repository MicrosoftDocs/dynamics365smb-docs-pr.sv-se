...
# <a name="the-sales-and-inventory-forecast-extension"></a><a name="the-sales-and-inventory-forecast-extension"></a>Tillägget Försäljning och lagerprognos
...
## <a name="setting-up-forecasting"></a><a name="setting-up-forecasting"></a>Konfigurera prognoser
...
## <a name="use-the-forecasts"></a><a name="use-the-forecasts"></a>Att använda prognoserna
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Se relaterad [Microsoft utbildning](/training/modules/use-sales-inventory-forecast-extension/)
