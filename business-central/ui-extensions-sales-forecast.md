...
# <a name="the-sales-and-inventory-forecast-extension" />Tillägget Försäljning och lagerprognos
...
## <a name="setting-up-forecasting" />Konfigurera prognoser
...
## <a name="use-the-forecasts" />Att använda prognoserna
...
### <a name="data-required-for-forecast" />Data som krävs för prognoser
...
## <a name="a-nameanchortext-acreate-and-use-your-own-predictive-web-service-for-sales-and-inventory-forecasts" /><a name="AnchorText"> </a>Skapa och använda din egen prediktiva webbtjänst för försäljnings- och lagerprognoser
...
## <a name="see-related-microsoft-trainingtrainingmodulesuse-sales-inventory-forecast-extension" />Se relaterad [Microsoft utbildning](/training/modules/use-sales-inventory-forecast-extension/)
