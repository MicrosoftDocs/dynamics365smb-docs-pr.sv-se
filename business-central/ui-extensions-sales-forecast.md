...
Innan du använder webbtjänsten komprimerar [!INCLUDE[d365fin](includes/d365fin_md.md)] transaktionerna efter **Artikelnr** och **Bokföringsdatum** baserat på värdet i fältet **Periodtyp** på sidan **Inställningar för försäljnings- och lagerprognos**.
...
6. Välj ikonen ![Glödlampa som öppnar funktionen Berätta](media/ui-search/search_small.png "Berätta vad du vill göra"), ange **Inställningar för försäljnings- och lagerprognoser** och välj sedan relaterad länk.  
