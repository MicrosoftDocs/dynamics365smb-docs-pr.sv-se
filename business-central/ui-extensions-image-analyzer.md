...
# <a name="the-image-analyzer-extension"></a><a name="the-image-analyzer-extension"></a>Tillägget Image Analyzer
...
## <a name="privacy-notice"></a><a name="privacy-notice"></a>Sekretesspolicy
...
## <a name="switch-on-the-image-analyzer-extension"></a><a name="switch-on-the-image-analyzer-extension"></a>Aktivera tillägget Image Analyzer
...
## <a name="analyze-an-item-image"></a><a name="analyze-an-item-image"></a>Analysera en artikelbild
...
## <a name="analyze-a-contact-person-picture"></a><a name="analyze-a-contact-person-picture"></a>Analysera en kontaktpersonsbild
...
## <a name="use-your-own-computer-vision-api-account"></a><a name="use-your-own-computer-vision-api-account"></a>Använda ditt konto för Computer Vision API
...
## <a name="see-how-many-analyses-you-have-left-in-the-current-period"></a><a name="see-how-many-analyses-you-have-left-in-the-current-period"></a>Se hur många analyser som du har kvar i den aktuella perioden
...
## <a name="stop-using-the-image-analyzer-extension"></a><a name="stop-using-the-image-analyzer-extension"></a>Sluta använda tillägget Image Analyzer
