...
ms.author: edupont
---
# <a name="send-electronic-documents"></a><a name="send-electronic-documents"></a>Skicka elektroniska dokument
...
### <a name="to-send-an-electronic-sales-invoice"></a><a name="to-send-an-electronic-sales-invoice"></a>Så här kan du skicka en elektronisk försäljningsfaktura
